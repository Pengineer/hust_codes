...
public class MapperClass extends Mapper<Object, Text, Text, IntWritable>{//定义输入输出参数类型

	//定义输出参数
	//Text是Hadoop封装String后的类型，IntWritable是Hadoop封装Integer后的类型，这些类能够被序列化
	...
	protected void map(Object key, Text value, Context context) throws IOException, InterruptedException {
		...
		while (stringTokenizer.hasMoreElements()) {
			...
			context.write(keyText, intValue);//等价于：context.write("XXXX",1);
		}
