...
//import eoas.dao.IHibernateBaseDao;
import eoas.service.IUploadService;
import eoas.tool.SignID;
import eoas.tool.FileRecord;
...
@Component
@Scope("session")
public class UploadService implements IUploadService ,java.io.Serializable{
	private static final long serialVersionUID = 7834367998013218528L;
//	@Autowired
//	private transient IHibernateBaseDao dao;
	...
	synchronized public String addFile(String groupId, File file) {
		/*System.out.println(fileGroups.values().toString());
		News n5 = new News();
		n5.setTitle("8");
		n5.setSource(fileGroups.values().toString());
		newsService.add(n5);*/
