...
<body>
	<div id="wrap">
		<div class="content">
			<div class="panel panel-success">
				<div class="panel-heading">加班申请</div>
				<div><s:hidden id="tag" name="tag" /></div>
				<table id="workOverTimeList" class="table">
					<thead>
					  <tr>
					  	<th>申请日期</th>
					    <th>申请人</th>
					...
					<tbody>
						<input id = "addFive" name = "btn" value = "新申请" onclick = "javascript:location.href = 'attendance/toAdd.action?tag=5'" type = "button" />
					</tbody>
		        </table>
	        </div>
		</div>
	...
	<script type="text/javascript" src="javascript/oa/attendance/attendance_listFive.js"></script>
</body>
</html>
