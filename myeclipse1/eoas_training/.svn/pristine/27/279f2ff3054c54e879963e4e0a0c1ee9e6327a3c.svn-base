	...
	<body>
		<div class="title_bar">
			<ul>
				...
				<li class="text_red"><s:text name="解决方案修改" /></li>
			</ul>
		</div>
		<div class="div_table">
			<s:form action = "modify"  namespace="/solution" theme="simple">
					...
					<tr>
						<td width="100" align="right" bgcolor="#b3c6d9" style="padding-top:5px; vertical-align:top;">
 						...
 						<td>
							...
							<input type="hidden" name="solutionId" value="<s:property value="solutionId" />" />
						</td> 
					</tr>
