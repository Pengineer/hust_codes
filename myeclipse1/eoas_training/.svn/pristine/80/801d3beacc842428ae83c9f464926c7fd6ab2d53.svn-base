...
<head>
	...
	<script type="text/javascript" src="script/pageCommon.js"></script>
			...
			<td align=center>
				<div id=Logout>
					...
					<div id=LogoutOperate>
                    	<img src="style/blue/images/logout/logout2.gif" border=0 /> <a href="jsp/oa/home/loginUI.jsp">重新进入系统</a>
