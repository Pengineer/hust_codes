$(document).ready(function(){
	...
	$('#newsList').dataTable({  
	    ...
	    "sAjaxSource": "news/list.action",
	    "fnRowCallback": function( nRow, aData, iDisplayIndex ) {
            $('td:eq(0)', nRow).html('<a href="news/view.action?newsId=' + aData[4] + '">' +
                aData[4] + '</a>');
            $('td:eq(4)', nRow).html('<a href="news/delete.action?newsId=' + aData[4] + '">' +
                    '删除' + '</a>').append(('<a href="news/toModify.action?newsId=' + aData[4] + '">' +
                            '修改' + '</a>'));
            return nRow;
        },
	    "bServerSide": false, 
