...
$(function(){
	...
	$(".j-subMenu").toggle(
		function(){
			var $onLi = $(this).parent();
			$(".j-subMenuList", $onLi).stop().show(500);
			$(".u-titleIcon", $onLi).removeClass("glyphicon-plus").addClass("glyphicon-minus");
		},
		function(){
			var $onLi = $(this).parent();
			$(".j-subMenuList", $onLi).stop().hide(500);
			$(".u-titleIcon", $onLi).removeClass("glyphicon-minus").addClass("glyphicon-plus");
		}
	);
})
