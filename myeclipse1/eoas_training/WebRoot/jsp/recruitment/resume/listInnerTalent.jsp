...
<html>
	...
	<body>
		...
		<div id="wrap">
			<div class="content">
				<s:form name ="selectedTalents" action="delete" theme="simple" namespace="/position">
					<div class="panel panel-success">
						<div class="panel-heading">人才库</div>
						<table id="allTalentsList" class="table">
				          <thead>
				            <tr>     
				            	<th>姓名</th>
				                <th>手机号码</th>
	...
	<script type="text/javascript" src="javascript/recruitment/resume/talent_list.js"></script>	
