...
<html>
	...
	<body>
			...
			<div class="content">
				<div class="m-titleBar">
					<ol class="breadcrumb mybreadcrumb">当前位置：
					  <li><a href="#"></a></li>
					  <li class="active">权限模块</li>
					  <li class="active">列表</li>
					</ol>
				</div>
				<div>
					<table id="rightList" class="table table-striped table-bordered" cellspacing="0" width="100%">
						<thead>
						  	<tr>
								<th>权限名称</th>
								<th>权限代码</th>
		...
		<script type="text/javascript" src="javascript/oa/right/right_list.js"></script>
