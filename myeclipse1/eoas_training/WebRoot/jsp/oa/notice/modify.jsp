...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body onload="displayFileError();">
		...
		<div class="div_table">
			<s:form theme="simple" method="post" id="form_notice" validate="true" action="modify" namespace="/notice">
				<div class="errorInfo">
				...
				<table width="100%" border="1" cellspacing="0" cellpadding="4" style="border-collapse:collapse;" bordercolor="#253d56">
					<tr>
						...
						<td><s:textfield name="notice.title" id="title" value="%{notice.title}" theme="simple" size="60" cssClass="inputcss" onblur="check()"/></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><s:textfield name="notice.source" value="%{notice.source}" theme="simple" size="60" cssClass="inputcss" /></td>
					</tr>
					<tr>
						<td width="100" align="right" bgcolor="#b3c6d9"><s:text name="可见范围" />：</td>
						<td><s:radio name="notice.isopen" list="#{'0':'内网可见','1':'所有可见'}" value="%{notice.isopen}" theme="simple" /></td>
					</tr>
					...
					<tr>
						...
						<td>
							<s:textfield name="notice.content" />
							<input type="hidden" name="noticeId" value="<s:property value="noticeId" />" />
						</td>
					</tr>
					<tr>
