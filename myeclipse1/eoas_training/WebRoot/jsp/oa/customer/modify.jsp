	...
	<body>
		<div class="title_bar">
			<ul>
				...
				<li class="text_red"><s:text name="修改客户信息" /></li>
			</ul>
		</div>
		<div class="div_table">
			<s:form action="modify" id="form_customer" namespace="/customer" theme="simple" method="post">
				<table>
					<tr>
						<td>客户信息</td>
						<td><input type = "hidden" name = "customer.id" value = "${customer.id}"></input></td>
						<td><input type = "hidden" name = "contact.id" value = "${contact.id}"></input></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td class="txtpadding" colspan="3"><input type="text" name="customer.consultationTime" id="customerConsultationTime" 
							value="<s:date name="customer.consultationTime" format="yyyy-MM-dd" />" format="yyyy-MM-dd"/></td>
					...
					<tr>
						...
						<td><input type = "text" name = "contact.birthday" id = "contactBirthday"
						value = "<s:date name = "contact.birthday" format="yyyy-MM-dd" />" format="yyyy-MM-dd" /></td>
