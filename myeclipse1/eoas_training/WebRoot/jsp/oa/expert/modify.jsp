...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body class="g-pageRight">
		<div class="g-wrapper">
			<ol class="breadcrumb mybreadcrumb">当前位置：
			  ...
			  <li class="active">修改专家顾问</li>
			</ol>
			<div class="m-form">
				<s:form class="form-horizontal" action="modify"  namespace="/expert" id = "expert_add" theme="simple">
					...
					<div class="m-main-content">
						...
						<div id="basic" style="display:none;">
							...
							<div class="form-group m-form-group">
								<label class="col-sm-3 control-label u-text-right">民族</label>
								<div class="col-sm-6">
							...
							<div class="form-group m-form-group">
								<label class="col-sm-3 control-label u-text-right">性别</label>
								<div class="col-sm-6">
							...
							<div class="form-group m-form-group">
								...
								<div class="col-sm-6">
									<input id ="birthday" name="expert.birthday" value='<s:date name="expert.birthday" format="yyyy-MM-dd" />' class="form-control validate[required, custom[date]]" placeholder="出生日期" />
								</div>
								<div class="col-sm-3"></div>
							</div>
							<div class="form-group m-form-group">
						...
						<div id="jobInfo" style="display:none;">
							...
							<div class="form-group m-form-group">
								...
								<div class="col-sm-6">
									<s:select cssClass="m-select validate[required]"  name="expert.postdoctor" list="#{0:'否',1:'是'}" listValue="value" headerKey="" headerValue="请选择" />	
								</div>
								<div class="col-sm-3"></div>
							</div>
							<div class="form-group m-form-group">
							...
							<div class="form-group m-form-group">
								<label class="col-sm-3 control-label u-text-right">最后学历</label>
								<div class="col-sm-6">
									<s:select cssClass="m-select validate[required]" name="expert.lastEducation" list="#{'本科':'本科','硕士研究生':'硕士研究生','博士研究生':'博士研究生'}"
									 listValue="value" headerKey="" headerValue="请选择" />	
								</div>
								<div class="col-sm-3"></div>
							</div>
							<div class="form-group m-form-group">
								<label class="col-sm-3 control-label u-text-right">最后学位</label>
								<div class="col-sm-6">
									<s:select cssClass="m-select validate[required]" name="expert.degree" list="#{'学士':'学士','硕士':'硕士','博士':'博士'}" listValue="value" headerKey="" headerValue="请选择" />	
								</div>
								<div class="col-sm-3"></div>
							</div>
							<div class="form-group m-form-group">
							...
							<div class="form-group m-form-group">
								<label class="col-sm-3 control-label u-text-right">学科代码</label>
								<div class="col-sm-6">
	...
	<script type="text/javascript" src="javascript/oa/expert/modify.js"></script>
