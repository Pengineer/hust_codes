...
public class SinossBook {

	private String id;//著作id
	private String sinossId;//管理平台著作id
	private String projectName;//项目名字
	private String press;//出版社
	private String bookType;//著作类型
	private Date pressTime;//出版时间
	private String isEnglish;//是否译成英文
	private String pressAddress;//出版地址
	...
	private String wordNumber;//总字数（千字）
