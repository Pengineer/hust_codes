 ...
 *
 */
public class GeneralEndInspectionFundingImporter extends Importer{
...
//	    validate();
	...
	private void importData() throws Exception {
		...
		projectFundingBatch.setDate(tool.getDate("2014-12-23"));
		projectFundingBatch.setName("2014年第二批高等学校哲学社会科学繁荣计划专项资金拨款");		
		
		fundingList.setCount(1558);
		...
		while (next(reader)) {			
			...
			funding.setDate(tool.getDate(2014, 12, 22));
	...
	public GeneralEndInspectionFundingImporter(){
	}
	
	public GeneralEndInspectionFundingImporter(String file1) {
