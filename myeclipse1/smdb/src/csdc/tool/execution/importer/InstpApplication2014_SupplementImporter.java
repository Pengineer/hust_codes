...
/**
 * 导入《2014年基地项目申请一览表_补录.xls》
 * @author pengliang
 * 备注：本次导入的数据是立项Excel中无申请信息的项目，根据评审表创建和2013年类型的Excel，然后参照2013年的代码导入。
 *
 */

public class InstpApplication2014_SupplementImporter extends Importer {
	...
	private void importData() throws Exception {
		...
		while (next(reader)) {
			...
			application.setFinalAuditDate(tool.getDate(application.getYear(), 9, 30));
...
//		member.setSpecialistTitle(academicFinder.findAcademic(person).getSpecialityTitle());
	...
	public InstpApplication2014_SupplementImporter() {}
	
	public InstpApplication2014_SupplementImporter(String file) {
