...
public class FileTool {
	...
	public static String saveUpload(File file, String fileName, String savePath, String signID) throws Exception {
		// 获得绝对路径
		String realPath = ApplicationContainer.sc.getRealPath(savePath), realName;
		// 获取源文件后缀名
	...
	public static String saveUploadFile(File file, String savePath, String fileName, String oFileName) throws Exception {
		String realPath = ApplicationContainer.sc.getRealPath(savePath);// 获得硬盘路径
	...
	public static void fileDelete(String fileName) {
		fileName = ApplicationContainer.sc.getRealPath(fileName);
	...
	public static String getTrueFilename(String dir,String id, File file) {
		...
		if (dir.contains("mail")) {
			realName  = "mail_"+id+"_" + new SimpleDateFormat("yyyyMMddHHmmss").format(new Date()) +"_"+ SignID.getRandomString(4) +getExtension(file);
