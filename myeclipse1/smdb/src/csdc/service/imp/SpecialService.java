...
@Transactional
public class SpecialService extends ProjectService implements ISpecialService  {
	...
	public List getDireProjectListByGrantedId(String projectid, String personid){
		...
		String hql1 = "select gra.name, app.englishName, app.year, gra.applicantName, " +
				"gra.university.name, gra.divisionName from SpecialGranted gra, " +
				"SpecialApplication app ,SpecialMember mem where " +
	...
	public List getDireProjectListByGrantedId(String projectid){
		...
		map1.put("projectid", projectid);
		String hql1 = "select gra.name, app.englishName, app.year, gra.applicantName, " +
				"gra.university.name, gra.divisionName from SpecialGranted gra, SpecialApplication app " +
