...
public interface IUnitService extends IBaseService {
	 ...
	 * @param thisAction
	 */
	public void getValidateModifyOfAgency(Agency agency, List<BankAccount> list, InputValidate inputValidate, ActionSupport thisAction);
	 ...
	 * 设置机构的地址信息
	 * @param agency
	 * @param commonAddress 常规地址
	 * @param financeAddress 财务部门地址
	 * @param subjectionAddress 管理部门地址
	 * @return
	 */
	 ...
	 * @param commonAddress
	 */
	public void getValidateModify(InputValidate inputValidate, List<Address> commonAddress, ActionSupport thisAction);
