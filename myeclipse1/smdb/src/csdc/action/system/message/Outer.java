...
public class Outer extends MessageAction {
	...
	public String add() {
		...
		message.setAuthorName(xf.encode(message.getAuthorName()));
		message.setTitle(xf.encode(message.getTitle()));
		message.setContent(xf.encode(message.getContent()));
