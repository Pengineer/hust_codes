...
public class TopicSelectionApplyAuditAction extends ProjectBaseAction{
	...
	private int topsAuditStatus;//选题申请状态
	private String topsAuditOpinion;//选题申请意见
	private int topsAuditResult;//选题申请结果
	private String topsId;//选题id
	private String topsAuditPerson;//选题申请审核人
	private Date topsAuditDate;//选题申请审核时间
	...
	public String add() {
		...
		for(int i = 0; i < gids.length; i++) {
			...
			KeyTopic topicSelection = (KeyTopic) this.dao.query(KeyTopic.class, gids[i]);
