...
public class FirstAuditAction extends BaseAction{
	...
	private static final String PAGE_NAME = "specialApplicationFirstAuditPage";//列表页面名称
	private static final String HQL = "select app.id, app.name, app.discipline, u.name, app.applicantName, app.firstAuditDate, app.firstAuditResult " +
			"from SpecialApplication app left join app.university u where app.firstAuditResult is not null ";//列表页面名称
	...
	public String firstAudit() {
		try {
			String beanName = "firstAuditSpecialApplication";
