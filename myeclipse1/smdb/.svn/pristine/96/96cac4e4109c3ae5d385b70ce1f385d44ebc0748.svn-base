...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			<div class="link_bar">
				当前位置：社科项目数据&nbsp;&gt;&nbsp;专项任务项目&nbsp;&gt;&nbsp;申请数据&nbsp;&gt;&nbsp;添加
			</div>
			<div class="main">
				<s:form id="application_form" action="addResult" namespace="/project/special/application/apply">
			...
			<script type="text/javascript">
				seajs.use(['javascript/project/special/application/apply/add.js','javascript/project/project_share/application/validate.js'], function(add, validate) {
					validate.valid();
					add.init();
				});
			</script>
