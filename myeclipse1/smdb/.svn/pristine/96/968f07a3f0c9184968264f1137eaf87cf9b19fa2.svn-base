						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="title_bar_td"  align="left">
 					                <a href="selfspace/memo/toList.action" title="点击进入备忘列表" target="main">今天您有 <span style="color:red;" id="memo_count"><s:property value="#request.map.get('map1').get('memoCount')" /></span> 条备忘，请点击查看！</a>
 					            </td>
							</tr>
							...
							<tr>
				                ...
				                <td class="title_bar_td"  align="left">
									...
									<a href="selfspace/memo/toView.action?viewFlag=2&entityId=<s:property value='key'/>" title="点击查看详细信息" target="main"><s:property value="value"/></a>
				               </td>
				               <td class="title_bar_td"  align="right">
									<a class="modify_flag" href="" id="<s:property value='key'/>" title="取消提醒" ><span style="color:blue;">不再提醒</span></a>
				               </td>
							</tr>
				            </s:iterator>   
						</table>
