...
function FileProgress(file, targetID) {
	...
	if (!this.fileProgressWrapper) {
		...
		progressCancel.href = "javascript:void();";
		...
		var progressBarBoarder = document.createElement("div");
		progressBarBoarder.className = "bd_upload";
		progressBarBoarder.appendChild(progressBar);
		...
		this.fileProgressElement.appendChild(progressBarBoarder);
...
FileProgress.prototype.setCancelled = function () {
	...
	this.fileProgressElement.childNodes[3].childNodes[0].className = "progressBarError";
	this.fileProgressElement.childNodes[3].childNodes[0].style.width = "";
	this.fileProgressElement.childNodes[3].style.visibility = "hidden";
...
FileProgress.prototype.toggleCancel = function (show, swfUploadInstance) {
	...
	if (swfUploadInstance) {
		...
		this.fileProgressElement.childNodes[0].onclick = function () {
			...
			inputObj = oSelf.fileProgressElement.getElementsByTagName("input")[0];
