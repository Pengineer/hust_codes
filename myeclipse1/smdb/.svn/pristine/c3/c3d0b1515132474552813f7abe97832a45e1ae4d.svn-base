...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			<div class="link_bar" id="view_project_special">
				<s:if test="listType==1">
					当前位置：社科项目数据&nbsp;&gt;&nbsp;专项任务项目&nbsp;&gt;&nbsp;申请数据&nbsp;&gt;&nbsp;查看
				</s:if>
				<s:elseif test="listType==2">
					当前位置：社科项目数据&nbsp;&gt;&nbsp;专项任务项目&nbsp;&gt;&nbsp;立项数据&nbsp;&gt;&nbsp;查看
				</s:elseif>
				<s:elseif test="listType==3">
					当前位置：社科项目数据&nbsp;&gt;&nbsp;专项任务项目&nbsp;&gt;&nbsp;中检数据&nbsp;&gt;&nbsp;查看
				</s:elseif>
				<s:elseif test="listType==4">
					当前位置：社科项目数据&nbsp;&gt;&nbsp;专项任务项目&nbsp;&gt;&nbsp;结项数据&nbsp;&gt;&nbsp;查看
				</s:elseif>
				<s:elseif test="listType==5">
					当前位置：社科项目数据&nbsp;&gt;&nbsp;专项任务项目&nbsp;&gt;&nbsp;变更数据&nbsp;&gt;&nbsp;查看
				</s:elseif>
				...
				<s:elseif test="listType==8">
					当前位置：鉴定项目&nbsp;&gt;&nbsp;专项任务项目&nbsp;&gt;&nbsp;结项数据&nbsp;&gt;&nbsp;查看
				</s:elseif>
				<s:elseif test="listType==9">
					当前位置：我的项目&nbsp;&gt;&nbsp;查看
				</s:elseif>
				<s:elseif test="listType==10">
					当前位置：评审项目&nbsp;&gt;&nbsp;专项任务项目&nbsp;&gt;&nbsp;申请数据&nbsp;&gt;&nbsp;查看
				</s:elseif>
				<s:elseif test="listType==11">
					当前位置：社科项目数据&nbsp;&gt;&nbsp;专项任务项目&nbsp;&gt;&nbsp;年检数据&nbsp;&gt;&nbsp;查看
				</s:elseif>
			</div>
			...
			<div class="main">
				...
				<s:include value="/project/special/viewButton.jsp"></s:include>
				<s:form id="view_special" theme="simple" namespace="/project/special">
				...
				<s:include value="/project/special/viewBasic.jsp" />
				...
				<div class="main_content" style="display:none;" id="tabcontent">
					...
					<div class="p_box">
						<div id="application">
							<s:include value="/project/special/viewApplyTab.jsp"/>
						</div>
						<div id="granted">
							<s:include value="/project/special/viewGrantedTab.jsp"/>
						</div>
						<div id="member">
							<s:include value="/project/special/viewMemberTab.jsp"/>
						</div>
						<div id="funding">
							<s:include value="/project/special/viewFundingTab.jsp" />
						</div>
						<div id="anninspection">
							<s:include value="/project/special/anninspection/apply/view.jsp"/>
						</div>
						<div id="midinspection">
							<s:include value="/project/special/midinspection/apply/view.jsp"/>
						</div>
						<div id="endinspection">
							<s:include value="/project/special/endinspection/apply/view.jsp"/>
						</div>
						<div id="variation">
							<s:include value="/project/special/variation/apply/view.jsp"/>
						</div>
						<div id="product">
							<s:include value="/product/extIf/viewRelated.jsp"/>
						</div>
						<div id="publishStatus">
							<s:include value="/project/special/publishStatus.jsp"/>
						</div>
					</div>
				</div>
			</div>
			<script type="text/javascript">
				seajs.use(['javascript/project/special/view.js',
		           'javascript/project/special/application/apply/view.js',
		           'javascript/project/special/application/granted/popSetUpProjectStatus.js',
		           'javascript/project/special/application/review/view.js',
		           'javascript/project/special/anninspection/view.js',
		           'javascript/project/special/midinspection/view.js',
		           'javascript/project/special/variation/view.js',
		           'javascript/project/special/endinspection/apply/view.js',
		           'javascript/project/special/endinspection/review/view.js'], 
