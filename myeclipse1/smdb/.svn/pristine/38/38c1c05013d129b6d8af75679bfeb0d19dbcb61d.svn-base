...
public interface IMobileProjectService extends IProjectService{
	 ...
	 * @return
	 */
	public void getTeacherSearchHqlAndMapOfGra(StringBuffer hql, HashMap parMap, String hqlDiff4Manage, Map session, String projName, String projDirector, String projUniversity,String projYear,String projDes);
