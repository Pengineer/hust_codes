						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
							<tr class="table_main_tr2">
								...
								<s:if test = "#session.loginer.currentType.compareTo(@csdc.tool.bean.AccountType@EXPERT)<0">
									<td width="58"><sec:authorize ifAllGranted="ROLE_PROJECT_GENERAL_APPLICATION_APPLY_ADD"><input class="btn1" type="button" id="list_add_result" value="添加" /></sec:authorize></td>
								</s:if>
								<s:else>
									<td width="58"><sec:authorize ifAllGranted="ROLE_PROJECT_GENERAL_APPLICATION_APPLY_ADD"><input class="btn1" type="button" id="list_add" value="申请" /></sec:authorize></td>
								...
								<sec:authorize ifAllGranted="ROLE_PROJECT_GENERAL_APPLICATION_APPLY_FIRST_AUDIT">
								...
								<td width="70"><sec:authorize ifAllGranted="ROLE_PROJECT_GENERAL_APPLICATION_APPLY_CHECK"><input class="btn2" type="button" id="list_check" value="申请核算" /></sec:authorize></td>
							</tr>
						</table>
					</textarea>
