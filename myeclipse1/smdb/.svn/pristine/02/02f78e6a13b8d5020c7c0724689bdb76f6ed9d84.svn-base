...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div class="link_bar">
			当前位置：社科人员数据&nbsp;&gt;&nbsp;社科研究人员&nbsp;&gt;&nbsp;外部专家&nbsp;&gt;&nbsp;合并
		</div>

		<div class="main">
			<s:form id="form_person" action="merge" namespace="/person/expert">
				...
				<div id="account_choose">
					...
					<tbody>
						<tr class="table_tr2">
							...
							<td class="table_td3"><s:select  id="account_select" cssClass="select" name="selectedAccountId"  list="%{personService.getOptionalPassportNames(checkedIds,2)}"  headerKey="-1" headerValue="--请选择--" value="2" /></td>
		...
		<script type="text/javascript">
			seajs.use('javascript/person/expert/modify.js', function(modify) {
				$(function(){
					modify.init("person/expert");
				});
			});
			seajs.use('javascript/person/expert/merge.js', function(merge) {
				$(function(){
					merge.init("person/expert");
				});
			});
		</script>
	</body>
