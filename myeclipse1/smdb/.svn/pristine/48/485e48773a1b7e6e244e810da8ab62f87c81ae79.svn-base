...
//@CheckSystemOptionStandard("gbt2260-2007")
	...
	private String addressIds;//管理机构通讯地址组ID
	private String faddressIds;//财务管理部门地址组ID
	private String saddressIds;//社科管理部门地址组ID
	...
	public String getFaddressIds() {
		return faddressIds;
	}

	public void setFaddressIds(String faddressIds) {
		this.faddressIds = faddressIds;
	}

	public String getSaddressIds() {
		return saddressIds;
	}

	public void setSaddressIds(String saddressIds) {
		this.saddressIds = saddressIds;
	}
