					...
					<s:if test="reviewFlag == 2">
						<table width="100%" border="0" cellspacing="2" cellpadding="0">
							<tr class="table_tr2">
								...
								<td class="table_td9"><s:radio name="isApplyExcellent" theme="simple" list="#{'1':'是','0':'否'}" value='2'/></td>
					...
					<div class="totalReview">
						<table width="100%" border="0" cellspacing="2" cellpadding="0">
							<tr class="table_tr2">
								...
								<td class="table_td6"><s:select cssClass="select" id="reviewOpinionQualitative" name="reviewOpinionQualitative" list="%{baseService.getSystemOptionMapAsName('reviewOpinionQualitative', null)}" headerKey="-1" headerValue="--请选择--" /></td>
							...
							<tr class="table_tr2">
								...
								<td class="table_td6"><s:radio name="reviewWay" theme="simple" list="#{'1':'通讯鉴定','2':'会议鉴定'}" value='1' disabled='true'/></td>
							...
							<tr class="table_tr2">
								...
								<td class="table_td9"><s:radio cssClass="j_showOpinionFeedbackOrNot" name="reviewResult" theme="simple" list="#{'2':'同意','1':'不同意'}" /></td>
								<td class="table_td10"></td>
							</tr>
							<tr class="table_tr2">
								<td class="table_td8"><span>鉴定意见：<br/>（限2000字）</span></td>
