...
<textarea id="view_tops_template" style="display:none;">
	...
	<div class="p_box_b">
		<div class="p_box_b_1">
			{if topicSelection.createMode == 0}
				{if appFlag == 1}
				...
				{/if}
			{elseif topicSelection.createMode == 1 || topicSelection.createMode == 2}
	...
	<div class="p_box_body">
		<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
			...
			<tr class="table_tr7">
				...
				<td class="key" width="120">申请时间：</td>
	...
	<s:if test="#session.loginer.currentType.within(@csdc.tool.bean.AccountType@EXPERT, @csdc.tool.bean.AccountType@STUDENT)"><!-- 研究人员-->
		{if (topicSelection.applicantSubmitStatus == 1 || topicSelection.applicantSubmitStatus == 2)}<!-- 选题申请暂存或退回 -->
	...
	{if appFlag == 1}
	<s:elseif test="#session.loginer.currentType.compareTo(@csdc.tool.bean.AccountType@EXPERT)<0 "><!-- 部门及以上管理人员审核专家申请选题 -->
					...
					<tbody>
						...
						<tr class="table_tr4">
							...
							<td>
								...
								{if topicSelection.createMode == 0 && topicSelection.status == 2 && topicSelection.finalAuditStatus != 3 && (accountType == "DEPARTMENT" || accountType == "INSTITUTE")}
						...
						<s:if test="#session.loginer.currentType.compareTo(@csdc.tool.bean.AccountType@DEPARTMENT)<0"><!-- 校级及以上管理人员 -->
							<tr class="table_tr4">
								...
								<td>
									...
									{if topicSelection.createMode == 0 && topicSelection.status == 3 && topicSelection.finalAuditStatus != 3 && (accountType =="MINISTRY_UNIVERSITY" || accountType == "LOCAL_UNIVERSITY")}
							...
							<s:if test="#session.loginer.currentType.compareTo(@csdc.tool.bean.AccountType@MINISTRY_UNIVERSITY)<0"><!-- 省厅及以上管理人员 -->
								<tr class="table_tr4">
									...
									<td>
										...
										{if topicSelection.createMode == 0 && topicSelection.status == 4 && topicSelection.finalAuditStatus != 3 && accountType == "PROVINCE"}
	...
	{else}
		...
		{if (topicSelection.universitySubmitStatus == 1 || topicSelection.universitySubmitStatus == 2)}<!-- 高校选题申请暂存或退回 -->
			<div class="p_box_body">
				<table width="100%" border="0" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
					<tr height="36">
						<td width="150">
	...
	<div class="p_box_body">
		<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
				...
				<tbody>
					...
					<tr class="table_tr4">
						...
						<td>
							...
							{if topicSelection.createMode == 0 && topicSelection.status == 5 && topicSelection.finalAuditStatus != 3 && accountType == "MINISTRY"}
			...
			<s:else><!-- 部级以下所有人员 -->
				{if topicSelection.createMode == 1 || topicSelection.createMode == 2 || topicSelection.applicantSubmitStatus == 3 || topicSelection.universitySubmitStatus == 3}
					<thead>
						<tr class="head_title">
