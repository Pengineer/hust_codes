		...
		<body>
			<div style="width:480px;">
				...
				<div class="btn_div_view">
					<input id="save" class="btn1 j_submitOrSaveAddEndReview" data="2" type="button" value="保存" />
					<input id="submit" class="btn1 j_submitOrSaveAddEndReview" data="3" type="button" value="提交" />
					<input id="cancel" class="btn1" type="button" value="取消" />
				</div>
			</div>
			<script type="text/javascript">
				seajs.use(['javascript/project/special/endinspection/review/edit.js','javascript/project/project_share/endinspection/review/validate.js'], function(edit, validate) {
					validate.valid();
					edit.init();
				});
			</script>
