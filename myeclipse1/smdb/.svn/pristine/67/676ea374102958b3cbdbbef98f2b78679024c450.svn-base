...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
				...
				<s:form id="app_review">
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						<tr class="table_tr2">
							...
							<td class="table_td6"><s:textfield id="totalScore" name="totalScore" readonly="true" cssStyle="cursor:pointer;;border-style:hidden; " cssClass="input_css" /></td>
							<td class="table_td7" width="70"></td>
						</tr>
						<tr class="table_tr2">
							<td class="table_td5"><span class="table_title7">建议评价等级：</span></td>
							<td class="table_td6"><s:textfield id="grade" name="grade" readonly="true"  cssStyle="cursor:pointer;;border-style:hidden; " cssClass="input_css" /></td>
							<td class="table_td7"></td>
						</tr>
						<tr class="table_tr2">
							<td class="table_td5"><span class="table_title7">成果修改定性意见：</span></td>
							<td class="table_td6"><s:select cssClass="select" id="qualitativeOpinion" name="qualitativeOpinion" list="%{baseService.getSystemOptionMapAsName('reviewOpinionQualitative', null)}" headerKey="-1" headerValue="--请选择--" /></td>
							<td class="table_td7"></td>
						</tr>
						<tr class="table_tr2">
			...
			<script type="text/javascript">
				seajs.use(['javascript/project/entrust/application/review/edit.js','javascript/project/project_share/application/review/validate.js'], function(edit, validate) {
					validate.valid();
					edit.init();
				});
			</script>
