...
public class StartUpListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent event) {
		...
		addSystemConfig(sc, "RecruitPictureUploadPath", "/upload/recruit/photo");//招聘照片保存路径[不以'/'开头表示相对路径]
		addSystemConfig(sc, "RecruitTemplateUploadPath", "upload/recruit/template");//招聘模板保存路径[不以'/'开头表示相对路径]
		addSystemConfig(sc, "RecruitFileUploadPath", "upload/recruit/file");//招聘文件保存路径[不以'/'开头表示相对路径]
		...
		sc.setAttribute("systemVersion", "12584");//系统版本号
