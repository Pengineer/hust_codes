	...
	<tr>
		<td colspan="2">
			<table width="100%" border="0" cellspacing="0" cellpadding="0" style="line-height:28px; border:solid #999; border-width:0 0 1px 0;">
				...
				<td align="right"><a id="download_model" href="">下载变更申请模板</a></td>
			</table>
		</td>
					...
					<table class="table_valid" width="100%" border="0" cellspacing="0" cellpadding="2">
						...
						<tr>
							...
							<td class="table_td17" width="100">
								<s:select cssClass="select" name="%{'members['+#stat.index+'].idcardType'}" headerKey="-1" headerValue="--请选择--" list="#{'身份证':'身份证','军官证':'军官证','护照':'护照'}"/>
							</td>
						...
						<tr>
							...
							<td class="table_td17">
								<s:select cssClass="select" name="%{'members['+#stat.index+'].memberType'}" headerKey='-1' headerValue="--请选择--" list="#{'1':'教师','2':'外部专家','3':'学生'}" />
							</td>
						...
						<tr>
							...
							<td class="table_td17">
								<s:select cssClass="select" name="%{'members['+#stat.index+'].gender'}" headerKey="-1" headerValue="--请选择--"  list="#application.sexList"/>
							</td>
							<td class="table_td10"></td>
						...
						<tr>
							...
							<td class="table_td17">
								<s:select cssClass="select" name="%{'members['+#stat.index+'].divisionType'}" headerKey="-1" headerValue="--请选择--" list="#{'1':'研究基地','2':'院系','3':'外部部门'}" />
							</td>
							<td class="table_td10"></td>
						...
						<tr>
							...
							<td class="table_td17">
								<s:select cssClass="select" name="%{'members['+#stat.index+'].specialistTitle'}" headerKey="-1" headerValue="--请选择--" list="10、entrust-variation-apply:editTable.jsp\popAddResult.jsp\popModifyResult.jsp
" />
							</td>
							<td class="table_td10"></td>
						...
						<tr>
							<td class="table_td8"><span class="table_title9">是否负责人：</span></td>
							<td class="table_td17">
							...
							<td class="table_td18">
								<s:select cssClass="select" name="%{'members['+#stat.index+'].isSubprojectDirector'}" headerKey='-1' headerValue="--请选择--" list="#{'1':'是','0':'否'}" />	
							</td>
							<td class="table_td10"></td>
						</tr>
						<tr>
...
<table id="table_member" width="100%" border="0" cellspacing="0" cellpadding="0" style="display:none;">
	...
	<tr>
		<td class="table_td8" width="110"><span class="table_title9">证件类型：</span></td>
		<td class="table_td17" width="100">
			<s:select cssClass="select" name="members[].idcardType" headerKey="-1" headerValue="--请选择--" list="#{'身份证':'身份证','军官证':'军官证','护照':'护照'}"/>
		</td>
		<td class="table_td10" width="70"></td>
		<td class="table_td8" width="80"><span class="table_title2">证件号：</span></td>
		<td class="table_td18" width="150">
	...
	<tr>
		<td class="table_td8"><span class="table_title9">成员类型：</span></td>
		<td class="table_td17">
			<s:select cssClass="select" name="members[].memberType" headerKey='-1' headerValue="--请选择--" list="#{'1':'教师','2':'外部专家','3':'学生'}" />
		</td>
		<td class="table_td10"></td>
		<td class="table_td8"><span class="table_title2">姓名：</span></td>
		<td class="table_td18">
	...
	<tr>
		<td class="table_td8"><span class="table_title9">性别：</span></td>
		<td class="table_td17">
			<s:select cssClass="select" name="members[].gender" headerKey="-1" headerValue="--请选择--" list="#application.sexList" />
		</td>
		<td class="table_td10"></td>
		<td class="table_td8"><span class="table_title2">所在单位：</span></td>
		<td class="table_td18">
	...
	<tr>
		<td class="table_td8"><span class="table_title9">部门类别：</span></td>
		<td class="table_td17">
			<s:select cssClass="select" name="members[].divisionType" headerKey="-1" headerValue="--请选择--" list="#{'1':'研究基地','2':'院系','3':'外部部门'}" />
		</td>
		<td class="table_td10"></td>
		<td class="table_td8"><span class="table_title2">所在部门：</span></td>
		<td class="table_td18">
	...
	<tr>
		<td class="table_td8"><span  class="table_title9">职称：</span></td>
		<td class="table_td17">
			<s:select cssClass="select" name="members[].specialistTitle" headerKey="-1" headerValue="--请选择--" list="10、entrust-variation-apply:editTable.jsp\popAddResult.jsp\popModifyResult.jsp
" />
		</td>
		<td class="table_td10"></td>
		<td class="table_td8"><span>专业：</span></td>
	...
	<tr>
		<td class="table_td8"><span class="table_title9">是否负责人：</span></td>
		<td class="table_td17">
			<s:select cssClass="select" name="members[].isDirector" headerKey='-1' headerValue="--请选择--" list="#{'1':'是','0':'否'}" />
		</td>
		<td class="table_td10"></td>
		<td class="table_td8"><span class="table_title2">是否子项目负责人：</span></td>
		<td class="table_td18">
			<s:select cssClass="select" name="members[].isSubprojectDirector" headerKey='-1' headerValue="--请选择--" list="#{'1':'是','0':'否'}" />	
		</td>
		<td class="table_td10"></td>
	</tr>
	<tr>
