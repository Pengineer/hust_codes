	...
	<table width="100%" border="0" cellspacing="2" cellpadding="0">
		...
		<s:if test = "(agency.type == 3 || agency.type == 4)">
			...
			<tr class="table_tr2">
				...
				<td class="table_td3"><s:select cssClass="select" name="agency.category" value="%{agency.category}" id="category" headerKey="-1" headerValue="--请选择--" list="%{baseService.getSystemOptionMapAsName('universityCategory', null)}"/></td>
				<td class="table_td4"></td>
			</tr>
			<tr class="table_tr2">
				<td class="table_td2">办学类型：</td>
				<td class="table_td3"><s:select cssClass="select" name="agency.style" value="%{agency.style}" id="style" headerKey="-1" headerValue="--请选择--" list="%{baseService.getSystemOptionMapAsName('universityStyle', null)}" /></td>
				<td class="table_td4"></td>
			</tr>
		</s:if>
		<tr class="table_tr2">
