 ...
 */
public class PersonStatisticAction extends BaseStatisticAction {

	private static final long serialVersionUID = 1559768258543130160L;
	...
	public String titleCreate(){
		...
		session.put("statisticType", "person");
		return SUCCESS;
	}
...
//		System.out.println("mdxBuffer = " + mdxBuffer);
	...
	public String toView() throws Exception {
		...
		session.put("statisticTitle", "社科人员定制统计");
		DesUtils des = new DesUtils();
		mdxQueryString = des.decrypt(encryptedMdxQueryString);
		Result result=statisticService.getMondrianResult("person", mdxQueryString);
