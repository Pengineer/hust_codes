												...
												<s:iterator value="homeApply" status="stat">
													<tr class="table_tr4">
														<td>
		             									...
		             									<td width="90"><input id="agree" name=<s:property value="homeApply[#stat.index][0]" /> type="button" class="btn1" value="同意" /></td>
		             									<td width="90"><input id="refuse" name=<s:property value="homeApply[#stat.index][0]" /> type="button" class="btn1" value="拒绝" /></td>
													</tr>
												</s:iterator>
             								</tbody>
			             				</table>
