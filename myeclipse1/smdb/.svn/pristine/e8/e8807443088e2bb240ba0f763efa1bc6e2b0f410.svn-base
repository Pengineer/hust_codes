		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
			<tr class="table_main_tr">
				<td align="right"><span class="choose_bar">
					<s:select cssClass="select" name="searchType" value="%{searchQuery.searchType}" headerKey="-1" headerValue="--不限--" list="#{'0':'姓名','1':'所在高校','2':'所在院系或研究基地','3':'学生类别'}" />
				</span>
		...
		<div class="adv_content">
			...
			<table class="adv_table" width="100%" border="0" cellspacing="2" cellpadding="0">
				...
				<tr class="adv_tr">
					...
					<td class="adv_td2"><s:select cssClass="select" name="position" value="%{searchQuery.position}" headerKey="-1" headerValue="--不限--" list="%{baseService.getSystemOptionMapAsName('studentType', null)}" /></td>
					<td class="adv_td2"></td>
