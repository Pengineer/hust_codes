...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			...
			<div class="main">
				<div class="main_content">
					<div class="table_main_tr_adv">
						<s:include value="/project/general/endinspection/review/search.jsp"/>
					</div>
								...
								<tr>
									...
									<td>
										{if item.laData[13]!=null && item.laData[13]!=""}
											<a id="${item.laData[14]}" name="${item.laData[13]}"  class="download_general_3" href="">
					...
					<s:form id="list" theme="simple" action="" namespace="/project/general/endinspection/review">
			...
			<script type="text/javascript">
				seajs.use('javascript/project/general/endinspection/review/list.js', function(list) {
					$(function(){
						list.init();
					})
				});
