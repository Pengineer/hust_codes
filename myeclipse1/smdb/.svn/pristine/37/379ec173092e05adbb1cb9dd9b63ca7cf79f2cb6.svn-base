...
<div class="main">
    <div class="main_content">
        ...
        <s:form id="search" theme="simple" action="list" namespace="/funding/fundingList/work">
    ...
    <script type="text/javascript">
        seajs.use('javascript/funding/noneResearchProjectFee/workFund/list.js', function (list) {
            $(function () {
                list.init();
            })
        });
