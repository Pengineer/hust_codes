...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div class="link_bar">
   		...
   		<div class="main">
   			<s:form id="form_product" action="modify" method="post" theme="simple" enctype="multipart/form-data" namespace="/product/otherProduct">
	   			<s:hidden id="accountType" value="%{#session.loginer.currentType}"/>
	   			<s:hidden id="addOrModify" value="0"/>
	   			<s:hidden name="entityId" value="%{otherProduct.id}"/>
					...
					<div class="edit_info" id="base_info">
						...
						<s:if test="applyType == 0">
							<table width="100%" border="0" cellspacing="2" cellpadding="2" id="personal_info" >
								...
								<s:if test="#session.loginer.currentType.compareTo(@csdc.tool.bean.AccountType@EXPERT)<0">
									<tr class="table_tr2">
										...
										<td class="table_td3" id="err_firstAuthor">
											...
											<div id="person_per_name_div" class="choose_show"><s:property value="otherProduct.authorName"/>&nbsp;&nbsp;<s:property value="otherProduct.agencyName"/>&nbsp;<s:property value="otherProduct.divisionName"/></div>
								...
								<tr class="table_tr2">
									...
									<td class="table_td3"><s:textfield name="otherProduct.otherAuthorName" cssClass="input_css"/></td>
									<td class="table_td4"></td>
								</tr>
							</table>
						</s:if>
							...
							<table width="100%" border="0" cellspacing="2" cellpadding="2" id="team_info">
								...
								<tr class="table_tr2">
									...
									<td class="table_td3">
										...
										<div id="unit" class="choose_show"><s:property value="otherProduct.agencyName"/>&nbsp;<s:property value="otherProduct.orgDivisionName"/></div>
								...
								<s:if test="#session.loginer.currentType.compareTo(@csdc.tool.bean.AccountType@EXPERT)<0">
									<tr class="table_tr2">
										...
										<td class="table_td3">
											...
											<div id="team_per_name_div" class="choose_show"><s:property value="author.name"/>&nbsp;&nbsp;<s:property value="otherProduct.agencyName"/>&nbsp;<s:property value="otherProduct.divisionName"/></div>
								...
								<tr class="table_tr2">
									...
									<td class="table_td3">
										...
										<div id="team_disptr" class="choose_show"><s:property value="otherProduct.orgDiscipline"/></div>
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="2">		
							...
							<tr class="table_tr2">
								...
								<td class="table_td3"><s:radio name="otherProduct.isForeignCooperation" list="#{'1':'是','0':'否'}"/></td>
								<td class="table_td4"></td>
							</tr>
							<tr class="table_tr2">
								<td class="table_td2"><span class="table_title5">学科门类：</span></td>
								<td class="table_td3" id="err_dtype">
									<input type="button" class="btn1 select_btn select_disciplineType_btn" value="选择"/>
									<div id="person_disptr" class="choose_show"><s:property value="otherProduct.disciplineType"/></div>
									<s:hidden name="otherProduct.disciplineType" id="person_dispName"/>
								</td>
								<td class="table_td4"></td>
							</tr>
							<tr class="table_tr2">
					...
					<div class="edit_info" id="publication_info">
						<table width="100%" border="0" cellspacing="2" cellpadding="0">
							...
							<tr class="table_tr2">
								...
								<td class="table_td3">
									<s:textfield id="publicationDate" name="otherProduct.pressDate" cssClass="input_css">
										<s:param name="value">
   		...
   		<script type="text/javascript">
			seajs.use('javascript/product/otherProduct/edit.js', function(modify) {
				$(function() {
					modify.init();
				});
			});
