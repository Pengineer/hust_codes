...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			<div class="link_bar">
				当前位置：社科项目数据&nbsp;&gt;&nbsp;专项任务项目&nbsp;&gt;&nbsp;申请数据&nbsp;&gt;&nbsp;修改
			</div>
			<div class="main">
				<s:form id="application_form" action="modifyResult" namespace="/project/special/application/apply">
					...
					<div id="info" style="display:none">
						...
						<div class="main_content">
							...
							<s:include value="/project/special/application/apply/editApplyTab.jsp" />
							<s:include value="/project/special/application/apply/editGrantedTab.jsp" />
							<s:include value="/project/special/application/apply/editMemberTab.jsp" />
						</div>
					</div>
				</s:form>
				<s:include value="/project/special/application/apply/memberTemplate.jsp" />
			...
			<script type="text/javascript">
				seajs.use(['javascript/project/special/application/apply/modify.js','javascript/project/project_share/application/validate.js'], function(modify, validate) {
					validate.valid();
					modify.init();
				});
			</script>
