 ...
 * 
 * 无申请数据的项目：人文社会科学研究成果评价的理论与方法研究 
 * 无申请数据的项目：高校人文社会科学研究能力评价研究 
 * 无申请数据的项目：网络信息技术在科研基金项目管理中的应用研究 
 * 
 */
...
public class GeneralProjectGranted2005ImporterV2 extends Importer {
	...
	public void work() throws Exception {
		...
		while (next()) {
			...
			if (ga == null) {
				//申请数据找不到，新建一个
				missingApplicationName.append(" * 无申请数据的项目：" + projectName + " \n");
