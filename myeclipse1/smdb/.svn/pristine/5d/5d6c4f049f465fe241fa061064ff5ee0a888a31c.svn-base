...
<textarea id="view_related_template" style="display:none;">
			...
			{if dirPerson != null && dirPerson.id != null && dirPerson.id !=""}
				<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
					<thead class="head_title1">
						<tr>
							<td colspan="6"><span>第</span><span class="director_num">${dirPerson_index}</span><span>负责人</span></td>
						</tr>
					</thead>
					<tbody>
						<tr class="table_tr7">
						...
						<tr class="table_tr7">
							...
							<td class="value">{if dirAcademics[dirPerson_index] != null}${dirAcademics[dirPerson_index].lastEducation}{/if}</td>
							<td class="key">职称：</td>
							<td class="value" >{if dirAcademics[dirPerson_index] != null}${dirAcademics[dirPerson_index].specialityTitle}{/if}</td>
						</tr>
						<tr class="table_tr7">
							<td class="key">办公电话：</td>
							<td class="value">${dirPerson.officePhone}</td>
							<td class="key">手机：</td>
							<td class="value" >${dirPerson.mobilePhone }</td>
							<td class="key">电子邮箱：</td>
							<td class="value">${dirPerson.email}</td>
						</tr>
					</tbody>
				</table>
			{else}
	...
	<div class="p_box_body">
		<table id="list_special_member" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding" style="text-align:center;">
			<thead>
					...
					<tr>
						...
						<td>
							...
							{elseif item[9] != "" && item[9] != null}
								<a id="${item[9]}" class="linkIns" href="" title="点击查看详细信息">${item[10]}</a></td>
							{else}
								${item[10]}
							{/if}
						</td>
