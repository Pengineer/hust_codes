...
<body>
                            ...
                            <table id="list_table" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
                                <thead id="list_head">
                                    <tr class="table_title_tr">
                                        ...
                                        <td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
                                        <td width="60"><a id="sortcolumn1" href="" class="{if sortColumn == 0}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按收款方排序">收款方</a></td>
                                        <td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>${item.laData[3]}</td>
                                        <td></td>
                                        <td><a href = "javascript:void(0)" class = "" id = ${item.laData[0]}>${item.laData[4]}</a></td>
                                        <td></td>
                                        <td>${item.laData[6]}</td>
                                        <td></td>
                                        <td>${item.laData[7]}</td>
    ...
    <script type="text/javascript">
        seajs.use('javascript/funding/noneResearchProjectFee/workFund/view.js', function (view) {
           $(function(){
        	   var nameSpace = "funding/fundingList/work";
               view.init(nameSpace);
           });
        });
    </script>
