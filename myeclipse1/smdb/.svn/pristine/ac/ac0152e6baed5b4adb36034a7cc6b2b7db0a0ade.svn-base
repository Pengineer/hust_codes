		...
		<body >
			<div style="width:500px;">
					...
					<s:form id="end_result">
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="0">
							...
							<tr class="table_tr2">
								...
								<td class="table_td12"><s:radio name="isApplyNoevaluation" theme="simple" list="#{'1':'是','0':'否'}" value='2' /></td>
							...
							<tr class="table_tr2">
								...
								<td class="table_td12"><s:radio name="isApplyExcellent" theme="simple" list="#{'1':'是','0':'否'}" value='2' /></td>
								<td class="table_td13"></td>
							</tr>
				...
				<div class="btn_div_view">
					<input id="save" class="btn1 addEndResult" type="button" data="2" types = "1" value="保存" />
					<input id="submit" class="btn1 addEndResult" type="button" data="3"  types = "1" value="提交" />
