...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div style="width:600px;overflow-y:scroll;height:500px;">
			<div class="main">
				<s:form id="view_product" action="" theme="simple" namespace="/product/electronic">
						...
						<div class="title_bar">
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									{if authorid!=null}<a id="${authorid}" class="view_author" href="">${electronic.authorName}</a>
									{else}${electronic.authorName}
									{/if}
									</td>
									...
									<td class="title_bar_td">${electronic.otherAuthorName}</td>
								</tr>
								<tr>
									<td class="title_bar_td" align="right"><img src="image/ico08.gif" width="5" height="9"/></td>
									...
									<td class="title_bar_td">${electronic.divisionName}</td>
								</tr>
								<tr>
									<td class="title_bar_td" align="right"><img src="image/ico08.gif" width="5" height="9"/></td>
						...
						<div class="p_box_body_t">
							<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
								<tr class="table_tr7">
									...
									<td class="value" width="120">{if electronic.isTranslation==0}否{elseif electronic.isTranslation==1}是{/if}</td>
									<td class="key" width="100">是否与国（境）外合作：</td>
									<td class="value">{if electronic.isForeignCooperation==0}否{elseif electronic.isForeignCoop==1}是{/if}</td>
								</tr>
								<tr class="table_tr7">
						...
						<div class="p_box_body_t">
							<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
								<tr class="table_tr7">
									...
									<td class="value" width="120">${electronic.publishUnit}</td>
	...
	<s:include value="/product/viewJs.jsp"/>
</html>