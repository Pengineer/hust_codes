				...
				<s:form id="ann_result">
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						...
						<tr class="table_tr2">
							...
							<td class="table_td3">
								<input type="button" id="modifyAnnFee" class="btn1 select_btn" value="修改" />
