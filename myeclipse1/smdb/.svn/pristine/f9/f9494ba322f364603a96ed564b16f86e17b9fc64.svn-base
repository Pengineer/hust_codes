...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			seajs.use('javascript/pop/select/select_province.js', function(select) {
				$(function(){
					select.init();
				})
			});
	...
	<body>
		<div style="width:430px;">
			<s:form id="search" theme="simple" action="list" namespace="/selectProvince">
				...
				<table id="list_table" width="411" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
					<thead id="list_head">
						<tr class="table_title_tr3">
							...
							<td width="30">序号</td>
							<td width="2"><img src="image/table_line.gif" width="2" height="21" /></td>
							<td><a id="sortcolumn0" href="" class="{if sortColumn == 0}{if sortColumnLabel == 0}up_css{else}down_css{/if}{/if}" title="点击按单位名称排序">单位名称</a></td>
							<td width="2"><img src="image/table_line.gif" width="2" height="21" /></td>
							<td width="120"><a id="sortcolumn1" href="" class="{if sortColumn == 1}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按社科管理部门排序">社科管理部门</a></td>
						</tr>
					</thead>
					<tbody>
					{for item in root}
