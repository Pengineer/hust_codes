				...
				<s:form id="end_audit">
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						<tr class="table_tr2">
							...
							<td class="table_td12"><s:radio cssClass="r_type j_showOpinionFeedbackOrNot" name="endAuditResult" theme="simple" list="#{'2':'同意','1':'不同意'}" /></td>
...
<%--						<input id="save" class="btn1" type="button" value="保存" onclick="modifyEndAudit(2, thisPopLayer);" />--%>
<%--						<input id="submit" class="btn1" type="button" value="提交" onclick="modifyEndAudit(3, thisPopLayer);" />--%>
