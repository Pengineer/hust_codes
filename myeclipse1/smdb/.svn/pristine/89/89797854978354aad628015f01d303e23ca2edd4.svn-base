					...
					<div class="edit_info" id="base_info">
						<table width="100%" border="0" cellspacing="2" cellpadding="0">
							...
							<tr class="table_tr2">
								...
								<td class="table_td3" id="err_chineseName"><s:textfield name="consultation.chineseName" cssClass="input_css"/></td>
								<td class="table_td4"></td>
							</tr>
							<tr class="table_tr2">
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="2" id="personal_info" >
							...
							<tr class="table_tr2">
								...
								<td class="table_td3">
									<s:textfield name="consultation.otherAuthorName" cssClass="input_css"/>
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="2" id="team_info" style="display:none;">
							...
							<tr class="table_tr2">
								...
								<td class="table_td3">
									...
									<s:hidden id="unitName" name="consultation.agencyName"/>
								</td>
								<td class="table_td4"></td>
							</tr>
							<s:if test="#session.loginer.currentType.compareTo(@csdc.tool.bean.AccountType@EXPERT)<0">
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="2">
							...
							<tr class="table_tr2">
								...
								<td class="table_td3" id="err_dtype">
									...
									<s:hidden name="consultation.disciplineType" id="product_dispName"/>
								</td>
								<td class="table_td4"></td>
							</tr>
							<tr class="table_tr2">
