...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<div class="main">
			<div class="main_content">
				...
				<div class="title_statistic">参数配置</div>
					...
					<tr class="table_tr2">
						...
						<input  id="importType" name="importType" value="application" type ="hidden"/>
						<td class="table_td4">
			...
			<div style = "margin: 10px auto;">数据入库总体统计信息：</div>
			<table class = "table_statistic" width = "100%" style = "text-align:center">
				<tr>
					<td>已入库（条）</td>
					<td>总数（条）</td>
				</tr>
				...
				<tr class= "even">
					<td  id = "totalImportNum"></td>
					<td id = "totalNum"></td>
				</tr>
				</table>
				<div style = "margin: 10px auto;">数据入库详细统计信息：</div>
				...
				<div id = "container" class = "p_box_body" style = "max-height:370px;overflow-y:scroll;background:white">
