...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div class="link_bar">
			当前位置：社科人员数据&nbsp;&gt;&nbsp;社科研究人员&nbsp;&gt;&nbsp;教师&nbsp;&gt;&nbsp;添加
		</div>

		<div class="main">
			<s:form id="form_person" action="add" namespace="/person/teacher">
				...
				<div id="info" style="display:none">
					<div class="main_content">
						<div id="procedure" class="step_css">
							<ul>
								...
								<li class="proc" name="teacher_affiliation_add"><span class="left_step"></span><span class="right_step">任职信息</span></li>
					...
					<div class="main_content">
						...
						<s:include value="/person/edit_teacher_affiliation_add.jsp" />
		...
		<script type="text/javascript">
			seajs.use('javascript/person/teacher/add.js', function(add) {
				$(function(){
					add.init();
				})
			});
