...
<%--								<td class="table_td12"><s:radio name="isApplyNoevaluation" theme="simple" list="#{'1':'是','0':'否'}" value='2' onclick="showNoEval(this.value);"/></td>--%>
								<td class="table_td12"><s:radio cssClass="j_showNoEval" name="isApplyNoevaluation" theme="simple" list="#{'1':'是','0':'否'}" value='2' /></td>
							...
							<tr class="table_tr2">
								...
								<td class="table_td12"><s:radio cssClass="j_showExcellect" name="isApplyExcellent" theme="simple" list="#{'1':'是','0':'否'}" value='2' /></td>
								<td class="table_td13"></td>
							</tr>
