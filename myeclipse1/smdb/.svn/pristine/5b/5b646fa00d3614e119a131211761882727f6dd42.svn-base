		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
			<tr class="table_main_tr">
				<td align="right"><span class="choose_bar">
					<s:select cssClass="select" name="searchType4unit" id="search_type_4unit" headerKey="-1" headerValue="--不限--"
					list="#{'1':'单位名称','2':'所在省','3':'是否部署高校'}" />
				</span><s:textfield id="keyword4unit" name="keyword4unit" cssClass="keyword" size="10" />
				</td>
				<td width="60"><input id="button_query" type="button" value="检索" class="btn1" /></td>
			</tr>
		</table>
	</s:form>
</div>