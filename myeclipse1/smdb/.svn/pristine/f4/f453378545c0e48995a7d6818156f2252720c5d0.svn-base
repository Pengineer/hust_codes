...
<div id="simple_search">
	<s:form id="search" theme="simple" action="list" namespace="/award/moesocial/application/awarded">
			...
			<tr class="table_main_tr">
				<td align="right">
					<span class="choose_bar">
						...
						list="#{'1':'成果名称','2':'申请人','3':'依托高校','4':'学科门类','5':'成果类型','7':'获奖等级','8':'获奖年度'}"/></span>
...
<div id="adv_search" style="display:none;">
	<s:form id="advSearch" action="advSearch" namespace="/award/moesocial/application/awarded" theme="simple">
		...
		<div class="adv_content">
			...
			<table class="adv_table" width="100%" border="0" cellspacing="2" cellpadding="0">
				<tr class="adv_tr">
					...
					<td class="adv_td1" width="205"><s:select cssClass="select" name="ptype" value="%{searchQuery.ptype}" headerKey="-1" headerValue="--%{'不限'}--" list="%{baseService.getSystemOptionMapAsName('productType', null)}"/></td>
					<td class="adv_td1"></td>
				</tr>
				<tr class="adv_tr">
				...
				<tr class="adv_tr">
					...
					<td class="adv_td1"></td>
					<td class="adv_td1" align="right">申请时间：</td>
				...
				<tr class="adv_tr">
					...
					<td class="adv_td1"><s:select cssClass="select" name="awardGradeid" value="%{searchQuery.awardGradeid}" headerKey="-1" headerValue="--%{'不限'}--" list="%{baseService.getSystemOptionMap('awardGrade', null)}"/></td>
					<td class="adv_td1"></td>
					<td class="adv_td1" align="right">获奖年度：</td>
					<td class="adv_td1">
						<s:select cssClass="select" name="year1" value="%{searchQuery.year1}" list="%{awardService.getYearMap()}" headerKey="-1" headerValue="--%{'不限'}--" />
						至
						<s:select cssClass="select" name="year2" value="%{searchQuery.year2}" list="%{awardService.getYearMap()}" headerKey="-1" headerValue="--%{'不限'}--" />
					</td>
					<td class="adv_td1"></td>
				</tr>
				</tr>
