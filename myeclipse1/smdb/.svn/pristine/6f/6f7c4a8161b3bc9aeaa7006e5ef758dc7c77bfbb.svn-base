...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			...
			<div class="main">
				...
				<div id="type_select">
					<s:form id="select_form" action="add" namespace="/project/key/application/granted">
...
<%--									</s:elseif>--%>
				...
				<div id="type_new" style="display:none">
					<s:form id="application_form" action="add" namespace="/project/key/application/granted">
			...
			<script type="text/javascript">
				seajs.use(['javascript/project/key/application/granted/add.js','javascript/project/project_share/application/validate.js'], function(add, validate) {
					validate.valid();
					add.init();
				});
			</script>
