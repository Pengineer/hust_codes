...
//	var nameSpace = "unit/agency/university";
	...
	exports.init = function() {
		...
		$("#view_addAccount").live("click", function(){
			popAccountAdd({
				src : "account/university/main/extIfToAdd.action",
				inData : {data : {"typeName" : "校级主账号", "belongId" : $("#entityId").val(), "belongName" : $("#unitName").html()}},
