...
<div class="edit_info" id="apply">
	...
	<table width="100%" border="0" cellspacing="2" cellpadding="2">
		...
		<tr class="table_tr2">
			...
			<td class="table_td3">
				<s:select cssClass="select" name="application1.subtype.id" headerKey="-1" headerValue="--请选择--" list="%{baseService.getSystemOptionMap('projectType', '07')}" />
				<br/>
				<s:select cssClass="select-sub" name="application1.subSubType.id" headerKey="-1" headerValue="--请选择--" list="{}" />
				</td>
			<td class="table_td4"></td>
		</tr>
		<tr class="table_tr2">
