...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			seajs.use('javascript/pop/select/select_universitySubjection.js', function(select) {
				$(function(){
					select.init();
				})
			});
	...
	<body>
		<div style="width:430px;">
			<s:form id="search" theme="simple" action="list" namespace="/selectUniversitySubjection">
