			...
			<div style="width:480px;">
				<s:form id="form_addFundList">
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						...
						<tr class="table_tr2">
							<td class="table_td11">研究类型：</td>
							<td class="table_td12"><s:select cssClass="select" id="researchType" name="researchType" value="%{searchQuery.researchType}" list="%{baseService.getSystemOptionMap('researchType', '00')}" headerKey="-1" headerValue="--不限--" /></td>
							<td class="table_td13"></td>
						</tr>
						<tr class="table_tr2">
