...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			<div class="link_bar">
				当前位置：社科项目数据&nbsp;&gt;&nbsp;重大攻关项目&nbsp;&gt;&nbsp;中检数据
			</div>
			
			<div class="main">
				<div class="main_content">
					<div class="table_main_tr_adv">
						<s:include value="/project/key/midinspection/apply/search.jsp"/>
					</div>
					...
					<textarea id="list_template" style="display:none;">
						<table id="list_table" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
							<thead id="list_head">
								...
								<sec:authorize ifAllGranted="ROLE_PROJECT_KEY_MIDINSPECTION_APPLY_DELETE">
									...
									<td width="30">序号</td>
									<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
									<td><a id="sortcolumn0" href="" class="{if sortColumn == 0}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按项目名称排序">点击按项目名称排序</a></td>
									<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
							<tr class="table_main_tr2">
								<td width="4"></td>
								<sec:authorize ifAllGranted="ROLE_PROJECT_KEY_MIDINSPECTION_APPLY_REQUIRED">
								...
								<sec:authorize ifAllGranted="ROLE_PROJECT_KEY_MIDINSPECTION_APPLY_PUBLISH">
									<td width="58"><input id="list_publish" type="button" class="btn1" value="发布" /></td>
								</sec:authorize>
								<sec:authorize ifAllGranted="ROLE_PROJECT_KEY_MIDINSPECTION_DATA_EXPORT">
									<td width="58"><input id="list_export" type="button" class="btn1" value="导出" /></td>
								</sec:authorize>
								<sec:authorize ifAllGranted="ROLE_PROJECT_KEY_MIDINSPECTION_APPLYAUDIT_MOTHBALL">
									<td width="58"><input id="list_mothball" type="button" class="btn1" value="封存" /></td>
								</sec:authorize>
							</tr>
						</table>
					</textarea>
					<s:form id="list" theme="simple" action="delete" namespace="/project/key/endinspection/apply">
			...
			<script type="text/javascript">
				seajs.use('javascript/project/key/midinspection/list.js', function(list) {
					list.init();
				});
			</script>
		</body>
