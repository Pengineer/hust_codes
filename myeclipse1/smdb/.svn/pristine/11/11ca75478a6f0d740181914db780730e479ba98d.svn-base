...
public class SwfuploadAction extends ActionSupport {
	...
	public String upload() throws IOException{
		...
		File dir = new File(ApplicationContainer.sc.getRealPath(sc.get("tempUploadPath") + "/" + sessionId + "/" + fileId));
		dir.mkdirs();
	...
	public String completeUpload(){
		...
		Map<String, Object> sc = ActionContext.getContext().getApplication();
		String basePath = ApplicationContainer.sc.getRealPath((String) sc.get("tempUploadPath"));
