		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
			<tr class="table_main_tr">
				<td align="right"><span class="choose_bar">
					<s:select cssClass="select" name="searchType" value="%{searchQuery.searchType}" headerKey="0" headerValue="--不限--"
						list="#{'1':'单位代码','2':'单位名称','3':'单位负责人','4':'单位类型'}" />
		...
		<div class="adv_content">
			...
			<table class="adv_table" width="100%" border="0" cellspacing="2" cellpadding="0">
				...
				<tr class="adv_tr">
					...
					<td class="adv_td1"><s:select cssClass="select" name="provinceId"  value="%{searchQuery.provinceId}" id="province" headerKey="-1" headerValue="--请选择省--" list="%{unitService.getProvinceList()}" /></td>
					<td class="adv_td1"></td>
