		...
		<form id="form_memberDetail">
			<table class="table_valid" width="100%" border="0" cellspacing="0" cellpadding="2">
				<tr>
					...
					<td><s:select id="memberType" name="memberType" cssClass="select" headerKey='-1' headerValue="--请选择--" list="#{'1':'教师','2':'外部专家','3':'学生'}" readonly="true" /></td>
					<td class="table_td10"></td>
				</tr>
				<tr>
					<td class="table_td8" width="150"><span class="table_title6">姓名：</span></td>
					<td style="position:relative;">
						<s:textfield cssClass="keyword" id="memberName" name="memberName" />
				...
				<tr>
					...
					<td class="table_td9"><s:textfield id="workMonthPerYear" name="workMonthPerYear" /></td>
					<td class="table_td10"></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="table_td9"><s:select id="isDirector" name="isDirector" cssClass="select" headerKey='-1' headerValue="--请选择--" list="#{'1':'是','0':'否'}" /></td>
					<td class="table_td10"></td>
				</tr>
				<tr>
