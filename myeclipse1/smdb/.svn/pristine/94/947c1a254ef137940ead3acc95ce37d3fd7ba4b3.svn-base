					...
					<span class="choose_bar">
						<s:if test="#session.loginer.currentType.equals(@csdc.tool.bean.AccountType@EXPERT) || #session.loginer.currentType.equals(@csdc.tool.bean.AccountType@TEACHER)"><!-- 专家或教师-->
							...
							<s:select cssClass="select" name="searchType" value="%{searchQuery.searchType}" headerKey="-1" headerValue="--不限--"
								list="#{'1':'项目名称','2':'依托高校','3':'课题类别','4':'学科门类','5':'项目年度'}" />
					</span>
		...
		<div class="adv_content">
			...
			<table width="100%" border="0" cellspacing="2" cellpadding="0">
				<tr class="adv_tr">
					...
					<td class="adv_td1" width="65" align="right">课题类别：</td>
					<td class="adv_td1" width="200"><s:select cssClass="select" name="projectSubtype" list="%{baseService.getSystemOptionMap('projectType', '08')}" headerKey="-1" headerValue="--不限--" /></td>
					<td class="adv_td1"></td>
				</tr>
				<tr class="adv_tr">
