...
define(function(require, exports, module) {
    ...
    var submitVarResultPop = function(varId, projectType, showProjectDetails){
    	...
    	if(currentStop == 1 && $("#midPending").val() == 1){
    		...
    		viewVariation.varSubmitform('project/instp/variation/apply/submitResult.action?varId='+varId+"&projectid=" + projectid, projectType, showProjectDetails);
    	}
    }
	...
	exports.initClick = function() {
		...
		$(".j_addVarResultPop").live('click',function(){
			viewVariation.addVarResultPop(projectType, viewInstp.showProjectDetails);
		});
		$(".j_modifyVarResultPop").live('click',function(){
			var varId = $(this).attr("itemIds");
			viewVariation.modifyVarResultPop(varId, projectType, viewInstp.showProjectDetails);
		});
		$(".j_submitVarResultPop").live('click',function(){
			var varId = $(this).attr("itemIds");
			submitVarResultPop(varId, projectType, viewInstp.showProjectDetails);
		});
		...
		$(".j_subVar").live('click',function(){
			var varId = $(this).attr("itemIds");
			viewVariation.subVar(varId, projectType, viewInstp.showProjectDetails);
		});
		$(".j_delVar").live('click',function(){
			var varId = $(this).attr("itemIds");
			viewVariation.delVar(varId, projectType, viewInstp.showProjectDetails);
		});
		$(".j_addVarAuditPop").live('click',function(){
			var varId = $(this).attr("itemIds");
			viewVariation.addVarAuditPop(varId, projectType, viewInstp.showProjectDetails);
		});
		$(".j_backVarAudit").live('click',function(){
			var varId = $(this).attr("itemIds");
			viewVariation.backVarAudit(varId, projectType, viewInstp.showProjectDetails);
		});
		...
		$(".j_modVarAuditPop").live('click',function(){
			var varId = $(this).attr("itemIds");
			viewVariation.modVarAuditPop(varId, projectType, viewInstp.showProjectDetails);
		});
		$(".j_subVarAudit").live('click',function(){
			var varId = $(this).attr("itemIds");
			viewVariation.subVarAudit(varId, projectType, viewInstp.showProjectDetails);
		});
...
//		window.subVar = function(varId){viewVariation.subVar(varId, projectType, viewInstp.showProjectDetails)};
//		window.delVar = function(varId){viewVariation.delVar(varId, projectType, viewInstp.showProjectDetails)};//公共部分
//		window.addVarAuditPop = function(varId){viewVariation.addVarAuditPop(varId, projectType, viewInstp.showProjectDetails)};
//		window.modVarAuditPop = function(varId){viewVariation.modVarAuditPop(varId, projectType, viewInstp.showProjectDetails)};
//		window.viewVarAuditPop = function(varId, auditViewFlag){viewVariation.viewVarAuditPop(varId, auditViewFlag, projectType)};
//		window.subVarAudit = function(varId){viewVariation.subVarAudit(varId, projectType, viewInstp.showProjectDetails)};
//		window.backVarAudit = function(varId){viewVariation.backVarAudit(varId, projectType, viewInstp.showProjectDetails)};
//		window.addVarResultPop = function(){viewVariation.addVarResultPop(projectType, viewInstp.showProjectDetails)};
//		window.modifyVarResultPop = function(varId){viewVariation.modifyVarResultPop(varId, projectType, viewInstp.showProjectDetails)};
//		window.submitVarResultPop = function(varId){submitVarResultPop(varId, projectType, viewInstp.showProjectDetails)};
		window.uploadVarPop = function(varId){viewVariation.uploadVarPop(varId, projectType, viewInstp.showProjectDetails)};
