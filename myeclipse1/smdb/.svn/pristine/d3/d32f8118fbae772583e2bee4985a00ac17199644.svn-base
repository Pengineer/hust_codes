...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			seajs.use('javascript/project/special/midinspection/midinspectionRequired.js', function(midinspectionRequired) {
				$(function(){
	...
	<body>
		<div style="width:840px;">
			<s:form id="search" theme="simple" action="list" namespace="/project/special/midinspection/apply/midRequired">
