				...
				<s:form id="mid_audit">
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						<tr class="table_tr2">
							...
							<td class="table_td12"><s:radio name="midAuditResult" theme="simple" cssClass="j_showOpinionFeedbackOrNot" list="#{'2':'同意','1':'不同意'}" /></td>
						...
						<s:if test="#session.loginer.currentType.within(@csdc.tool.bean.AccountType@ADMINISTRATOR, @csdc.tool.bean.AccountType@MINISTRY)"><!-- 系统管理员或部级 -->
							<tr class="table_tr2">
								<td class="table_td11">审核意见：<br /></span><span>（反馈给负责人）</span>（限200字）</td>
								<td class="table_td12">
