			...
			<s:form id="award_review">
				<table width="100%" border="0" cellspacing="2" cellpadding="0">
					...
					<tr class="table_tr2">
						...
						<td class="table_td3"><s:select cssClass="select" id="gradeid" name="awardGradeid" list="%{baseService.getSystemOptionMap('awardGrade', null)}" headerKey="-1" headerValue="--%{'请选择'}--"/></td>
