define(function(require, exports, module) {
	...
	var nameSpace = "other/nssf/application";
	...
	exports.init = function() {
		list.pageShow({
			"nameSpace":nameSpace,
			"sortColumnId":["sortcolumn0","sortcolumn1","sortcolumn3","sortcolumn11","sortcolumn12","sortcolumn13"],
			"sortColumnValue":{"sortcolumn0":0,"sortcolumn1":1,"sortcolumn3":3,"sortcolumn11":11,"sortcolumn12":12,"sortcolumn13":13}
		});
		...
		$("#firstAudit").live("click", function() {
			if (confirm("您确定要进行" + $("#select_year").val() + "年国家社科基金项目的初审操作吗？继续操作会覆盖之前的初审结果！")) {
				if (parent != null) {
