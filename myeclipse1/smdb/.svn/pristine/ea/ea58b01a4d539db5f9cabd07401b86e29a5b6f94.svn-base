...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>查看院系管理人员</title>
		<s:include value="/innerBase.jsp" />
	</head>

	<body>
		<div class="link_bar">
			当前位置：社科人员数据&nbsp;&gt;&nbsp;社科管理人员&nbsp;&gt;&nbsp;院系管理人员&nbsp;&gt;&nbsp;查看
		</div>
		...
		<div class="main">
			...
			<div class="choose_bar">
				<ul>
					...
					<li id="view_del"><sec:authorize ifAllGranted="ROLE_PERSON_OFFICER_DEPARTMENT_DELETE"><input class="btn1" type="button" value="删除" /></sec:authorize></li>
					<li id="view_mod"><sec:authorize ifAllGranted="ROLE_PERSON_OFFICER_DEPARTMENT_MODIFY"><input class="btn1" type="button" value="修改" /></sec:authorize></li>
					<li id="view_add"><sec:authorize ifAllGranted="ROLE_PERSON_OFFICER_DEPARTMENT_ADD"><input class="btn1" type="button" value="添加" /></sec:authorize></li>
				</ul>
			</div>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<sec:authorize ifAnyGranted="ROLE_SYSTEM_KEY,ROLE_SYSTEM_KEY_VIEW,ROLE_SYSTEM_KEY_MODIFY">
									<td class="title_bar_td" width="20" align="right"><img src="image/ico08.gif" width="5" height="9" /></td>
									<td class="title_bar_td" width="60" align="right" >
										标识：
									</td>
									<td class="title_bar_td" id="personName" >
							...
							<tr>
								<sec:authorize ifAnyGranted="ROLE_SECURITY_ACCOUNT_DEPARTMENT_SUB_ADD">
									<td class="title_bar_td" width="20" align="right"><img src="image/ico08.gif" width="5" height="9" /></td>
									<td class="title_bar_td" width="60" align="right">通行证：</td>
									...
									<td class="title_bar_td" width="20" align="right"><img src="image/ico08.gif" width="5" height="9" /></td>
									<td class="title_bar_td" width="60" align="right">账号：</td>
									<td class="title_bar_td"  id="accountDisp">	
							...
							<div class="p_box_body">
								<div class="p_box_body_t">
									<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
										<tr class="table_tr7">
											<td class="key" width="100">所在院系：</td>
											<td class="value" ><a class="linkD" id="${departmentId}" href="">${officer.divisionName}</a></td>
											<td class="key" width="100">上级管理部门：</td>
											<td class="value" ><a class="linkA" id="${subjectionId}" href="">${officer.agencyName}</a></td>
										</tr>
										<tr class="table_tr7">
											<td class="key" width="100">开始时间：</td>
											<td class="value" width="200">${officer.startDate}</td>
											<td class="key" width="100">结束时间：</td>
										...
										<tr class="table_tr7">
											...
											<td class="value">${officer.staffCardNumber}</td>
										</tr>
										<tr class="table_tr7">
											<td class="key">人员类型：</td>
											<td class="value" colspan="3">${officer.type}</td>
										</tr>
									</table>
								</div>
							</div>
		...
		<script type="text/javascript">
			seajs.use('javascript/person/officer/department/view.js', function(view) {
				$(function(){
					view.init();
				})
			});
