		...
		<table class="table_valid" width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				<s:if test="rms[#stat.index].member.id != null">
					<tr>
						...
						<td class="table_td9">
							...
							<s:hidden name="%{'rms['+#stat.index+'].member.id'}" value="%{rms[#stat.index].member.id}" />
							<s:hidden name="%{'rms['+#stat.index+'].memberName'}"/>
						</td>
						<td class="table_td10"></td>
					</tr>
					<tr>
						<td class="table_td8"><span class="table_title5">所在单位与部门：</span></td>
						<td class="table_td9">
			...
			<s:else>
				...
				<tr>
					...
					<td class="table_td17">
						<s:select cssClass="select" name="%{'rms['+#stat.index+'].isDirector'}" value="1" headerKey='-1' headerValue="--请选择--" list="#{'1':'是','0':'否'}" />
					</td>
					<td class="table_td10"></td>
					<td class="table_td8"><span>职务：</span></td>
					<td class="table_td9">
