...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			<div class="link_bar">
				当前位置：评审项目&nbsp;&gt;&nbsp;重大攻关项目&nbsp;&gt;&nbsp;申请数据
			</div>
			
			<div class="main">
				<div class="main_content">
					<div class="table_main_tr_adv">
						<s:include value="/project/key/application/review/search.jsp"/>
					</div>
								...
								<tr>
									...
									<td>
										{if item.laData[12]!=null && item.laData[12]!=""}
											<a id="${item.laData[0]}" name="${item.laData[0]}"  class="download_key_3" href="">
					...
					<s:form id="list" theme="simple" action="" namespace="/project/key/application/review">
			...
			<script type="text/javascript">
				seajs.use('javascript/project/key/application/review/list.js', function(list) {
					list.init();
				});
			</script>
		</body>
