...
<div class="edit_info" id="apply">
	<table width="100%" border="0" cellspacing="2" cellpadding="2">
		...
		<tr class="table_tr2">
			...
			<td class="table_td3"><s:select cssClass="select" name="application1.subtype.id" headerKey="-1" headerValue="--请选择--" list="%{baseService.getSystemOptionMap('projectType', '01')}" /></td>
			<td class="table_td4"></td>
		</tr>
		<tr class="table_tr2">
			<td class="table_td2">
		...
		<tr class="table_tr2">
			<td class="table_td2"><span>申请经费（万）：</span></td>
		...
		<tr class="table_tr2">
			<td class="table_td2"><span class="table_title5">申请经费概算：</span></td>
				<s:if test="flag == 0"><%-- 添加 --%>
					<td class="table_td3">
