...
define(function(require, exports, module) {
    ...
    var submitVarResultPop = function(varId, projectType, showProjectDetails){
    	...
    	if(currentStop == 1 && $("#midPending").val() == 1){
    		...
    		viewVariation.varSubmitform('project/general/variation/apply/submitResult.action?varId='+varId+"&projectid=" + projectid, projectType, showProjectDetails);
    	}
    }
	...
	exports.initClick = function() {
		...
		$(".j_addVarResultPop").live('click',function(){
			viewVariation.addVarResultPop(projectType, viewGeneral.showProjectDetails);
		});
		$(".j_modifyVarResultPop").live('click',function(){
			var varId = $(this).attr("itemIds");
			viewVariation.modifyVarResultPop(varId, projectType, viewGeneral.showProjectDetails);
		});
		$(".j_submitVarResultPop").live('click',function(){
			var varId = $(this).attr("itemIds");
			submitVarResultPop(varId, projectType, viewGeneral.showProjectDetails);
		});
		...
		$(".j_subVar").live('click',function(){
			var varId = $(this).attr("itemIds");
			viewVariation.subVar(varId, projectType, viewGeneral.showProjectDetails);
		});
		$(".j_delVar").live('click',function(){
			var varId = $(this).attr("itemIds");
			viewVariation.delVar(varId, projectType, viewGeneral.showProjectDetails);
		});
		$(".j_addVarAuditPop").live('click',function(){
			var varId = $(this).attr("itemIds");
			viewVariation.addVarAuditPop(varId, projectType, viewGeneral.showProjectDetails);
		});
		$(".j_backVarAudit").live('click',function(){
			var varId = $(this).attr("itemIds");
			viewVariation.backVarAudit(varId, projectType, viewGeneral.showProjectDetails);
		});
		...
		$(".j_modVarAuditPop").live('click',function(){
			var varId = $(this).attr("itemIds");
			viewVariation.modVarAuditPop(varId, projectType, viewGeneral.showProjectDetails);
		});
		$(".j_subVarAudit").live('click',function(){
			var varId = $(this).attr("itemIds");
			viewVariation.subVarAudit(varId, projectType, viewGeneral.showProjectDetails);
		});
		$(".j_switchVarPublish").live('click', function(){//切换发布
			viewVariation.switchVarPublish(projectType);
		});
...
//		window.subVar = function(varId){viewVariation.subVar(varId, projectType, viewGeneral.showProjectDetails)};
//		window.delVar = function(varId){viewVariation.delVar(varId, projectType, viewGeneral.showProjectDetails)};//公共部分
//		window.addVarAuditPop = function(varId){viewVariation.addVarAuditPop(varId, projectType, viewGeneral.showProjectDetails)};
//		window.modVarAuditPop = function(varId){viewVariation.modVarAuditPop(varId, projectType, viewGeneral.showProjectDetails)};
//		window.viewVarAuditPop = function(varId, auditViewFlag){viewVariation.viewVarAuditPop(varId, auditViewFlag, projectType)};
//		window.subVarAudit = function(varId){viewVariation.subVarAudit(varId, projectType, viewGeneral.showProjectDetails)};
//		window.backVarAudit = function(varId){viewVariation.backVarAudit(varId, projectType, viewGeneral.showProjectDetails)};
//		window.addVarResultPop = function(){viewVariation.addVarResultPop(projectType, viewGeneral.showProjectDetails)};
//		window.modifyVarResultPop = function(varId){viewVariation.modifyVarResultPop(varId, projectType, viewGeneral.showProjectDetails)};
//		window.submitVarResultPop = function(varId){submitVarResultPop(varId, projectType, viewGeneral.showProjectDetails)};
		window.uploadVarPop = function(varId){viewVariation.uploadVarPop(varId, projectType, viewGeneral.showProjectDetails)};
