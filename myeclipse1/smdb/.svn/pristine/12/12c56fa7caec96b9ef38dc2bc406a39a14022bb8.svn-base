...
<div class="edit_info list_edit" id="education">
	<table id="table_education" class="table_edit" width="100%" border="0" cellspacing="0" cellpadding="2">
		...
		<tr class="tr_valid" >
			...
			<td>&nbsp;</td>
			<td>
				<s:select cssClass="select" headerKey="-1" headerValue="请选择" list="%{baseService.getSystemOptionMapAsName('educationBackground', null)}" name="%{'ebs['+#stat.index+'].education'}" value="%{ebs[#stat.index].education}" />
			</td>
			<td>&nbsp;</td>
			<td>
				<s:select cssClass="select" headerKey="-1" headerValue="请选择" list="%{baseService.getSystemOptionMapAsName('degree', null)}" name="%{'ebs['+#stat.index+'].degree'}" value="%{ebs[#stat.index].degree}" />
			</td>
			<td>&nbsp;</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="display:none;">
	<tr class="tr_valid" id="tr_education" style="display:none;">
		...
		<td>&nbsp;</td>
		<td><s:select cssClass="select" headerKey="-1" headerValue="请选择" list="%{baseService.getSystemOptionMapAsName('educationBackground', null)}" name="ebs[].education" /></td>
		<td>&nbsp;</td>
		<td><s:select cssClass="select" headerKey="-1" headerValue="请选择" list="%{baseService.getSystemOptionMapAsName('degree', null)}" name="ebs[].degree" /></td>
		<td>&nbsp;</td>
