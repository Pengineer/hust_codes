...
//	private Set<AwardApplication> productType;//成果类别
	...
	private Set<SpecialApplication> specialAppSubtype;
	private Set<SpecialApplication> specialAppSubsubtype;
	private Set<SpecialGranted> specialGraSubtype;//
	private Set<SpecialGranted> specialGraSubsubtype;
...
//	}
	...
	public void setSubType(Set<AwardApplication> subType) {
	...
	@JSON(serialize=false)
	public Set<SpecialGranted> getSpecialGraSubtype() {
		return specialGraSubtype;
	}
	public void setSpecialGraSubtype(Set<SpecialGranted> specialGraSubtype) {
		this.specialGraSubtype = specialGraSubtype;
	}
	@JSON(serialize=false)
	public Set<SpecialGranted> getSpecialGraSubsubtype() {
		return specialGraSubsubtype;
	}
	public void setSpecialGraSubsubtype(Set<SpecialGranted> specialGraSubsubtype) {
		this.specialGraSubsubtype = specialGraSubsubtype;
	}
	@JSON(serialize=false)
	public Set<SpecialApplication> getSpecialAppSubtype() {
		return specialAppSubtype;
	}
	@JSON(serialize=false)
	public Set<SpecialApplication> getSpecialAppSubsubtype() {
		return specialAppSubsubtype;
	}
	public void setSpecialAppSubsubtype(Set<SpecialApplication> specialAppSubsubtype) {
		this.specialAppSubsubtype = specialAppSubsubtype;
	}
	public void setSpecialAppSubtype(Set<SpecialApplication> specialAppSubtype) {
		this.specialAppSubtype = specialAppSubtype;
	}
