...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			seajs.use('javascript/project/instp/midinspection/midinspectionRequired.js', function(midinspectionRequired) {
				$(function(){
	...
	<body>
		<div style="width:840px;">
			<s:form id="search" theme="simple" action="list" namespace="/project/instp/midinspection/apply/midRequired">
