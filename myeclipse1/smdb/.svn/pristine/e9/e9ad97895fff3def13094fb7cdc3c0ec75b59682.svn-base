...
<div id="simple_search">
	<s:form id="search" theme="simple" action="list" namespace="/project/key/application/granted">
				...
				<td align="right"><span class="choose_bar">
					<s:if test="!#session.loginer.currentType.within(@csdc.tool.bean.AccountType@MINISTRY_UNIVERSITY, @csdc.tool.bean.AccountType@INSTITUTE)">
						<s:select cssClass="select" name="searchType" value="%{searchQuery.searchType}" headerKey="-1" headerValue="--不限--"
							list="#{'1':'批准号','2':'项目名称','3':'首席专家','4':'依托高校','5':'研究类型','6':'学科门类','7':'项目年度'}" />
					</s:if>
					<s:else>
						<s:select cssClass="select" name="searchType" value="%{searchQuery.searchType}" headerKey="-1" headerValue="--不限--"
							list="#{'1':'批准号','2':'项目名称','3':'首席专家','5':'研究类型','6':'学科门类','7':'项目年度'}" />
					</s:else>
...
<div id="adv_search" style="display:none;">
	<s:form id="advSearch" action="advSearch" theme="simple" namespace="/project/key/application/granted">
		...
		<div class="adv_content">
			...
			<table class="adv_table" width="100%" border="0" cellspacing="2" cellpadding="0">
				...
				<tr class="adv_tr">
					...
					<td class="adv_td1">
						<s:select cssClass="select" name="midiStatus" value="%{searchQuery.midiStatus}" headerKey="-1" headerValue="--不限--" list="#{'1':'通过','2':'未通过'}" />
					</td>
					<td class="adv_td1"></td>
				</tr>
				<tr class="adv_tr">
