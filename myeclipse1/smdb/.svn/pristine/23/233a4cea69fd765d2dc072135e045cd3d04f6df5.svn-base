			...
			<div style="width:400px;">
				<s:form id="mid_result">
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						<tr class="table_tr2">
							<td class="table_td11"><span class="table_title4">上传中检申请书：</span></td>
							<td class="table_td12">
						...
						<tr class="table_tr2">
							<td class="table_td2"><span class="table_title4">中检经费结算：</span></td>
							<td class="table_td3">
								<input type="button" id="modifyMidFee" class="btn1 select_btn" value="修改" />
						...
						<tr class="table_tr2">
							...
							<td class="table_td12"><s:radio name="midResult" theme="simple" list="#{'2':'同意','1':'不同意'}"/></td>
						...
						<tr class="table_tr2">
							...
							<s:textarea name="midOpinionFeedback" rows="2" cssClass="textarea_css" /><br/><span class="warning">此意见将会反馈给该项目负责人，请慎重填写！</span></td>
							<td class="table_td13"></td>
						</tr>
					</table>
				</s:form>
