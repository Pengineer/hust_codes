		...
		<body>
			<div style="width:480px;">
				<s:form id="var_audit">
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						<tr class="table_tr2">
							...
							<td class="table_td12"><s:radio name="varAuditResult" cssClass="j_showOpinionFeedbackOrNot" theme="simple" list="#{'2':'同意','1':'不同意'}"/></td>
						...
						<s:if test="#session.loginer.currentType.within(@csdc.tool.bean.AccountType@ADMINISTRATOR, @csdc.tool.bean.AccountType@MINISTRY)"><!-- 系统管理员或部级 -->
							<tr class="table_tr2">
								<td class="table_td11">变更时间：</td>
								<td class="table_td12"><input type="text" id="startDate1" name="varAuditDate" class="input_css_self date_hint FloraDatepick" value="<s:date name='%{varAuditDate}' format='yyyy-MM-dd' />" /></td>
							</tr>
						</s:if>
						<tr class="table_tr2">
						...
						<s:if test="#session.loginer.currentType.within(@csdc.tool.bean.AccountType@ADMINISTRATOR, @csdc.tool.bean.AccountType@MINISTRY)"><!-- 系统管理员或部级 -->
							<tr class="table_tr2">
								<td class="table_td11"><span>审核意见：<br /></span><span>（反馈给负责人）</span><br/>（限200字）</td>
						...
						<s:elseif test="#session.loginer.currentType.within(@csdc.tool.bean.AccountType@PROVINCE, @csdc.tool.bean.AccountType@INSTITUTE)"> 
							<tr class="table_tr2" id="opinion_feedback" style="display:none;">
							    <td class="table_td11"><span>审核意见：<br /></span>（反馈给负责人）<br/>（限200字）</td>
				...
				<div class="btn_div_view">
					<input id="save" class="btn1 j_addVarAudit" data=2 type="button" value="保存" />
					<input id="submit" class="btn1 j_addVarAudit" data=3 type="button" value="提交" />
