define(function(require, exports, module) {
	...
	var nameSpace = "project/special/application/applyStrict";
	...
	exports.init = function() {
		...
		$("#mail").live("click", function() {
			alert("即将给各高校发送有关年度项目限项申请总数的通知邮件");
			$.ajax({
				url: nameSpace+"/sendMail.action",
				type: "post",
				data:"strictAppYear="+$("#strictAppYear").val(),
				dataType: "json",
		...
		$("#default").live("click", function() {
			window.location.href = basePath + "/project/special/application/applyStrict/toList.action";
		});
		...
		$("#export").live("click", function(){
			window.location.href = basePath + "/project/special/application/applyStrict/confirmExportOverView.action";
		});
	};
});