			...
			<s:include value="/validateError.jsp" />
				<div style="overflow-y:scroll;height:500px;">
					<s:form id="end_result">
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="0">
							<tr class="table_tr2">
								<td class="table_td11"><span class="table_title6">上传结项申请书：</span></td>
								<td class="table_td12">
							...
							<tr class="table_tr2">
								...
								<td class="table_td12"><s:radio name="isApplyNoevaluation" theme="simple" list="#{'1':'是','0':'否'}" /></td>
								<td class="table_td13" width="100"></td>
							</tr>
							<tr class="table_tr2" id="no_eval_info" style="display:none;">
								<td class="table_td11"><span class="table_title6">免鉴定成果：</span></td>
							...
							<tr class="table_tr2">
								...
								<td class="table_td12"><s:radio name="isApplyExcellent" theme="simple" list="#{'1':'是','0':'否'}" /></td>
								<td class="table_td13"></td>
							</tr>
							<tr class="table_tr2" id="excellect_info" style="display:none;">
								<td class="table_td11"><span class="table_title6">优秀成果结果：</span></td>
								<td class="table_td12"><s:radio name="endExcellentResult" theme="simple" list="#{'2':'同意','1':'不同意','0':'待定'}"/></td>
								<td class="table_td13"></td>
							</tr>
							<tr class="table_tr2">
							...
							<tr class="table_tr2">
								...
								<td class="table_td12"><s:radio name="endResult" theme="simple" list="#{'2':'同意','1':'不同意'}" /></td>
								<td class="table_td13"></td>
							</tr>
							...
							<tr class="table_tr2">
								...
								<td class="table_td12">
								<s:select cssClass="select" style = "width:100%" id = "auditOption" name="auditOption" list="%{baseService.getSystemOptionMap('endinspectionAuditOpinion', '02')}" />
				...
				<div class="btn_div_view">
					<s:if test="modifyFlag != 1">
						<input id="save" class="btn1 addEndResult" type="button" data = "2" types = "2" value="保存"  />
<%--						<input id="save" class="btn1" type="button" value="保存" onclick="addEndResult(2, 2, thisPopLayer);" />--%>
					</s:if>
					<s:if test="varPending == 0">
						<input id="submit" class="btn1 addEndResult" type="button" data = "3" types = "2" value="提交" />
					</s:if>
					<input id="cancel" class="btn1" type="button" value="取消" />
				</div>
			</div>
			<script type="text/javascript">
				seajs.use(['javascript/project/special/endinspection/apply/edit.js','javascript/project/project_share/endinspection/apply/validate.js'], function(edit, validate) {
					validate.valid();
					edit.init();
				});
			</script>
