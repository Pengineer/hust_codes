...
<div class="main">
	<div class="main_content">
		...
		<table width="100%" border="0" cellspacing="2" cellpadding="0">
			...
			<tr class="table_tr2" style="display:none;" id = "RoleType">
				...
				<td class="table_td3">
					<div id="type">
						<s:radio name="type" value="%{type}" list="#{'0':'非默认角色','1':'指定账号类型的默认角色','2':'指定机构的默认角色'}" />
					</div>
	...
	<div class="btn_bar2">
		<input id="save" class="btn1" type="submit" value="保存" />
