...
public class ProjectAction extends BaseAction {
	...
	private static final String[] HQL = {
		...
		"order by app.name asc, app.id asc",//申请暂存
	...
	protected Integer listType;//项目列表类型(1.申请列表；2.立项列表；3.中检列表；4.结项列表；5.变更列表；6项目管理系统首页进入；7我的项目列表；8评审项目结项列表；9用户信息中心首页进入；10评审项目申请列表；11年检列表);
	private String projectType;//项目类型
	private String selectedTab;//查看项目默认显示标签
	private Integer appStatus;//申请业务设置状态
