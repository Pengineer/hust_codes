...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<s:if test="viewFlag == 1">
			...
			<s:hidden name="namespace" id="namespace" value="unit/selfspace"/>
		</s:if>
		<s:else>
			<div class="link_bar">
				当前位置：社科机构数据&nbsp;&gt;&nbsp;社科管理机构&nbsp;&gt;&nbsp;院系管理机构&nbsp;&gt;&nbsp;查看
			</div>
			<s:hidden name="namespace" id="namespace" value="unit/department"/>
		</s:else>
		
		<div class="main">
			<s:form id="view_unit" action="" theme="simple" namespace="/unit/department">
			...
			<div class="choose_bar">
				<ul>
					<s:if test="viewFlag==0">
						...
						<sec:authorize ifAllGranted="ROLE_UNIT_DEPARTMENT_MODIFY">
			...
			<div class="main_content" style="display:none;" id="tabcontent">
				<s:include value="/unit/agency/viewDepartmentCommon.jsp" />
				...
				<div class="main_content">
					...
					<div class="p_box">
						<s:include value="/unit/agency/viewDepartmentContact.jsp" />
						<s:include value="/unit/agency/viewUniAndDepAcademic.jsp" />
					</div>
				</div>
			</div>
		</div>
		<script type="text/javascript">
			seajs.use('javascript/unit/agency/department/view.js', function(view) {
				$(function(){
					view.init();
				})
			});
