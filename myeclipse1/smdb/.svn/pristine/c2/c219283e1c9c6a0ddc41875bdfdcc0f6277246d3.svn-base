				...
				<s:form id="form_dm" action="toAnalyze" namespace="/dataMining/association" theme="simple" >
					<table width="100%" border="0" cellspacing="2" cellpadding="2">
						<tr class="table_tr2">
							...
							<td class="table_td3"><s:select cssClass="select" id="type" name="type" headerKey="-1" headerValue="--请选择--" list="#{'discipline':'学科关联性分析', 'university':'高校关联性分析', 'member':'研究人员关联性分析'}"/></td>
						...
						<tr class="table_tr2">
							...
							<td class="table_td3">
								<s:radio name="analyzeAngle" value="1" list="#{'0':'申请数据', '1':'立项数据', '2':'批准经费'}" />
							</td>
							<td class="table_td4"></td>
						</tr>
