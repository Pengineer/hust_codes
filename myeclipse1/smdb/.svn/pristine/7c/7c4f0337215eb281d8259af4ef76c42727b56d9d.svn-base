...
public class SinossServerAction extends ActionSupport{
	...
	private int finalAuditResultPublish;
	...
	public String toApplicationResultConfig() {
		...
		finalAuditResultPublish = interfaceService.getFinalAuditResultPublish("SinossWebService", "requestProjectApplicationResult");
		if(opMap != null) {
	...
	public String applicationResultConfig() {
		...
		interfaceConfig.setFinalAuditResultPublish(finalAuditResultPublish);
	...
	public String toMidinspectionResultConfig() {
		...
		finalAuditResultPublish = interfaceService.getFinalAuditResultPublish("SinossWebService", "requestProjectMidinspectionResult");
		if(opMap != null) {
			SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
			try {
				startYear = (Integer) opMap.get("startYear");
	...
	public String toVariationResultConfig() {
		...
		finalAuditResultPublish = interfaceService.getFinalAuditResultPublish("SinossWebService", "requestProjectVariationResult");
		if(opMap != null) {
			SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
			try {
				startYear = (Integer) opMap.get("startYear");
	...
	public String toEndinspectionResultConfig() {
		...
		finalAuditResultPublish = interfaceService.getFinalAuditResultPublish("SinossWebService", "requestProjectEndinspectionResult");
		if(opMap != null) {
			SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
			try {
				startYear = (Integer) opMap.get("startYear");
	...
	public String toMidinspectionRequiredConfig() {
		...
		finalAuditResultPublish = interfaceService.getFinalAuditResultPublish("SinossWebService", "requestProjectMidinspectionRequired");
		if(opMap != null) {
			SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
			startYear = (Integer) opMap.get("startYear");
			endYear = (Integer) opMap.get("endYear");				
