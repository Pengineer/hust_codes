  ...
  <body>
	<div class="link_bar" id="view_project_general">
			        ...
			        <table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
						<tbody>
							...
							<tr class="table_tr7">
								...
								<td class="value">（1）在研项目查重：项目申请人应不具有在研的国家社科基金重大项目、教育部哲学社会科学研究重大课题攻关项目、基地重大项目、后期资助项目；</td>
								<td class="value">（2）撤项项目审核：项目申请人应不具有三年内撤项的教育部人文社会科学研究一般项目、专项任务项目、重大攻关项目、后期资助项目、基地项目。</td>
							</tr>
						</tbody>
					</table>
			...
			<div id="firstAuditResult" class="main">
				...
				<div class="p_box_body">
					<div id="main">
						<s:form id="search" theme="simple" action="simpleSearch" namespace="/project/general/application/firstAudit">
			...
			<script type="text/javascript">
				seajs.use('javascript/project/instp/application/firstAudit/firstAuditConfig.js', function(view) {
					view.init();
				});
			</script>
  </body>
