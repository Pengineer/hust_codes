					...
					<s:form id="select_form" action="add" namespace="/project/instp/application/granted">
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="2">
							...
							<tr class="table_tr2">
								...
								<td class="table_td3"><s:select cssClass="select" name="granted.subtype.id" headerKey="-1" headerValue="--请选择--" list="%{baseService.getSystemOptionMap('projectType', '03')}" /></td>
								<td class="table_td4"></td>
							</tr>
							<tr class="table_tr2">
