...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			...
			<div class="main">
				...
				<div id="type_select">
					<s:form id="select_form" action="add" namespace="/project/special/application/granted">
...
<%--							</tr>--%>
				...
				<div id="type_new" style="display:none">
					<s:form id="application_form" action="add" namespace="/project/special/application/granted">
						...
						<div id="info" style="display:none">
							...
							<div class="main_content">
								...
								<s:include value="/project/special/application/granted/editApplyTab.jsp" />
								<s:include value="/project/special/application/granted/editGrantedTab.jsp" />
								<s:include value="/project/special/application/granted/editMemberTab.jsp" />
							</div>
						</div>
					</s:form>
					<s:include value="/project/special/application/granted/memberTemplate.jsp" />
			...
			<script type="text/javascript">
				seajs.use(['javascript/project/special/application/granted/add.js','javascript/project/project_share/application/validate.js'], function(add, validate) {
					validate.valid();
					add.init();
				});
			</script>
