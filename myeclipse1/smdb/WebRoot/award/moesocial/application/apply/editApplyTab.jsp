...
<div class="edit_info" id="apply">
	<table width="100%" border="0" cellspacing="2" cellpadding="0">
		<tr class="table_tr2">
			<td class="table_td2" width="130"><span class="table_title5">申请类型：</span></td>
			<td class="table_td3">
				<s:radio id="app" name="awardApplication.applicationType" value="#request.get('applicationType')" list="#{'1':'以个人名义申请','2':'以团队、课题组、机构等名义申请'}" /></td>
   	...
   	<div id="individual">
		<table width="100%" border="0" cellspacing="2" cellpadding="2">
			...
			<tr class="table_tr2">
				...
				<td class="table_td3"><s:select cssClass="select" name="person.gender" headerKey="" headerValue="--%{'请选择'}--" list="#application.sexList" /></td>
				<td class="table_td4"></td>
			</tr>
			<tr class="table_tr2">
				<td class="table_td2"><span class="table_title5">出生日期：</span></td>
				<td class="table_td3">
			...
			<tr class="table_tr2">
				...
				<td class="table_td3"><s:select cssClass="select" headerKey="" headerValue="--%{'请选择'}--" list="%{baseService.getSystemOptionMapAsName('degree', null)}" name="academic.lastDegree" /></td>
				<td class="table_td4"></td>
		    </tr>
		    <tr class="table_tr2">
	...
	<div id="organization" style="display: none;">
		<table width="100%" border="0" cellspacing="2" cellpadding="2">
			<tr class="table_tr2">
				<td class="table_td2" width="130"><span class="table_title5">申请人：</span></td>
				<td class="table_td3">		
					<s:select cssClass="select" id="selectOrNot" name="isSelectOrgan" list="#{'1':'选择','0':'其他'}" headerKey="-1" headerValue="--%{'请选择'}--" />
					<span id="select_yes" style="display:none;"><s:select cssClass="select" id="select_organ_btn" name="product.id" list="%{#session.organizations}" headerKey="-1" headerValue="--%{'请选择'}--"/></span>
