					...
					<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
						...
						<tbody>
							...
							<tr class="table_tr4">
								...
								<td>
									{if awardApplication.reviewStatus != 0 || (awardApplication.createMode == 1 || awardApplication.createMode == 2)}
					...
					<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
						...
						<tbody>
							...
							<tr class="table_tr4">
								...
								<td width="250"  align="center" >
									{if awardApplication.reviewAuditStatus != 0 || (awardApplication.createMode == 1 || awardApplication.createMode == 2)}
