				...
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					...
					<td width="49%" valign="top">
							...
							<div class="m_content" style="height:140px;">
								<s:if test="homeNotice == null || homeNotice.isEmpty()">
						...
						<div class="m_content" style="height:140px;">
								<s:if test="homeNews == null || homeNews.isEmpty()">
									<div class="no_records">暂无符合条件的记录</div>
								</s:if>
								<s:else>
									<ul>
           	...
           	<div class="main_content">
           		<table width="100%" border="0" cellspacing="0" cellpadding="0">
   					<tr>
           				...
           				<td width="49%" valign="top">
		     	     	 	<div class="m_title">
   								<span>备忘提醒</span><a href="selfspace/memo/toList.action?update=1">更多</a>
   							</div>
			              	<div class="m_content" style="height:140px;">
			                  	<s:if test="homeRemind == null || homeRemind.isEmpty()">
									<div class="no_records">暂无符合条件的记录</div>
								</s:if>
								<s:else>
									<ul>
										<s:iterator value="homeRemind" status="stat">
											<li><a title="<s:property value="homeRemind[#stat.index][1]" />" href="selfspace/memo/toView.action?viewFlag=2&entityId=<s:property value="homeRemind[#stat.index][0]" />" class="txt_left"><s:property value="homeRemind[#stat.index][1]" /></a><span class="txt_right">[<s:if test="#session.locale == 'zh_CN'"><s:date name="homeRemind[#stat.index][2]" format="yyyy-MM-dd" /></s:if><s:else><s:date name="homeRemind[#stat.index][2]" format="dd/MM/yyyy" /></s:else>]</span></li>
										</s:iterator>
									</ul>
								</s:else>
		                    </div>
