				...
				<div class="left_menu">
					...
					<!-------------------- 机构 --------------->
							...
							<sec:authorize ifAnyGranted="ROLE_PROJECT_GENERAL_APPLICATION_APPLY_VIEW,ROLE_PROJECT_GENERAL_APPLICATION_GRANTED_VIEW,ROLE_PROJECT_GENERAL_ANNINSPECTION_APPLY_VIEW,ROLE_PROJECT_GENERAL_MIDINSPECTION_APPLY_VIEW,ROLE_PROJECT_GENERAL_ENDINSPECTION_APPLY_VIEW,ROLE_PROJECT_GENERAL_VARIATION_APPLY_VIEW,
								...
								<sec:authorize ifAnyGranted="ROLE_PROJECT_GENERAL_APPLICATION_APPLY_VIEW,ROLE_PROJECT_GENERAL_APPLICATION_GRANTED_VIEW,ROLE_PROJECT_GENERAL_ANNINSPECTION_APPLY_VIEW,ROLE_PROJECT_GENERAL_MIDINSPECTION_APPLY_VIEW,ROLE_PROJECT_GENERAL_ENDINSPECTION_APPLY_VIEW,ROLE_PROJECT_GENERAL_VARIATION_APPLY_VIEW">
									<li id="0506" class="menu2" style="display:none;"><a href="javascript:void(0);">专项任务项目</a></li>
								</sec:authorize>
									<sec:authorize ifAnyGranted="ROLE_PROJECT_GENERAL_APPLICATION_APPLY_VIEW">
										<li id="050601" class="menu3" style="display:none;"><a href="project/special/application/apply/toList.action?update=1" target="main">申请数据</a></li>
									</sec:authorize>
									<sec:authorize ifAnyGranted="ROLE_PROJECT_GENERAL_APPLICATION_GRANTED_VIEW">
										<li id="050602" class="menu3" style="display:none;"><a href="project/special/application/granted/toList.action?update=1" target="main">立项数据</a></li>
									</sec:authorize>
									<sec:authorize ifAnyGranted="ROLE_PROJECT_GENERAL_ANNINSPECTION_APPLY_VIEW">	
										<li id="050603" class="menu3" style="display:none;"><a href="project/special/anninspection/apply/toList.action?update=1" target="main">年检数据</a></li>
									</sec:authorize>
									<sec:authorize ifAnyGranted="ROLE_PROJECT_GENERAL_MIDINSPECTION_APPLY_VIEW">
										<li id="050604" class="menu3" style="display:none;"><a href="project/special/midinspection/apply/toList.action?update=1" target="main">中检数据</a></li>
									</sec:authorize>
									<sec:authorize ifAnyGranted="ROLE_PROJECT_GENERAL_ENDINSPECTION_APPLY_VIEW">
										<li id="050605" class="menu3" style="display:none;"><a href="project/special/endinspection/apply/toList.action?update=1" target="main">结项数据</a></li>
									</sec:authorize>
									<sec:authorize ifAnyGranted="ROLE_PROJECT_GENERAL_VARIATION_APPLY_VIEW">
										<li id="050606" class="menu3" style="display:none;"><a href="project/special/variation/apply/toList.action?update=1" target="main">变更数据</a></li>
									</sec:authorize>
