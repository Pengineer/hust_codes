...
<div id="simple_search">
	<s:form id="search" theme="simple" action="list" namespace="/projectFund/instp">
		...
		<div class="adv_content">
			...
			<table class="adv_table" width="100%" border="0" cellspacing="2" cellpadding="0">
				...
				<tr class="adv_tr">
					...
					<td class="adv_td1"><s:select cssClass="select" name="projectSubtype" value="%{searchQuery.projectSubtype}" list="%{baseService.getSystemOptionMap('projectType', '02')}" headerKey="-1" headerValue="--不限--" /></td>
					<td class="adv_td1"></td>
				...
				<tr class="adv_tr">
					<td class="adv_td1" align="right">拨款类型：</td>
					<td class="adv_td1"><s:select cssClass="select" name="type" value="%{searchQuery.type}" list="#{'grantedfund':'立项拨款','midfund':'中检拨款','endfund':'结项拨款'}" headerKey="" headerValue="--不限--" /></td>
					<td class="adv_td1"></td>
					<td class="adv_td1" align="right">拨款状态：</td>
					<td class="adv_td1">
					<s:select cssClass="select" name="status" value="%{searchQuery.status}" list="#{'0':'未拨款','1':'已拨款'}" headerKey="-1" headerValue="--不限--" />
					</td>
					<td class="adv_td1"></td>
				</tr>
