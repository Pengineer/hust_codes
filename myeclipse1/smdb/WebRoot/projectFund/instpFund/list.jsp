...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<head>
			...
			<script type="text/javascript">
				seajs.use('javascript/projectFund/instp/list.js', function(list) {
					list.init();
				});
			</script>
		</head>
		...
		<body>
			<div class="link_bar">
				当前位置：研究项目经费&nbsp;&gt;&nbsp;基地项目&nbsp;&gt;&nbsp;拨款概况
			</div>
			
			<div class="main">
				<div class="main_content">
					<div class="table_main_tr_adv">
						<s:include value="/projectFund/instpFund/search.jsp"/>
					</div>
					...
					<s:form id="list" theme="simple" action="funding" namespace="/projectFund/instp">
