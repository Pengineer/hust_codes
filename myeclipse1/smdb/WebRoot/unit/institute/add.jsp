					...
					<div id="basicInfo">
						<table width="100%" border="0" cellspacing="2" cellpadding="0">
							...
							<tr class="table_tr2">
								...
								<td class="table_td3"><s:select cssClass="select" name="institute.type.id" headerKey="-1" headerValue="--请选择--" list="%{baseService.getSystemOptionMap('researchAgencyType', null)}" /></td>
								<td class="table_td4"></td>
							</tr>
							<tr class="table_tr2">
