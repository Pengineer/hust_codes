...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<s:else>
			<div class="link_bar" id="view_unit_province">
				当前位置：社科机构数据&nbsp;&gt;&nbsp;社科管理机构&nbsp;&gt;&nbsp;省级管理机构&nbsp;&gt;&nbsp;查看
			</div>
			...
			<div class="choose_bar">
				<ul>
					...
					<s:else>
						...
						<sec:authorize ifAllGranted="ROLE_UNIT_PROVINCE_MODIFY">
							<li id="view_mod"><input class="btn1" type="button" value="修改" /></li>
						</sec:authorize>
		...
		<script type="text/javascript">
			seajs.use('javascript/unit/agency/province/view.js', function(view) {
				$(function(){
					view.init();
				})
			});
