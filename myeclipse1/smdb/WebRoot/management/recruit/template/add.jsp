...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<form id = "template" method = "post" action = "management/recruit/template/add.action?entityId=">
		<table width="100%" border="0" cellspacing="2" cellpadding="0">
			<tr class="table_tr2">
				<td class="table_td2" width="130"><span class="table_title2">模版文件：</span></td>
				<td class="table_td3">
					<input type="file" id="template_add" />
					<input type = "hidden" disable = "disable" id = "file" name = "file"/>
				</td>
		...
		<script type="text/javascript">
			seajs.use(['javascript/management/recruit/template/add.js','javascript/management/recruit/template/validate.js'], function(add,validate) {
				$(function(){
					add.init();
					validate.valid();
				})
