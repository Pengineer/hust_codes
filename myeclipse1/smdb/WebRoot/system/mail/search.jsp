			...
			<tr class="table_main_tr">
				<td align="right"><span class="choose_bar">
					<s:select cssClass="select" name="searchType" value="%{searchQuery.searchType}" headerKey="-1" headerValue="--不限--"
						list="#{'1':'邮件主题','2':'邮件正文','3':'创建账号','4':'创建者'}" />
		...
		<div class="adv_content">
			...
			<table class="adv_table" width="100%" border="0" cellspacing="2" cellpadding="0">
				...
				<tr class="adv_tr">
					...
					<td class="adv_td2"><s:select cssClass="select" name="status" value="%{searchQuery.status}" headerKey="-1" headerValue="--不限--" list="#{'3':'已完成','1':'发送中','2':'已暂停'}" /></td>
					<td class="adv_td2"></td>
				</tr>
			</table>
			<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
