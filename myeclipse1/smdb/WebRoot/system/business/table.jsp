	...
	<div class="main_content">
		...
		<table width="100%" border="0" cellspacing="2" cellpadding="0">
			...
			<tr class="table_tr2">
				...
				<td class="table_td3">
					<s:select cssClass="select" name="business.status" headerKey="-1" headerValue="--请选择--"
						list="#{'1':'业务激活中','0':'业务停止'}" />
				</td>
				<td class="table_td4"></td>
			</tr>
			...
			<tr class="table_tr2">
				...
				<td class="table_td3">
					<s:select cssClass="select" name="business.startYear" list="%{businessService.getYearMap()}" headerKey="-1" headerValue="--不限--" />
					至
					<s:select cssClass="select" name="business.endYear" list="%{businessService.getYearMap()}" headerKey="-1" headerValue="--不限--" />
				</td>
				<td class="table_td4"></td>
			</tr>
		    <tr class="table_tr2" id="businessYear">
			    ...
			    <td class="table_td3">
			        <s:select cssClass="select" name="business.businessYear" list="%{businessService.getYearMap()}" headerKey="-1" headerValue="--不限--" />
			    </td>
			    <td class="table_td4"></td>
		    </tr>
			<tr class="table_tr2">
				<td class="table_td2">申请截止时间：</td>
				<td class="table_td3">
