				...
				<div class="main_content">
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						<tr class="table_tr2">
							...
							<td class="table_td3"><s:select id="methodName" cssClass="select" name="methodName" list="#{'getApplyProject':'申请数据',
					...
					<div class="btn_div_view">
						<input id="submit" class="btn2" type="button" value="下载附件" />
					</div>
				</div>
			</div>
		</s:form>
