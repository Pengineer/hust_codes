				...
				<div class="title_bar">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td class="title_bar_td" width="50" align="right">主题：</td>
							<td class="title_bar_td" width="200">${inBox.theme}
							</td>
							<td class="title_bar_td" width="10" align="right"><img src="image/ico08.gif" width="5" height="9" /></td>
							<td class="title_bar_td" width="70" align="right">发信者：</td>
						...
						{if inBox.sendType == 1}
							<td class="title_bar_td" width="10" align="right"><img src="image/ico08.gif" width="5" height="9" /></td>
							<td class="title_bar_td" width="70" align="right">类型：</td>
							<td class="title_bar_td" width="200">单播</td>
							<td class="title_bar_td" width="10" align="right"><img src="image/ico08.gif" width="5" height="9" /></td>
							<td class="title_bar_td" width="70" align="right">收信者：</td>
							<td class="title_bar_td" width="200">${inBox.recName}
							</td>
						{elseif inBox.sendType == 2}
							<td class="title_bar_td" width="10" align="right"><img src="image/ico08.gif" width="5" height="9" /></td>
							<td class="title_bar_td" width="70" align="right">类型：</td>
							<td class="title_bar_td" width="200">多播</td>
							<td class="title_bar_td" width="10" align="right"><img src="image/ico08.gif" width="5" height="9" /></td>
							<td class="title_bar_td" width="70" align="right">收信者：</td>
						...
						{elseif inBox.sendType == 3}
							<td class="title_bar_td" width="10" align="right"><img src="image/ico08.gif" width="5" height="9" /></td>
							<td class="title_bar_td" width="70" align="right">类型：</td>
							<td class="title_bar_td" width="200">广播</td>
						{/if}
						</tr>
						</table>
					</div>
