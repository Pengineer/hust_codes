...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>选择</title>
		<link rel="stylesheet" type="text/css" href="/smdb/tool/tree/css/dhtmlxtree.css" />
			...
			<s:form theme="simple">
				<div id="expall">
					...
					<table border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; width:100%">
						<tr>
							<td height="30" style="border:solid #999 1px; width:225px;">一级学科：<s:select cssClass="select" cssStyle="width:164px" id="discipline1" name="discipline1" headerKey="-1" headerValue="--不限--" list="%{unitExtService.getDisciplineOne()}" onchange="loadDiscpTree(this.value)" /></td>
