...
<textarea id="view_product" style="display:none;">
	<div class="p_box_body">
		<table id="list_product" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_statistic">
			<thead id="list_head">
				<tr class="first">
					<td width="30%" style = "text-align:center;">成果名称</td>
					<td width="30%" style = "text-align:center;">成果类型</td>
					<td width="20%" style = "text-align:center;">所属单位</td>
					<td style = "text-align:center;">发布刊物</td>
				</tr>
			</thead>
			<tbody>
