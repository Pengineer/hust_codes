...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			<div class="link_bar">
				当前位置：社科项目数据&nbsp;&gt;&nbsp;专项任务项目&nbsp;&gt;&nbsp;年检数据
			</div>
			
			<div class="main">
				<div class="main_content">
					<div class="table_main_tr_adv">
						<s:include value="/project/special/anninspection/apply/search.jsp"/>
					</div>
					...
					<textarea id="list_template" style="display:none;">
						<table id="list_table" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
							<thead id="list_head">
								...
								<sec:authorize ifAllGranted="ROLE_PROJECT_SPECIAL_ANNINSPECTION_APPLY_DELETE">
								...
								<s:else>
									<td width="64"><a id="sortcolumn10" href="" class="{if sortColumn == 10}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按年检状态排序">年检状态</a></td>
									<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
									<td width="64"><a id="sortcolumn15" href="" class="{if sortColumn == 15}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按年检时间排序">年检时间</a></td>
								</s:else>
								<s:if test="#session.loginer.currentType.compareTo(@csdc.tool.bean.AccountType@MINISTRY)>0">
									<td width="64"><a id="sortcolumn10" href="" class="{if sortColumn == 10}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按年检结果排序">年检状态</a></td>
								</s:if>	
								</tr>
							</thead>
							<tbody>
							{for item in root}
								...
								<sec:authorize ifAllGranted="ROLE_PROJECT_SPECIAL_ANNINSPECTION_APPLY_DELETE">
									...
									<td>${item.num}</td>
									<td></td>
									<td class="table_txt_td"><a id="${item.laData[0]}" class="link1" href="" title="点击查看详细信息" type="11">${item.laData[2]}</a></td>
									<td></td>
			...
			<script type="text/javascript">
				seajs.use('javascript/project/special/anninspection/list.js', function(list) {
					list.init();
				});
			</script>
		</body>
