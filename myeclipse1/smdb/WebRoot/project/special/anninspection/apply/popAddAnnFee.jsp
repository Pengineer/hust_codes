...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<head>
			...
			<script type="text/javascript" >
				seajs.use('javascript/project/special/anninspection/popAddAnnFee.js', function(add) {
					add.init();
				});
			</script>
		</head>
			...
			<div style="width:480px;">
				<s:form id="form_addAnnFee">
					<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
						...
						<tr class="table_tr3">
							<td class="key" colspan="6">年检经费明细</td>
						</tr>
					</table>	
					<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
						<tbody>
							...
							<tr class="table_tr4">
								...
								<td class="value" colspan="3"><s:textarea name="feeNote" id="feeNote" rows="2" cssClass="textarea_css"/></td>
							</tr>
						</tbody>
					</table>
				</s:form>
