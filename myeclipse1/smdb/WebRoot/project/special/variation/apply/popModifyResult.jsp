...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
					...
					<s:form id="form_apply">
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="2">
										...
										<table class="table_valid" width="100%" border="1" cellspacing="0" cellpadding="2" bordercolor="#CCCCCC" style="border-collapse:collapse;table-layout:fixed;">
											<thead class="table_tr3">
												<tr>
													<td width="20">选择</td>
													<td width="20">序号</td>
													<td width="85">类型<img src="image/ico04.gif"></td>
													<td width="80">姓名<img src="image/ico04.gif"></td>
													<td width="30">关联/新建</td>
													<td width="140">所在单位及部门</td>
											...
											<tbody>
												...
												<tr class="table_tr3">
													...
													<td>
														<s:if test="!agencyName&&!divisionName">
															<s:if test="memberType==2">
															<div class="choose_expert" style="display:none;">
																<input type="text" name="%{'members['+#stat.index+'].agencyName'}" size="15" placeholder="单位"/>
																<input type="text" name="%{'members['+#stat.index+'].divisionName'}" size="15" placeholder="部门" />
															</div>
															</s:if>
															<s:else>
													...
													<td><a class="moreDetail" href="javascript:void(0);" title="更多"><img src="image/btn_more.png" /></a></td>
							...
							<tr id="fEE" class="table_tr2" style="display:none;">
								<td class="table_td11"><span class="table_title6">变更项目经费预算：</span></td>
								<td class="table_td12">
									<input type="button" id="modifyVarFee" class="btn1 select_btn" value="修改" />
						...
						<tr>
							...
							<td>
								...
								<div class="choose_expert" style="display:none;padding:0;">
									<input type="text" name="%{'members['+#stat.index+'].agencyName'}" size="15" placeholder="单位"/><br />
									<input type="text" name="%{'members['+#stat.index+'].type'}" size="15" placeholder="部门" />
								</div>
								<span class="divisionName">
									<s:property value="%{members[#stat.index].agencyName}"/>
									<s:property value="%{members[#stat.index].divisionName}"/>
			...
			<script type="text/javascript">
				seajs.use(['javascript/project/special/variation/edit.js','javascript/project/project_share/variation/validate.js'], function(edit, validate) {
					validate.valid();
					edit.init();
				});
			</script>
