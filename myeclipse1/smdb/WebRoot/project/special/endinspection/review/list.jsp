...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			<div class="link_bar">
				当前位置：鉴定项目&nbsp;&gt;&nbsp;专项任务项目&nbsp;&gt;&nbsp;结项数据
			</div>
			
			<div class="main">
				<div class="main_content">
					<div class="table_main_tr_adv">
						<s:include value="/project/special/endinspection/review/search.jsp"/>
					</div>
								...
								<tr>
									...
									<td>
										{if item.laData[13]!=null && item.laData[13]!=""}
											<a id="${item.laData[14]}" name="${item.laData[13]}"  class="download_SPECIAL_3" href="">
					...
					<s:form id="list" theme="simple" action="" namespace="/project/special/endinspection/review">
			...
			<script type="text/javascript">
				seajs.use('javascript/project/special/endinspection/review/list.js', function(list) {
					$(function(){
						list.init();
					})
				});
