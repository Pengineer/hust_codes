		...
		<body>
			<div style="width:500px;">
				...
				<s:form id="endFile">
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						...
						<tr class="table_tr2">
							...
							<td class="table_td3">
								<input type="button" id="modifyEndFeeApply" class="btn1 select_btn" value="修改" />
						...
						<tr class="table_tr2">
							...
							<td class="table_td15">
								<s:radio name="isApplyNoevaluation" list="#{'1':'是','0':'否'}"/>
							</td>
						...
						<tr class="table_tr2">
							...
							<td class="table_td15">
								<s:radio name="isApplyExcellent" list="#{'1':'是','0':'否'}"/>
							</td>
							<td class="table_td16"></td>
						</tr>
						<tr class="table_tr2">
				...
				<div class="btn_div_view">
					<input id="save" class="btn1 j_modifyEndApply" type="button" data="2" value="保存" />
					<input id="submit" class="btn1 j_modifyEndApply" type="button" data="3" value="提交" />
