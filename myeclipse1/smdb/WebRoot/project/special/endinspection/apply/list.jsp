...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			<div class="link_bar">
				当前位置：社科项目数据&nbsp;&gt;&nbsp;专项任务项目&nbsp;&gt;&nbsp;结项数据
			</div>
			
			<div class="main">
				<div class="main_content">
					<div class="table_main_tr_adv">
						<s:include value="/project/special/endinspection/apply/search.jsp"/>
					</div>
					<textarea id="list_template" style="display:none;">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
							<tr class="table_main_tr2">
								...
								<sec:authorize ifAllGranted="ROLE_PROJECT_SPECIAL_ENDINSPECTION_APPLY_PUBLISH">
			...
			<script type="text/javascript">
				seajs.use('javascript/project/special/endinspection/apply/list.js', function(list) {
					list.init();
				});
			</script>
		</body>
