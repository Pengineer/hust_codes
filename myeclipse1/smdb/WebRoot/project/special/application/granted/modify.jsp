...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			<div class="link_bar">
				当前位置：社科项目数据&nbsp;&gt;&nbsp;专项任务项目&nbsp;&gt;&nbsp;立项数据&nbsp;&gt;&nbsp;修改
			</div>

			<div class="main">
				<s:form id="application_form" action="modify" namespace="/project/special/application/granted">
			...
			<script type="text/javascript">
				seajs.use(['javascript/project/special/application/granted/modify.js','javascript/project/project_share/application/validate.js'], function(modify, validate) {
					validate.valid();
					modify.init();
				});
			</script>
