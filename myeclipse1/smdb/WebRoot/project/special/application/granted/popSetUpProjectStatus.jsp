...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
				...
				<s:form id="granted_revoke">
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						<tr class="table_tr2">
							...
							<td class="table_td3"><s:select cssClass="select" name="projectStatus" headerKey="-1" headerValue="--请选择--" list="#{'4':'已撤项'}" /></td>
			...
			<script type="text/javascript" >
				seajs.use('javascript/project/special/application/granted/popSetUpProjectStatus.js', function(setStatus) {
					setStatus.init();
				});
			</script>
		</body>
