			...
			<tbody>
				...
				<tr class="table_tr7">
					...
					<td class="value" colspan="3">
						<s:select cssClass="select" id="graStartYear" name="graStartYear" list="%{specialService.getYearMapFrom2005()}" />
						至
						<s:select cssClass="select" id="graEndYear" name="graEndYear" list="%{specialService.getYearMapFrom2005()}" />年
					</td>
				</tr>
				<tr class="table_tr7">
					...
					<td class="value" colspan="3">
						<s:select cssClass="select" id="midStartYear" name="midStartYear" list="%{specialService.getYearMapFrom2005()}" />
						至
						<s:select cssClass="select" id="midEndYear" name="midEndYear" list="%{specialService.getYearMapFrom2005()}" />年
					</td>
				</tr>
				<tr class="table_tr7">
					...
					<td class="value" colspan="3">
						<s:select cssClass="select" id="endStartYear" name="endStartYear" list="%{specialService.getYearMapFrom2005()}" />
						至
						<s:select cssClass="select" id="endEndYear" name="endEndYear" list="%{specialService.getYearMapFrom2005()}" />年
					</td>
				</tr>
				<tr style="height:10px">
				</tr>
