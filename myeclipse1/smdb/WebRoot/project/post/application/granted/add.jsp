...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			...
			<div class="main">
				...
				<div id="type_select">
					<s:form id="select_form" action="add" namespace="/project/post/application/granted">
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="2">
							...
							<tr class="table_tr2">
								...
								<td class="table_td3"><s:select cssClass="select" name="granted.subtype.id" headerKey="-1" headerValue="--请选择--" list="%{baseService.getSystemOptionMap('projectType', '04')}" /></td>
								<td class="table_td4"></td>
							</tr>
							<tr class="table_tr2">
							...
							<tr class="table_tr2">
								<td class="table_td2"><span class="table_title5">立项经费预算：</span></td>
										<td class="table_td3">
											<input type="button" id="addGrantedFee2" class="btn1" value="添加" />
											<div id="totalFee2" class="choose_show"><s:property value="projectFeeGranted.totalFee"/></div>
										</td>
<%--									<s:elseif test="flag == 1"> 修改 --%>
<%--										<td class="table_td3">--%>
<%--											<input type="button" id="modifyGrantedFee2" class="btn1" value="修改" />--%>
<%--											<div id="totalFee2" class="choose_show"><s:property value="projectFeeGranted.totalFee"/></div>--%>
<%--										</td>--%>
<%--									</s:elseif>--%>
					...
					<div class="btn_bar2">
						<input class="btn1" type="button" value="提交" onclick="submitSelectForm();"/>
						<input class="btn1" type="button" value="取消" onclick="history.back();" />
					</div>
				</div>
				<div id="type_new" style="display:none">
					<s:form id="application_form" action="add" namespace="/project/post/application/granted">
						...
						<div id="info" style="display:none">
							...
							<div class="main_content">
								...
								<s:include value="/validateError.jsp" />
								<s:include value="/project/post/application/granted/editApplyTab.jsp" />
								<s:include value="/project/post/application/granted/editGrantedTab.jsp" />
								<s:include value="/project/post/application/granted/editMemberTab.jsp" />
							</div>
						</div>
					</s:form>
					<s:include value="/project/post/application/granted/memberTemplate.jsp" />
			...
			<script type="text/javascript">
				seajs.use(['javascript/project/post/application/granted/add.js','javascript/project/project_share/application/validate.js'], function(add, validate) {
					validate.valid();
					add.init();
				});
			</script>
