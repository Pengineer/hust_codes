...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			<div class="link_bar">
				当前位置：社科项目数据&nbsp;&gt;&nbsp;后期资助项目&nbsp;&gt;&nbsp;年检数据
			</div>
			
			<div class="main">
				<div class="main_content">
					<div class="table_main_tr_adv">
						<s:include value="/project/post/anninspection/apply/search.jsp"/>
					</div>
					...
					<s:form id="list" theme="simple" action="delete" namespace="/project/post/endinspection/apply">
			...
			<script type="text/javascript">
				seajs.use('javascript/project/post/anninspection/list.js', function(list) {
					list.init();
				});
			</script>
		</body>
