		...
		<table class="table_valid" width="100%" border="0" cellspacing="0" cellpadding="0">
			<s:if test="#session.loginer.currentType.equals(@csdc.tool.bean.AccountType@MINISTRY)"><!-- 部级 -->
				...
				<tr>
					...
					<td class="table_td9">
						<s:select cssClass="select" name="%{'rms['+#stat.index+'].memberType'}" headerKey='-1' headerValue="--请选择--" list="#{'1':'教师','2':'外部专家','3':'学生'}" />
					</td>
					<td class="table_td10" width="90"></td>
				</tr>
				...
				<tr>
					...
					<td class="table_td9">
						<s:select cssClass="select" name="%{'rms['+#stat.index+'].specialistTitle'}" headerKey="-1" headerValue="--请选择--" list="%{projectService.getChildrenMapByParentIAndStandard()}" />
					</td>
					<td class="table_td10"></td>
				</tr>
				<tr>
					...
					<td class="table_td9">
						<s:textfield name="%{'rms['+#stat.index+'].major'}" />
					</td>
					<td class="table_td10"></td>
				</tr>
				<tr>
					...
					<td class="table_td9">
						<s:textfield name="%{'rms['+#stat.index+'].workMonthPerYear'}" />
					</td>
					<td class="table_td10"></td>
				</tr>
				<tr>
					...
					<td class="table_td9">
						<s:textfield name="%{'rms['+#stat.index+'].workDivision'}" />
					</td>
					<td class="table_td10"></td>
				</tr>
				<tr>
					<td class="table_td8"><span class="table_title5">是否首席专家：</span></td>
					<td class="table_td9">
						<s:select cssClass="select" name="%{'rms['+#stat.index+'].isDirector'}" headerKey='-1' headerValue="--请选择--" list="#{'1':'是','0':'否'}" />
					</td>
					<td class="table_td10"></td>
				</tr>
				<tr>
					<td class="table_td8"><span class="table_title5">是否子课题负责人：</span></td>
					<td class="table_td9">
						<s:select cssClass="select" name="%{'rms['+#stat.index+'].isSubprojectDirector'}" headerKey='-1' headerValue="--请选择--" list="#{'1':'是','0':'否'}" />
					</td>
					<td class="table_td10"></td>
				</tr>
				<tr>
			...
			<s:else>
				...
				<tr>
					...
					<td class="table_td17" width="100">
						<s:select cssClass="select" name="%{'rms['+#stat.index+'].idcardType'}" headerKey="-1" headerValue="--请选择--" list="#{'身份证':'身份证','军官证':'军官证','护照':'护照'}"/>
					</td>
				...
				<tr>
					...
					<td class="table_td17">
						<s:select cssClass="select" name="%{'rms['+#stat.index+'].gender'}" headerKey="-1" headerValue="--请选择--" list="#application.sexList" />
					</td>
					<td class="table_td10"></td>
				...
				<tr>
					...
					<td class="table_td17">
						<s:select cssClass="select" name="%{'rms['+#stat.index+'].divisionType'}" headerKey="-1" headerValue="--请选择--" list="#{'1':'研究基地','2':'院系','3':'外部部门'}" />
					</td>
					<td class="table_td10"></td>
				...
				<tr>
					...
					<td class="table_td10"></td>
					<td class="table_td8"><span class="table_title4">是否子课题负责人：</span></td>
					<td class="table_td18">
						<s:select cssClass="select" name="%{'rms['+#stat.index+'].isSubprojectDirector'}" headerKey='-1' headerValue="--请选择--" list="#{'1':'是','0':'否'}" />
					</td>
					<td class="table_td10"></td>
