...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			...
			<s:form id="topicSelection_form" action="modify" namespace="/project/key/topicSelection/apply">
				...
				<div class="main">
					<div class="main_content">
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="0">
							...
							<s:if test = "#session.loginer.currentType == 4 || #session.loginer.currentType == 5">
					...
					<div class="btn_div_view">
						<input class="btn1" type="button" value="保存" onclick="modifyTopsApply(2);" />
						<input class="btn1" type="button" value="提交" onclick="modifyTopsApply(3);" />
