...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			<div class="link_bar">
				当前位置：鉴定项目&nbsp;&gt;&nbsp;委托应急课题&nbsp;&gt;&nbsp;结项数据
			</div>
			
			<div class="main">
				<div class="main_content">
					<div class="table_main_tr_adv">
						<s:include value="/project/entrust/endinspection/review/search.jsp"/>
					</div>
						...
						<table id="list_table" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
							<thead id="list_head">
								<tr class="table_title_tr">
									...
									<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
									<td width="64"><a id="sortcolumn3" href="" class="{if sortColumn == 3}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按项目类别排序">课题类别</a></td>
									<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
								...
								<tr>
									...
									<td>
										{if item.laData[13]!=null && item.laData[13]!=""}
											<a id="${item.laData[14]}" name="${item.laData[13]}"  class="download_entrust_3" href="">
					...
					<s:form id="list" theme="simple" action="" namespace="/project/entrust/endinspection/review">
			...
			<script type="text/javascript">
				seajs.use('javascript/project/entrust/endinspection/review/list.js', function(list) {
					$(function(){
						list.init();
					})
				});
