...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			...
			<div class="main">
				...
				<div id="type_select">
					<s:form id="select_form" action="add" namespace="/project/entrust/application/granted">
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="2">
							...
							<tr class="table_tr2">
								<td class="table_td2"><span class="table_title5">立项经费预算明细：</span></td>
										<td class="table_td3">
...
<%--									</s:elseif>--%>
				...
				<div id="type_new" style="display:none">
					<s:form id="application_form" action="add" namespace="/project/entrust/application/granted">
			...
			<script type="text/javascript">
				seajs.use(['javascript/project/entrust/application/granted/add.js','javascript/project/project_share/application/validate.js'], function(add, validate) {
					validate.valid();
					add.init();
				});
			</script>
