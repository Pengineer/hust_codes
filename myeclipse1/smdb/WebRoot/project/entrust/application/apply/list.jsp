						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
							<tr class="table_main_tr2">
								...
								<s:if test = "#session.loginer.currentType.compareTo(@csdc.tool.bean.AccountType@EXPERT)<0 ">
									<td width="58" align="center"><sec:authorize ifAllGranted="ROLE_PROJECT_ENTRUST_APPLICATION_APPLY_ADD"><input class="btn1" type="button" id="list_add_result" value="添加" /></sec:authorize></td>
								</s:if>
								<s:else>
									<td width="58" align="center"><sec:authorize ifAllGranted="ROLE_PROJECT_ENTRUST_APPLICATION_APPLY_ADD"><input class="btn1" type="button" id="list_add" value="申请" /></sec:authorize></td>
