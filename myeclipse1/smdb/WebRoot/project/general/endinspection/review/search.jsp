		...
		<div class="main_content">
			...
			<table class="adv_table" width="100%" border="0" cellspacing="2" cellpadding="0">
				<tr class="adv_tr">
					...
					<td class="adv_td1" width="200"><s:select cssClass="select" name="projectSubtype" value="%{searchQuery.projectSubtype}" list="%{baseService.getSystemOptionMap('projectType', '01')}" headerKey="-1" headerValue="--不限--" /></td>
					<td class="adv_td1"></td>
				</tr>
				<tr class="adv_tr">
				...
				<tr class="adv_tr">
					...
					<td class=""adv_td1"">
						  <s:select cssClass="select" name="submitStatus" value="%{searchQuery.submitStatus}" value="-1" list="#{'3':'提交','2':'暂存','1':'退回', '0':'待审'}" headerKey="-1" headerValue="--不限--" />
			   		</td>
					<td class=""adv_td1""></td>
				...
				<tr class="adv_tr">
					...
					<td class="adv_td2">
						   <s:select cssClass="select" name="reviewStatus" value="%{searchQuery.reviewStatus}" value="-1" list="#{'32':'同意','31':'不同意','22':'同意（暂存）','21':'不同意（暂存）','0':'待审'}" headerKey="-1" headerValue="--不限--" />
			   		</td>
					<td class="adv_td2"></td>
