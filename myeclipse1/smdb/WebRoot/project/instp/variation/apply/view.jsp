				...
				<sec:authorize ifAllGranted='ROLE_PROJECT_INSTP_VARIATION_APPLY_VIEW'>
					{if item.file != null}
						<div style="float: right;"><img src="image/ico09.gif" />
							<a href="" id="${item.id}" class="download_instp_4">下载变更申请书</a>
						...
						<tr>
							...
							<td>延期
								{if item.postponementPlanFile != null}
									<a href="" id="${item.id}" class="download_instp_7">[下载延期项目计划书]</a>
					...
					<s:if test="#session.loginer.currentType.compareTo(@csdc.tool.bean.AccountType@PROVINCE)<0"><!-- 部级及以上管理人员 -->
						...
						<tbody>
							<tr class="table_tr3">
								...
								<td width="30%">是否同意变更</td>
								<td width="300">查看详情</td>
								<sec:authorize ifAllGranted="ROLE_PROJECT_INSTP_VARIATION_APPLY_PUBLISH_SWITCH">
