					...
					<span class="choose_bar">
						<s:if test="#session.loginer.currentType.within(@csdc.tool.bean.AccountType@ADMINISTRATOR, @csdc.tool.bean.AccountType@INSTITUTE)"><!-- 管理人员-->
							<s:select cssClass="select" id="mainFlag" name="mainFlag" headerKey="" headerValue="--所有项目--"
								list="#{'0251':'已上报','0252':'待审核','0253':'已审核'}" />
						</s:if>
		...
		<div class="adv_content">
			...
			<s:else>
				<tr class="adv_tr">
					...
					<td class="adv_td1">
						   <s:select cssClass="select" name="auditStatus" value="%{searchQuery.projectNumber}" list="#{'32':'同意','31':'不同意','22':'同意（暂存）','21':'不同意（暂存）','12':'退回','0':'待审'}" headerKey="-1" headerValue="--不限--" />
			   		</td>
					<td class="adv_td1"></td>
