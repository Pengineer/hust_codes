...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			...
			<script type="text/javascript">
				seajs.use(['javascript/project/instp/endinspection/review/edit.js','javascript/project/project_share/endinspection/review/validate.js'], function(edit, validate) {
					validate.valid();
					edit.init();
				});
			</script>
