					...
					<s:form id="end_result">
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="0">
							...
							<tr class="table_tr2">
								...
								<td class="table_td12"><s:radio cssClass="j_showNoEval" name="isApplyNoevaluation" theme="simple" list="#{'1':'是','0':'否'}" /></td>
							...
							<tr class="table_tr2">
								...
								<td class="table_td12"><s:radio name="isApplyExcellent" theme="simple" cssClass="j_showExcellect" list="#{'1':'是','0':'否'}" /></td>
								<td class="table_td13"></td>
							</tr>
							...
							<tr class="table_tr2">
								<td class="table_td11">主要参加人：<br>（不含负责人）</td>
							...
							<tr class="table_tr2">
								...
								<td class="table_td12"><s:radio name="endResult" cssClass="j_showNumber" theme="simple" list="#{'2':'同意','1':'不同意'}" /></td>
								<td class="table_td13"></td>
							</tr>
