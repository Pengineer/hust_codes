		...
		<body>
			<div class="link_bar" id="view_project_instp">
				<s:if test="listType==1">
					当前位置：社科项目数据&nbsp;&gt;&nbsp;基地项目&nbsp;&gt;&nbsp;申请数据&nbsp;&gt;&nbsp;查看
				</s:if>
				<s:elseif test="listType==2">
					当前位置：社科项目数据&nbsp;&gt;&nbsp;基地项目&nbsp;&gt;&nbsp;立项数据&nbsp;&gt;&nbsp;查看
				</s:elseif>
				<s:elseif test="listType==3">
					当前位置：社科项目数据&nbsp;&gt;&nbsp;基地项目&nbsp;&gt;&nbsp;中检数据&nbsp;&gt;&nbsp;查看
				</s:elseif>
				<s:elseif test="listType==4">
					当前位置：社科项目数据&nbsp;&gt;&nbsp;基地项目&nbsp;&gt;&nbsp;结项数据&nbsp;&gt;&nbsp;查看
				</s:elseif>
				<s:elseif test="listType==5">
					当前位置：社科项目数据&nbsp;&gt;&nbsp;基地项目&nbsp;&gt;&nbsp;变更数据&nbsp;&gt;&nbsp;查看
				</s:elseif>
				...
				<div class="main_content" style="display:none;" id="tabcontent">
					<div id="tabs" class="p_box_bar">
						<ul>
							...
							<sec:authorize ifAllGranted='ROLE_PROJECT_INSTP_PUBLISH_VIEW'>
					...
					<div class="p_box">
						...
						<sec:authorize ifAllGranted='ROLE_PROJECT_INSTP_PUBLISH_VIEW'>
							<div id="publishStatus">
								<s:include value="/project/instp/publishStatus.jsp"/>
							</div>
						</sec:authorize>
					</div>
				</div>
