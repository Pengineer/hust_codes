						...
						<div class="title_bar">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<td class="title_bar_td" colspan="4">${consultation.englishName}</td>
								</tr>
							</table>
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									{if authorid!=null}<a id="${authorid}" class="view_author" href="">${consultation.authorName}</a>
									{else}${consultation.authorName}
									{/if}
									</td>
									...
									<td class="title_bar_td">${consultation.otherAuthorName}</td>
								</tr>
								<tr>
									<td class="title_bar_td" align="right"><img src="image/ico08.gif" width="5" height="9"/></td>
									...
									<td class="title_bar_td">${consultation.divisionName}</td>
								</tr>
								<tr>
									<td class="title_bar_td" align="right"><img src="image/ico08.gif" width="5" height="9"/></td>
					...
					<div class="p_box_body">
						<div class="p_box_body_t">
							<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
								<tr class="table_tr7">
									<td class="key" width="100">是否为译文：</td>
									<td class="value" width="120">{if consultation.isTranslation==0}否{else}是{/if}</td>
									<td class="key" width="120">是否与国（境）外合作：</td>
									<td class="value">{if consultation.isForeignCooperation==0}否{else}是{/if}</td>
								</tr>
								<tr class="table_tr7">
									<td class="key">形态：</td>
						...
						<div class="p_box_body_t">
							<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
								<tr class="table_tr7">
									...
									<td class="value" width="120">${consultation.useUnit}</td>
