			...
			<div style="height:<s:if test='viewType==3'>500px;</s:if><s:else>545px;</s:else> *margin-right:20px; _margin-right:20px;">
				...
				<table width="100%" border="0" cellspacing="2" cellpadding="0">
					<s:if test="viewType!=3">
						<tr class="table_tr2">
							...
							<td class="table_td3"><s:radio cssClass="SecOrAdd" name="SecOrAdd" list="#{'1': '是', '0': '否'}"/></td>
				...
				<table width="100%" border="0" cellspacing="2" cellpadding="2">
					<tr class="table_tr2">
						...
						<td class="table_td3"><s:radio cssClass="pro_form" name="pro_form" list="#{'1': '论文', '2': '著作', '3': '研究咨询报告', '4': '电子出版物', '5': '专利', '6': '其他成果'}"/></td>
						<td class="table_td4"></td>
					</tr>
				</table>
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="0">
							<tr class="table_tr2">
								...
								<td class="table_td3" id="product_content">
									<s:select cssClass="select" list="#{}" id="list_product" headerKey="-1" headerValue="--%{'请选择'}--" name="entityId"/>
								</td>
								<td class="table_td4"></td>
							</tr>
						</table>
