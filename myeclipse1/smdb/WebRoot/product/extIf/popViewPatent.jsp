						...
						<div class="title_bar">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<td class="title_bar_td" colspan="4">${patent.englishName}</td>
								</tr>
							</table>
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									{if authorid!=null}<a id="${authorid}" class="view_author" href="">${patent.authorName}</a>
									{else}${patent.authorName}
									{/if}
									</td>
									<td class="title_bar_td" align="right"><img src="image/ico08.gif" width="5" height="9"/></td>
									<td class="title_bar_td" align="right" width="74">其他申请人：</td>
									<td class="title_bar_td">${patent.otherAuthorName}</td>
								</tr>
								<tr>
									<td class="title_bar_td" align="right"><img src="image/ico08.gif" width="5" height="9"/></td>
									...
									<td class="title_bar_td">${patent.divisionName}</td>
								</tr>
								<tr>
									<td class="title_bar_td" align="right"><img src="image/ico08.gif" width="5" height="9"/></td>
					...
					<div class="p_box_body">
						<div class="p_box_body_t">
							<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
								<tr class="table_tr7">
									<td class="key" width="100">发明人姓名：</td>
									<td class="value" width="120">${patent.inventorName}</td>
									<td class="key" width="120">是否与国（境）外合作：</td>
									<td class="value">{if patent.isForeignCooperation==0}否{else}是{/if}</td>
								</tr>
								<tr class="table_tr7">
									<td class="key">形态：</td>
				...
				<textarea id="view_template_publication" style="display:none;">
					<div class="p_box_body">
						<div class="p_box_body_t">
							<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
								<tr class="table_tr7">
									<td class="key" width="100">采纳单位：</td>
									<td class="value" width="120">${patent.useUnit}</td>
									<td class="key" width="120">采纳时间：</td>
									<td class="value">${patent.publicationDate}</td>
								</tr>
							</table>
						</div>
					</div>
