...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div class="link_bar">
   		...
   		<div class="main">
   			<s:form id="form_product" action="modify" method="post" theme="simple" enctype="multipart/form-data" namespace="/product/patent">
	   			<s:hidden id="accountType" value="%{#session.loginer.currentType}"/>
	   			<s:hidden id="addOrModify" value="0"/>
	   			<s:hidden name="entityId" value="%{patent.id}"/>
	   			<s:hidden id="submitStatus" name="patent.submitStatus"/>
				...
				<div class="p_box_b" style="margin-top:10px;">
					<div class="p_box_b_2" style="float:right; line-height:30px; padding-right:30px;"><img src="image/ico09.gif" />
						<a href="" class="downlaod_product" name="${patent.file}" id="${patent.id}">下载成果文件</a>
					</div>
				</div>
				...
				<div class="main_content">
					...
					<div class="edit_info" id="base_info">
						...
						<s:if test="applyType == 0">
							<table width="100%" border="0" cellspacing="2" cellpadding="2" id="personal_info" >
								...
								<s:if test="#session.loginer.currentType.compareTo(@csdc.tool.bean.AccountType@EXPERT)<0">
									<tr class="table_tr2">
										<td class="table_td2" width="150"><span class="table_title5">申请人：</span></td>
										<td class="table_td3" id="err_firstAuthor">
											...
											<div id="person_per_name_div" class="choose_show"><s:property value="patent.authorName"/>&nbsp;&nbsp;<s:property value="patent.agencyName"/>&nbsp;<s:property value="patent.divisionName"/></div>
								...
								<tr class="table_tr2">
									...
									<td class="table_td3"><s:textfield name="patent.otherAuthorName" cssClass="input_css"/></td>
									<td class="table_td4"></td>
								</tr>
							</table>
						</s:if>
						...
						<s:else>
							<table width="100%" border="0" cellspacing="2" cellpadding="2" id="team_info">
								...
								<tr class="table_tr2">
									...
									<td class="table_td3"><s:textfield name="patent.orgName" cssClass="input_css"/></td>
									<td class="table_td4"></td>
								</tr>
								<tr class="table_tr2">
									...
									<td class="table_td3">
										...
										<div id="unit" class="choose_show"><s:property value="patent.agencyName"/>&nbsp;<s:property value="patent.divisionName"/></div>
										<s:hidden id="instituteId" name="patent.institute.id"/>
										<s:hidden id="departmentId" name="patent.department.id"/>
									</td>
									<td class="table_td4"></td>
								</tr>
								<s:if test="#session.loginer.currentType.compareTo(@csdc.tool.bean.AccountType@EXPERT)<0">
									<tr class="table_tr2">
										...
										<td class="table_td3">
											...
											<div id="team_per_name_div" class="choose_show"><s:property value="author.name"/>&nbsp;&nbsp;<s:property value="patent.agencyName"/>&nbsp;<s:property value="patent.divisionName"/></div>
								...
								<tr class="table_tr2">
									...
									<td class="table_td3"><s:textfield name="patent.orgMember" cssClass="input_css"/>
								...
								<tr class="table_tr2">
									...
									<td class="table_td3">
										...
										<div id="team_disptr" class="choose_show"><s:property value="patent.orgDiscipline"/></div>
										<s:hidden name="patent.orgDiscipline" id="team_dispName"/>
									</td>
									<td class="table_td4"></td>
								</tr>
								<tr class="table_tr2">
									<td class="table_td2">办公电话：</td>
									<td class="table_td3"><s:textfield name="patent.orgOfficePhone" cssClass="input_css"/></td>
									<td class="table_td4"></td>
								</tr>
								<tr class="table_tr2">
									<td class="table_td2">办公地址：</td>
									<td class="table_td3"><s:textfield name="patent.orgOfficeAddress" cssClass="input_css"/></td>
									<td class="table_td4"></td>
								</tr>
								<tr class="table_tr2">
									<td class="table_td2">办公邮编：</td>
									<td class="table_td3"><s:textfield name="patent.orgOfficePostcode" cssClass="input_css"/></td>
									<td class="table_td4"></td>
								</tr>
								<tr class="table_tr2">
									<td class="table_td2">办公邮箱：</td>
									<td class="table_td3"><s:textfield name="patent.orgEmail" cssClass="input_css"/></td>
									<td class="table_td4"></td>
								</tr>
								<tr class="table_tr2">
									<td class="table_td2">手机：</td>
									<td class="table_td3"><s:textfield name="patent.orgMobilePhone" cssClass="input_css"/></td>
									<td class="table_td4"></td>
								</tr>
							</table>
						</s:else>
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="2">		
							...
							<tr class="table_tr2">
								...
								<td class="table_td3"><s:radio name="patent.isForeignCooperation" list="#{'1':'是','0':'否'}"/></td>
								<td class="table_td4"></td>
							</tr>
							...
							<tr class="table_tr2">
								...
								<td class="table_td3" id="err_dtype">
									<input type="button" class="btn1 select_btn select_disciplineType_btn" value="选择" alt="person"/>
									<div id="person_disptr" class="choose_show"></div>
									<s:hidden name="patent.disciplineType" id="person_dispName"/>
								</td>
								<td class="table_td4"></td>
							</tr>
							<tr class="table_tr2">
							...
							<tr class="table_tr2">
								...
								<td class="table_td3" id="err_keyWord"><s:textfield name="patent.keywords" cssClass="input_css"/>
										<br/><span class="tip">多个以分号（即; 或；）隔开！</span></td>
								<td class="table_td4"></td>
							</tr>
							<tr class="table_tr2">
					...
					<div class="edit_info" id="publication_info">
						<table width="100%" border="0" cellspacing="2" cellpadding="0">
							<tr class="table_tr2">
								<td class="table_td2" width="100">发明人姓名：</td>
							...
							<tr class="table_tr2">
								...
								<td class="table_td3"><s:textfield id="publicationDate" cssClass="input_css" /></td>
								<s:param name="value">
   		...
   		<script type="text/javascript">
			seajs.use('javascript/product/patent/edit.js', function(add) {
				$(function() {
					add.init();
				});
			});
