				...
				<div style="overflow-y:scroll; overflow-x:hidden; height:460px;">
					...
					<table width="700" border="0" cellspacing="2" cellpadding="0">
						...
						<tr class="table_tr2">
							...
							<td class="table_td3"><s:select cssClass="select" name="awardApplication.session" list="{}" id="session5" headerKey="-1" headerValue="--%{'请选择'}--"/></td>
							<td class="table_td4"></td>
						</tr>
						<tr class="table_tr2">
							<td class="table_td2"><span class="table_title3">学科门类：</span></td>
							<td class="table_td3"><s:select cssClass="select" id="dtype" name="awardApplication.disciplineType" list="%{#session.dtypemap}" headerKey="-1" headerValue="--%{'请选择'}--" /></td>
							<td class="table_td4"></td>
						</tr>
						<tr class="table_tr2">
							<td class="table_td2"><span class="table_title3">所属单位：</span></td>
							<td class="table_td3"><s:select cssClass="select" name="unitId" list="unitDetails" headerKey="-1" headerValue="--%{'请选择'}--"/></td>
							<td class="table_td4"></td>
						</tr>
						<tr class="table_tr2">
