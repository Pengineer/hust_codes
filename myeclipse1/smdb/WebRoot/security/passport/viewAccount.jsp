		...
		<table id="list_account" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
			...
			{for item in userList}
				...
				{if item[0] != 'ADMINISTRATOR'}
					...
					<td><a id="${item[6]}" class="linkP" type="4" href="" title="点击查看详细信息">${item[3]}</a></td>
					{elseif item[1] == 1 && (item[0] == 'TEACHER' || item[0] == 'STUDENT')}
					<td><a id="${item[6]}" class="linkP" type="5" href="" title="点击查看详细信息">${item[3]}</a></td>
					{elseif item[1] == 0 && (item[0] == 'MINISTRY' || item[0] == 'PROVINCE' || item[0] == 'MINISTRY_UNIVERSITY' || item[0] == 'LOCAL_UNIVERSITY')}
					<td><a type="1" id="${item[10]}" class="linkP" href="" title="点击查看详细信息">${item[3]}</a></td>
					{elseif item[1] == 0 && item[0] == 'DEPARTMENT'}
					<td>
					<a id="${item[8]}" class="linkA" href="" title="点击查看详细信息">${item[7]}</a>&nbsp;<a id="${item[10]}" type="2" class="linkP" href="" title="点击查看详细信息">${item[3]}</a>
					</td>
					{elseif item[1] == 0 && item[0] == 'INSTITUTE'}
					<td>
						<a id="${item[8]}" class="linkA" href="" title="点击查看详细信息">${item[7]}</a>&nbsp;<a id="${item[10]}" type="3" class="linkP" href="" title="点击查看详细信息">${item[3]}</a>
					</td>
					{/if}
					<td></td>
					<td>${item[4]}</td>
