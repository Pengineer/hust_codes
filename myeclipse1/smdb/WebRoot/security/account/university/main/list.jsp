...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			<div class="link_bar">
				当前位置：账号管理&nbsp;&gt;&nbsp;校级管理账号&nbsp;&gt;&nbsp;主账号
			</div>
			
			<div class="main">
				<div class="main_content">
					<div class="table_main_tr_adv">
						<s:include value="/security/account/university/main/search.jsp"/>
					</div>
					...
					<textarea id="list_template" style="display:none;">
						<table id="list_table" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
							<thead id="list_head">
								...
								<sec:authorize ifAnyGranted="ROLE_SECURITY_ACCOUNT_UNIVERSITY_MAIN_DELETE,ROLE_SECURITY_ACCOUNT_UNIVERSITY_MAIN_STATUS,ROLE_SECURITY_ACCOUNT_ASSIGNROLE">
									...
									<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
									<td width="90"><a id="sortcolumn1" href="" class="{if sortColumn == 1}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按所属高校排序">所属高校</a></td>
									<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
			...
			<script type="text/javascript">
				seajs.use('javascript/security/account/university/main/list.js', function(list) {
					$(function(){
						list.init();
					})
				});
