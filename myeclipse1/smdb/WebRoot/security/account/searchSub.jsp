	...
	<div class="adv_content">
		...
		<table class="adv_table" width="100%" border="0" cellspacing="2" cellpadding="0">
			<tr class="adv_tr">
				...
				<td class="adv_td1" width="65" align="right">所属机构：</td>
				<td class="adv_td1" width="200"><s:textfield name="belongUnitName" value="%{searchQuery.belongUnitName}" cssClass="input_css" /></td>
				<td class="adv_td1"></td>
			</tr>
			<tr class="adv_tr">
				<td class="adv_td1" align="right">所属人员：</td>
				<td class="adv_td1"><s:textfield name="belongPersonName" value="%{searchQuery.belongPersonName}" cssClass="input_css" /></td>
				<td class="adv_td1"></td>
			...
			<tr class="adv_tr">
				<td class="adv_td2" align="right">有效期限：</td>
				...
				<td class="adv_td2"><s:select cssClass="select" name="status" value="%{searchQuery.status}" value="-1" headerKey="-1" headerValue="--不限--" list="#{'1':'启用','0':'停用'}" /> </td>
				<td class="adv_td2"></td>
			</tr>
		</table>
