...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="main">
			...
			<div class="choose_bar">
				<ul>
					...
					<li id="view_del"><sec:authorize ifAllGranted="ROLE_PERSON_STUDENT_DELETE"><input class="btn1" type="button" value="删除" /></sec:authorize></li>
					<li id="view_mod"><sec:authorize ifAllGranted="ROLE_PERSON_STUDENT_MODIFY"><input class="btn1" type="button" value="修改" /></sec:authorize></li>
					<li id="view_add"><sec:authorize ifAllGranted="ROLE_PERSON_STUDENT_ADD"><input class="btn1" type="button" value="添加" /></sec:authorize></li>
				</ul>
			</div>
				...
				<div id="name_gender" class="title_bar">
					<textarea class="view_template" style="display:none;">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<sec:authorize ifAnyGranted="ROLE_SECURITY_ACCOUNT_STUDENT_ADD">
									<td class="title_bar_td" width="20" align="right"><img src="image/ico08.gif" width="5" height="9" /></td>
				...
				<div class="main_content">
					<div id="tabs" class="p_box_bar">
						<ul>
							...
							<li><a href="#student">学籍信息</a></li>
							<li><a href="#contact">联系信息</a></li>
							<li><a href="#academic">学术信息</a></li>
							<li><a href="#thesis">学位论文信息</a></li>
		...
		<script type="text/javascript">
			seajs.use('javascript/person/student/view.js', function(view) {
				$(function(){
					view.init();
				})
			});
