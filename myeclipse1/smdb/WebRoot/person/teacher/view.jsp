...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
			...
			<s:hidden id="update" name="update" />
				...
				<div class="choose_bar">
					<ul>
						...
						<s:if test="!#session.loginer.currentType.within(@csdc.tool.bean.AccountType@EXPERT , @csdc.tool.bean.AccountType@STUDENT)">
							...
							<li id="view_del"><sec:authorize ifAllGranted="ROLE_PERSON_TEACHER_DELETE"><input class="btn1" type="button" value="删除" /></sec:authorize></li>
							<li id="view_mod"><sec:authorize ifAllGranted="ROLE_PERSON_TEACHER_MODIFY"><input class="btn1" type="button" value="修改" /></sec:authorize></li>
							<li id="view_add"><sec:authorize ifAllGranted="ROLE_PERSON_TEACHER_ADD"><input class="btn1" type="button" value="添加" /></sec:authorize></li>
						</s:if>
					</ul>
				</div>
				...
				<div id="name_gender" class="title_bar">
					<textarea class="view_template" style="display:none;">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<sec:authorize ifAnyGranted="ROLE_SECURITY_ACCOUNT_TEACHER_ADD">
									<td class="title_bar_td" width="20" align="right"><img src="image/ico08.gif" width="5" height="9" /></td>
				...
				<div class="main_content">
					...
					<div class="p_box">
						...
						<s:include value="/person/view_teacher_affiliation.jsp" />
		...
		<script type="text/javascript">
			seajs.use('javascript/person/teacher/view.js', function(view) {
				$(function(){
					view.init();
				})
			});
