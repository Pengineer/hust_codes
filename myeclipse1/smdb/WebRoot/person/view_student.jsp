		...
		<div class="p_box_body_t">
			<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
				<tr class="table_tr7">
					...
					<td class="value" width="180"><a id="${universityId}" class="linkA" href="">${student.agencyName}</a></td>
					<td class="key" width="80">所在{if departmentId != null}院系{else}研究基地{/if}：</td>
					<td class="value" colspan="3">
						{if departmentId != null}
							<a id="${departmentId}" class="linkD" href="">${student.divisionName}</a>
						{else}
							<a id="${instituteId}" class="linkI" href="">${student.divisionName}</a>
						{/if}
					</td>
				</tr>
				<tr class="table_tr7">
