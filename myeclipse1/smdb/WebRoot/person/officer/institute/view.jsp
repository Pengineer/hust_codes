...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>查看基地管理人员</title>
		<s:include value="/innerBase.jsp" />
	</head>

	<body>
		<div class="link_bar">
			当前位置：社科人员数据&nbsp;&gt;&nbsp;社科管理人员&nbsp;&gt;&nbsp;基地管理人员&nbsp;&gt;&nbsp;查看
		</div>
		...
		<div class="main">
			...
			<div class="choose_bar">
				<ul>
					...
					<li id="view_del"><sec:authorize ifAllGranted="ROLE_PERSON_OFFICER_INSTITUTE_DELETE"><input class="btn1" type="button" value="删除" /></sec:authorize></li>
					<li id="view_mod"><sec:authorize ifAllGranted="ROLE_PERSON_OFFICER_INSTITUTE_MODIFY"><input class="btn1" type="button" value="修改" /></sec:authorize></li>
					<li id="view_add"><sec:authorize ifAllGranted="ROLE_PERSON_OFFICER_INSTITUTE_ADD"><input class="btn1" type="button" value="添加" /></sec:authorize></li>
				</ul>
			</div>
				...
				<div id="name_gender" class="title_bar">
					<textarea class="view_template" style="display:none;">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								<sec:authorize ifAnyGranted="ROLE_SECURITY_ACCOUNT_INSTITUTE_SUB_ADD">
									<td class="title_bar_td" width="20" align="right"><img src="image/ico08.gif" width="5" height="9" /></td>
							...
							<div class="p_box_body">
								<div class="p_box_body_t">
									<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
										<tr class="table_tr7">
											<td class="key" width="100">所在基地：</td>
											<td class="value" ><a class="linkD" id="${instituteId}" href="">${officer.divisionName}</a></td>
		...
		<script type="text/javascript">
			seajs.use('javascript/person/officer/institute/view.js', function(view) {
				$(function(){
					view.init();
				})
			});
