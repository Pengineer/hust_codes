...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>查看省级管理人员</title>
		<s:include value="/innerBase.jsp" />
	</head>

	<body>
		<div class="link_bar">
			当前位置：社科人员数据&nbsp;&gt;&nbsp;社科管理人员&nbsp;&gt;&nbsp;省级管理人员&nbsp;&gt;&nbsp;查看
		</div>
		...
		<div class="main">
			...
			<div class="choose_bar">
				<ul>
					...
					<li id="view_del"><sec:authorize ifAllGranted="ROLE_PERSON_OFFICER_PROVINCE_DELETE"><input class="btn1" type="button" value="删除" /></sec:authorize></li>
					<li id="view_mod"><sec:authorize ifAllGranted="ROLE_PERSON_OFFICER_PROVINCE_MODIFY"><input class="btn1" type="button" value="修改" /></sec:authorize></li>
					<li id="view_add"><sec:authorize ifAllGranted="ROLE_PERSON_OFFICER_PROVINCE_ADD"><input class="btn1" type="button" value="添加" /></sec:authorize></li>
				</ul>
			</div>
					...
					<textarea class="view_template" style="display:none;">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="title_bar_td" width="" id="personName" >
									${person.name}
								</td>
								<td class="title_bar_td" width="20" align="right"><img src="image/ico08.gif" width="5" height="9" /></td>
							...
							<tr>
								<sec:authorize ifAnyGranted="ROLE_SECURITY_ACCOUNT_PROVINCE_SUB_ADD">
									<td class="title_bar_td" width="20" align="right"><img src="image/ico08.gif" width="5" height="9" /></td>
								...
								<div class="p_box_body_t">
									<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
										<tr class="table_tr7">
											...
											<td class="value" width="300"><a class = "linkA" id = "${subjectionId}" href = ""> ${subjectionName}</a></td>
										</tr>
										<tr class="table_tr7">
		...
		<script type="text/javascript">
			seajs.use('javascript/person/officer/province/view.js', function(view) {
				$(function(){
					view.init();
				})
			});
