		...
		<s:form id="form_chat" action="add" namespace="/inBox" theme="simple">
			<table width="100%" border="0" cellspacing="2" cellpadding="0">
				<tr class="table_tr2">
					...
					<td style="padding: 20px 0 50px 20px;"><input id="submit" class="btn1" type="button" value="发送" /></td>
					<td style="padding: 20px 0 50px 20px;"><input id="cancel" class="btn1" type="button" value="取消" onclick="history.back();" /></td>
				</tr>
			</table>
