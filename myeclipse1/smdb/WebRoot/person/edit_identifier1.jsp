...
<div id="identifier1">
	<table width="100%" border="0" cellspacing="2" cellpadding="0">
		...
		<tr class="table_tr2">
			...
			<td class="table_td3"><s:select cssClass="select" headerKey="-1" headerValue="--请选择--" list="%{baseService.getSystemOptionMapAsName('idcardType', null)}" name="person.idcardType" /></td>
			<td class="table_td4"></td>
		</tr>
		<tr class="table_tr2">
