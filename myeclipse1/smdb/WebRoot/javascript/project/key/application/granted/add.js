...
//		window.submitSelectForm = function(){addGranted.submitSelectForm(projectType)};
		...
		$("#addApplyFee").live("click",function() {
			...
			popAddApplyFee({
				title : "添加申请经费概算明细",
				src : "project/key/application/granted/toAddApplyFee.action?applyFee=" + $("#applyFee").val() + "&otherFee=" + $("#otherFee").val() + 
...
//					location.href = url;
		...
		$("#addGrantedFee").live("click",function() {
			popAddGrantedFee({
				title : "添加立项经费预算明细",
				src : "project/key/application/granted/toAddGrantedFee.action?approveFee=" + $("#approveFee").val() +  
		...
		$("#addGrantedFee2").live("click",function() {
			popAddGrantedFee({
				title : "添加立项经费预算明细",
				src : "project/key/application/granted/toAddGrantedFee.action?approveFee=" + $("#approveFee2").val() +  
