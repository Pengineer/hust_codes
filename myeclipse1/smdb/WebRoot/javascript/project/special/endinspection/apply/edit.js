define(function(require, exports, module) {
	...
	exports.init = function() {
		...
		$(".addEndResult").live("click", function(){
			var data = $(this).attr("data");
			var types = $(this).attr("types");
			editEndinspection.addEndResult(data, types, thisPopLayer, projectType)
		});
		
		$("input[name = 'isApplyNoevaluation'][type = 'radio']").click(function(){
			var data = $("input[name='isApplyNoevaluation'][type='radio']:checked").val();
			editEndinspection.showNoEval(data);
		});
		
		$("input[name = 'isApplyExcellent'][type = 'radio']").click(function(){
			var data = $("input[name='isApplyExcellent'][type='radio']:checked").val();
			editEndinspection.showExcellect(data);
		});
		
		$(".j_editProductType").click(function(){
			editEndinspection.editProductType();
		})
		$("input[name = 'endResult'][type = 'radio']").click(function(){
...
//		window.showNumber = function(type){editEndinspection.showNumber(type)};
		...
		$("#addEndFee").live("click",function() {
			popAddEndFee({
				title : "添加结项经费结算明细",
				src : "project/special/endinspection/apply/toAddEndFee.action?projectid=" + $("#projectid").val() + "&feeNote=" + $("#feeNote").val() + 
		...
		$("#addEndFeeApply").live("click",function() {
			popAddEndFee({
				title : "添加结项经费结算明细",
				src : "project/special/endinspection/apply/toAddEndFee.action?projectid=" + $("#endFileProjectid").val() + "&feeNote=" + $("#feeNote").val() + 
																			"&bookFee=" + $("#bookFee").val() + "&bookNote=" + $("#bookNote").val() + 
																			"&dataFee=" + $("#dataFee").val() + "&dataNote=" + $("#dataNote").val() +
																			"&travelFee=" + $("#travelFee").val() + "&travelNote=" + $("#travelNote").val() +
																			"&conferenceFee=" + $("#conferenceFee").val() + "&conferenceNote=" + $("#conferenceNote").val() +
