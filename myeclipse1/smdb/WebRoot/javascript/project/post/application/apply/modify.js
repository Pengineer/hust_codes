...
//			};
			popAddApplyFee({
				title : "修改申请经费概算明细",
				src : "project/post/application/apply/toAddApplyFee.action?applyFee=" + $("#applyFee").val() + "&otherFee=" + $("#otherFee").val() + 
...
//					location.href = url;
		...
		$("#addGrantedFee").live("click",function() {
			popAddGrantedFee({
				title : "添加立项经费预算明细",
				src : "project/post/application/apply/toAddGrantedFee.action?approveFee=" + $("#approveFee").val() +  
