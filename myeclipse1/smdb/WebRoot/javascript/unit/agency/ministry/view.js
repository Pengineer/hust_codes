define(function(require, exports, module) {
	...
	var showDetails = function(result){
		...
		if (result.errorInfo == null || result.errorInfo == "") {
			...
			if(result.agency.type == 3 || result.agency.type == 4){
				...
				setOddEvenLine("list_discipline", 0);if (typeof(result.deptList) == "undefined" || result.deptList == 0) {
	...
	exports.init = function() {
		...
		$("#view_addAccount").live("click", function(){
			popAccountAdd({
				src : "account/ministry/main/extIfToAdd.action",
				inData : {data : {"typeName" : "部级主账号", "belongId" : $("#entityId").val(), "belongName" : $("#unitName").html()}},
