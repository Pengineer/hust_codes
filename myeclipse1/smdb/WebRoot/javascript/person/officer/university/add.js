define(function(require, exports, module) {
	...
	var edit_university_officer_affiliation = require('javascript/person/edit_university_officer_affiliation');
	...
	exports.init = function() {
		...
		var university_officer_affiliation_setting = edit_university_officer_affiliation.setting;
		...
		edit_basic1.init();
		edit_university_officer_affiliation.init();
		edit_contact.init();
		...
		identifier1_setting.out_check_custom = function(){
			...
			$.ajax({ 
				type: "post", 
				url: "person/universityOfficer/checkIfIsOfficer.action", 
				data:{
		...
		//任职信息
		university_officer_affiliation_setting.buttons = ['prev', 'next', 'retry', 'cancel'];
		...
		step_controller.add_step(university_officer_affiliation_setting);
