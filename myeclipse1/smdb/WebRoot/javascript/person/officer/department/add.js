define(function(require, exports, module) {
	...
	var edit_department_officer_affiliation = require('javascript/person/edit_department_officer_affiliation');
	...
	exports.init = function() {
		...
		var department_officer_affiliation_setting = edit_department_officer_affiliation.setting;
		...
		edit_basic1.init();
		edit_department_officer_affiliation.init();
		edit_contact.init();
		...
		identifier1_setting.out_check_custom = function(){
			...
			$.ajax({ 
				type: "post", 
				url: "person/departmentOfficer/checkIfIsOfficer.action", 
				data:{
		...
		//任职信息
		department_officer_affiliation_setting.buttons = ['prev', 'next', 'retry', 'cancel'];
		...
		step_controller.add_step(department_officer_affiliation_setting);
