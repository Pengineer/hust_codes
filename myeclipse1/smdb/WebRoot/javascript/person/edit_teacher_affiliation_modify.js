define(function(require, exports, module) {
	...
	function selectDI(){
		...
		if (unitType == 0){
			popSelect({
				type : 4,
				inData : {"type" : "-1", "id" :  $("[name$='department.id']", $here).val(), "name" : $("[name^='DIName_subjectionName']", $here).val()},
			...
			popSelect({
				type : 5,
				inData : {"type" : "-1","id" : $("[name$='institute.id']", $here).val(), "name" : $("[name^='DIName_subjectionName']", $here).val()},
				callBack : function(result){
