define(function(require, exports, module) {
	...
	var edit_expert_affiliation = require('javascript/person/edit_expert_affiliation');
	...
	exports.init = function() {
		...
		var expert_affiliation_setting = edit_expert_affiliation.setting;
		...
		//任职信息
		expert_affiliation_setting.buttons = ['prev', 'next', 'finish', 'cancel'];
		...
		step_controller.add_step(expert_affiliation_setting);
