...
public class SimilarityTest {
	public static void main(String[] args) {
		//检索内容
		String text1 = "IK Analyzer是一个结合词典中文你好啊分词和文法分词的中文分词开源工具包。它使用了全新的正向迭代最细粒度切分算法。中文分词";
		String text2 = "中文中文中文中文你好啊";
		//实例化IKAnalyzer分词器
		...
		try {
			...
			doc1.add(new StringField("ID", "01", Field.Store.YES));
			doc1.add(new TextField("TEXT", text1, Field.Store.YES));
			iwriter.addDocument(doc1);
			
			Document doc2 = new Document();
			doc2.add(new StringField("ID", "02", Field.Store.YES));
			...
			DocsEnum de = MultiFields.getTermDocsEnum(ireader, MultiFields.getLiveDocs(ireader), "TEXT", new BytesRef("中文"));
			int doc;
