...
app.string = {}; 
app.string.upload = '上传';
app.string.fileManagement = '文档管理';
app.string.fileSearch = '文档检索';
app.string.systemManagement = '系统管理';

/**
 *  文档管理
 */
app.string.fm = {};
app.string.fm.directoryTree = '文档目录树';
app.string.fm.documentList = '文档列表';
app.string.type = '格式';
app.string.title = '标题';
app.string.author = '作者';
app.string.creator ='创建者';
app.string.createdDate = '创建时间';
app.string.version = '版本号';
app.string.modifiedDate = '修改时间';
