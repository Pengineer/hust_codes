...
public class UploadService  extends BaseService  {
	public String id = SignID.getRandomString(10);
	...
	synchronized public String addFile(String groupId, File file,String dir) {
		return addFile(groupId, file, file.getName(),dir);
	}

	synchronized public String addFile(String groupId, File file, String fileName,String dir) {
		...
		if (!file.exists()) {
			...
			fileGroups.get(groupId).put(fileId, new FileRecord(fileId, file, fileName,dir));
			return fileId;
		}
	}
	...
	synchronized public void flush(String groupId) {
		...
		// 导致前者回滚、后者无法回滚造成的不一致
		System.out.println("execute flush.......");
