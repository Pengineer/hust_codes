	...
	public boolean handleMessage(SOAPMessageContext ctx) {
		...
		if(!out_b){
			try {
				...
				String visitorTag = serverInforsElement.getElementsByTagName("visitorTag").item(0).getFirstChild().getTextContent();
				...
				case 0:
					...
					genSignValue = serverInforsElement.getElementsByTagName("serverSignValue").item(0).getFirstChild().getTextContent();
                ...
                case 1:
                	...
                	serverCerString = serverInforsElement.getElementsByTagName("serverCertificate").item(0).getFirstChild().getTextContent();
                	serverSignValue = serverInforsElement.getElementsByTagName("serverSignValue").item(0).getFirstChild().getTextContent();
					//验证证书
                ...
                case 2://连接断开，密文安全传输
					...
					disconnSignValue = serverInforsElement.getElementsByTagName("serverSignValue").item(0).getFirstChild().getTextContent();
