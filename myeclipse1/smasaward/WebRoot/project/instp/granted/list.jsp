...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			<div id="top">
				项目管理&nbsp;&gt;&gt;&nbsp;基地项目&nbsp;&gt;&gt;&nbsp;<span class="text_red">立项项目</span>
			</div>
			
			<div class="main">
				<div class="main_content">
					<s:form id="search" theme="simple" action="list" namespace="/project/instp/granted">
						<table class="table_bar">
							<tr height="28px">
								...
								<td align="right">
									<s:select cssClass="select" name="searchType" headerKey="-1" headerValue="--%{'请选择'}--" list="#{'1':'项目名称','2':'批准号', '3':'负责人','4':'依托高校','5':'项目子类','6':'学科类型','7':'项目年度'}" />
						...
						<table id="list_table" class="table_list" cellspacing="0" cellpadding="0">
							<thead id="list_head">
								<tr class="tr_list1">
									...
									<td class="border0" style="width:75px;"><a id="sortcolumn1" href="" class="{if sortColumn == 1}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按项目批准号排序">批准号</a></td>
									...
									<td class="border0" style="width:85px;"><a id="sortcolumn3" href="" class="{if sortColumn == 3}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按依托高校排序">依托高校</a></td>
									...
									<td class="border0" style="width:60px;"><a id="sortcolumn7" href="" class="{if sortColumn == 7}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按项目状态排序">项目状态</a></td>
								</tr>
							</thead>
							<tbody>
							{for item in root}
			...
			<script type="text/javascript" src="javascript/project/instp/granted/list.js?ver=<%=application.getAttribute("systemVersion")%>"></script>
		</body>
</html>