...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			<div id="container">
				...
				<div style="margin-left: 10px;margin-right: 10px;">
					<table class="table_pview" cellspacing="0" cellpadding="0">
						...
						<s:iterator value="pojList" status="stat">
							<tr>
								<td><a href="project/instp/toView.action?entityId=<s:property value="pojList[#stat.index][0]" />&isReviewable=1&listType=1&businessType=${businessType}"><s:property value="pojList[#stat.index][1]" /></a></td>
				...
				<div style="width:100%;">
					<iframe id="expertTreeFrame" src="project/instp/showExpertTree.action?entityId=${entityId}" scrolling="auto" frameborder="no" border="0" width="100%"></iframe>
				</div>
			...
			<s:hidden id="InstpMinistryExpertNumber" value="%{#application.InstpMinistryExpertNumber}"/><!-- 隐藏字段，查询出"基地项目_每个项目_部属高校专家数" -->
			<s:hidden id="InstpLocalExpertNumber" value="%{#application.InstpLocalExpertNumber}"/><!-- 隐藏字段，查询出"基地项目_每个项目_地方高校专家数" -->
