...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div id="container">
			<div id="top">
				系统管理&nbsp;&gt;&gt;&nbsp;系统配置&nbsp;&gt;&gt;&nbsp;<span class="text_red">配置每页显示记录数</span>
			</div>
			...
			<div id="bottom">
				<s:form action="configPageSize" id="form_sysconfig" namespace="/main" theme="simple">
					...
					<table class="table_edit table_edit2" cellspacing="0" cellpadding="0">
						<tr>
							<td class="wd12">每页显示记录数</td>
							<td class="wd13"><s:textfield name="rows" value="%{#application.rows}" cssClass="input"  size="40" /></td>
						</tr>
						<tr>
							<td></td>
