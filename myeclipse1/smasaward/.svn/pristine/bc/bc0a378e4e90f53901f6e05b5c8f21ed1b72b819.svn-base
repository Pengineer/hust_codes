...
public class ProjectFee implements java.io.Serializable {

	private static final long serialVersionUID = 1L;
	public String id;//id
	private Double bookFee;//图书资料费
	private String bookNote;//图书资料费备注
	private Double dataFee;//数据采集费
	private String dataNote;//数据采集费备注
	private Double travelFee;//调研差旅费
	private String travelNote;//调研差旅费备注
	private Double deviceFee;//设备购置和使用费
	private String deviceNote;//设备购置和使用费备注
	private Double conferenceFee;//会议费
	private String conferenceNote;//会议费备注
	private Double consultationFee;//专家咨询与评审费
	private String consultationNote;//专家咨询与评审费备注
	private Double laborFee;//助研津贴和劳务费
	private String laborNote;//助研津贴和劳务费备注
	private Double printFee;//印刷和出版费
	private String printNote;//印刷和出版费备注
	private Double internationalFee;//国际合作交流费
	private String internationalNote;//国际合作交流费备注	
	private Double indirectFee;//间接费用
	private String indirectNote;//间接费用备注	
	private Double otherFee;//其他费用
	private String otherNote;//其他费用备注
	private Double totalFee;//费用合计
	private Integer feeType; //经费类型[1申请概算，2立项预算，3年检经费（支出），4中检经费（支出），5结项经费（支出）]
	private String feeNote;//备注
	private Double fundedFee;//已拨经费
