...
//				}
	...
	*/
	$(".addFee").live("click",function(){
		...
		popGeneralAudit({
			title : "添加经费预算变更明细",
			src : "project/general/variation/toAddVarFee.action?projectid=" + projectid + "&feeNote=" + $("#feeNote").val() + 
	...
	$(".confirm").bind("click",function(){
		...
		*/
		$("#varAddForm").ajaxSubmit({
			//发送表单前填充newAgencyName
			beforeSubmit:function(){
				var newAgencyName = $("#agenceUniversity").val() + ";" + $("#agenceColleage").val();
				$("#newAgencyName").val(newAgencyName);
				return true;
			},
