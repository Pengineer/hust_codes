...
public class SmdbClient {
	...
	public String invokeDirectory(String passport, String password, String serviceName, 
		...
		try {
			busy = true;
			resultContent = getSmdbService().invokeDirectory(passport, password, serviceName, method, argsMap);
		} catch (Exception e) {
			e.printStackTrace();
			resultContent = null; 
		} finally {
	...
	public String invokeDirectory(String passport, String password, String serviceName, 
		...
		try {
			busy = true;
			resultContent = getSmdbService().invokeDirectory(passport, password, serviceName, method);
		} catch (Exception e) {
			e.printStackTrace();
			resultContent = null; 
		} finally {
