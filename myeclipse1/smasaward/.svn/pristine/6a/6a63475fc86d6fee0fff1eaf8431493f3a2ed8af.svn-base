				...
				<s:form action="syncDataOnline" id="form_synData" namespace="/system/smdbClient" theme="simple">
					...
					<table class="table_edit table_edit2" cellspacing="0" cellpadding="0">
						...
						<tr>
							...
							<td class="wd13">
								数据类型：<s:select cssClass="select" name="dataTypeTag" headerKey="-1" headerValue="--%{'请选择'}--" list="#{'1':'申报数据','2':'立项数据','3':'变更数据','4':'中检数据','5':'结项数据', '6':'smas高校表更新', '7':'部级审核信息更新至smdb'}" />
							</td>
						</tr>
						<tr>
							<td class="wd12"></td>
				...
				<s:form action="syncDataFix" id="form_enterData" namespace="/system/smdbClient" theme="simple">
					...
					<table class="table_edit table_edit2" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td class="wd12">参数配置</td>
							<td class="wd13">
								数据类型：<s:select cssClass="select" name="dataTypeTag" headerKey="-1" headerValue="--%{'请选择'}--" list="#{'1':'申报数据','2':'立项数据','3':'变更数据','4':'中检数据','5':'结项数据','6':'fixSmasProgram'  }" />
							</td>
						</tr>
						<tr>
							<td class="wd12"></td>
