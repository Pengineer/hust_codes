...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			<div id="top">
				项目管理&nbsp;&gt;&gt;&nbsp;一般项目&nbsp;&gt;&gt;&nbsp;<span class="text_red">初审结果</span>
			</div>
			...
			<div class="main">
				<div class="main_content">
					<s:form id="search" theme="simple" action="list" namespace="/project/general/firstAudit">
						<table class="table_bar">
							<tr height="28px">
								<td align="right">
									<s:select cssClass="select" name="searchType" headerKey="-1" headerValue="--%{'请选择'}--" list="#{'1':'项目名称','2':'项目类型', '3':'负责人','4':'高校名称','5':'初审结果'}" />
			...
			<script type="text/javascript" src="javascript/project/general/firstAudit/list.js?ver=<%=application.getAttribute("systemVersion")%>"></script>
		</body>
</html>