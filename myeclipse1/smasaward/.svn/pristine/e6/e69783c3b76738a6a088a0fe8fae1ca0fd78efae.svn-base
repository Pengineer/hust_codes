...
$(document).ready(function(){
	...
	*/
	$(".modifyEndFee").live("click",function(){
		...
		popGeneralAudit({
			...
			src : "project/general/endinspection/toAddEndFee.action?projectid=" + projectid + "&feeNote=" + $("#feeNote").val() + 
					...
					"&totalFee=" + $("#totalFee").val() + "&surplusFee=" + $("#surplusFee").val(),//应该修改为对应的action，暂时因为后台没做，就仅用一般项目申报审核弹出层
	...
	$(".confirm").bind("click",function(){
		...
		$.ajax({
			url: "project/general/endinspection/auditReview.action",
			type: "post",
			data: "projectid=" + projectid + "&endId=" + endId + "&isApplyNoevaluation=" + $("input[name=isApplyNoevaluation]:checked").val()
				+ "&reviewAuditResultNoevalu=" + $("input[name=finalAuditResultNoevaluation]:checked").val()
				+ "&isApplyExcellent=" + $("input[name=isApplyExcellent]:checked").val()
				+ "&reviewAuditResultExcelle=" + $("input[name=finalAuditResultExcellent]:checked").val()
				+ "&endMember=" + $("#memberName").val() + "&reviewAuditResultEnd=" + $("input[name=finalAuditResultEnd]:checked").val()
				+ "&certificate=" + $("#certificate").val() + "&endDate=" + $("#finalAuditDate").val()
				+ "&reviewAuditOpinion=" + $("#endAuditOpinion").val()
				+ "&reviewAuditOpinionFeedback=" + $("#endAuditOpinionFeedback").val()
