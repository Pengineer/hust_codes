...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			<div id="top">
				项目管理&nbsp;&gt;&gt;&nbsp;基地项目&nbsp;&gt;&gt;&nbsp;<span class="text_red">中检项目</span>
			</div>
			
			<div class="main">
				<div class="main_content">
					<s:form id="search" theme="simple" action="list" namespace="/project/instp/midinspection">
			...
			<script type="text/javascript" src="javascript/project/instp/midinspection/list.js?ver=<%=application.getAttribute("systemVersion")%>"></script>
		</body>
</html>