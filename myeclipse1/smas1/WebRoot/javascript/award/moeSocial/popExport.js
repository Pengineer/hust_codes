$(function(){
	...
	$("#exportReviewProject").click(function(){
		//包含评审信息
		document.location.href = "award/moeSocial/exportAwardReviewer.action?exportAll=0";
		return true;
	});
	...
	$("#exportNotReviewProject").click(function(){
		document.location.href = "award/moeSocial/exportAward.action?exportAll=0";
		return true;
	});
	...
	$("#exportMatchUpdate").click(function(){
		...
		document.location.href = "award/moeSocial/exportMatchUpdate.action?startTime=" + startTime.getTime() + "&endTime=" + newEndTime;
	});
});
