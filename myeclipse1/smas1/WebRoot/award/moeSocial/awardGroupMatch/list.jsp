...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
  	<div id="top">
		奖励管理&nbsp;&gt;&gt;&nbsp;人文社科奖励&nbsp;&gt;&gt;&nbsp;<span class="text_red">分组匹配</span>
	</div>
	
	<div class="main">
		<div class="main_content">
			<!-- TODO -->
			<s:form id="search" theme="simple" action="list" namespace="#">
				<table class="table_bar">
					<tr height="28px">
						...
						<td align="right">
							...
							<s:select cssClass="select" name="searchType" headerKey="-1" headerValue="--%{'不限'}--" list="#{'1':'分组名称','2':'学科代码', '3':'奖励数量'}" />
				...
				<table id="list_table" class="table_list" cellspacing="0" cellpadding="0">
					<thead id="list_head">
						<tr class="tr_list1">
							...
							<td class="border0" style="width:200px;"><a id="sortcolumn0" href="" class="{if sortColumn == 0}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按分组名称排序">分组名称</a></td>
							<td class="border0" style="width:100px;"><a id="sortcolumn1" href="" class="{if sortColumn == 1}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按学科代码排序">学科代码</a></td>
							<td class="border0" style="width:85px;"><a id="sortcolumn2" href="" class="{if sortColumn == 2}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按奖励数量排序">奖励数量</a></td>
							<td class="border0" style="width:55px;"><a id="sortcolumn3" href="" class="{if sortColumn == 3}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按评审专家排序">评审专家</a></td>
							<td class="border0" style="width:70px;"><a id="sortcolumn4" href="" class="{if sortColumn == 4}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按专家数量排序">专家数量</a></td>
							<td class="border0" style="width:70px;"><a id="sortcolumn5" href="" class="{if sortColumn == 5}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按警告排序">警告</a></td>
						</tr>
					</thead>
					<tbody>  
					{for item in root}
			...
			<!-- TODO -->
			<s:form id="list" theme="simple" action="delete" namespace="#">
	...
	<script type="text/javascript" src="javascript/award/moeSocial/awardGroupMatch/list.js?ver=<%=application.getAttribute("systemVersion")%>"></script>
	</body>
</html>
