 ...
 * @author fengcl
 */
public class AwardApplicationReview {
	private Integer id;
	...
	public AwardApplicationReview(){}

	/**
	 * 匹配结果快速构造器
	 * @param reviewerId 评审家Id
	 * @param awardId  评审对象Id
	 * @param isManual 是否手动添加结果 0：自动；1：手工
	 * @param year 所属年份
	 * @param type 奖励类型[ moeSocial 或者其他]
	 */
	public AwardApplicationReview(Object reviewerId, Object awardId, Object isManual, Object year, Object type){
		this.reviewer = new Expert();
		this.reviewer.setId((String) reviewerId);
		this.isManual = (Integer)isManual;
		this.year = (Integer)year;
		this.award = new AwardApplication();
		this.award.setId((String) awardId);
