...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			<div id="top">
				项目管理&nbsp;&gt;&gt;&nbsp;一般项目&nbsp;&gt;&gt;&nbsp;<span class="text_red">变更项目</span>
			</div>
			
			<div class="main">
				<div class="main_content">
					<s:form id="search" theme="simple" action="list" namespace="/project/general/variation">
						...
						<table id="list_table" class="table_list" cellspacing="0" cellpadding="0">
							<thead id="list_head">
								<tr class="tr_list1">
									...
									<td class="border0" style="width:60px;"><a id="sortcolumn6" href="" class="{if sortColumn == 6}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按变更状态排序">变更状态</a></td>
									<td class="border0" style="width:60px;"><a id="sortcolumn7" href="" class="{if sortColumn == 7}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按变更时间排序">变更时间</a></td>
								</tr>
							</thead>
							<tbody>
							{for item in root}
...
<!-- 								<td class="border1"><input type="button" value="删除" class="btn" /></td> -->
			...
			<script type="text/javascript" src="javascript/project/general/variation/list.js?ver=<%=application.getAttribute("systemVersion")%>"></script>
		</body>
</html>
