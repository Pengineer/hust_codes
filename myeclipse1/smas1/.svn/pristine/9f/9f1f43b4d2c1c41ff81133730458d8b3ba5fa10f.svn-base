...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			<div id="container">
				...
				<div class="main">
					...
					<table class="table_edit" cellspacing="0" cellpadding="0">
						...
						<tr><td class="wd12">权限名称</td>
							<td class="wd13">${right.name}</td>
						</tr>
						<tr><td class="wd12">权限描述</td>
							<td class="wd13">${right.description}</td>
						</tr>
			...
			<script type="text/javascript" src="javascript/security/right/view.js?ver=<%=application.getAttribute("systemVersion")%>"></script>
		</body>
</html>