...
@WebServiceClient(name = "WebServicesService", targetNamespace = "http://server.webService.service.csdc/", wsdlLocation = "http://localhost:8080/smdb/service/webService?wsdl")
    ...
    extends Service
{
    ...
    static {
        URL url = null;
        try {
        	url = new URL("http://localhost:8080/smdb/service/webService?wsdl");
