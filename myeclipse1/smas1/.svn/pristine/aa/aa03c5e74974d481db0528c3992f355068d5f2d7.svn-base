 ...
 * 
 */
@WebServiceClient(name = "WebServicesService", targetNamespace = "http://server.webService.service.csdc/", wsdlLocation = "http://192.168.88.2:8080/smdb/service/webService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
        	//两个地方需要修改
        	//	csdc/tool/webService/smdb/client/WebServicesService.java
        	//	csdc/tool/webService/smdb/jaxws/WebServicesService.java
            url = new URL("http://192.168.88.2:8080/smdb/service/webService?wsdl");
