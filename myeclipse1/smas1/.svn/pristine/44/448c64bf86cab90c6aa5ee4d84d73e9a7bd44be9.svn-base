 ...
 * @author pengliang
 */
public class Project2015ExpertSecondSupplementImporter extends Importer{
	...
	public Project2015ExpertSecondSupplementImporter(){
	}
	
	public Project2015ExpertSecondSupplementImporter(String file) {
		reader = new PoiExcelReader(file);
	}
	
	public static void main(String[] args) throws DocumentException {
		Project2015ExpertSecondSupplementImporter expertImporter = new Project2015ExpertSecondSupplementImporter();
