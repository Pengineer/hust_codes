...
//通过encodeURL()方法将Session添加到URL地址的尾部。经测试发现，搜狗浏览器禁止cookie的功能形同虚设，因为cookie被禁止后，通过封装URL，我们在网页源码中是可以看到SessionID的，而搜狗浏览器看不到，IE可以看到，说明在搜狗浏览器中SessionID还是通过cookie传递给了浏览器，而没有添加到URL地址末尾
