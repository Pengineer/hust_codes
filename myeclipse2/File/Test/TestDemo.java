...
class Student implements Comparable<Student>
{
	...
	public boolean equals(Object obj)
	{
		if(!(obj instanceof Student))
			throw new ClassCastException("类型匹配出错");
...
class StudentInfoTool
{
	...
	{
		BufferedWriter bufw = new BufferedWriter(new FileWriter("infomation.txt"));
...
class  TestDemo
{
	...
	{
		Comparator<Student> cmp = Collections.reverseOrder(); //定义一个强行逆转比较器
