...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title><s:text name="导出" /></title>
		<s:include value="/innerBase.jsp" />
	</head>
	<body>
		<div class="link_bar">
			<s:text name="当前位置" />：<s:text name="接口管理" />&nbsp;&gt;&nbsp;<s:text name="社科网服务端" />&nbsp;&gt;&nbsp;<s:text name="导出" />
		</div>
		    ...
		    <div class="main">
				<div class="main_content">
					...
					<div class="btn_div_view">
						<input id="submit" class="btn2" type="submit" value="<s:text name='导出' />" />
					</div>
				</div>
			</div>
		</s:form>
