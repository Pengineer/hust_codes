		...
		<body>
			<div style="width:480px;">
				<s:form id="app_review_audit">
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						<tr class="table_tr2">
							...
							<td class="table_td12"><s:radio name="reviewAuditResult" theme="simple" list="#{'2':getText('同意'),'1':getText('不同意')}" cssClass="j_showNumberAndFee"/></td>
				...
				<div class="btn_div_view">
					...
					<input id="submit" class="btn1 j_addOrModifySave" type="button" value="提交"/>
					<input id="cancel" class="btn1" type="button" value="取消" />
				</div>
			</div>
			<script type="text/javascript">
				seajs.use('javascript/project/post/application/review/audit.js', function(audit) {
					audit.init();
				});
			</script>
		</body>
