	...
	<s:i18n name="csdc.resources.i18n_Project">
		...
		<body>
			<div style="width:450px;">
				<s:form id="ann_result">
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						<tr class="table_tr2">
							<td class="table_td11"><span class="table_title6"><s:text name='i18n_UploadAnnApply' />：</span></td>
							<td class="table_td12">
						...
						<tr class="table_tr2">
							<td class="table_td2"><s:text name="年检经费结算" />：</td>
							<td class="table_td3">
								<input type="button" id="addAnnFee" class="btn1 select_btn" value="<s:text name="添加" />" />
						...
						<tr class="table_tr2">
							<td class="table_td11" width="120"><span class="table_title6"><s:text name="i18n_AnninspectionResult" />：</span></td>
							<td class="table_td12"><s:radio name="annResult" theme="simple" list="#{'2':getText('i18n_Qualified'),'1':getText('i18n_Unqualified')}"/></td>
							<td class="table_td13" width="100"></td>
						</tr>
						<tr class="table_tr2">
							<td class="table_td2"><span class="table_title6"><s:text name="i18n_AnninspectionYear" />：</span></td>
							<td class="table_td3"><s:textfield id="annYear" name="annYear" cssClass="input_css" /></td>
							<td class="table_td4"></td>
						</tr>
						<tr class="table_tr2">
							<td class="table_td11"><span  class="table_title6"><s:text name="i18n_AnninspectionDate" />：</span></td>
							<td class="table_td12">
			...
			<script type="text/javascript">
				seajs.use(['javascript/project/general/anninspection/edit.js','javascript/project/project_share/anninspection/validate.js'], function(edit, validate) {
					validate.valid();
					edit.init();
				});
			</script>
