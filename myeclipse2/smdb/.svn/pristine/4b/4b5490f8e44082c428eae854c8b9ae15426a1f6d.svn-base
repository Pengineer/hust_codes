			...
			<div style="width:450px;">
				<s:form id="search" theme="simple" action="list" namespace="/selectMinistry">
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
						...
						<tr class="table_main_tr">
							<td>项目</td>
							<td><s:radio list="#{'申报项目数量':'申报项目数量','申报项目数量同比增加':'申报项目数量同比增加','立项项目数量':'立项项目数量','立项项目数量同比增加':'立项项目数量同比增加','立项率':'立项率','项目数量':'项目数量','人均项目数量':'人均项目数量','项目数量同比增加':'项目数量同比增加','拨入经费':'拨入经费','人均拨入经费':'人均拨入经费','拨入经费同比增加':'拨入经费同比增加','支出经费':'支出经费','人均支出经费':'人均支出经费','支出经费同比增加':'支出经费同比增加'}" ></s:radio></td>
						</tr>
						<tr class="table_main_tr">
							<td>成果</td>
							<td><s:radio list="#{'1':'1','2':'2','3':'3'}" ></s:radio></td>
