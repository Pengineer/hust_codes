...
<div id="simple_search"><!-- 初级检索 -->
	<s:form id="search" theme="simple" action="list" namespace="/person/provinceOfficer">
				...
				<td align="right">
					<span class="choose_bar">
						<s:select cssClass="select" name="searchType" value="%{searchQuery.searchType}" headerKey="-1" headerValue="--%{getText('不限')}--" 
							list="#{'0':getText('姓名'),'1':getText('所在机构'),'2':getText('所在部门'),'3':getText('职务')}" />
...
<div id="adv_search" style="display:none;">			
	<s:form id="advSearch" action="advSearch" namespace="/person/provinceOfficer" theme="simple">
		...
		<div class="adv_content">
			...
			<table class="adv_table" width="100%" border="0" cellspacing="2" cellpadding="0">
				<tr class="adv_tr">
					...
					<td class="adv_td1" width="200"><s:select cssClass="select" value="%{searchQuery.gender}" name="gender" headerKey="-1" headerValue="--%{getText('不限')}--" list="#application.sexList" /></td>
				...
				<tr class="adv_tr">
					<td class="adv_td2" align="right"><s:text name="所在省份" />：</td>
