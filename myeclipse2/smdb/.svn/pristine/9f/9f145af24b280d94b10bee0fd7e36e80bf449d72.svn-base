			...
			<table id="list_officer" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
				<thead id="list_head">
					<tr class="table_title_tr">
						...
						<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
						<td width="120"><s:text name="工作证号" /></td>
						<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
						<td width="80"><s:text name="行政职务" /></td>
						<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
						<td width="90"><s:text name="定职时间" /></td>
						<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
						<td width="80"><s:text name="离职时间" /></td>
						<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
						<td width="100"><s:text name="人员类型" /></td>
					</tr>
				</thead>
				<tbody>
				{for item in officer}
			...
			<table id="list_teacher" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
				<thead id="list_head">
					<tr class="table_title_tr">
						...
						<td><s:text name="姓名" /></td>
						<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
						<td width="100"><s:text name="工作证号" /></td>
						<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
						<td width="80"><s:text name="职务" /></td>
						<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
						<td width="70"><s:text name="每年工作时间（月）" /></td>
						<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
						<td width="70"><s:text name="定职时间" /></td>
						<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
						<td width="70"><s:text name="离职时间" /></td>
						<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
						<td width="80"><s:text name="人员类型" /></td>
					</tr>
				</thead>
				<tbody>
				{for item in teacher}
			...
			<table id="list_student" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
				<thead id="list_head">
					<tr class="table_title_tr">
						...
						<td><s:text name="姓名" /></td>
						<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
						<td width="60"><s:text name="学生证号" /></td>
						<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
						<td width="30"><s:text name="学生类别" /></td>
						<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
						<td width="30"><s:text name="学生状态" /></td>
						<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
						<td width="40"><s:text name="入学时间" /></td>
						<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
						<td width="40"><s:text name="毕业时间" /></td>
						<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
						<td width="30"><s:text name="导师" /></td>
						<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
						<td width="40"><s:text name="专业" /></td>
						<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
						<td width="50"><s:text name="研究方向" /></td>
						<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
						<td width="80"><s:text name="参与项目" /></td>
						<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
						<td width="90"><s:text name="学位论文题目" /></td>
					</tr>
				</thead>
				<tbody>
				{for item in student}
