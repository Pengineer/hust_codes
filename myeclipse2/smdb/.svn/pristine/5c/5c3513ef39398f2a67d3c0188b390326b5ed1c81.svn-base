								...
								<td class="table_td12">
									<table border="0" cellspacing="0" cellpadding="2">
										<s:iterator value="#application.pdtItems" status="stat">
											<s:if test="(#stat.index)%4 == 0"><tr></s:if>
											<td width="20" style="text-align:center;" valign="top"><input id="<s:property value='#application.pdtItems[#stat.index][0]' />" type="checkbox" name="selectProductType" value="<s:property value='#application.pdtItems[#stat.index][0]'/>" class="pType"/></td>
