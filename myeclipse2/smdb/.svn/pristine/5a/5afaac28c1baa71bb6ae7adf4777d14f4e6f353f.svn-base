		...
		<body>
			<div style="width:580px;">
				...
				<div class="btn_div_view">
					<input id="save" class="btn1 j_modifyEndApply" data="2" type="button" value="<s:text name='i18n_Save' />" />
					<input id="submit"class="btn1 j_modifyEndApply" data="3" type="button" value="<s:text name='i18n_Submit' />" />
