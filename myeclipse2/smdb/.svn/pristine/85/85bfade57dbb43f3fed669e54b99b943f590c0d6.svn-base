		...
		<body>
			<div style="width:480px;">
				...
				<div class="btn_div_view">
					<input id="save" class="btn1 j_submitOrSaveModifyEndReview" data="2" type="button" value="<s:text name='i18n_Save' />" />
					<input id="submit" class="btn1 j_submitOrSaveModifyEndReview" data="3" type="button" value="<s:text name='i18n_Submit' />" />
