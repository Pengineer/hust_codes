...
<%--									</table>--%>
				...
				<div class="btn_div_view">
					<input id="save" type="button" class="btn1 j_modifyResultSave" value="<s:text name='i18n_Save' />" />
					<input id="submit" type="button" class="btn1 j_modifyResultSubmit" value="<s:text name='i18n_Submit' />" />
