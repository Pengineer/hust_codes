	...
	<s:i18n name="csdc.resources.i18n_Project">
		<head>
			...
			<script type="text/javascript" >
				seajs.use('javascript/project/project_share/popAddApplyFee.js', function(add) {
					add.init();
				});
			</script>
		</head>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
						<tbody>
							...
							<tr class="table_tr4">
								...
								<td ></td>
								<s:hidden id="applyFee" name="applyFee" />
								<s:hidden id="otherFee" name="otherFee" />
								<s:hidden id="applytotal" name="applytotal" />
							</tr>
							<tr class="table_tr4">
								<td class="table_td11"><s:text name="相关说明" /></td>
