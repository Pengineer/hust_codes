...
<html xmlns="http://www.w3.org/1999/xhtml">
	<s:i18n name="csdc.resources.i18n_Project">
		...
		<body>
			<div class="link_bar">
				<s:text name="i18n_CurrentPosition" />：<s:text name="i18n_ProjectData" />&nbsp;&gt;&nbsp;<s:text name="i18n_EntrustSubProject" />&nbsp;&gt;&nbsp;<s:text name="i18n_AddVariationApply" />
			</div>
			<div class="main">
				...
				<div class="main_content">
					...
					<s:form id="form_apply" action="add" namespace="/project/entrust/variation/apply" method="post" theme="simple" enctype="multipart/form-data">
