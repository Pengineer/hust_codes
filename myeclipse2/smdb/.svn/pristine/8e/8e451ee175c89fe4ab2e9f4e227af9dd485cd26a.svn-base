...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body >
				...
				<s:form id="end_review_audit">
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						<tr class="table_tr2">
							...
							<td class="table_td12"><s:radio name="reviewAuditResultEnd" theme="simple" list="#{'2':getText('同意'),'1':getText('不同意')}" cssClass="j_showNumber"/></td>
			...
			<script type="text/javascript">
				seajs.use('javascript/project/key/endinspection/review/audit.js', function(audit) {
					audit.init();
				});
			</script>
		</body>
