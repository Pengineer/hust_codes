...
<div id="simple_search"><!-- 初级检索 -->			
	<s:form id="search" theme="simple" action="list" namespace="/project/general/endinspection/review">
			...
			<tr class="table_main_tr">
				...
				<s:if test="#session.loginer.currentType.equals(@csdc.tool.bean.AccountType@EXPERT) || #session.loginer.currentType.equals(@csdc.tool.bean.AccountType@TEACHER)">
					<s:select cssClass="select" id="mainFlag" name="mainFlag"  value="%{searchQuery.mainFlag}" headerKey="" headerValue="--所有项目--"
						list="#{'0134':getText('i18n_ToReview')}" />
				</s:if>
...
<div id="adv_search" style="display:none;"><!-- 高级检索 -->		
	<s:form id="advSearch" action="advSearch" theme="simple" namespace="/project/general/endinspection/review">
		...
		<div class="main_content">
			...
			<table class="adv_table" width="100%" border="0" cellspacing="2" cellpadding="0">
				...
				<tr class="adv_tr">
					...
					<td class=""adv_td1"">
						  <s:select cssClass="select" name="submitStatus" value="%{searchQuery.submitStatus}" value="-1" list="#{'3':getText('i18n_Submit'),'2':getText('i18n_Saved'),'1':getText('i18n_SendBack'), '0':getText('i18n_Pending')}" headerKey="-1" headerValue="--%{getText('i18n_NoLimit')}--" />
			   		</td>
					<td class=""adv_td1""></td>
					<td class=""adv_td1"" align="right"><s:text name="i18n_ReviewDate1" />：</td>
					<td class=""adv_td1"">
				...
				<tr class="adv_tr">
					<td class="adv_td2" align="right"><s:text name="i18n_GroupReviewStatus1" />：</td>
					<td class="adv_td2">
						   <s:select cssClass="select" name="reviewStatus" value="%{searchQuery.reviewStatus}" value="-1" list="#{'32':getText('i18n_Approve'),'31':getText('i18n_NotApprove'),'22':getText('i18n_SaveApprove'),'21':getText('i18n_SaveNotApprove'),'0':getText('i18n_Pending')}" headerKey="-1" headerValue="--%{getText('i18n_NoLimit')}--" />
			   		</td>
					<td class="adv_td2"></td>
					<td class="adv_td2" align="right"><s:text name="i18n_Score" />：</td>
					<td class="adv_td2">
						<s:textfield name="minScore" value="%{searchQuery.minScore}" size="10"/> <s:text name="i18n_To"/> <s:textfield name="maxScore" value="%{searchQuery.maxScore}" size="10"/>
					</td>
					<td class="adv_td2"></td>
				</tr>
			</table>
