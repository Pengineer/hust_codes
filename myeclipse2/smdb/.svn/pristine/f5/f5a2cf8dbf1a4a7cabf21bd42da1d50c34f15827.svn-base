...
<html xmlns="http://www.w3.org/1999/xhtml">
	<s:i18n name="csdc.resources.i18n_Project">
		...
		<body>
			<div style="width:700px;" id="varTable">
				...
				<div style="overflow-y:scroll;height:500px; *margin-right:20px; _margin-right:20px;">
					<s:form id="form_apply">
						...
						<s:hidden id="midPending" name="midPending" value="%{#request.midPending}" />
...
<%--									</table>--%>
								...
								<td colspan = '3'>
									<div id="member">
										<s:iterator value="members" status="stat">
											<table class="table_valid" width="100%" border="0" cellspacing="0" cellpadding="2">
												<tr>
													<td class="table_td8" width="150"><div class="sort_title"><b><span><s:text name="i18n_ProjectMember"/></span><span title="memberSpan"><s:property value="#stat.index+1" /></span></b></div>&nbsp;</td>
													<td class="table_td9">
												...
												<tr>
													<td class="table_td8"><span class="table_title6"><s:text name="i18n_MemberType" />：</span></td>
													<td class="table_td9">
												...
												<tr class = "j_newMember" style="display: none">
													<td class="table_td8"><span><s:text name='所在部门'/>：</span></td>
													<td class="table_td9" style="line-height:22px;">
												...
												<tr>
													<td class="table_td8"><span class="table_title6"><s:text name="i18n_SpecialistTitle" />：</span></td>
													<td class="table_td9">
												...
												<tr>
													<td class="table_td8"><span class="table_title6"><s:text name="i18n_WorkMonthPerYear" />：</span></td>
													<td class="table_td9">
												...
												<tr>
													<td class="table_td8"><span class="table_title6"><s:text name="i18n_IsDirector" />：</span></td>
													<td class="table_td9">
												...
												<tr>
													<td class="table_td8"><span class="table_title6"><s:text name="i18n_IsSubprojectDirector" />：</span></td>
													<td class="table_td9">
														<s:select cssClass="select" name="%{'members['+#stat.index+'].isSubprojectDirector'}" headerKey='-1' headerValue="--%{getText('i18n_PleaseSelect')}--" list="#{'1':getText('i18n_Yes'),'0':getText('i18n_No')}" />
													</td>
													<td class="table_td10"></td>
												</tr>
												<tr>
									...
									<div id="last_add_div" style="display:none;">
										<table  width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td class="table_td8" width="150"><div class="sort_title"><b><span><s:text name="i18n_ProjectMember"/></span><span title="memberSpan"></span></b></div>&nbsp;</td>
												<td class="table_td9">
							...
							<tr class="table_tr2">
								<td class="table_td11"><span  class="table_title6"><s:text name="i18n_VariationResult" />：</span></td>
								<td class="table_td12"><s:radio name="varResult" cssClass="j_showResultDetail" theme="simple" list="#{'2':getText('i18n_Approve'),'1':getText('i18n_NotApprove')}"/></td>
								<td class="table_td13"></td>
							</tr>
							<tr class="table_tr2" id="var_result_item_tr" style="display:none">
								<td class="table_td11">
									<span class="table_title6">
										<s:text name="i18n_VariationApproveItem" />：<br />
										<span class="select_all_box"><s:text name="i18n_SelectAll"/>&nbsp;<input id="checkAllVarResultItem" name="check" type="checkbox"  title="<s:text name='i18n_ClickSelectAll' />"/></span>
									</span>
								</td>
								<td class="table_td12">
							...
							<tr class="table_tr2">
								<td class="table_td11"><span  class="table_title6"><s:text name="i18n_VariationDate" />：</span></td>
								<td class="table_td12">
				...
				<table id="table_member" width="100%" border="0" cellspacing="0" cellpadding="0" style="display:none;">
					...
					<tr class="table_tr2">
						...
						<td class="table_td12">
							...
							<input type="radio" name="members[].type" class="j_showMembertDetail" value="1" /><span>新建成员</span>
						</td>
						<td class="table_td13"></td>
					</tr>
					<tr>
					...
					<tr>
						<td class="table_td8"><span class="table_title6"><s:text name="i18n_IsSubprojectDirector" />：</span></td>
						<td class="table_td9">
							<s:select cssClass="select" name="members[].isSubprojectDirector" headerKey='-1' headerValue="--%{getText('i18n_PleaseSelect')}--" list="#{'1':getText('i18n_Yes'),'0':getText('i18n_No')}" />
						</td>
						<td class="table_td10"></td>
					</tr>
					<tr>
				...
				<div class="btn_div_view">
					<input id="save" type="button" class="btn1 j_addResultSave" value="<s:text name='i18n_Save' />" />
					<input id="submit" type="button" class="btn1 j_addResultSubmit" value="<s:text name='i18n_Submit' />" />
					<input id="cancel" type="button" class="btn1" value="<s:text name='i18n_Cancel' />"/>
				</div>
			</div>
			<script type="text/javascript" src="javascript/project/project_share/handlers_variation.js"></script>
			<script type="text/javascript">
				seajs.use(['javascript/project/instp/variation/edit.js','javascript/project/project_share/variation/validate.js'], function(edit, validate) {
					validate.valid();
					edit.init();
				});
			</script>
