		...
		<div class="main">
			...
			<table width="100%" border="0" cellspacing="2" cellpadding="0">
				<tr class="table_tr2">
					...
					<td class="table_td3"><s:radio cssClass="productType" name="ptype" list="#{'1':getText('论文'),'2':getText('著作'),'3':getText('研究咨询报告'),'4':getText('电子出版物'),'5':getText('专利'),'6':getText('其他成果')}"/></td>
