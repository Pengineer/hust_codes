		...
		<body>
			<div style="width:480px;">
				<s:form id="tops_audit">
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						<tr class="table_tr2">
							...
							<td class="table_td12"><s:radio name="topsAuditResult" theme="simple" list="#{'2':getText('同意'),'1':getText('不同意')}"/></td>
				...
				<div class="btn_div_view">
					<input id="save" class="btn1" type="button" value="保存" onclick="addTopsAudit(2, thisPopLayer);" />
					<input id="submit" class="btn1" type="button" value="提交" onclick="addTopsAudit(3, thisPopLayer);" />
