...
<html xmlns="http://www.w3.org/1999/xhtml">
	<s:i18n name="csdc.resources.i18n_Project">
		...
		<body>
			<div class="link_bar">
				<s:text name="i18n_CurrentPosition" />：<s:text name="i18n_ProjectData" />&nbsp;&gt;&nbsp;<s:text name="i18n_GeneralProject" />&nbsp;&gt;&nbsp;<s:text name="i18n_ApplyData" />
			</div>
			
			<div class="main">
				<div class="main_content">
					<div class="table_main_tr_adv">
						<s:include value="/project/general/application/apply/search.jsp"/>
					</div>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
							<tr class="table_main_tr2">
								...
								<s:if test = "#session.loginer.currentType.compareTo(@csdc.tool.bean.AccountType@EXPERT)<0">
									<td width="58"><sec:authorize ifAllGranted="ROLE_PROJECT_GENERAL_APPLICATION_APPLY_ADD"><input class="btn1" type="button" id="list_add_result" value="<s:text name='i18n_AddResult' />" /></sec:authorize></td>
								</s:if>
								<s:else>
									<td width="58"><sec:authorize ifAllGranted="ROLE_PROJECT_GENERAL_APPLICATION_APPLY_ADD"><input class="btn1" type="button" id="list_add" value="<s:text name='i18n_Apply' />" /></sec:authorize></td>
								...
								<sec:authorize ifAllGranted="ROLE_PROJECT_GENERAL_APPLICATION_APPLY_PUBLISH">
								...
								<td width="70"><sec:authorize ifAllGranted="ROLE_PROJECT_GENERAL_APPLICATION_APPLY_CHECK"><input class="btn2" type="button" id="list_check" value="<s:text name='申报核算' />" /></sec:authorize></td>
							</tr>
						</table>
					</textarea>
					<s:form id="list" theme="simple" action="delete" namespace="/project/general/application/apply">
			...
			<script type="text/javascript">
				seajs.use('javascript/project/general/application/apply/list.js', function(list) {
					list.init();
				});
			</script>
		</body>
