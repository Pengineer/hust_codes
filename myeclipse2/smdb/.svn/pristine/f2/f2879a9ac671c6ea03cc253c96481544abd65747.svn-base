...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body >
				...
				<s:form id="end_review_audit">
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						<tr class="table_tr2">
							...
							<td class="table_td12"><s:radio name="reviewAuditResultEnd" cssClass="j_showNumber" theme="simple" list="#{'2':getText('同意'),'1':getText('不同意')}" /></td>
							<td class="table_td13" width="100"></td>
						</tr>
						<s:if test="isApplyNoevaluation == 1">
							<tr class="table_tr2">
								<td class="table_td11"><span class="table_title5">免鉴定结果：</span></td>
								<td class="table_td12"><s:radio name="reviewAuditResultNoevalu" theme="simple" list="#{'2':getText('同意'),'1':getText('不同意')}" /></td>
						...
						<s:if test ="isApplyExcellent == 1">
							<tr class="table_tr2">
								...
								<td class="table_td12"><s:radio name="reviewAuditResultExcelle" theme="simple" list="#{'2':getText('同意'),'1':getText('不同意')}" /></td>
								<td class="table_td13"></td>
							</tr>
						</s:if>
			...
			<script type="text/javascript">
				seajs.use('javascript/project/post/endinspection/review/audit.js', function(audit) {
					audit.init();
				});
			</script>
		</body>
