...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			...
			<div class="main">
				<s:form id="application_form" action="modifyResult" namespace="/project/post/application/apply">
					...
					<div id="info" style="display:none">
						...
						<div class="main_content">
							...
							<s:include value="/project/post/application/apply/editGrantedTab.jsp" />
