			...
			<div style="width:480px;">
				...
				<s:form id="graFile">
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						<tr class="table_tr2">
							<td class="table_td11" width="100"><span class="table_title6"><s:text name='上传立项计划书' />：</span></td>
							<td class="table_td12">
						...
						<tr class="table_tr2">
							...
							<td class="table_td3">
								<input type="button" id="addGrantedFeeApply" class="btn1 select_btn" value="<s:text name="添加" />" />
