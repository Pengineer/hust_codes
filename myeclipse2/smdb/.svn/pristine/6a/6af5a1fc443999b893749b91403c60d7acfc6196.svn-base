...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			<div class="login_box">
				...
				<s:form id="retrievePassword" action="retrievePassword" namespace="/selfspace" theme="simple">
					<div class="login_input_box">
						<div class="login_input_area">
							<div class="login_find_pw_title">找回密码</div>
							<div class="login_find_pw_txt login_reset_pw">
								<ul>
									<li><span class="pw_title">用户名</span><span><s:textfield cssClass="login_input" name="accountname" /></span><span class="pw_error"></span></li>
									<li><span class="pw_title">邮箱</span><span><s:textfield cssClass="login_input" name="email" /></span><span class="pw_error"></span></li>
								</ul>
							</div>
