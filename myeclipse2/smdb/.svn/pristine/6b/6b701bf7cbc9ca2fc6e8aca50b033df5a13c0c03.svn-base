			...
			<div class="p_box_body">
				<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
					...
					<tr class="table_tr4">
						...
						<td width="%50">
							{if awardApplication.deptInstAuditStatus != 0 || awardApplication.isImported == 1}
					...
					<s:if test="#session.loginer.currentType.compareTo(@csdc.tool.bean.AccountType@DEPARTMENT)<0"><!-- 校级及以上管理人员 -->
						<tr class="table_tr4">
							...
							<td width="%50">
								{if awardApplication.universityAuditStatus != 0 || awardApplication.isImported == 1}
					...
					{if universityType == 4}<!-- 地方高校 -->
						<s:if test="#session.loginer.currentType.compareTo(@csdc.tool.bean.AccountType@MINISTRY_UNIVERSITY)<0"><!-- 省厅及以上管理人员 -->
							<tr class="table_tr4">
								...
								<td width="%50">
									{if awardApplication.provinceAuditStatus != 0 || awardApplication.isImported == 1}
					...
					<s:if test="#session.loginer.currentType.compareTo(@csdc.tool.bean.AccountType@PROVINCE)<0"><!-- 部级及以上管理人员 -->
						<tr class="table_tr4">
							...
							<td width="%50">
								{if awardApplication.ministryAuditStatus != 0 || awardApplication.isImported == 1}
