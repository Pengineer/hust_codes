...
<html xmlns="http://www.w3.org/1999/xhtml">
	<s:i18n name="csdc.resources.i18n_Project">
		...
		<body>
			<div class="link_bar">
				<s:text name="i18n_CurrentPosition" />：<s:text name="i18n_ProjectData" />&nbsp;&gt;&nbsp;<s:text name="i18n_GeneralProject" />&nbsp;&gt;&nbsp;<s:text name="i18n_EndinspectionData" />
			</div>
			
			<div class="main">
				<div class="main_content">
					<div class="table_main_tr_adv">
						<s:include value="/project/general/endinspection/apply/search.jsp"/>
					</div>
					<textarea id="list_template" style="display:none;">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
							<tr class="table_main_tr2">
								...
								<sec:authorize ifAllGranted="ROLE_PROJECT_GENERAL_ENDINSPECTION_APPLY_PUBLISH">
			...
			<script type="text/javascript">
				seajs.use('javascript/project/general/endinspection/apply/list.js', function(list) {
					list.init();
				});
			</script>
		</body>
