				...
				<div class="title_bar">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td class="title_bar_td"><s:property value="appAuditPerson"/></td>
							<td class="title_bar_td" width="30" align="right"><img src="image/ico08.gif" width="5" height="9" /></td>
							<td class="title_bar_td" width="64" align="right"><s:text name='i18n_AuditDate' />：</td>
							<td class="title_bar_td" width="120"><s:date name="appAuditDate" format="yyyy-MM-dd HH:mm:ss" /></td>
						</tr>
						<tr>
							<td class="title_bar_td" width="30" align="right"><img src="image/ico08.gif" width="5" height="9" /></td>
							<td class="title_bar_td" align="right"><s:text name='i18n_AuditResult' />：</td>
							<td class="title_bar_td" colspan="4">
								<s:if test="appAuditResult==2"><s:text name='i18n_Approve' /></s:if>
								<s:elseif test="appAuditResult==1"><s:text name='i18n_NotApprove' /></s:elseif>
							</td>
						</tr>
						<s:if test="appAuditOpinion != null && appAuditOpinion != ''">
						<tr>
							<td class="title_bar_td" width="30" align="right"><img src="image/ico08.gif" width="5" height="9" /></td>
							<td class="title_bar_td" align="right"><s:text name="i18n_AuditOpinion" />：</td>
							<td class="title_bar_td" colspan="4">
								<pre><s:property value="appAuditOpinion"/></pre>
							</td>
						</tr>
						</s:if>
					</table>
