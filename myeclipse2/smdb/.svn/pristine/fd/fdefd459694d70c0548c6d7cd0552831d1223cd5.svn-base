	...
	<s:i18n name="csdc.resources.i18n_Project">
		...
		<body>
			...
			<div class="btn_div_view">
				<input id="save" class="btn1 j_submitOrSaveAddEndReviewResult" data="2" type="button" value="<s:text name='i18n_Save' />" />
				<input id="submit" class="btn1 j_submitOrSaveAddEndReviewResult" data="3" type="button" value="<s:text name='i18n_Submit' />" />
			...
			<script type="text/javascript">
				...
				seajs.use(['javascript/project/entrust/endinspection/review/edit_result.js','javascript/project/project_share/endinspection/review/validate_result.js'], function(editResult, validate) {
					validate.valid();
					editResult.init();
				});
			</script>
