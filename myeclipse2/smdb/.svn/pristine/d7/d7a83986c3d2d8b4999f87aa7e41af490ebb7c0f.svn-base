...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div style="width:750px;">
							...
							<s:iterator value="reviews" status="stat">
								<table class="table_valid" width="100%" border="0" cellspacing="2" cellpadding="0">
									<s:if test="#session.loginer.currentType.equals(@csdc.tool.bean.AccountType@MINISTRY)">
										...
										<tr class="table_tr2">
											<td class="table_td8"><span class="table_title11">主要创新和学术价值（满分20分）：</span></td>
										...
										<tr class="table_tr2">
											...
											<td class="table_td9"><s:textfield name="%{'reviews['+#stat.index+'].methodScore'}" cssClass="cal_score input_css" /></td>
											<td class="table_td10"></td>
										</tr>
										<tr class="table_tr2">
											<td class="table_td8"><span class="table_title11">研究内容意义和前沿性（满分30分）：</span></td>
											<td class="table_td9"><s:textfield name="%{'reviews['+#stat.index+'].meaningScore'}" cssClass="cal_score input_css" /></td>
											<td class="table_td10"></td>
										</tr>
										<tr class="table_tr2">
											<td class="table_td8"><span class="table_title11">学术影响或效益方法（满分30分）：</span></td>
											<td class="table_td9"><s:textfield name="%{'reviews['+#stat.index+'].influenceScore'}" cssClass="cal_score input_css" /></td>
											<td class="table_td10"></td>
										</tr>
										<tr class="table_tr2">
			...
			<table id="table_review" width="100%" border="0" cellspacing="0" cellpadding="0" style="display:none;">
				<s:if test="#session.loginer.currentType.equals(@csdc.tool.bean.AccountType@MINISTRY)">
					...
					<tr class="table_tr2">
						<td class="table_td8"><span class="table_title11">研究方法和学术规范（满分20分）：</span></td>
						<td class="table_td9"><s:textfield name="reviews[].methodScore" cssClass="cal_score input_css" /></td>
						<td class="table_td10"></td>
					</tr>
					<tr class="table_tr2">
						<td class="table_td8"><span class="table_title11">研究内容意义和前沿性（满分30分）：</span></td>
						<td class="table_td9"><s:textfield name="reviews[].meaningScore" cssClass="cal_score input_css" /></td>
						<td class="table_td10"></td>
					</tr>
					<tr class="table_tr2">
						<td class="table_td8"><span class="table_title11">学术影响或效益方法（满分30分）：</span></td>
						<td class="table_td9"><s:textfield name="reviews[].influenceScore" cssClass="cal_score input_css" /></td>
						<td class="table_td10"></td>
					</tr>
					<tr class="table_tr2">
						<td class="table_td8"><span>总分：<br></span></td>
		...
		<div class="btn_div_view">
			<input id="save" class="btn1 j_saveModifyReviewResult" type="button" value="保存"/>
			<input id="submit" class="btn1 j_submitModifyReviewResult" type="button" value="提交"/>
			<input id="cancel" class="btn1" type="button" value="取消" />
		</div>
		<script type="text/javascript">
			seajs.use('javascript/award/moesocial/application/review/edit_result.js', function(edit) {
				edit.init();
				edit.initClick();
			});
