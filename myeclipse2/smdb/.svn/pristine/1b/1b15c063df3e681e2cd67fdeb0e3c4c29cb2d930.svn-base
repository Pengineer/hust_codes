...
<div class="edit_info" id="granted">
	...
	<table width="100%" border="0" cellspacing="2" cellpadding="2">
		...
		<tr class="table_tr2">
			...
			<td class="table_td3"><s:select cssClass="select" name="subtypeId" headerKey="-1" headerValue="--%{getText('i18n_PleaseSelect')}--" list="%{baseService.getSystemOptionMap('projectType', '01')}" /></td>
