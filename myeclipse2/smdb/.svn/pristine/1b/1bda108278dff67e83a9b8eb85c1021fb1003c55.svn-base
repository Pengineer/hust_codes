 ...
 * @author 雷达
 */
public class MDXQuery implements java.io.Serializable {
	private static final long serialVersionUID = 1L;
	
	private String id;
	private String title;//查询标题
	private String description;//查询描述
	private String mdx;//MDX语句
	private String type;//所属类别
	private Integer year;//年度
	private Date date;//发布时间
	private String chartConfig;//图表显示配置
	private String chartJson; //图表json
	private int isHomeShow;//是否首页显示
