						...
						<tr class="table_tr2">
							...
							<td class="table_td31">
								<table width="100%" border="0" cellspacing="0" cellpadding="2" style="border: 1px solid rgb(170, 170, 170);padding-bottom:5px;">
									<tr>
										<td style="width:10%;">
											<input type="checkbox" class="selected" name="statistic_data" value="[Measures].[申报数]"/>
											<span>申报项目数量</span>
										</td>
										<td style="width:10%;">
										...
										<td style="width:10%;">
											<input type="checkbox" class="selected" name="statistic_data" value="[Measures].[中检通过数]" />
											<span>中检通过数</span>
										</td>
										<td style="width:10%;">
											<input type="checkbox" class="selected" name="statistic_data" value="[Measures].[中检通过率]" />
											<span>中检通过率</span>
										</td>
										<td style="width:10%;">
							...
							<td class="table_td31">
								<table width="100%" border="0" cellspacing="0" cellpadding="2" style="border: 1px solid rgb(170, 170, 170);padding-bottom:5px;">
									...
									<tr>
										...
										<td>
											<div id="projectTypeShow" style="display: none;"><s:select cssClass="select" id="statistic_projectType" name="statistic_projectType" list="#{'':'--请选择--', '一般项目':'一般项目', '重大攻关项目':'重大攻关项目', '基地项目':'基地项目', '后期资助项目':'后期资助项目', '应急委托课题':'应急委托课题'}"/></div>
										</td>
									</tr>
									<tr>
										<td style="width:20%;">
										...
										<td>
											<div id="subTypeShow" style="display: none;"><s:select cssClass="select" id="statistic_subType" name="statistic_subType" list="#{'':'--请选择--', '青年基金项目':'青年基金项目', '规划基金项目':'规划基金项目', '自筹经费项目':'自筹经费项目', '专项任务项目':'专项任务项目'}"/></div>
										</td>
									</tr>
									<tr>
										<td style="width:20%;">
									...
									<tr>
										...
										<td>
											<div id="universityOrganizerShow" style="display: none;"><s:select id="statistic_universityOrganizer" name="statistic_universityOrganizer" headerKey="" headerValue="--%{getText('请选择')}--" list="%{statisticService.getUniversityOrganizer()}" /></div>
										</td>
									</tr>
									<tr>
										<td style="width:20%;">
