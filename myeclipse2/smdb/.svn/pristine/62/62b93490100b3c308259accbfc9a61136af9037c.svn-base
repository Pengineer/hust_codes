	...
	<s:i18n name="csdc.resources.i18n_Project">
		<head>
			...
			<script type="text/javascript">
					seajs.use(['javascript/fundList/key/end/view.js',
		...
		<body>
			<div class="link_bar" >
				<s:text name="i18n_CurrentPosition" />：<s:text name="研究项目经费数据" />&nbsp;&gt;&nbsp;<s:text name="重大攻关项目" />&nbsp;&gt;&nbsp;<s:text name="结项拨款清单查看" />
			</div>
			...
			<div class="main">
				...
				<div class="main_content">
					...
					<div class="main_content">
						...
						<div class="p_box">
							<div id="forProject">
								<s:include value="/fundList/key/end/projectView.jsp" />
							</div>
							<div id="forUnit">
