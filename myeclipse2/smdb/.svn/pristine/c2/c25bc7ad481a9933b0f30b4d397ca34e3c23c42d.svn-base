...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
						...
						<div>
							<table width="100%" border="0" cellspacing="2" cellpadding="0">
								<tr class="table_tr2">
									...
									<td class="table_td9"><s:radio name="reviewWay" list="#{'1':getText('通讯评审'),'2':getText('会议评审')}"/></td>
									<td class="table_td10" width="90"></td>
								</tr>
								<tr class="table_tr2">
			...
			<div class="btn_div_view">
				<input id="save" class="btn1 j_modifyResultSave" type="button" value="保存" onclick="submitOrSaveModifyAppReviewResult(2);" />
				<input id="submit" class="btn1 j_modifyResultSubmit" type="button" value="提交" onclick="submitOrSaveModifyAppReviewResult(3);" />
			...
			<script type="text/javascript">
				...
				seajs.use(['javascript/project/post/application/review/edit_result.js','javascript/project/project_share/application/review/validate_result.js'], function(editResult, validate) {
					validate.valid();
					editResult.init();
				});
			</script>
