 ...
 * @author 龚凡
 */
public class ProvinceGroupAction extends BaseAction {
	...
	private static final String PAGE_NAME = "selectProvinceGroupPage";// 列表页面名称
	private static final String DATE_FORMAT = "yyyy-MM-dd";// 列表时间格式
	private static final String PAGE_BUFFER_ID = "a.id";// 上下条查看时用于查找缓存的字段

	public String pageName() {
		return ProvinceGroupAction.PAGE_NAME;
	}
	public String[] column() {
		return ProvinceGroupAction.COLUMN;
	}
	public String dateFormat() {
		return ProvinceGroupAction.DATE_FORMAT;
	}
	public String pageBufferId() {
		return ProvinceGroupAction.PAGE_BUFFER_ID;
	}
