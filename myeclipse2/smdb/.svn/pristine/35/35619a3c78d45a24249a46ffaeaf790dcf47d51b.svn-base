		...
		<body>
			<div style="width:450px;">
				<s:form id="end_review_group">
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						<tr class="table_tr2">
							...
							<td class="table_td12"><s:radio name="reviewWay" list="#{'1':getText('通讯鉴定'),'2':getText('会议鉴定')}"/></td>
				...
				<div class="btn_div_view">
					<input id="save" class="btn1 j_submitOrSaveModifyEndGroupReview" data="2" type="button" value="保存" >
					<input id="submit" class="btn1 j_submitOrSaveModifyEndGroupReview" data="3" type="button" value="提交" />
