...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			...
			<div class="main">
				<div class="main_content">
					<div class="table_main_tr_adv">
						<s:include value="/security/account/expert/search.jsp"/>
					</div>
					...
					<textarea id="list_template" style="display:none;">
						<table id="list_table" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
							<thead id="list_head">
								...
								<sec:authorize ifAnyGranted="ROLE_SECURITY_ACCOUNT_EXPERT_DELETE,ROLE_SECURITY_ACCOUNT_EXPERT_STATUS,ROLE_SECURITY_ACCOUNT_ASSIGNROLE">
			...
			<script type="text/javascript">
				seajs.use('javascript/security/account/expert/list.js', function(list) {
					$(function(){
						list.init();
					})
				});
