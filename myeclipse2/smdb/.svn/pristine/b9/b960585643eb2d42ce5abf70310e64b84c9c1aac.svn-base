...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			...
			<s:form id="topicSelection_form" action="addResult" namespace="/project/key/topicSelection/apply">
					...
					<div class="main_content">
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="0">
							...
							<tr class="table_tr2">
								...
								<td class="table_td3">
									<s:select cssClass="select" name="topicSelection.topicSource" headerKey="-1" headerValue="--%{getText('请选择')}--"
							...
							<tr class="table_tr2 university" style="display:none;">
								...
								<td class="table_td3">
									<div name="selectUniDiv">
										...
										<div name="universityNameDiv" class="choose_show"><s:property value="topicSelection.university.name"/></div>
							...
							<tr class="table_tr2 applicant_valid" style="display:none;">
								...
								<td class="table_td3">
									<s:select cssClass="select" name="topicSelection.applicantType" headerKey='-1' headerValue="--%{getText('请选择')}--" list="#{'1':getText('教师'),'2':getText('外部专家')}" />
								</td>
								<td class="table_td4"></td>
							</tr>
							<tr class="table_tr2 applicant_valid" style="display:none;">
							...
							<tr class="table_tr2 applicant_valid" style="display:none;">
								<td class="table_td2"><span>所在单位与部门：</span></td>
								<td class="table_td3">
									<div name="applicantUnitDiv" class="unit_show"><s:property value="topicSelection.expAgencyName"/>&nbsp;<s:property value="topicSelection.expDivisionName}"/></div>
								</td>
								<td class="table_td4"></td>
							</tr>
							<tr class="table_tr2">
							...
							<tr class="table_tr2">
								...
								<td class="table_td3"><s:radio name="topsResult" theme="simple" list="#{'2':getText('同意'),'1':getText('不同意')}"/></td>
								<td class="table_td4"></td>
							</tr>
							<tr class="table_tr2">
