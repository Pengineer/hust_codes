					...
					<textarea id="list_template" style="display:none;">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
							<tr class="table_main_tr2">
								...
								<s:else>
									<td width="58" align="center"><sec:authorize ifAllGranted="ROLE_PROJECT_KEY_TOPIC_SELECTION_APPLY_ADD"><input class="btn1" type="button" id="list_add" value="申报" /></sec:authorize></td>
