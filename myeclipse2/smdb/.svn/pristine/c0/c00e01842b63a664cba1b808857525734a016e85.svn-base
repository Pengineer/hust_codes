define(function(require, exports, module) {
	...
	exports.init = function() {
		...
		$(".j_editSave").live('click',function(){
			editVariation.submitOrNotApply(2, projectType);
		});
		$(".j_editSubmit").live('click',function(){
			editVariation.submitOrNotApply(3, projectType);
		});
		...
		$(".j_addResultSave").live('click',function(){
			editVariation.addVarResult(2, 1, projectType);
		});
		$(".j_addResultSubmit").live('click',function(){
			editVariation.addVarResult(3, 1, projectType);
		});
		$(".j_modifyResultSave").live('click',function(){
			editVariation.addVarResult(2, 2, projectType);
		});
		$(".j_modifyResultSubmit").live('click',function(){
			editVariation.addVarResult(3, 2, projectType);
		});
...
//		window.showResultDetail = function(data){editVariation.showResultDetail(data)};
		...
		$("#addVarFee").live("click",function() {
			popAddVarFee({
				title : "添加经费预算变更明细",
				src : "project/entrust/variation/apply/toAddVarFee.action?projectid=" + $("#projectid").val() + "&feeNote=" + $("#feeNote").val() + 
