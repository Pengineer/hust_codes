...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>合并部级管理人员</title>
		<s:include value="/innerBase.jsp" />
	</head>

	<body>
		<div class="link_bar">
			当前位置：社科人员数据&nbsp;&gt;&nbsp;社科管理人员&nbsp;&gt;&nbsp;部级管理人员&nbsp;&gt;&nbsp;合并
		</div>

		<div class="main">
			<s:form id="form_person" action="merge" namespace="/person/ministryOfficer">
				...
				<div id="account_choose">
					...
					<tbody>
						<tr class="table_tr2">
							...
							<td class="table_td3"><s:select  id="account_select" cssClass="select" name="selectedAccountId"  list="%{personService.getOptionalPassportNames(checkedIds,1)}"  headerKey="" headerValue="--请选择--" value="2" /></td>
				...
				<div id="info" style="display:none">
					<div class="main_content">
						<div id="procedure" class="step_css">
							<ul>
								...
								<li class="proc" name="ministry_officer_affiliation"><span class="left_step"></span><span class="right_step">任职信息</span></li>
					...
					<div class="main_content">
						...
						<s:include value="/person/edit_ministry_officer_affiliation.jsp" />
			...
			<div id="optr" class="btn_bar2">
				<input id="prev" class="btn_step btn2" type="button" value="上一步" />
				<input id="next" class="btn_step btn2" type="button" value="下一步" />
				<input id="finish" class="btn_step btn1" type="button" value="完成" />
				<input id="cancel" class="btn_step btn1" type="button" value="取消" />
			</div>
		</div>
		<script type="text/javascript">
			seajs.use('javascript/person/officer/ministry/modify.js', function(modify) {
				$(function(){
					modify.init();
				});
			});
			seajs.use('javascript/person/officer/merge.js', function(merge) {
				$(function(){
					merge.init("person/ministryOfficer");
				});
			});
		</script>
	</body>
