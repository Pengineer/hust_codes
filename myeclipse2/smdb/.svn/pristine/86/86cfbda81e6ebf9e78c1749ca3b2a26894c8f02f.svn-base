			...
			<tr class="table_main_tr">
				<td align="right">
					<span class="choose_bar">
						...
						list="#{'1':getText('成果名称'),'2':getText('申请人'),'3':getText('依托高校'),'4':getText('学科门类'),'5':getText('成果类型'),'7':getText('获奖等级'),'8':getText('获奖年度')}"/></span>
		...
		<div class="adv_content">
			...
			<table class="adv_table" width="100%" border="0" cellspacing="2" cellpadding="0">
				<tr class="adv_tr">
					...
					<td class="adv_td1" width="205"><s:select cssClass="select" name="ptype" value="%{searchQuery.ptype}" headerKey="-1" headerValue="--%{getText('不限')}--" list="%{baseService.getSystemOptionMapAsName('productType', null)}"/></td>
					<td class="adv_td1"></td>
				</tr>
				<tr class="adv_tr">
				...
				<tr class="adv_tr">
					...
					<td class="adv_td1">
						<s:select cssClass="select" name="year1" value="%{searchQuery.year1}" list="%{awardService.getYearMap()}" headerKey="-1" headerValue="--%{getText('不限')}--" />
						至
						<s:select cssClass="select" name="year2" value="%{searchQuery.year2}" list="%{awardService.getYearMap()}" headerKey="-1" headerValue="--%{getText('不限')}--" />
					</td>
					<td class="adv_td1"></td>
				</tr>
				</tr>
