...
<textarea id="view_award" style="display:none;">
	<div class="p_box_body">
		<table id="list_award" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_statistic">
			<thead id="list_head">
				<tr class="first">
					<td width="30%" style = "text-align:center;"><s:text name="奖励名称" /></td>
					<td width="30%" style = "text-align:center;"><s:text name="奖励类型" /></td>
					<td width="20%" style = "text-align:center;"><s:text name="获奖届次" /></td>
					<td style = "text-align:center;"><s:text name="获奖状态" /></td>
				</tr>
			</thead>
			<tbody>
			{if awardList != null}
