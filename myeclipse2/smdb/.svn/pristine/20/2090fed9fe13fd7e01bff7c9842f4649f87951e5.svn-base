...
define(function(require, exports, module) {
	var fundListGeneralEnd = require('javascript/fundList/list');
	var nameSpace = "fundList/general/end";
	var projectType = "general";
//	var modifyGenenralFee = require('javascript/projectFee/popModifyFee');
	
	exports.init = function() {
		fundListGeneralEnd.init(nameSpace);//公共部分
		fundListGeneralEnd.graExport(nameSpace);
