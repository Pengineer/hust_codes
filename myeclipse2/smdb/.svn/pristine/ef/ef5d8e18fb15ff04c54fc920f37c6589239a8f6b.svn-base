			...
			<div style="width:400px;">
				<s:form id="ann_result">
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						<tr class="table_tr2">
							<td class="table_td11"><span><s:text name='i18n_UploadAnnApply' />：</span></td>
							<td class="table_td12">
								<input type="file" id="file_${annId}" />
						...
						<tr class="table_tr2">
							...
							<td class="table_td3">
								<input type="button" id="modifyAnnFee" class="btn1 select_btn" value="<s:text name="修改" />" />
