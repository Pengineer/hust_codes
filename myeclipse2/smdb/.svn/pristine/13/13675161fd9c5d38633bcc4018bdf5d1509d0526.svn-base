					...
					<s:form id="end_result">
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="0">
							...
							<tr class="table_tr2">
								...
								<td class="table_td12"><s:radio cssClass="j_showNoEval" name="isApplyNoevaluation" theme="simple" list="#{'1':getText('是'),'0':getText('否')}" /></td>
							...
							<tr class="table_tr2">
								...
								<td class="table_td12"><s:radio cssClass="j_showExcellect" name="isApplyExcellent" theme="simple" list="#{'1':getText('是'),'0':getText('否')}" /></td>
								<td class="table_td13"></td>
							</tr>
							<tr class="table_tr2" id="excellect_info" style="display:none;">
								<td class="table_td11"><span class="table_title6">优秀成果结果：</span></td>
								<td class="table_td12"><s:radio name="endExcellentResult" theme="simple" list="#{'2':getText('同意'),'1':getText('不同意'),'0':getText('待定')}"/></td>
								<td class="table_td13"></td>
							</tr>
							<tr class="table_tr2">
							...
							<tr class="table_tr2">
								...
								<td class="table_td12"><s:radio name="endResult" cssClass="j_showNumber" theme="simple" list="#{'2':getText('同意'),'1':getText('不同意')}" /></td>
								<td class="table_td13"></td>
							</tr>
