...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			...
			<div class="main">
				<div class="main_content">
					<div class="table_main_tr_adv">
						<s:include value="/project/post/endinspection/review/search.jsp"/>
					</div>
						...
						<table id="list_table" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
							<thead id="list_head">
								<tr class="table_title_tr">
									...
									<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
									<td width="52"><a id="sortcolumn6" href="" class="{if sortColumn == 6}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按鉴定状态排序">鉴定状态</a></td>
									<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
									<td width="64"><a id="sortcolumn7" href="" class="{if sortColumn == 7}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按鉴定时间排序">鉴定时间</a></td>
									<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
									<td width="51"><a id="sortcolumn9" href="" class="{if sortColumn == 9}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按小组鉴定状态排序">小组鉴定状态</a></td>
									<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
								...
								<tr>
									...
									<td>
										{if item.laData[13]!=null && item.laData[13]!=""}
											<a id="${item.laData[14]}" name="${item.laData[13]}"  class="download_post_3" href="">
					...
					<s:form id="list" theme="simple" action="" namespace="/project/post/endinspection/review">
			...
			<script type="text/javascript">
				seajs.use('javascript/project/post/endinspection/review/list.js', function(list) {
					$(function(){
						list.init();
					})
				});
