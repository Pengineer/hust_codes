				...
				<td align="right"><span class="choose_bar">
					<s:if test="!#session.loginer.currentType.within(@csdc.tool.bean.AccountType@MINISTRY_UNIVERSITY, @csdc.tool.bean.AccountType@INSTITUTE)">
						<s:select cssClass="select" name="searchType" value="%{searchQuery.searchType}" headerKey="-1" headerValue="--%{getText('i18n_NoLimit')}--"
							list="#{'1':getText('i18n_ProjectNumber'),'2':getText('i18n_ProjectName'),'3':getText('i18n_Director'),'4':getText('i18n_University'),'5':getText('i18n_IssueType'),'6':getText('i18n_DisciplineType'),'7':getText('i18n_ProjectYear')}" />
					</s:if>
					<s:else>
						<s:select cssClass="select" name="searchType" value="%{searchQuery.searchType}" headerKey="-1" headerValue="--%{getText('i18n_NoLimit')}--"
							list="#{'1':getText('i18n_ProjectNumber'),'2':getText('i18n_ProjectName'),'3':getText('i18n_Director'),'5':getText('i18n_IssueType'),'6':getText('i18n_DisciplineType'),'7':getText('i18n_ProjectYear')}" />
					</s:else>
