...
<div class="main">
	<div class="main_content">
		...
		<table width="100%" border="0" cellspacing="2" cellpadding="0">
			...
			<tr class="table_tr2">
				<td class="table_td2"><s:text name="电话" />：</td>
			...
			<tr class="table_tr2">
				...
				<td class="table_td3"><s:radio name="message.isOpen" value="%{message.isOpen}" list="#{'1':getText('是'),'0':getText('否')}" cssClass="input_css_radio" /></td>
				<td class="table_td4"></td>
			</tr>
			<tr class="table_tr2">
				<td class="table_td2"><span class="table_title2">是否匿名：</span></td>
				<td class="table_td3"><s:radio name="anonymous" list="#{'1':getText('是'),'0':getText('否')}" cssClass="input_css_radio" /></td>
				<td class="table_td4"></td>
			</tr>
