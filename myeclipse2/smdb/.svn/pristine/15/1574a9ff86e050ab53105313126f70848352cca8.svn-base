					...
					<div class="title_bar">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
								...
								<td class="title_bar_td">${otherProduct.englishName}</td>
							</tr>
						</table>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="title_bar_td" width="200">
									{if otherProduct.orgName != null}
										<a id="${otherProduct.id}" class="view_organization" href="">${otherProduct.orgName}</a>
									{elseif authorid != null}
										<a id="${authorid}" class="view_author" href="">${otherProduct.authorName}</a>
									{else}
										${otherProduct.authorName}
									{/if}
								</td>
								...
								<td class="title_bar_td" colspan="3">${otherProduct.otherAuthorName}</td>
							</tr>
							<tr>
								<td class="title_bar_td" align="right"><img src="image/ico08.gif" width="5" height="9"/></td>
								...
								<td class="title_bar_td" colspan="3">${otherProduct.divisionName}</td>
							</tr>
							<tr>
								<td class="title_bar_td" align="right"><img src="image/ico08.gif" width="5" height="9"/></td>
								<td class="title_bar_td" align="right">审核状态：</td>
								<td class="title_bar_td" >
									{if otherProduct.auditStatus==0}待审
									{else}已审
						   			{/if} 
						   			<!-- 管理人员均能审核 -->
				...
				<div class="p_box_body">
					<div class="p_box_body_t">
						<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
							<tr class="table_tr7">
								<td class="key" width="120">评价：</td>
								<td class="value" width="200">${otherProduct.evaluation}</td>
								<td class="key" width="120">是否与国（境）外合作：</td>
								<td class="value">{if otherProduct.isForeignCooperation==0 || otherProduct.isForeignCooperation==null}否{else}是{/if}</td>
							</tr>
							<tr class="table_tr7">
								<td class="key">形态：</td>
							...
							<tr class="table_tr7">
								<td class="key">评价：</td>
								<td class="value" colspan="3"><pre>${otherProduct.evaluation}</pre></td>
							</tr>
						</table>
					</div>
				</div>
					...
					<div class="p_box_body_t">
						<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
							<tr class="table_tr7">
								...
								<td class="value" width="200">${otherProduct.publishUnit}</td>
