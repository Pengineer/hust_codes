				...
				<s:form id="resetPassword" action="resetPassword" namespace="/selfspace" theme="simple">
					...
					<div class="login_input_box">
						<div class="login_input_area">
							<div class="login_find_pw_txt"><s:text name="您的邮箱已经成功绑定了！您现在可以使用邮箱登陆本系统。" /></div>
							...
							<input id="cancel" class="login_btn" type="button" value="返回首页" /></div>
						</div>
