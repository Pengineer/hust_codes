	...
	<body >
		<div style="width:450px;">
			<s:form id="award_audit">
				...
				<table width="100%" border="0" cellspacing="2" cellpadding="0">
					<tr class="table_tr2">
						...
						<td class="table_td3"><s:radio cssClass="r_type" name="auditResult" theme="simple" list="#{'2':getText('同意'),'1':getText('不同意')}" /></td>
			...
			<div class="btn_div_view">
				<input id="save" class="btn1 j_saveModifyReviewAudit" type="button" value="保存" />
				<input id="submit" class="btn1 j_submitModifyReviewAudit" type="button" value="提交" />
