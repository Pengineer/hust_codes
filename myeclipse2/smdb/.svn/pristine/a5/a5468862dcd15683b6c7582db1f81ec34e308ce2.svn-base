	...
	<s:i18n name="csdc.resources.i18n_Project">
		<head>
			...
			<script type="text/javascript" >
				seajs.use('javascript/fundList/key/add.js', function(add) {
					add.init();
				});
			</script>
		</head>
			...
			<div style="width:480px;">
				<s:form id="form_addFundList">
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						...
						<tr class="table_tr2">
							<td class="table_td11"><s:text name='i18n_ResearchType'/>：</td>
							<td class="table_td12"><s:select cssClass="select" id="researchType" name="researchType" value="%{searchQuery.researchType}" list="%{baseService.getSystemOptionMap('researchType', '00')}" headerKey="-1" headerValue="--%{getText('i18n_NoLimit')}--" /></td>
							<td class="table_td13"></td>
						</tr>
						<tr class="table_tr2">
