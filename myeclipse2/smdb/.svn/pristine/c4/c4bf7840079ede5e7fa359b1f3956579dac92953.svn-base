					...
					<div class="title_bar">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								{if book.orgName != null}
										<a id="${book.id}" class="view_organization" href="">${book.orgName}</a>
									{elseif authorid != null}
										<a id="${authorid}" class="view_author" href="">${book.authorName}</a>
									{else}
										${book.authorName}
									{/if}
								</td>
								...
								<td class="title_bar_td" colspan="3">${book.otherAuthorName}</td>
							</tr>
							<tr>
								<td class="title_bar_td" align="right"><img src="image/ico08.gif" width="5" height="9"/></td>
								...
								<td class="title_bar_td" colspan="3">${book.divisionName}</td>
							</tr>
							<tr>
								<td class="title_bar_td" align="right"><img src="image/ico08.gif" width="5" height="9"/></td>
								<td class="title_bar_td" align="right">审核状态：</td>
								<td class="title_bar_td" >
									{if book.auditStatus==0}待审
									{else}已审
						   			{/if} 
						   			<!-- 管理人员均能审核 -->
					...
					<div class="p_box_body_t">
						<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
							<tr class="table_tr7">
								...
								<td class="value" width="200">{if book.isTranslation==0}否{elseif book.isTranslation==1}是{/if}</td>
								<td class="key" width="145">是否与国（境）外合作：</td>
								<td class="value">{if book.isForeignCooperation==null || book.iisForeignCooperation==0}否{else}是{/if}</td>
							</tr>
							<tr class="table_tr7">
							...
							<tr class="table_tr7">
								...
								<td class="value">${bookType}
									{if null != bookType && (bookType == '译著' || bookType == '译')}
					...
					<div class="p_box_body_t">
						<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
							<tr class="table_tr7">
								...
								<td class="value" width="200">${book.publishUnit}</td>
