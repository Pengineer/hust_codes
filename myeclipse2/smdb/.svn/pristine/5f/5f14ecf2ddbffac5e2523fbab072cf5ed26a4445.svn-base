...
<%--									<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>--%>
<%--									<td ><a id="sortcolumn8" href="" class="{if sortColumn == 8}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="<s:text name='点击按中检拨款金额排序' />"><s:text name="中检拨款" /></a></td>--%>
				<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
				<td width="70"><a id="sortcolumn9" href="" class="{if sortColumn == 9}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="<s:text name='点击按结项拨款金额排序' />"><s:text name="结项拨款" /></a></td>
			</tr>
		</thead>
		<tbody>
		{for item in root}
...
<%--									{/if}--%>
<%--									<td></td>--%>
<%--									{if item.laData[16]==0}<td style="color:red;">${item.laData[13]}</td>--%>
<%--									{else}<td style="color:green;">${item.laData[13]}</td>--%>
<%--									{/if}--%>
				<td></td>
				<td>
...
<s:form id="list" theme="simple" action="fundListDelete" namespace="/fundList/general/end">
