...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div style="width:450px;">
			...
			<div id="institute" style="height: 237px; overflow-y: scroll; overflow-x: hidden;">
				<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
					<thead id="list_head">
						<tr class="table_title_tr">
							...
							<td width="30">序号</td>
							<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
							<td width="140">研究基地名称</td>
							<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
							<td width="80">研究基地代码</td>
							<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
							<td width="">所属高校</td>
						</tr>
					</thead>
					<tbody>
						...
						<tr>
							...
							<td></td>
							<td class=""><s:property value="#request.list[#stat.index][4]" /></td>
						</tr>
						</s:iterator>
						<tr>
							<td colspan="3">合并后研究基地</td>
							<td></td>
							<td><s:textfield cssStyle="width:130px" id="name" name="name"></s:textfield></td>
							<td></td>
							<td><s:textfield cssStyle="width:72px" id="code" name="code"></s:textfield></td>
							<td></td>
							<td><s:property value="#request.list[0][4]" /></td>
						</tr>
					</tbody>
				</table>
			</div>
		...
		<script type="text/javascript">
			seajs.use('javascript/unit/institute/merge.js', function(merge) {
				merge.init();
			});
		</script>
	</body>
