						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<sec:authorize ifAllGranted="ROLE_BASE_ACCOUNT_SELF_MODIFY">
									<span id="view_mod">[<a href="" title="点击修改通行证"><s:text name='修改通行证' /></a>]</span>
									<span id="view_bind_email">[<a href="" title="点击关联邮箱"><s:text name='绑定邮箱' /></a>]</span>
									<span id="view_bind_phone">[<a href="" title="点击关联手机号"><s:text name='绑定手机' /></a>]</span>
								</sec:authorize>
								</td>
							</tr>
						</table>
