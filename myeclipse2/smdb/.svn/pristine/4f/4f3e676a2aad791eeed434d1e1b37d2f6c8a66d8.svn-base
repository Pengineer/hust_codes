				...
				<div id="account_choose">
					...
					<tbody>
						<tr class="table_tr2">
							...
							<td class="table_td3"><s:select  id="account_select" cssClass="select" name="selectedAccountId"  list="%{personService.getOptionalPassportNames(checkedIds,4)}"  headerKey="" headerValue="--请选择--" value="2" /></td>
