	...
	<body>
		...
		<div class="main">
			<div class="main_content">
				...
				<textarea id="list_template" style="display:none;">
					<table id="list_table" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
						<thead id="list_head">
							<tr class="table_title_tr">
								...
								<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
								<td><a id="sortcolumn2" href="" class="{if sortColumn == 2}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="按所在机构排序">所在机构</a></td>
								<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
						<tr class="table_main_tr2">
							<td width="4"></td>
							<sec:authorize ifAllGranted="ROLE_PERSON_OFFICER_PROVINCE_ADD">
								<td width="58"><input id="list_add" class="btn1" type="button" value="添加" /></td>
							</sec:authorize>
							<sec:authorize ifAllGranted="ROLE_PERSON_OFFICER_PROVINCE_DELETE">
								<td width="58"><input id="list_delete" type="button" class="btn1" value="删除" /></td>
							</sec:authorize>
							<sec:authorize ifAllGranted="ROLE_PERSON_OFFICER_PROVINCE_MERGE">
				...
				<s:form id="list" theme="simple" action="delete" namespace="/person/provinceOfficer">
		...
		<script type="text/javascript">
			seajs.use('javascript/person/officer/province/list.js', function(list) {
				$(function(){
					list.init();
				})
			});
			seajs.use('javascript/person/pop_merge.js', function(merge) {
				$(function(){
					merge.popMergeDialog(1,"person/provinceOfficer");
				})
			});
		</script>
	</body>
