...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div class="link_bar">
			...
			<s:else>
				当前位置：社科成果数据&nbsp;&gt;&nbsp;电子出版物&nbsp;&gt;&nbsp;修改
			</s:else>
		</div>
		
		<div class="main">
			<s:form id="form_product" action="modify" method="post" theme="simple" enctype="multipart/form-data" namespace="/product/electronic">
   				<s:hidden id="accountType" value="%{#session.loginer.currentType}"/>
   				<s:hidden id="addOrModify" value="0"/>
   				<s:hidden name="entityId" value="%{electronic.id}"/>
   				<s:hidden id="submitStatus" name="electronic.submitStatus"/>
				...
				<div  class="main_content" style="margin-top:0px;">
					...
					<div class="edit_info" id="base_info">
						...
						<s:if test="applyType == 0">
							<table width="100%" border="0" cellspacing="2" cellpadding="2" id="personal_info" >
								...
								<s:if test="#session.loginer.currentType.compareTo(@csdc.tool.bean.AccountType@EXPERT)<0">
									<tr class="table_tr2">
										...
										<td class="table_td3">
											...
											<div id="person_per_name_div" class="choose_show"><s:property value="electronic.authorName"/>&nbsp;&nbsp;&nbsp;<s:property value="electronic.agencyName"/>&nbsp;<s:property value="electronic.divisionName"/></div>
								...
								<tr class="table_tr2">
									...
									<td class="table_td3"><s:textfield name="electronic.otherAuthorName" cssClass="input_css"/></td>
									<td class="table_td4"></td>
								</tr>
							</table>
						</s:if>
						...
						<s:else>
							<table width="100%" border="0" cellspacing="2" cellpadding="2" id="team_info">
								...
								<tr class="table_tr2">
									...
									<td class="table_td3"><s:textfield name="electronic.orgName" cssClass="input_css"/></td>
									<td class="table_td4"></td>
								</tr>
								<tr class="table_tr2">
									...
									<td class="table_td3">
										...
										<div id="unit" class="choose_show"><s:property value="electronic.agencyName"/>&nbsp;<s:property value="electronic.orgDivisionName"/></div>
										<s:hidden id="instituteId" name="electronic.institute.id"/>
										<s:hidden id="departmentId" name="electronic.department.id"/>
									</td>
									<td class="table_td4"></td>
								</tr>
								<s:if test="#session.loginer.currentType.compareTo(@csdc.tool.bean.AccountType@EXPERT)<0">
									<tr class="table_tr2">
										...
										<td class="table_td3">
											...
											<div id="team_per_name_div" class="choose_show"><s:property value="author.name"/>&nbsp;&nbsp;<s:property value="electronic.agencyName"/>&nbsp;<s:property value="electronic.divisionName"/></div>
								...
								<tr class="table_tr2">
									...
									<td class="table_td3"><s:textfield name="electronic.orgMember" cssClass="input_css"/>
								...
								<tr class="table_tr2">
									...
									<td class="table_td3">
										...
										<div id="team_disptr" class="choose_show"><s:property value="electronic.orgDiscipline"/></div>
										<s:hidden name="electronic.orgDiscipline" id="team_dispName"/>
									</td>
									<td class="table_td4"></td>
								</tr>
								<tr class="table_tr2">
									<td class="table_td2">办公电话：</td>
									<td class="table_td3"><s:textfield name="electronic.orgOfficePhone" cssClass="input_css"/></td>
									<td class="table_td4"></td>
								</tr>
								<tr class="table_tr2">
									<td class="table_td2">办公地址：</td>
									<td class="table_td3"><s:textfield name="electronic.orgOfficeAddress" cssClass="input_css"/></td>
									<td class="table_td4"></td>
								</tr>
								<tr class="table_tr2">
									<td class="table_td2">办公邮编：</td>
									<td class="table_td3"><s:textfield name="electronic.orgOfficePostcode" cssClass="input_css"/></td>
									<td class="table_td4"></td>
								</tr>
								<tr class="table_tr2">
									<td class="table_td2">办公邮箱：</td>
									<td class="table_td3"><s:textfield name="electronic.orgEmail" cssClass="input_css"/></td>
									<td class="table_td4"></td>
								</tr>
								<tr class="table_tr2">
									<td class="table_td2">手机：</td>
									<td class="table_td3"><s:textfield name="electronic.orgMobilePhone" cssClass="input_css"/></td>
									<td class="table_td4"></td>
								</tr>
							</table>
						</s:else>
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="2">	
							<tr class="table_tr2">
								<td class="table_td2" width="150"><span class="table_title5">出版物类型：</span></td>
								<td class="table_td3">
									<s:select cssClass="select" list="%{baseService.getSystemOptionMap('productType', '04')}" name="electronic.type.id" 
							...
							<tr class="table_tr2">
								...
								<td class="table_td3" id="err_dtype">
									...
									<div id="person_disptr" class="choose_show"><s:property value="electronic.disciplineType"/></div>
									<s:hidden name="electronic.disciplineType" id="person_dispName"/>
								</td>
								<td class="table_td4"></td>
							</tr>
							<tr class="table_tr2">
							...
							<tr class="table_tr2">
								...
								<td class="table_td3" id="err_keyWord"><s:textfield name="electronic.keywords" cssClass="input_css"/>
										<br/><span class="tip">多个以分号（即; 或；）隔开！</span></td>
								<td class="table_td4"></td>
							</tr>
							<tr class="table_tr2">
					...
					<div class="edit_info" id="publication_info">
						<table width="100%" border="0" cellspacing="2" cellpadding="0">
							...
							<tr class="table_tr2">
								...
								<td class="table_td3">
									<s:textfield id="publicationDate" name="electronic.publishDate" cssClass="input_css">
										<s:param name="value">
   		...
   		<script type="text/javascript">
			seajs.use('javascript/product/electronic/edit.js', function(modify) {
				$(function() {					
					modify.init();
				});
			});
