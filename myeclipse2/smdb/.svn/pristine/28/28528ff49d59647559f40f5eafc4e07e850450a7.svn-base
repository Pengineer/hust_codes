		...
		<body>
			<div style="width:450px;">
				...
				<div class="btn_div_view">
					<input id="save" class="btn1 j_submitOrSaveAddEndGroupReview" data="2" type="button" value="<s:text name='i18n_Save' />" />
					<input id="submit" class="btn1 j_submitOrSaveAddEndGroupReview" data="3" type="button" value="<s:text name='i18n_Submit' />" />
