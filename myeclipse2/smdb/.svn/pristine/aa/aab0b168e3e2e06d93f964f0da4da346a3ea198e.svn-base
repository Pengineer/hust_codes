...
define(function(require, exports, module) {
	...
	var downloadfile = function(){
		$(".download_general_3").live("click", function() {
			var validateUrl = "project/general/application/apply/validateFile.action?entityId="+this.id+"&filepath="+this.name;
			var successUrl = "project/general/application/apply/downloadApply.action?entityId="+this.id+"&filepath="+this.name;
