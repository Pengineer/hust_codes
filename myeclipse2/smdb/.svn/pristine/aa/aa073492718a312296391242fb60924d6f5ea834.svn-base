				...
				<s:form id="end_audit">
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						<tr class="table_tr2">
							...
							<td class="table_td12"><s:radio cssClass="r_type j_showOpinionFeedbackOrNot" name="endAuditResult" theme="simple" list="#{'2':getText('i18n_Approve'),'1':getText('i18n_NotApprove')}" /></td>
					...
					<div class="btn_div_view">
						<input id="save" class="btn1 j_modifyEndAudit" data="2" type="button" value="<s:text name='i18n_Save' />"  />
						<input id="submit" class="btn1 j_modifyEndAudit" data="3" type="button" value="<s:text name='i18n_Submit' />" />
<%--						<input id="save" class="btn1" type="button" value="<s:text name='i18n_Save' />" onclick="modifyEndAudit(2, thisPopLayer);" />--%>
<%--						<input id="submit" class="btn1" type="button" value="<s:text name='i18n_Submit' />" onclick="modifyEndAudit(3, thisPopLayer);" />--%>
