	...
	<s:i18n name="csdc.resources.i18n_Project">
		...
		<body>
			<div style="width:400px;">
				<s:form id="mid_result">
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						<tr class="table_tr2">
							<td class="table_td11"><span class="table_title4"><s:text name='i18n_UploadMidApply' />：</span></td>
							<td class="table_td12">
						...
						<tr class="table_tr2">
							<td class="table_td2"><span class="table_title4"><s:text name="中检经费结算" />：</span></td>
							<td class="table_td3">
								<input type="button" id="modifyMidFee" class="btn1 select_btn" value="<s:text name="修改" />" />
						...
						<tr class="table_tr2">
							...
							<td class="table_td12"><s:radio name="midResult" theme="simple" list="#{'2':getText('i18n_Approve'),'1':getText('i18n_NotApprove')}"/></td>
							<td class="table_td13" width="100"></td>
						</tr>
						<tr class="table_tr2">
							<td class="table_td11"><span  class="table_title4"><s:text name="i18n_MidinspectionDate" />：</span></td>
							<td class="table_td12">
			...
			<script type="text/javascript">
				seajs.use(['javascript/project/instp/midinspection/edit.js','javascript/project/project_share/midinspection/validate.js'], function(edit, validate) {
					validate.valid();
					edit.init();
				});
			</script>
