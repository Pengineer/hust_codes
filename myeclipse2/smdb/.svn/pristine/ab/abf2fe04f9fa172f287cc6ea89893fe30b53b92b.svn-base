...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			...
			<s:form id="review_endform" theme="simple">
				...
				<s:hidden id="reviewFlag" name="reviewFlag" />
				...
				<div style="overflow-y:scroll;height:500px; *margin-right:20px; _margin-right:20px;">
					<s:if test="reviewFlag == 2">
						<table width="100%" border="0" cellspacing="2" cellpadding="0">
							<tr class="table_tr2">
								<td class="table_td8" width="200"><span class="table_title11">是否申请优秀成果：</span></td>
								<td class="table_td9"><s:radio name="isApplyExcellent" theme="simple" list="#{'1':getText('是'),'0':getText('否')}" value='2'/></td>
								<td class="table_td10" width="90"></td>
							</tr>
							<tr class="table_tr2">
								<td class="table_td5"><span class="table_title11">结项成果数量：</span></td>
								<td class="table_td6"><input type="button" class="btn1 select_btn j_editProductType" value="编辑" />
							...
							<tr class="table_tr2">
								<td class="table_td5"><span>主要参加人：<br />（不含负责人）</span></td>
								<td class="table_td6"><s:textfield name="endMember" cssClass="input_css"/><br/><span class="tip">多个以分号（即;或；）隔开</span></td>
								<td class="table_td7"></td>
							</tr>
						</table>
					</s:if>
									...
									<s:if test="#session.loginer.currentType.equals(@csdc.tool.bean.AccountType@MINISTRY)"><!-- 部级 -->
										<tr class="table_tr2">
											...
											<td class="table_td9">
												...
												<input type="button" class="down_row btn1" value="下移" />&nbsp;&nbsp;<span class="tip">可拖拽空白区域对成员排序</span>
											</td>
											<td class="table_td10" width="90"></td>
										</tr>
										<tr class="table_tr2">
										...
										<tr class="table_tr2">
											...
											<td class="table_td6"><s:select cssClass="select" name="%{'reviews['+#stat.index+'].qualitativeOpinion'}" list="%{baseService.getSystemOptionMapAsName('reviewOpinionQualitative', null)}" headerKey="-1" headerValue="--%{getText('请选择')}--" /></td>
											<td class="table_td7"></td>
										</tr>
										<tr class="table_tr2">
									...
									<s:else>
										...
										<tr class="table_tr2">
											...
											<td class="table_td17" width="100">
												<s:select cssClass="select" name="%{'reviews['+#stat.index+'].idcardType'}" headerKey="-1" headerValue="--%{getText('请选择')}--" list="#{'身份证':'身份证','军官证':'军官证','护照':'护照'}"/>
											</td>
										...
										<tr class="table_tr2">
											...
											<td class="table_td17">
												<s:select cssClass="select" name="%{'reviews['+#stat.index+'].gender'}" headerKey="-1" headerValue="--%{getText('请选择')}--" list="#application.sexList" />
											</td>
											<td class="table_td10"></td>
										...
										<tr class="table_tr2">
											...
											<td class="table_td17">
												<s:select cssClass="select" name="%{'reviews['+#stat.index+'].divisionType'}" headerKey="-1" headerValue="--%{getText('请选择')}--" list="#{'1':getText('研究基地'),'2':getText('院系'),'3':getText('外部部门')}" />
											</td>
											<td class="table_td10"></td>
										...
										<tr class="table_tr2">
											...
											<td class="table_td9" colspan='4'><s:select cssClass="select" name="%{'reviews['+#stat.index+'].qualitativeOpinion'}" list="%{baseService.getSystemOptionMapAsName('reviewOpinionQualitative', null)}" headerKey="-1" headerValue="--%{getText('请选择')}--" /></td>
											<td class="table_td10"></td>
										</tr>
										<tr class="table_tr2">
					...
					<div class="p_box_t">
						<div class="p_box_t_t">总鉴定信息</div>
						<div class="p_box_t_b"><img class="image" src="image/open.gif" style="display:none;"/><img class="image" src="image/close.gif" /></div>
					</div>
					<div class="totalReview">
						<table width="100%" border="0" cellspacing="2" cellpadding="0">
							<tr class="table_tr2">
								<td class="table_td5" width="200"><span class="table_title11">成果修改定性意见：</span></td>
								<td class="table_td6"><s:select cssClass="select" id="reviewOpinionQualitative" name="reviewOpinionQualitative" list="%{baseService.getSystemOptionMapAsName('reviewOpinionQualitative', null)}" headerKey="-1" headerValue="--%{getText('请选择')}--" /></td>
								<td class="table_td7"  width="90"></td>
							</tr>
							<tr class="table_tr2">
								<td class="table_td5"><span class="table_title11">鉴定时间：</span></td>
								<td class="table_td6">
									<s:textfield name="reviewDate" cssClass="FloraDatepick" readonly="true">
										<s:param name="value">
											<s:date name="reviewDate" format="yyyy-MM-dd" />
										</s:param>
									</s:textfield>
								</td>
								<td class="table_td7"></td>
							...
							<tr class="table_tr2">
								<td class="table_td5"><span class="table_title11">鉴定方式：</span></td>
								<td class="table_td6"><s:radio name="reviewWay" theme="simple" list="#{'1':getText('通讯鉴定'),'2':getText('会议鉴定')}" value='1' disabled='true'/></td>
								<s:hidden name="reviewWay" value="1" />
								<td class="table_td7"></td>
							</tr>
							<tr class="table_tr2">
								<td class="table_td8"><span>总分：<br></span></td>
							...
							<tr class="table_tr2">
								...
								<td class="table_td9"><s:radio cssClass="j_showOpinionFeedbackOrNot" name="reviewResult" theme="simple" list="#{'2':getText('同意'),'1':getText('不同意')}" /></td>
								<td class="table_td10"></td>
							</tr>
							<tr class="table_tr2">
								<td class="table_td8"><span>鉴定意见：<br/>（限2000字）</span></td>
								<td class="table_td9"><s:textarea id="reviewOpinion" name="reviewOpinion" rows="2" cssClass="textarea_css" /></td>
								<td class="table_td10"></td>
							</tr>
							<s:if test="reviewFlag == 2">
								<tr class="table_tr2" id="opinion_feedback" style="display:none;">
								    <td class="table_td8"><span>审核意见：<br />（反馈给负责人）<br/>（限200字）</span></td>
									<td class="table_td9"><s:textarea id="opinion_feedback" name="reviewOpinionFeedback" rows="2" cssClass="textarea_css"  /><br/><span class="warning">此意见将会反馈给该项目负责人，请慎重填写！</span></td>
								    <td class="table_td10"></td>
								</tr>
							</s:if>
						</table>
			...
			<table id="table_review" width="100%" border="0" cellspacing="0" cellpadding="0" style="display:none;">
				<s:if test="#session.loginer.currentType.equals(@csdc.tool.bean.AccountType@MINISTRY)"><!-- 部级 -->
					...
					<tr class="table_tr2">
						<td class="table_td8"><span class="table_title11">成果修改定性意见：</span></td>
						<td class="table_td9"><s:select cssClass="select" name="reviews[].qualitativeOpinion" list="%{baseService.getSystemOptionMapAsName('reviewOpinionQualitative', null)}" headerKey="-1" headerValue="--%{getText('请选择')}--" /></td>
						<td class="table_td10"></td>
					</tr>
					<tr class="table_tr2">
						<td class="table_td8"><span>鉴定意见：<br/>（限2000字）</span></td>
				...
				<s:else>
					...
					<tr class="table_tr2">
						<td class="table_td8" width="110"><span class="table_title4">证件类型：</span></td>
						<td class="table_td17" width="100">
							<s:select cssClass="select" name="reviews[].idcardType" headerKey="-1" headerValue="--%{getText('请选择')}--" list="#{'身份证':'身份证','军官证':'军官证','护照':'护照'}"/>
						</td>
						<td class="table_td10" width="70"></td>
						<td class="table_td8" width="80"><span class="table_title2">证件号：</span></td>
						<td class="table_td18" width="150">
					...
					<tr class="table_tr2">
						<td class="table_td8"><span class="table_title4">性别：</span></td>
						<td class="table_td17">
							<s:select cssClass="select" name="reviews[].gender" headerKey="-1" headerValue="--%{getText('请选择')}--" list="#application.sexList" />
						</td>
						<td class="table_td10"></td>
						<td class="table_td8"><span class="table_title2">所在单位：</span></td>
						<td class="table_td18">
					...
					<tr class="table_tr2">
						<td class="table_td8"><span class="table_title4">部门类别：</span></td>
						<td class="table_td17">
							<s:select cssClass="select" name="reviews[].divisionType" headerKey="-1" headerValue="--%{getText('请选择')}--" list="#{'1':getText('研究基地'),'2':getText('院系'),'3':getText('外部部门')}" />
						</td>
						<td class="table_td10"></td>
						<td class="table_td8"><span class="table_title2">所在部门：</span></td>
						<td class="table_td18">
					...
					<tr class="table_tr2">
						<td class="table_td8"><span class="table_title11">成果修改定性意见：</span></td>
						<td class="table_td9" colspan='4'><s:select cssClass="select" name="reviews[].qualitativeOpinion" list="%{baseService.getSystemOptionMapAsName('reviewOpinionQualitative', null)}" headerKey="-1" headerValue="--%{getText('请选择')}--" /></td>
						<td class="table_td10"></td>
					</tr>
					<tr class="table_tr2">
						<td class="table_td8"><span>鉴定意见：<br/>（限2000字）</span></td>
		...
		<div class="btn_div_view">
			<input id="save" class="btn1 j_submitOrSaveAddEndReviewResult" data="2" type="button" value="保存" />
			<input id="submit" class="btn1 j_submitOrSaveAddEndReviewResult" data="3" type="button" value="提交" />
			...
			<script type="text/javascript">
				...
				seajs.use(['javascript/project/post/endinspection/review/edit_result.js','javascript/project/post/endinspection/review/validate_result.js'], function(editResult, validate) {
					validate.valid();
					editResult.init();
				});
			</script>
