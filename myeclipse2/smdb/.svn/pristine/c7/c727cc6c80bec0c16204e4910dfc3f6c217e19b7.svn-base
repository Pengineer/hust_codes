...
<div id="simple_search"><!-- 初级检索 -->	
	<s:form id="search" theme="simple" action="list" namespace="/person/universityOfficer">
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
			<tr class="table_main_tr">
				<td align="right">
					<span class="choose_bar">
						<s:select cssClass="select" name="searchType" value="%{searchQuery.searchType}"  headerKey="-1" headerValue="--%{getText('不限')}--"  list="#{'0':getText('姓名'),'1':getText('所在高校'),'2':getText('所在部门'),'3':getText('职务')}" />
					</span>
					<s:textfield id="keyword" value="%{searchQuery.keyword}" name="keyword" cssClass="keyword" size="10" />
...
<div id="adv_search" style="display:none;"><!-- 高级检索 -->
	<s:form id="advSearch" action="advSearch" namespace="/person/universityOfficer" theme="simple">
		...
		<div class="main_content">
			...
			<table class="adv_table" width="100%" border="0" cellspacing="2" cellpadding="0">
				...
				<tr class="adv_tr">
					...
					<td class="adv_td2"></td>
					<td class="adv_td2" align="right"><s:text name="工作证号" />：</td>
