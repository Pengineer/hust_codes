				...
				<s:form id="form_dm" action="toPredict" namespace="/dataMining/classification" theme="simple" >
					<table width="100%" border="0" cellspacing="2" cellpadding="2">
						<tr class="table_tr2">
							...
							<td class="table_td3"><s:select cssClass="select" id="predictType" name="predictType" headerKey="-1" headerValue="--%{getText('请选择')}--" list="#{'general_mid':getText('一般项目中检预测'), 'general_end':getText('一般项目结项预测'), 'key_mid':getText('重大攻关项目中检预测'), 'key_end':getText('重大攻关项目结项预测'),
								 'instp_mid':getText('基地项目中检预测'), 'instp_end':getText('基地项目结项预测'), 'post_end':getText('后期资助项目结项预测'), 'entrust_end':getText('应急委托课题结项预测')}"/></td>
