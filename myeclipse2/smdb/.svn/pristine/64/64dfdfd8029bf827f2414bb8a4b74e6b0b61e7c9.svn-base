...
<div class="edit_info main_content" id="student">
	<table width="100%" border="0" cellspacing="2" cellpadding="0">
		...
		<tr class="table_tr2">
			...
			<td class="table_td3"><s:select cssClass="select" name="student.type" headerKey="-1" headerValue="--%{getText('请选择')}--" list="%{baseService.getSystemOptionMapAsName('studentType', null)}" /></td>
			<td class="table_td4"></td>
		</tr>
		<tr class="table_tr2">
			<td class="table_td2"><span class="table_title4">学生状态：</span></td>
			<td class="table_td3"><s:select cssClass="select" name="student.status" headerKey="-1" headerValue="--%{getText('请选择')}--" list="%{baseService.getSystemOptionMapAsName('studentStatus', null)}" /></td>
			<td class="table_td4"></td>
		</tr>
		<tr class="table_tr2">
