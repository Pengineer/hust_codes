		...
		<body>
			<div style="width:480px;">
				<s:form id="var_audit">
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						<tr class="table_tr2">
							...
							<td class="table_td12"><s:radio cssClass="r_type j_showOpinionFeedbackOrNot" name="varAuditResult" theme="simple" list="#{'2':getText('i18n_Approve'),'1':getText('i18n_NotApprove')}" /></td>
				...
				<div class="btn_div_view">
					<input id="save" class="btn1 j_modifyVarAudit" data=2 type="button" value="<s:text name='i18n_Save' />" />
					<input id="submit" class="btn1 j_modifyVarAudit" data=3 type="button" value="<s:text name='i18n_Submit' />" />
