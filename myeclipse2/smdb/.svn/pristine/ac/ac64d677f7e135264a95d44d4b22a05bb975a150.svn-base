...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
						...
						<div>
							<table width="100%" border="0" cellspacing="2" cellpadding="0">
								<tr class="table_tr2">
									...
									<td class="table_td9"><s:radio name="reviewWay" list="#{'1':getText('通讯鉴定'),'2':getText('会议鉴定')}"/></td>
									<td class="table_td10" width="90"></td>
								</tr>
								<tr class="table_tr2">
									<td class="table_td8"><span>总分：<br></span></td>
								...
								<tr class="table_tr2">
									...
									<td class="table_td9"><s:radio name="reviewResult" list="#{'2':getText('同意'),'1':getText('不同意')}"/></td>
									<td class="table_td10"></td>
								</tr>
								<tr class="table_tr2">
									<td class="table_td8"><span class="table_title11">成果修改定性意见：</span></td>
			...
			<script type="text/javascript">
				seajs.use(['javascript/project/key/endinspection/review/edit.js','javascript/project/project_share/endinspection/review/validate.js'], function(edit, validate) {
					validate.valid();
					edit.init();
					window.onload = edit.initGroupOpinion("key");
				});
			</script>
		</body>
