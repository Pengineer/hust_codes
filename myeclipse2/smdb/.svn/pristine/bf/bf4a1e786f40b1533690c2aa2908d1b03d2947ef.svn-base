...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			seajs.use(['javascript/statistic/custom.js', 'javascript/statistic/custom/person.js'], function(custom, person) {
				$(function(){
					custom.init();
					person.init();
					person.initClick();
	...
	<body>
		...
		<s:form id="form_stat" action="customStatistic" namespace="/statistic/custom/person" theme="simple" target="sChart">
			<div class="main">
						...
						<tr class="table_tr2">
							...
							<td class="table_td31">
								<table width="100%" border="0" cellspacing="0" cellpadding="2" style="border: 1px solid rgb(170, 170, 170);padding-bottom:5px;">
									<tr>
										<td style="width:15%;">
											<input type="radio" name="statistic_index" value="[人员维度.年龄段].[年龄段].Members" checked="true"/>
											<span>年龄段</span>
										</td>
										<td style="width:15%;">
											<input type="radio" name="statistic_index" value="[人员维度.性别].[性别].Members"/>
											<span>性别</span>
										</td>
										<td style="width:15%;">
											<input type="radio" name="statistic_index" value="[人员维度.学历].[学历].Members"/>
											<span>最后学历</span>
										</td>
										<td style="width:15%;">
											<input type="radio" name="statistic_index" value="[人员维度.学位].[学位].Members"/>
											<span>最后学位</span>
										</td>
										<td style="width:15%;">
											<input type="radio" name="statistic_index" value="[人员维度.导师类型].[导师类型].Members"/>
											<span>导师类型</span>
										</td>
										<td style="width:15%;">
									...
									<tr>
										<td style="width:15%;">
											<input type="radio" name="statistic_index" id="statistic_data_university" value="[机构维度.高校名称].[高校名称].Members"/>
											<span>所属高校</span>
										</td>
										<td style="width:15%;">
											<input type="radio" name="statistic_index" value="[机构维度.高校类别].[高校类别].Members"/>
											<span>所属高校类别</span>
										</td>
										<td style="width:15%;">
											<input type="radio" name="statistic_index" value="[机构维度.性质类别].[性质类别].Members"/>
											<span>所属高校性质</span>
										</td>
										<td style="width:15%;">
											<input type="radio" name="statistic_index" value="[人员维度.项目类别].[项目类别].Members"/>
											<span>参与项目类别</span>
										</td>
										<td style="width:15%;">
											<input type="radio" name="statistic_index" value="[人员维度.项目负责人].[项目负责人].Members"/>
											<span>是否项目负责人</span>
										</td>
										<td style="width:15%;">
											<input type="radio" name="statistic_index" value="[人员维度.项目成员].[项目成员].Members" />
											<span>是否项目成员</span>
										</td>
									</tr>
									<tr>
										<td style="width:15%;">
											<input type="radio" name="statistic_index" value="[人员维度.职称].[职称].Members" />
											<span>专业职称</span>
										</td>
										<td style="width:15%;">
											<input type="radio" name="statistic_index" value="[人员维度.学科门类].[学科门类].Members"/>
											<span>学科门类</span>
										</td>
									</tr>
								</table>
						...
						<tr class="table_tr2">
							...
							<td class="table_td31">
								<table width="100%" border="0" cellspacing="0" cellpadding="2" style="border: 1px solid rgb(170, 170, 170);padding-bottom:5px;">
									<tr>
										<td style="width:15%;">
											<input type="checkbox" name="statistic_data" value="[Measures].[人员数目]"/>
											<span>人员数量</span>
										</td>
										<td style="width:15%;">
											<input type="checkbox" name="statistic_data" value="grantCount" disabled="disabled"/>
											<span class="disable">人员数量同比增加</span>
										</td>
										<td style="width:15%;">
											<input type="checkbox" name="statistic_data" value="grantPercentage" disabled="disabled"/>
											<span class="disable">全时人员数量</span>
										</td>
									</tr>
								</table>
							</td>
							...
							<td class="table_td31">
								<table width="100%" border="0" cellspacing="0" cellpadding="2">
									<tr>
										...
										<td style="width:20%;">
											<input type="radio" name="chartType" value="HORIZONTAL_BAR"/>
											<span>水平柱图</span>
										</td>
										<td style="width:20%;">
		...
		<div class="right2" id="chartIframe">
			<iframe id="sChart" width="100%" name="sChart" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe>
		</div>
	</body>
</html>