...
<textarea id="view_visit" style="display:none;">
	<div class="p_box_body">
		<table id="list_visit" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_statistic">
			<thead id="list_head">
				<tr class="first">
					<td width="30%" style = "text-align:center;"><s:text name="操作地点" /></td>
					<td width="40%" style = "text-align:center;"><s:text name="事件描述" /></td>
					<td style = "text-align:center;"><s:text name="操作次数" /></td>
				</tr>
			</thead>
			<tbody>
			{if visitList != null}
