	...
	<div class="p_box_body">
		...
		<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
			<tbody>
				...
				<tr class="table_tr7">
					<td class="key" colspan="2"><s:text name="按期中检项目起止年度跨度" />：</td>
					<td class="value"><s:textfield id="midYearScope" name="midYearScope" cssClass="input_css4" />年</td>
					<td class="key" colspan="2"><s:text name="按期中检项目起止年度" />：</td>
					<td class="value" colspan="3">
				...
				<tr class="table_tr7">
					<td class="key" colspan="2"><s:text name="按期结项项目起止年度跨度" />：</td>
					<td class="value"><s:textfield id="endYearScope" name="endYearScope" cssClass="input_css4" />年</td>
					<td class="key" colspan="2"><s:text name="按期结项项目起止年度" />：</td>
					<td class="value" colspan="3">
				...
				<tr class="table_tr7">
					<td class="head_title1" rowspan="6"><s:text name="奖励分值" /></td>
					<td style="text-align:center;" rowspan="3"><s:text name="著作奖" /></td>
					<td class="key"><s:text name="一等奖" />：</td>
					<td class="value"><s:textfield id="bookAwardFir" name="bookAwardFir" cssClass="input_css4" /></td>
					<td style="text-align:center;" rowspan="3"><s:text name="论文奖" /></td>
					<td class="key"><s:text name="一等奖" />：</td>
					<td class="value" colspan="3"><s:textfield id="paperAwardFir" name="paperAwardFir" cssClass="input_css5" /></td>
				</tr>
				<tr class="table_tr7">
					<td class="key"><s:text name="二等奖" />：</td>
				...
				<tr class="table_tr7">
					<td class="key"><s:text name="三等奖" />：</td>
				...
				<tr class="table_tr7">
					<td style="text-align:center;" rowspan="3"><s:text name="研究报告奖（采纳/批示）" /></td>
					<td class="key"><s:text name="一等奖" />：</td>
					<td class="value"><s:textfield id="ResAdoAwardFir" name="ResAdoAwardFir" cssClass="input_css4" /></td>
					<td class="key" colspan="2" rowspan="3"><s:text name="成果普及奖" />：</td>
		...
		<div style="text-align:center; margin-top:10px;">
			<input id="setDefault" class="btn2" type="button" value="<s:text name="设为默认" />" />
			&nbsp;&nbsp;&nbsp;&nbsp;
			<input id="default" class="btn2" type="button" value="<s:text name="恢复默认" />" />
			&nbsp;&nbsp;&nbsp;&nbsp;
			<input id="submit" class="btn2" type="button" value="<s:text name='开始核算' />" />
		</div>
	</div>
</s:form>