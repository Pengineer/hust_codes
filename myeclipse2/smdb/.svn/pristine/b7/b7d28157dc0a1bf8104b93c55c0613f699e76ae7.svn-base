					...
					<div class="title_bar">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="title_bar_td" width="64" align="right"><s:text name="i18n_UserName" />：</td>
								<td class="title_bar_td" width="120"><s:property value="#request.map.get('name')" /></td>
								<td class="title_bar_td" width="30" align="right"><img src="image/ico08.gif" width="5" height="9" /></td>
								<td class="title_bar_td" width="64" align="right"><s:text name="i18n_AccountStatus" />：</td>
								<td class="title_bar_td"><s:property value="#request.map.get('status')" /></td>
							</tr>
							<tr>
								<td class="title_bar_td" width="30" align="right"><img src="image/ico08.gif" width="5" height="9" /></td>
								<td class="title_bar_td" align="right"><s:text name="i18n_AccountType" />：</td>
								...
								<s:if test="#request.map.get('belongUnit') == null || #request.map.get('belongUnit') == ''">
									<td class="title_bar_td" align="right"><s:text name="i18n_PersonBelongTo" />：</td>
									<td class="title_bar_td"><s:property value="#request.map.get('belongPerson')" /></td>
								</s:if>
								<s:else>
									<td class="title_bar_td" align="right"><s:text name="i18n_AgencyBelongTo" />：</td>
									<td class="title_bar_td"><s:property value="#request.map.get('belongPerson')" /></td>
								</s:else>
							</tr>
						</table>
