				...
				<s:form id="form_memo" action="advSearch" theme="simple" namespace="/selfspace/memo">
					<div class="main_content">
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="0">
							<tr class="table_tr2">
								<td class="table_td2" width="100"><s:text name="标题" />：</td>
								<td class="table_td3"><s:textfield name="memo.title" cssClass="input_css" /></td>
								<td class="table_td4"></td>
							</tr>
							<tr class="table_tr2">
								<td class="table_td2"><s:text name="是否提醒" />：</td>
								<td class="table_td3"><s:select name="memo.isRemind" value="-1" headerKey="-1" headerValue="--%{getText('请选择')}--" list="#{'1':getText('是'),'0':getText('否')}" /></td>
								<td class="table_td4"></td>
							</tr>
							<tr class="table_tr2">
								<td class="table_td2"><s:text name="提醒方式" />：</td>
<%--								<td class="table_td3"><s:select name="memo.remindWay" value="-1" headerKey="-1" headerValue="--%{getText('请选择')}--" list="#{'1':getText('指定日期'),'2':getText('按天'),'3':getText('按周'),'4':getText('按月'),'5':getText('倒计时'),'6':getText('阴历')}"  /></td>--%>
								<td class="table_td3"><s:select name="memo.remindWay" value="-1" headerKey="-1" headerValue="--%{getText('请选择')}--" list="#{'1':getText('指定日期'),'2':getText('按天'),'3':getText('按周'),'4':getText('按月')}"  /></td>
								<td class="table_td4"></td>
							</tr>
							<tr class="table_tr2">
								<td class="table_td2"><s:text name="更新时间" />：</td>
								<td class="table_td3">
