...
public class InputValidate {
	 ...
	 */
	public boolean singleValidate(String str, String regex){
		if(str.isEmpty()){
			return true;
		}
	...
	public boolean checkCellphone(String str){
		...
		return singleValidate(string, regex);
	}
	 ...
	 * @return b true:校验通过；false:校验不通过
	 */
	public boolean checkMultiQQ(String str){
		String[] qqs = str.split(";");
		for (int i = 0; i < qqs.length; i++) {
			String	qq = qqs[i].trim();
			if(!checkQQ(qq)){
				return false;
			}
		}
...
//		String regex = "^(0[0-9]{2,3}-[0-9]{6,8}|0[0-9]{2,3}-[0-9]{6,8}-[0-9]{1,4}|(\\b(13\\d{9})|(15\\d{9})|(189\\d{8})\\b))$";
		String string = str.replaceAll(" ", "");
	 ...
	 * @return b true:校验通过；false:校验不通过
	 */
	public boolean checkMultiHomepage(String str){
	...
	public boolean checkPhone(String str){
		...
		//String regex = "^(0[0-9]{2,3}-[0-9]{6,8}|0[0-9]{2,3}-[0-9]{6,8}-[0-9]{1,4}|(\\b(13\\d{9})|(15\\d{9})|(189\\d{8})\\b))$(?:;^(0[0-9]{2,3}-[0-9]{6,8}|0[0-9]{2,3}-[0-9]{6,8}-[0-9]{1,4}|(\\b(13\\d{9})|(15\\d{9})|(189\\d{8})\\b))$)";
		String string = str.replaceAll(" ", "");
		String regex = "\\d+-\\d+(?:-\\d+)?(?:;\\d+-\\d+(?:-\\d+)?)*";
		return singleValidate(string, regex);
	}
	 ...
	 * @return b true:校验通过；false:校验不通过
	 */
	public boolean checkMultiPostcode(String str){
		String[] postcodes = str.split(";");
		for (int i = 0; i < postcodes.length; i++) {
			String	postcode = postcodes[i].trim();
...
//		String regex = "^(0[0-9]{2,3}-[0-9]{6,8}|0[0-9]{2,3}-[0-9]{6,8}-[0-9]{1,4})$";
		String string = str.replaceAll(" ", "");
		String regex = "\\d+-\\d+(?:-\\d+)?(?:;\\d+-\\d+(?:-\\d+)?)*";
		return singleValidate(string, regex);
	}
	 ...
	 * @return b true:校验通过；false:校验不通过
	 */
	public boolean checkMultiEmail(String str){
