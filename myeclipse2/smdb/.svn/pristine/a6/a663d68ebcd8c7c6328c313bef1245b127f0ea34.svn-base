...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			seajs.use('javascript/statistic/custom.js', function(custom) {
				$(function(){
					custom.init();
				})
			});
	...
	<body>
		...
		<s:form id="form_stat" action="customStatistic" namespace="/statistic/custom/unit" theme="simple" target="sChart">
			<div class="main">
						...
						<tr class="table_tr2">
							...
							<td class="table_td31">
								<table width="100%" border="0" cellspacing="0" cellpadding="2" style="border: 1px solid rgb(170, 170, 170);padding-bottom:5px;">
									<tr>
										<td style="width:15%;">
											<input type="radio" name="statistic_index" value="[机构维度.省份名称].[省份名称].Members"  checked="true"/>
											<span>所在省份</span>
										</td>
										<td style="width:15%;">
											<input type="radio" name="statistic_index" value="[机构维度.办学类型].[办学类型].Members"/>
											<span>办学类型</span>
										</td>
										<td style="width:15%;">
										...
										<td style="width:15%;">
											<input type="radio" name="statistic_index" value="[机构维度.举办者].[举办者].Members"/>
											<span>举办者</span>
										</td>
						...
						<tr class="table_tr2">
							...
							<td class="table_td31">
								<table width="100%" border="0" cellspacing="0" cellpadding="2" style="border: 1px solid rgb(170, 170, 170);padding-bottom:5px;">
									<tr>
										<td style="width:10%;">
											<input type="checkbox" class="selected" name="statistic_data" value="[Measures].[高校总数]"/>
											<span >所有高校</span>
										</td>
										<td style="width:10%;">
											<input type="checkbox" class="selected" name="statistic_data" value="[Measures].[部属高校]"/>
											<span>部属高校</span>
										</td>
										<td style="width:10%;">
											<input type="checkbox" class="selected" name="statistic_data" value="[Measures].[地方高校]"/>
											<span>地方高校</span>
										</td>
									</tr>
								</table>
