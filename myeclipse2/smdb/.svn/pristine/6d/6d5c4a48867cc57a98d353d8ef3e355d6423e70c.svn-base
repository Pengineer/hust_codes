...
<%--								<td class="table_td12"><s:radio name="isApplyNoevaluation" theme="simple" list="#{'1':getText('i18n_Yes'),'0':getText('i18n_No')}" value='2' onclick="showNoEval(this.value);"/></td>--%>
								<td class="table_td12"><s:radio cssClass="j_showNoEval" name="isApplyNoevaluation" theme="simple" list="#{'1':getText('i18n_Yes'),'0':getText('i18n_No')}" value='2' /></td>
							...
							<tr class="table_tr2">
								...
								<td class="table_td12"><s:radio cssClass="j_showExcellect" name="isApplyExcellent" theme="simple" list="#{'1':getText('i18n_Yes'),'0':getText('i18n_No')}" value='2' /></td>
								<td class="table_td13"></td>
							</tr>
							...
							<tr class="table_tr2">
								...
								<td class="table_td12"><s:radio cssClass="j_showNumber" name="endResult" theme="simple" list="#{'2':getText('i18n_Approve'),'1':getText('i18n_NotApprove')}" /></td>
								<td class="table_td13"></td>
							</tr>
				...
				<div class="btn_div_view">
					<input id="save" class="btn1 j_addEndResult" data="2" types="1" type="button" value="<s:text name='i18n_Save' />" />
					<input id="submit" class="btn1 j_addEndResult" data="3" types="1" type="button" value="<s:text name='i18n_Submit' />" />
