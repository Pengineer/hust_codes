			...
			<div style="width:480px;">
				<s:form id="end_audit">
					...
					<div class="btn_div_view">
						<input id="save" class="btn1 j_addEndAudit" type="button" data="2" value="<s:text name='i18n_Save' />"  />
						<input id="submit" class="btn1 j_addEndAudit" type="button" data="3" value="<s:text name='i18n_Submit' />" />
<%--						<input id="save" class="btn1" type="button" value="<s:text name='i18n_Save' />" onclick="addEndAudit(2, thisPopLayer);" />--%>
<%--						<input id="submit" class="btn1" type="button" value="<s:text name='i18n_Submit' />" onclick="addEndAudit(3, thisPopLayer);" />--%>
