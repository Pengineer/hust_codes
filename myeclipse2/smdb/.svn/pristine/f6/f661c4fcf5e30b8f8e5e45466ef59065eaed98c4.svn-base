...
//					return res1 && res2;//执行全部校验后再返回结果
			...
			var buttons;
			if($("#accountType").val() == "MINISTRY" || $("#accountType").val() == "ADMINISTRATOR"){
			...
			if($("#accountType").val() == "MINISTRY" || $("#accountType").val() == "ADMINISTRATOR"){//教育部录入需填写立项信息
