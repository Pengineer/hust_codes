...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			<div class="link_bar">
				当前位置：社科项目数据&nbsp;&gt;&nbsp;后期资助项目&nbsp;&gt;&nbsp;添加变更申请
			</div>
			
			<div class="main">
				<s:include value="/validateError.jsp" />
				<s:include value="/project/post/variation/apply/editBasic.jsp" />
				<div class="main_content">
					<s:hidden name = "flag"></s:hidden>
					<s:form id="form_apply" action="add" namespace="/project/post/variation/apply" method="post" theme="simple" enctype="multipart/form-data">
						<s:include value="/project/post/variation/apply/editTable.jsp" />
