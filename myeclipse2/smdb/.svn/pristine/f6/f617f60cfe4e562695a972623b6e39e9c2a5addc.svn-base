				...
				<div class="main">
					<div class="main_content">
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="0">
							<tr class="table_tr2">
								<td class="table_td2" width="100"><span class="table_title2"><s:text name="发信方式" />：</span></td>
								<td class="table_td3">
									<span class="choose_bar">
										<s:select cssClass="select" id="sendType" name="sendType" headerKey="2" headerValue="--%{getText('广播')}--"
											list="#{'1':getText('单播或多播 ')}" />
									</span>
								</td>
						...
						<div id='unicast' style="display:none;">
							<table width="100%" border="0" cellspacing="2" cellpadding="0">
								<tr class="table_tr2" id="Unicast" >
									<td class="table_td2" width="100"><span class="table_title2"><s:text name="收信人" />：</span></td>
									<td class="table_td3">
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="0">
							<tr class="table_tr2">
								<td class="table_td2" width="100"><span class="table_title2"><s:text name="主题" />：</span></td>
								<td class="table_td3"><s:textfield name="theme" cssClass="input_css" /></td>
								<td class="table_td4"></td>
							</tr>
							<tr class="table_tr2">
								<td class="table_td2" width="100"><span class="table_title2"><s:text name="内容" />：</span></td>
