...
<html xmlns="http://www.w3.org/1999/xhtml">
	<s:i18n name="csdc.resources.i18n_Project">
		...
		<body>
			<div class="link_bar">
				<s:text name="i18n_CurrentPosition" />：<s:text name="i18n_ProjectData" />&nbsp;&gt;&nbsp;<s:text name="i18n_InstpProject" />&nbsp;&gt;&nbsp;<s:text name="i18n_AddVariationApply" />
			</div>
			
			<div class="main">
				<s:include value="/validateError.jsp" />
				<s:include value="/project/instp/variation/apply/editBasic.jsp" />
				<div class="main_content">
					<s:hidden name = "flag"></s:hidden>
					<s:form id="form_apply" action="add" namespace="/project/instp/variation/apply" method="post" theme="simple" enctype="multipart/form-data">
						<s:include value="/project/instp/variation/apply/editTable.jsp" />
