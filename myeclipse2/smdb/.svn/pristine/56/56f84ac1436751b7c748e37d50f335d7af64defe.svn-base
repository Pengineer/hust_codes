...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<s:else>
			<div class="link_bar" id="view_univ_university">
				当前位置：社科机构数据&nbsp;&gt;&nbsp;社科管理机构&nbsp;&gt;&nbsp;校级管理机构&nbsp;&gt;&nbsp;查看
			</div>
			...
			<div class="choose_bar">
				<ul>
					...
					<s:else>
						...
						<sec:authorize ifAllGranted="ROLE_UNIT_UNIVERSITY_MODIFY">
							<li id="view_mod"><input class="btn1" type="button" value="修改" /></li>
						</sec:authorize>
				...
				<div class="main_content">
					<div id="tabs" class="p_box_bar">
						<ul>
							...
							<li><a href="#department">院系信息</a></li>
					...
					<div class="p_box">
						...
						<s:include value="/unit/agency/viewUniversityDepartment.jsp" />
		...
		<script type="text/javascript">
			seajs.use('javascript/unit/agency/university/view.js', function(view) {
				$(function(){
					view.init();
				})
			});
