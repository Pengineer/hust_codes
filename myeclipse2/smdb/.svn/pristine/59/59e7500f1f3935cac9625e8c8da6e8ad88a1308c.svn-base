			...
			<div style="width:400px;">
				<s:form id="ann_result">
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						...
						<tr class="table_tr2">
							<td class="table_td2"><span class="table_title4"><s:text name="i18n_AnninspectionYear" />：</span></td>
							<td class="table_td3"><s:textfield id="annYear" name="annYear" cssClass="input_css" /></td>
							<td class="table_td4"></td>
						</tr>
						<tr class="table_tr2">
							<td class="table_td11"><span  class="table_title4"><s:text name="i18n_AnninspectionDate" />：</span></td>
							<td class="table_td12">
