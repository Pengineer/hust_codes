...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="main">
			<s:form id="view_product" action="" theme="simple" namespace="/product/patent">
					...
					<div class="title_bar">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="title_bar_td" width="74" align="right">专利名称：</td>
								<td class="title_bar_td">${patent.chineseName}</td>
							</tr>
							<tr>
								<td class="title_bar_td" width="30" align="right"><img src="image/ico08.gif" width="5" height="9"/></td>
								<td class="title_bar_td" width="74" align="right">英文名称：</td>
								<td class="title_bar_td">${patent.englishName}</td>
							</tr>
						</table>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								<td class="title_bar_td" width="30" align="right"><img src="image/ico08.gif" width="5" height="9"/></td>
								<td class="title_bar_td" width="74" align="right">申请人：</td>
								<td class="title_bar_td" width="200">
									{if patent.orgName != null}
										<a id="${patent.id}" class="view_organization" href="">${patent.orgName}</a>
									{elseif authorid != null}
										<a id="${authorid}" class="view_author" href="">${patent.authorName}</a>
									{else}
										${patent.authorName}
									{/if}
							</td>
								...
								<td class="title_bar_td" colspan="3">${patent.otherAuthorName}</td>
							</tr>
							<tr>
								<td class="title_bar_td" align="right"><img src="image/ico08.gif" width="5" height="9"/></td>
								<td class="title_bar_td" align="right">所属单位：</td>
								<td class="title_bar_td">
									{if universityid!=null && universityid!=""}<a id="${universityid}" class="view_university" href="">${patent.agencyName}</a>
									{else}${patent.agencyName}
									{/if}
									</td>
								<td class="title_bar_td" align="right"><img src="image/ico08.gif" width="5" height="9"/></td>
								<td class="title_bar_td" align="right">所属部门：</td>
								<td class="title_bar_td" colspan="3">${patent.divisionName}</td>
							</tr>
							<tr>
								<td class="title_bar_td" align="right"><img src="image/ico08.gif" width="5" height="9"/></td>
								<td class="title_bar_td" align="right">审核状态：</td>
								<td class="title_bar_td" >
									{if patent.auditStatus==0}待审
									{else}已审
						   			{/if} 
						   			<!-- 管理人员均能审核 -->
								...
								<td class="title_bar_td" width="120">
									{if patent.auditResult==0}待审
						   			{elseif patent.auditResult==1}不同意
						   			{elseif patent.auditResult==2}同意
						   			{/if}  
					   			</td>
					   			{if patent.file != null}
				...
				<div class="p_box_body">
					<div class="p_box_body_t">
						<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
							<tr class="table_tr7">
								<td class="key" width="120">发明人姓名：</td>
								<td class="value" width="200">${patent.inventorName}</td>
								<td class="key" width="120">是否与国（境）外合作：</td>
								<td class="value">{if patent.isForeignCooperation==0 || patent.isForeignCooperation==null}否{else}是{/if}</td>
							</tr>
							<tr class="table_tr7">
								<td class="key">形态：</td>
								<td class="value">${form}</td>
								<td class="key">范畴分类：</td>
								<td class="value">${patent.categotyType}</td>
							</tr>
							<tr class="table_tr7">
								<td class="key">申请号：</td>
								<td class="value">${patent.applicationNumber}</td>
								<td class="key">申请时间：</td>
								<td class="value">${patent.applicationDate}</td>
							</tr>
							<tr class="table_tr7">
								<td class="key">公开号：</td>
								<td class="value">${patent.publicNumber}</td>
								<td class="key">公开日：</td>
								<td class="value">${patent.publicDate}</td>
							</tr>
							<tr class="table_tr7">
								<td class="key">分类号：</td>
								<td class="value">${patent.classNumber}</td>
								<td class="key">优先权号：</td>
								<td class="value">${patent.priorityNumber}</td>
							</tr>
							<tr class="table_tr7">
								<td class="key">学科门类：</td>
								<td class="value">${patent.disciplineType}</td>
								<td class="key">学科代码：</td>
								<td class="value">${patent.discipline}</td>
							</tr>
							<tr class="table_tr7">
								<td class="key">关键词：</td>
								<td class="value">${patent.keywords}</td>
								<td class="key">范畴分类：</td>
								<td class="value">${patent.categotyType}</td>
							</tr>
							<tr class="table_tr7">
								<td class="key">独立权利要求：</td>
								<td class="value" colspan="3"><pre>${patent.independentClaims}</pre></td>
							</tr>
							<tr class="table_tr7">
								<td class="key">摘要：</td>
								<td class="value" colspan="3"><pre>${patent.summary}</pre></td>
							</tr>
							<tr class="table_tr7">
								<td class="key">简介：</td>
								<td class="value" colspan="3"><pre>${patent.introduction}</pre></td>
							</tr>
						</table>
					</div>
				</div>
				...
				<div class="p_box_body">
					<div class="p_box_body_t">
						<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
							<tr class="table_tr7">
								<td class="key" width="120">发明人姓名：</td>
								<td class="value" width="200">${patent.inventorNumber}</td>
								<td class="key" width="120">分类号：</td>
								<td class="value">${patent.ClassNumber}</td>
							</tr>
							<tr class="table_tr7">
								<td class="key">申请号：</td>
						...
						{elseif relAwardInfos.isAwarded==0}
							...
							{else}
								...
								<s:if test="#session.loginer.currentType.equals(@csdc.tool.bean.AccountType@TEACHER)">
          								<div class="p_box_b">
              								<div class="p_box_b_1">
              									<input class="btn2" type="button" id="apply_award" value="申报奖励"/>
										</div>
										<div class="p_box_b_2">
