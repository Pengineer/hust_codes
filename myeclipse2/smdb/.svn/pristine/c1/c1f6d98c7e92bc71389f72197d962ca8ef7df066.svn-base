...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>添加院系管理人员</title>
		<s:include value="/innerBase.jsp" />
	</head>

	<body>
		<div class="link_bar">
			当前位置：社科人员数据&nbsp;&gt;&nbsp;社科管理人员&nbsp;&gt;&nbsp;院系管理人员&nbsp;&gt;&nbsp;添加
		</div>

		<div class="main">
			<s:form id="form_person" action="add" namespace="/person/departmentOfficer">
		...
		<script type="text/javascript">
			seajs.use('javascript/person/officer/department/add.js', function(add) {
				$(function(){
					add.init();
				})
			});
