...
<html xmlns="http://www.w3.org/1999/xhtml">
	<s:i18n name="csdc.resources.i18n_Project">
		...
		<body>
			<div class="link_bar">
				<s:text name="i18n_CurrentPosition" />：<s:text name="i18n_ReviewProject" />&nbsp;&gt;&nbsp;<s:text name="i18n_GeneralProject" />&nbsp;&gt;&nbsp;<s:text name="i18n_ApplyData" />
			</div>
			
			<div class="main">
				<div class="main_content">
					<div class="table_main_tr_adv">
						<s:include value="/project/general/application/review/search.jsp"/>
					</div>
								...
								<tr>
									...
									<td>
										{if item.laData[12]!=null && item.laData[12]!=""}
											<a id="${item.laData[0]}" name="${item.laData[0]}"  class="download_general_3" href="">
					...
					<s:form id="list" theme="simple" action="" namespace="/project/general/application/review">
			...
			<script type="text/javascript">
				seajs.use('javascript/project/general/application/review/list.js', function(list) {
					list.init();
				});
			</script>
		</body>
