						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="title_bar_td" width="200">
									{if paper.orgName != null}
										<a id="${paper.id}" class="view_organization" href="">${paper.orgName}</a>
									{elseif authorid != null}
										<a id="${authorid}" class="view_author" href="">${paper.authorName}</a>
									{else}
										${paper.authorName}
									{/if}
								</td>
								...
								<td class="title_bar_td" colspan="3">${paper.otherAuthorName}</td>
							</tr>
							<tr>
								<td class="title_bar_td" align="right"><img src="image/ico08.gif" width="5" height="9"/></td>
								...
								<td class="title_bar_td" colspan="3">${paper.divisionName}</td>
							</tr>
							<tr>
								<td class="title_bar_td" align="right"><img src="image/ico08.gif" width="5" height="9"/></td>
								<td class="title_bar_td" align="right">审核状态：</td>
								<td class="title_bar_td">
									{if paper.auditStatus==0}待审
									{else}已审
						   			{/if} 
						   			<!-- 管理人员均能审核 -->
					...
					<div class="p_box_body_t">
						<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
							<tr class="table_tr7">
								...
								<td class="value" width="200">${form}</td>
								<td class="key" width="120">论文类型：</td>
								<td class="value">${paperType}</td>
							</tr>
							<tr class="table_tr7">
								<td class="key" width="120">是否与国（境）外合作：</td>
								<td class="value">{if paper.isForeignCooperation==null || paper.isForeignCooperation==0}否{else}是{/if}</td>
					...
					<div class="p_box_body_t">
						<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
							<tr class="table_tr7">
								...
								<td class="value" width="200">${paper.publication}</td>
								<td class="key" width="120">被引情况：</td>
								<td class="value">${paper.index}</td>
							</tr>
							<tr class="table_tr7">
								<td class="key" >发表时间：</td>
								<td class="value" >${paper.publicationDate}</td>
								<td class="key" width="120">发表范围：</td>
							...
							{else}
								...
								<sec:authorize ifAnyGranted="ROLE_AWARD_MOESOCIAL_APPLICATION_APPLY_ADD">
									<s:if test="#session.loginer.currentType.equals(@csdc.tool.bean.AccountType@TEACHER)">
											...
											<div class="p_box_b_2">
												<span><img src="image/ico09.gif"/><a href="" id="download_award_model">下载人文社科奖申请书模板</a></span>
											</div>
										</div>
									</s:if>
								</sec:authorize>
