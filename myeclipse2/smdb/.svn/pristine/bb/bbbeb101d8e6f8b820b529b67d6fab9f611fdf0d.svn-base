...
public class KeyTopicSelection implements java.io.Serializable {
	...
	private String applicantId;//申报人Id
	private String applicantName;//申报人姓名
	private Integer applicantType;//申报人类型:1教师;2专家
