				...
				<s:form id="gra_audit">
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						<tr class="table_tr2">
							...
							<td class="table_td12"><s:radio name="graAuditResult" theme="simple" cssClass="j_showOpinionFeedbackOrNot" list="#{'2':getText('i18n_Approve'),'1':getText('i18n_NotApprove')}" /></td>
