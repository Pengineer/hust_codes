define(function(require, exports, module) {
	...
	var nameSpace = "person/ministryOfficer";
	...
	exports.init = function() {
		...
		$("#view_addAccount").live("click", function(){
			popAccountAdd({
				title : "添加子账号",
				src : "account/ministry/sub/extIfToAdd.action?belongId=" + $("#entityId").val(),
				inData : {data : {"typeName" : "部级子账号", "belongId" : $("#entityId").val(), "belongName" : $("#personName").html()}},
