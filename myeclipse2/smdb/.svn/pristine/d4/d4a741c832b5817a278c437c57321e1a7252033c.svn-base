...
<html xmlns="http://www.w3.org/1999/xhtml">
	<s:i18n name="csdc.resources.i18n_Person">
		<head>
			<title><s:text name="i18n_Edit" /></title>
		...
		<body>
			<div style="width:380px;">
					...
					<table class="dashedTable" width="100%" border="0" cellspacing="0" cellpadding="2">
						<thead>
							<tr>
								...
								<td width="2"></th>
								<td width="100"><s:text name="成果形式" /></th>
								<td width="2"></th>
								<td width="90"><s:text name="成果总数" /></th>
								<td width="2"></th>
								<td width="60"><s:text name="成果合格数" /></td>
								<td></td>
							</tr>
						</thead>
						<tbody>
				...
				<div class="btn_div_view">
					<input id="confirm" class="btn1" type="submit" value="<s:text name='i18n_Ok' />" />
