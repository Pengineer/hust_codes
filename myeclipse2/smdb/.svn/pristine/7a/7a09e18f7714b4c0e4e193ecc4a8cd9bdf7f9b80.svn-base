...
<div class="edit_info" id="thesis">
	<table width="100%" border="0" cellspacing="2" cellpadding="0">
		...
		<tr class="table_tr2">
			...
			<td class="table_td3"><div id="is_excellent"><s:radio name="student.isExcellent" list="#{'1':getText('是'),'0':getText('否')}" /></div></td>
			<td class="table_td4"></td>
		</tr>
		<tr class="table_tr2">
			<td class="table_td2">优秀学位论文等级：</td>
			<td class="table_td3"><s:select cssClass="select" name="student.excellentGrade" headerKey="" headerValue="--%{getText('请选择')}--" list="%{baseService.getSystemOptionMapAsName('excellentGrade', null)}" /></td>
			<td class="table_td4"></td>
		</tr>
		<tr class="table_tr2">
