		...
		<div class="main">
			<div class="main_content">
				<div class="table_main_tr_adv">
					<s:include value="/product/book/search.jsp"/>
				</div>
					...
					<table id="list_table" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
						<thead id="list_head">
							<tr class="table_title_tr">
								...
								<td><a id="sortcolumn0" href="" class="{if sortColumn == 0}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按书籍名称排序">书籍名称</a></td>
								<td width="2"><img src="image/table_line.gif" width="2" height="24"/></td>
								
								<td width="64"><a id="sortcolumn1" href="" class="{if sortColumn == 1}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按书籍类型排序">书籍类型</a></td>
								<td width="2"><img src="image/table_line.gif" width="2" height="24"/></td>
						...
						<tbody>
							{for item in root}
								<tr>
									...
									<!-- 研究人员 -->
									<s:if test="#session.loginer.currentTypewithin(@csdc.tool.bean.AccountType@EXPERT, @csdc.tool.bean.AccountType@STUDENT)">
										<td>
				...
				<s:form id="list" theme="simple" action="delete" namespace="/product/book">
   		...
   		<script type="text/javascript">
			seajs.use('javascript/product/book/list.js', function(list) {
				list.init();
			});
		</script>
	</body>
