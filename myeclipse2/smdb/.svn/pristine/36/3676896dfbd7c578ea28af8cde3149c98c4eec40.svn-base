				...
				<textarea id="view_template" style="display:none;">
					...
					<div class="main_content">
						<div id="tabs" class="p_box_bar">
							<ul>
								<li><a href="javascript:void(0)"><s:text name='详细信息'/></a></li>
							</ul>
						</div>
						...
						<div class="p_box">
							{if data != null}
								<div class="p_box_t">
									<div class="p_box_t_t"><s:text name='操作对象' /></div>
								...
								<div class="p_box_body">
									<div class="p_box_body_t">
										<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse; table-layout:fixed;">
											...
											<col style="width:310" />  
											<tr class="table_tr7">
												<td class="key" width="100"><s:text name='目标对象数据' />：</td>
												<td class="value" colspan="3" style="word-wrap: break-word; word-break: break-all;">${data}</td>
											</tr>
											<tr class="table_tr7">											
												{if changedData != null}
												<td class="key" width="100"><s:text name='更改后对象数据' />：</td>
								...
								<div class="p_box_body">
									<div class="p_box_body_t">
										<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse; table-layout:fixed;">
											...
											<col style="width:310" />  
											<tr class="table_tr7">
												<td class="key" width="100"><s:text name='编码' />：</td>
												<td class="value" width="200">${request.characterEncoding}</td>
												<td class="key" width="100"><s:text name='协议' />：</td>
												<td class="value">${request.protocol}</td>
											</tr>
											<tr class="table_tr7">
												<td class="key" width="100"><s:text name='服务器' />：</td>
												<td class="value" width="200">${request.server}</td>
												<td class="key" width="100"><s:text name='请求路径' />：</td>
									...
									<div class="p_box_body_t">
										<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
											<tr class="table_tr7">
												...
												<td class="key" width="100"><s:text name='大小' />：</td>
												<td class="value">${response.bufferSize}</td>
											</tr>
											<tr class="table_tr7">
												<td class="key" width="100"><s:text name='内容类型' />：</td>
											...
											<tr class="table_tr7">
												<td class="key" width="100"><s:text name='响应状态' />：</td>
												<td class="value" width="200">${response.responseStatus}</td>
											</tr>
											{/if}
											{if locale != null}
											<tr class="table_tr7">
												<td class="key" width="100"><s:text name='语言' />：</td>
