			...
			<div style="width:480px;">
				<s:form id="var_audit">
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						<tr class="table_tr2">
							<td class="table_td11" width="120"><span class="table_title4"><s:text name="i18n_VariationResult" />：</span></td>
							<td class="table_td12"><s:radio name="varAuditResult" cssClass="j_showOpinionFeedbackOrNot" theme="simple" list="#{'2':getText('i18n_Approve'),'1':getText('i18n_NotApprove')}" /></td>
						...
						<tr class="table_tr2" id="var_result_item_tr" style="display:none">
							<td class="table_td11" width="120">
								<span class="table_title4">
									...
									<span class="select_all_box"><s:text name="i18n_SelectAll"/>&nbsp;<input id="checkAllVarItem" name="check" type="checkbox"  title="<s:text name='i18n_ClickSelectAll' />" onclick="checkAll(this.checked, 'varSelectIssue');"/></span>
								</span>
							</td>
							<td class="table_td12">
						...
						<s:if test="#session.loginer.currentType.within(@csdc.tool.bean.AccountType@ADMINISTRATOR, @csdc.tool.bean.AccountType@MINISTRY)"><!-- 系统管理员或部级 -->
							<tr class="table_tr2">
								<td class="table_td11"><span><s:text name="i18n_AuditOpinionFeedback" />：<br /></span><s:text name='i18n_FeedbackToDirector'/><br/><s:text name="i18n_LimitWordTwo"/></td>
				...
				<div class="btn_div_view">
					<input id="save" class="btn1 j_addVarAudit" data=2 type="button" value="<s:text name='i18n_Save' />" />
					<input id="submit" class="btn1 j_addVarAudit" data=3 type="button" value="<s:text name='i18n_Submit' />" />
