		...
		<div style="width:450px;">
			<s:if test="audflag == 1">
			 <table width="100%" border="0" cellspacing="2" cellpadding="0">
					<tr>
						<td width="15"></td>
						<td class="text_red">此次操作对选中的已提交评审审核结果的奖励申请无效！</td>
					</tr>
				</table>
			</s:if>
			...
			<div class="btn_div_view">
				<input id="save" class="btn1 j_saveAddReviewAudit" type="button" value="保存" />
				<input id="submit" class="btn1 j_submitAddReviewAudit" type="button" value="提交"/>
