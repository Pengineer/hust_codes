	...
	<body>
		<div style="width:450px;">
			<s:form id="award_review">
				<table width="100%" border="0" cellspacing="2" cellpadding="0">
					...
					<tr class="table_tr2">
						...
						<td class="table_td9"><s:textfield name="totalScore" value="%{reviews[#stat.index].score}"  readonly="true" cssStyle="cursor:pointer;" cssClass="input_css" /></td>
						<td class="table_td10"></td>
					</tr>
					<tr class="table_tr2">
						<td class="table_td2"><span class="table_title11">建议等级：</span></td>
						<td class="table_td3"><s:select cssClass="select" id="gradeid" name="awardGradeid" list="%{baseService.getSystemOptionMap('awardGrade', null)}" headerKey="-1" headerValue="--%{getText('请选择')}--"/></td>
			...
			<div class="btn_div_view">
				<input id="save" class="btn1 j_saveAddReview" type="button" value="保存" />
				<input id="submit" class="btn1 j_submitAddReview" type="button" value="提交" />
		...
		<script type="text/javascript" src="javascript/award/moesocial/application/review/validate.js?ver=<%=application.getAttribute("systemVersion")%>"></script> 
	</body>
</html>