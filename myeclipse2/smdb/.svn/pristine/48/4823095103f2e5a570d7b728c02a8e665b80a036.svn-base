		...
		<body>
			<div style="width:750px;">
				<s:form id="review_endform" theme="simple">
					...
					<s:if test="reviewFlag == 2">
						<table width="100%" border="0" cellspacing="2" cellpadding="0">
							<tr class="table_tr2">
								...
								<td class="table_td9"><s:radio name="isApplyExcellent" theme="simple" list="#{'1':getText('是'),'0':getText('否')}"/></td>
								<td class="table_td10" width="90"></td>
							</tr>
							<tr class="table_tr2">
								<td class="table_td8"><span class="table_title11">结项成果数量：</span></td>
								<td class="table_td9"><input type="button" class="btn1 select_btn j_editProductType" value="编辑" />
							...
							<tr class="table_tr2">
								<td class="table_td8"><span>主要参加人：<br>（不含负责人）</span></td>
								<td class="table_td9"><s:textfield name="endMember" cssClass="input_css"/><br/><span class="tip">多个以分号（即;或；）隔开</span></td>
								<td class="table_td10"></td>
							</tr>
						</table>
					</s:if>
					...
					<div class="totalReview">
						<table width="100%" border="0" cellspacing="2" cellpadding="0">
							<tr class="table_tr2">
								<td class="table_td8" width="200"><span class="table_title11">成果修改定性意见：</span></td>
								<td class="table_td9"><s:select cssClass="select" id="reviewOpinionQualitative" name="reviewOpinionQualitative" list="%{baseService.getSystemOptionMapAsName('reviewOpinionQualitative', null)}" headerKey="-1" headerValue="--%{getText('请选择')}--" /></td>
								<td class="table_td10" width="90"></td>
							</tr>
							<tr class="table_tr2">
								<td class="table_td8"><span class="table_title11">鉴定时间：</span></td>
								<td class="table_td9">
							...
							<tr class="table_tr2">
								<td class="table_td8"><span class="table_title11">鉴定方式：</span></td>
								<td class="table_td9"><s:radio name="reviewWay" theme="simple" list="#{'1':getText('通讯鉴定'),'2':getText('会议鉴定')}" value='1' disabled='true'/></td>
							...
							<tr class="table_tr2">
								...
								<td class="table_td9"><s:radio cssClass="r_type j_showOpinionFeedbackOrNot" name="reviewResult" theme="simple" list="#{'2':getText('同意'),'1':getText('不同意')}" /></td>
								<td class="table_td10"></td>
							</tr>
							<tr class="table_tr2">
								<td class="table_td8"><span>鉴定意见：<br/>（限2000字）</span></td>
			...
			<table id="table_review" width="100%" border="0" cellspacing="0" cellpadding="0" style="display:none;">
				...
				<s:else>
					...
					<tr class="table_tr2">
						<td class="table_td8"><span>总分：<br></span></td>
						<td class="table_td9" colspan='4'><s:textfield name="reviewScore" readonly="true" cssStyle="cal_score cursor:pointer;" cssClass="input_css3" /></td>
						<td class="table_td10"></td>
					</tr>
					<tr class="table_tr2">
						<td class="table_td8"><span>建议评价等级：</span></td>
