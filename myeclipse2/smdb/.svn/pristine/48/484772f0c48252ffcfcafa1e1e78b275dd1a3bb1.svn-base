...
<div id="simple_search">
	<s:form id="search" theme="simple" action="list" namespace="/project/entrust/application/review">
...
<div id="adv_search" style="display:none;">
	<s:form id="advSearch" action="advSearch" theme="simple" namespace="/project/entrust/application/review">
		...
		<div class="adv_content">
			...
			<table width="100%" border="0" cellspacing="2" cellpadding="0">
				<tr class="adv_tr">
					...
					<td class="adv_td1" width="200"><s:textfield name="projectName" cssClass="input_css" /></td>
					<td class="adv_td1" width="100"></td>
					<td class="adv_td1" width="65" align="right"><s:text name="i18n_IssueType" />：</td>
					<td class="adv_td1" width="200"><s:select cssClass="select" name="projectSubtype" list="%{baseService.getSystemOptionMap('projectType', '05')}" headerKey="-1" headerValue="--%{getText('i18n_NoLimit')}--" /></td>
					<td class="adv_td1"></td>
				</tr>
				<tr class="adv_tr">
