...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			<div class="link_bar">
				当前位置：社科项目数据&nbsp;&gt;&nbsp;重大攻关项目&nbsp;&gt;&nbsp;投标数据
			</div>
			
			<div class="main">
				<div class="main_content">
					<div class="table_main_tr_adv">
						<s:include value="/project/key/application/apply/search.jsp"/>
					</div>
						...
						<table id="list_table" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
							<thead id="list_head">
								...
								<s:if test="!#session.loginer.currentType.within(@csdc.tool.bean.AccountType@MINISTRY_UNIVERSITY, @csdc.tool.bean.AccountType@INSTITUTE)">
									...
									<td width="54"><a id="sortcolumn3" href="" class="{if sortColumn == 3}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按研究类型排序">研究类型</a></td>
									<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
							<tr class="table_main_tr2">
								...
								<s:if test = "#session.loginer.currentType.compareTo(@csdc.tool.bean.AccountType@EXPERT)<0">
									<td width="58" align="center"><sec:authorize ifAllGranted="ROLE_PROJECT_KEY_APPLICATION_APPLY_ADD"><input class="btn1" type="button" id="list_add_result" value="添加" /></sec:authorize></td>
								</s:if>
								<s:else>
									<td width="58" align="center"><sec:authorize ifAllGranted="ROLE_PROJECT_KEY_APPLICATION_APPLY_ADD"><input class="btn1" type="button" id="list_add" value="申报" /></sec:authorize></td>
								...
								<sec:authorize ifAllGranted="ROLE_PROJECT_KEY_APPLICATION_APPLY_PUBLISH">
					...
					<s:form id="list" theme="simple" action="delete" namespace="/project/key/application/apply">
			...
			<script type="text/javascript">
				seajs.use('javascript/project/key/application/apply/list.js', function(list) {
					list.init();
				});
			</script>
		</body>
