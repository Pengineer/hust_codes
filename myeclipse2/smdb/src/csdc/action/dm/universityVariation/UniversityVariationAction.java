...
public class UniversityVariationAction extends BaseAction {
	...
	private static final String HQL = "select ur.id, ur.nameOld, ur.codeOld, ur.nameNew, ur.codeNew, ur.type, ur.description, ur.date from UniversityVariation ur where 1 = 1";
