...
public class CommonStatisticAction extends MobileAction{
	...
	private IStatisticService statisticService;//统计接口
...
//		mdxQuery.setDate(chartDate);
//		mdxQuery.setMdx(mdx);
//		mdxQuery.setTitle(chartTitle);
//		mdxQuery.setYear(chartYear);
//		if("person".equals(statisticType) || "unit".equals(statisticType) || "award".equals(statisticType)){
//			mdxQuery.setType(statisticType);
//		}else if("project".equals(statisticType)){
//			switch(listType){
//			case 1: mdxQuery.setType("project_general");break;
//			case 2: mdxQuery.setType("project_instp");break;
//			case 3: mdxQuery.setType("project_basep");break;
//			case 4: mdxQuery.setType("project_post");break;
//			case 5: mdxQuery.setType("project_committee");break;
//			}			
//		}else if("product".equals(statisticType)){
//			switch(listType){
//			case 1:mdxQuery.setType(statisticType);break;
//			case 2: mdxQuery.setType("product_paper");break;
//			case 3: mdxQuery.setType("product_book");break;
//			case 4: mdxQuery.setType("product_consultation");break;
//			case 5: mdxQuery.setType("product_electronic");break;
//			case 6: mdxQuery.setType("product_patent");break;
//			case 7: mdxQuery.setType("product_otherProduct");break; 
//			}
//		}
//		if(chart_config ==1){//自定义排序
//			StringBuffer measures=new StringBuffer(chartColumn.toString());
////			int measureNumber=Integer.parseInt(request.getParameter("measureNumber"));//查询栏位的总个数
//			//对于客户端 ，看是否可以由前台直接传回measureNumber这个数据
//			for(int i=0;i<measureNumber;i++){//measureNumber是前台JS里解析MDX语句生成的一个数
//				if(i != chartColumn){//chart_column为展示栏位的序号
//					measures.append(","+i);//补全后面的栏位配置
//				}
//			}
//			chartConfig=chartType+":"+ measures.toString();//生成图表配置(只记录生成图的列的标号)
//			mdxQuery.setChartConfig(chartConfig);
//		}else if(chart_config ==0){//默认排序
//			mdxQuery.setChartConfig("NORMAL_BAR:0");
//		}
