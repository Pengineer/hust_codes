...
public class MinistryAction extends AgencyAction {
	...
	private static final String HQL = "select ag.id,ag.code,ag.name,pe.name,ag.sname,pr.name,ag.sphone,ag.sfax,pe.id,pr.id from Agency ag left join ag.director pe left join ag.sdirector pr where ag.type=1";
