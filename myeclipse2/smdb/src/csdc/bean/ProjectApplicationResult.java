...
public class ProjectApplicationResult {
	...
	private Integer priApplicationTotal;//初算：限项申报数量
	private Long moeTiltTotal;//部属高校倾斜
	private Long westTiltTotal;//西部高校倾斜
	private String pubApplicationTotal;//发布：限项申报数量
	private Long forApplicationTotal;//预测：预期申报数量
