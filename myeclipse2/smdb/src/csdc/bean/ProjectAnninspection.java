...
public abstract class ProjectAnninspection {
	
	private String id;//主键id
	private String projectType;//项目类型
	private int year;//报告年度
	private int status;//年检业务状态 流程状态[1新建年度进展报告申请，2院系/研究机构审核，3校级审核，4省级审核，5最终审核]
	private int applicantSubmitStatus;//年检申请新建状态
	private Date applicantSubmitDate;//年检申请新建时间
	private int deptInstAuditStatus;//院系/研究机构审核状态
	private int deptInstAuditResult;//院系/研究机构年检审核结果
	...
	private String file;//年检申请书文件
	private String note;//备注
	private int isImported;//是否导入/录入数据：1是，0否
	private Date importedDate;//导入时间
	private String progress;//研究工作进展情况
	private String productIntroduction;//1到2项代表性成果简介
	
	private Set<ProjectAnninspectionProduct> projectAnninspectionProduct;//年检成果
	
	private String grantedId;
	private ProjectFee projectFee;//年检经费明细
...
//	public abstract void setGranted(ProjectGranted granted);
	...
	@JSON(serialize=false)
	public Set<ProjectAnninspectionProduct> getProjectAnninspectionProduct() {
		return projectAnninspectionProduct;
	}
	public void setProjectAnninspectionProduct(
			Set<ProjectAnninspectionProduct> projectAnninspectionProduct) {
		this.projectAnninspectionProduct = projectAnninspectionProduct;
	}
