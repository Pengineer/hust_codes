...
//	public static final String SYSTEM_KEY_VIEW = "030604";
	...
	private static final String[][] LOG_CODE_URL = {
		...
		// 申报070201
		// 申请07020101
		{PROJECT_GENERAL_APPLICATION_APPLY_ADD, "project/general/application/apply/add", "添加一般项目申报申请"},
		{PROJECT_GENERAL_APPLICATION_APPLY_DELETE, "project/general/application/apply/delete", "删除一般项目申报申请"},
		{PROJECT_GENERAL_APPLICATION_APPLY_MODIFY, "project/general/application/apply/modify", "修改一般项目申报申请"},
		{PROJECT_GENERAL_APPLICATION_APPLY_VIEW, "project/general/application/apply/view", "查看一般项目申报申请"},
		{PROJECT_GENERAL_APPLICATION_APPLY_SIMPLESEARCH, "project/general/application/apply/simpleSearch", "初级检索一般项目申报申请"},
		{PROJECT_GENERAL_APPLICATION_APPLY_ADVSEARCH, "project/general/application/apply/advSearch", "高级检索一般项目申报申请"},
		{PROJECT_GENERAL_APPLICATION_APPLY_DOWNLOAD, "project/general/application/apply/downloadApply", "下载一般项目申报申请书"},
		{PROJECT_GENERAL_APPLICATION_APPLY_SUBMIT, "project/general/application/apply/submit", "提交一般项目申报申请"},
		{PROJECT_GENERAL_APPLICATION_APPLY_LIST, "project/general/application/apply/list", "进入一般项目申报申请列表"},
		{PROJECT_GENERAL_APPLICATION_APPLYSTRICT_LIST, "project/general/application/applyStrict/list", "进入限项申报"},
		{PROJECT_GENERAL_APPLICATION_APPLYSTRICT_CONFIRMEXPORTOVERVIEW, "project/general/application/confirmExportOverView", "导出限项申报结果"},
		{PROJECT_GENERAL_APPLICATION_APPLYSTRICT_SAVE, "project/general/application/save", "保存限项申报结果"},
		{PROJECT_GENERAL_APPLICATION_APPLY_TOLIST,"project/general/application/apply/toList", "project/general/application/apply/toList.action?update=1", "一般项目申报数据"},
		
		// 审核07020102
		{PROJECT_GENERAL_APPLICATION_APPLYAUDIT_ADD, "project/general/application/applyAudit/add", "添加一般项目申报审核"},
		{PROJECT_GENERAL_APPLICATION_APPLYAUDIT_DELETE, "project/general/application/applyAudit/delete", "删除一般项目申报审核"},
		{PROJECT_GENERAL_APPLICATION_APPLYAUDIT_MODIFY, "project/general/application/applyAudit/modify", "修改一般项目申报审核"},
		{PROJECT_GENERAL_APPLICATION_APPLYAUDIT_VIEW, "project/general/application/applyAudit/view", "查看一般项目申报审核"},
		{PROJECT_GENERAL_APPLICATION_APPLYAUDIT_SUBMIT, "project/general/application/applyAudit/submit", "提交一般项目申报审核"},
		{PROJECT_GENERAL_APPLICATION_APPLYAUDIT_BACK, "project/general/application/applyAudit/back", "退回一般项目申报申请"},
		// 评审07020103
		{PROJECT_GENERAL_APPLICATION_REVIEW_ADD, "project/general/application/review/add", "添加一般项目申报评审"},
		{PROJECT_GENERAL_APPLICATION_REVIEW_DELETE, "project/general/application/review/delete", "删除一般项目申报评审"},
		{PROJECT_GENERAL_APPLICATION_REVIEW_MODIFY, "project/general/application/review/modify", "修改一般项目申报评审"},
		{PROJECT_GENERAL_APPLICATION_REVIEW_VIEW, "project/general/application/review/view", "查看一般项目申报专家评审"},
		{PROJECT_GENERAL_APPLICATION_REVIEW_VIEWREVIEW, "project/general/application/review/viewReview", "查看一般项目申报评审"},
		{PROJECT_GENERAL_APPLICATION_REVIEW_SUBMIT, "project/general/application/review/submit", "提交一般项目申报评审"},
		{PROJECT_GENERAL_APPLICATION_REVIEW_ADDGROUP, "project/general/application/review/addGroup", "添加一般项目小组申报评审"},
		{PROJECT_GENERAL_APPLICATION_REVIEW_DELETEGROUP, "project/general/application/review/deleteGroup", "删除一般项目小组申报评审"},
		{PROJECT_GENERAL_APPLICATION_REVIEW_MODIFYGROUP, "project/general/application/review/modifyGroup", "修改一般项目小组申报评审"},
		{PROJECT_GENERAL_APPLICATION_REVIEW_VIEWGROUP, "project/general/application/review/viewGroup", "查看一般项目申报小组评审"},
		{PROJECT_GENERAL_APPLICATION_REVIEW_VIEWGROUPOPINION, "project/general/application/review/viewGroupOpinion", "查看一般项目申报所有专家评审意见"},
		{PROJECT_GENERAL_APPLICATION_REVIEW_SUBMITGROUP, "project/general/application/review/submitGroup", "提交一般项目小组申报评审"},
		{PROJECT_GENERAL_APPLICATION_REVIEW_SIMPLESEARCH, "project/general/application/review/simpleSearch", "初级检索一般项目申报评审"},
		{PROJECT_GENERAL_APPLICATION_REVIEW_ADVSEARCH, "project/general/application/review/advSearch", "高级检索一般项目申报评审"},
		{PROJECT_GENERAL_APPLICATION_REVIEW_LIST, "project/general/application/review/list", "进入一般项目申报评审列表"},
		{PROJECT_GENERAL_APPLICATION_REVIEW_TOLIST, "project/general/application/review/toList", "project/general/application/review/toList.action?update=1", "一般项目申报评审"},
		// 评审审核07020104
		{PROJECT_GENERAL_APPLICATION_REVIEWAUDIT_ADD, "project/general/application/reviewAudit/add", "添加一般项目申报评审审核"},
		{PROJECT_GENERAL_APPLICATION_REVIEWAUDIT_DELETE, "project/general/application/reviewAudit/delete", "删除一般项目申报评审审核"},
		{PROJECT_GENERAL_APPLICATION_REVIEWAUDIT_MODIFY, "project/general/application/reviewAudit/modify", "修改一般项目申报评审审核"},
		{PROJECT_GENERAL_APPLICATION_REVIEWAUDIT_VIEW, "project/general/application/reviewAudit/view", "查看一般项目申报评审审核"},
		{PROJECT_GENERAL_APPLICATION_REVIEWAUDIT_SUBMIT, "project/general/application/reviewAudit/submit", "提交一般项目申报评审审核"},
		// 立项07020103
		...
		// 招标070301
		// 投标申请07030101
		{PROJECT_KEY_APPLICATION_APPLY_ADD, "project/key/application/apply/add", "添加重大攻关项目申报申请"},
		{PROJECT_KEY_APPLICATION_APPLY_DELETE, "project/key/application/apply/delete", "删除重大攻关项目申报申请"},
		{PROJECT_KEY_APPLICATION_APPLY_MODIFY, "project/key/application/apply/modify", "修改重大攻关项目申报申请"},
		{PROJECT_KEY_APPLICATION_APPLY_VIEW, "project/key/application/apply/view", "查看重大攻关项目申报申请"},
		{PROJECT_KEY_APPLICATION_APPLY_SIMPLESEARCH, "project/key/application/apply/simpleSearch", "初级检索重大攻关项目申报申请"},
		{PROJECT_KEY_APPLICATION_APPLY_ADVSEARCH, "project/key/application/apply/advSearch", "高级检索重大攻关项目申报申请"},
		{PROJECT_KEY_APPLICATION_APPLY_DOWNLOAD, "project/key/application/apply/downloadApply", "下载重大攻关项目申报申请书"},
		{PROJECT_KEY_APPLICATION_APPLY_SUBMIT, "project/key/application/apply/submit", "提交重大攻关项目申报申请"},
		{PROJECT_KEY_APPLICATION_APPLY_LIST, "project/key/application/apply/list", "进入重大攻关项目申报申请列表"},
		...
		// 审核07030102
		{PROJECT_KEY_APPLICATION_APPLYAUDIT_ADD, "project/key/application/applyAudit/add", "添加重大攻关项目申报审核"},
		{PROJECT_KEY_APPLICATION_APPLYAUDIT_DELETE, "project/key/application/applyAudit/delete", "删除重大攻关项目申报审核"},
		{PROJECT_KEY_APPLICATION_APPLYAUDIT_MODIFY, "project/key/application/applyAudit/modify", "修改重大攻关项目申报审核"},
		{PROJECT_KEY_APPLICATION_APPLYAUDIT_VIEW, "project/key/application/applyAudit/view", "查看重大攻关项目申报审核"},
		{PROJECT_KEY_APPLICATION_APPLYAUDIT_SUBMIT, "project/key/application/applyAudit/submit", "提交重大攻关项目申报审核"},
		{PROJECT_KEY_APPLICATION_APPLYAUDIT_BACK, "project/key/application/applyAudit/back", "退回重大攻关项目申报申请"},
		// 评审07030103
		{PROJECT_KEY_APPLICATION_REVIEW_ADD, "project/key/application/review/add", "添加重大攻关项目申报评审"},
		{PROJECT_KEY_APPLICATION_REVIEW_DELETE, "project/key/application/review/delete", "删除重大攻关项目申报评审"},
		{PROJECT_KEY_APPLICATION_REVIEW_MODIFY, "project/key/application/review/modify", "修改重大攻关项目申报评审"},
		{PROJECT_KEY_APPLICATION_REVIEW_VIEW, "project/key/application/review/view", "查看重大攻关项目申报专家评审"},
		{PROJECT_KEY_APPLICATION_REVIEW_VIEWREVIEW, "project/key/application/review/viewReview", "查看重大攻关项目申报评审"},
		{PROJECT_KEY_APPLICATION_REVIEW_SUBMIT, "project/key/application/review/submit", "提交重大攻关项目申报评审"},
		{PROJECT_KEY_APPLICATION_REVIEW_ADDGROUP, "project/key/application/review/addGroup", "添加重大攻关项目小组申报评审"},
		{PROJECT_KEY_APPLICATION_REVIEW_DELETEGROUP, "project/key/application/review/deleteGroup", "删除重大攻关项目小组申报评审"},
		{PROJECT_KEY_APPLICATION_REVIEW_MODIFYGROUP, "project/key/application/review/modifyGroup", "修改重大攻关项目小组申报评审"},
		{PROJECT_KEY_APPLICATION_REVIEW_VIEWGROUP, "project/key/application/review/viewGroup", "查看重大攻关项目申报小组评审"},
		{PROJECT_KEY_APPLICATION_REVIEW_VIEWGROUPOPINION, "project/key/application/review/viewGroupOpinion", "查看重大攻关项目申报所有专家评审意见"},
		{PROJECT_KEY_APPLICATION_REVIEW_SUBMITGROUP, "project/key/application/review/submitGroup", "提交重大攻关项目小组申报评审"},
		{PROJECT_KEY_APPLICATION_REVIEW_SIMPLESEARCH, "project/key/application/review/simpleSearch", "初级检索重大攻关项目申报评审"},
		{PROJECT_KEY_APPLICATION_REVIEW_ADVSEARCH, "project/key/application/review/advSearch", "高级检索重大攻关项目申报评审"},
		{PROJECT_KEY_APPLICATION_REVIEW_LIST, "project/key/application/review/list", "进入重大攻关项目申报评审列表"},
		{PROJECT_KEY_APPLICATION_REVIEW_LIST, "project/key/application/review/toList", "project/key/application/review/toList.action?update=1","重大攻关项目申报评审"},
		
		// 评审审核07030104
		{PROJECT_KEY_APPLICATION_REVIEWAUDIT_ADD, "project/key/application/reviewAudit/add", "添加重大攻关项目申报评审审核"},
		{PROJECT_KEY_APPLICATION_REVIEWAUDIT_DELETE, "project/key/application/reviewAudit/delete", "删除重大攻关项目申报评审审核"},
		{PROJECT_KEY_APPLICATION_REVIEWAUDIT_MODIFY, "project/key/application/reviewAudit/modify", "修改重大攻关项目申报评审审核"},
		{PROJECT_KEY_APPLICATION_REVIEWAUDIT_VIEW, "project/key/application/reviewAudit/view", "查看重大攻关项目申报评审审核"},
		{PROJECT_KEY_APPLICATION_REVIEWAUDIT_SUBMIT, "project/key/application/reviewAudit/submit", "提交重大攻关项目申报评审审核"},
		// 中标07030103
		...
		// 申报070401
		// 申请07040101
		{PROJECT_INSTP_APPLICATION_APPLY_ADD, "project/instp/application/apply/add", "添加基地项目申报申请"},
		{PROJECT_INSTP_APPLICATION_APPLY_DELETE, "project/instp/application/apply/delete", "删除基地项目申报申请"},
		{PROJECT_INSTP_APPLICATION_APPLY_MODIFY, "project/instp/application/apply/modify", "修改基地项目申报申请"},
		{PROJECT_INSTP_APPLICATION_APPLY_VIEW, "project/instp/application/apply/view", "查看基地项目申报申请"},
		{PROJECT_INSTP_APPLICATION_APPLY_SIMPLESEARCH, "project/instp/application/apply/simpleSearch", "初级检索基地项目申报申请"},
		{PROJECT_INSTP_APPLICATION_APPLY_ADVSEARCH, "project/instp/application/apply/advSearch", "高级检索基地项目申报申请"},
		{PROJECT_INSTP_APPLICATION_APPLY_DOWNLOAD, "project/instp/application/apply/downloadApply", "下载基地项目申报申请书"},
		{PROJECT_INSTP_APPLICATION_APPLY_SUBMIT, "project/instp/application/apply/submit", "提交基地项目申报申请"},
		{PROJECT_INSTP_APPLICATION_APPLY_LIST, "project/instp/application/apply/list", "进入基地项目申报申请列表"},
		{PROJECT_INSTP_APPLICATION_APPLY_LIST, "project/instp/application/apply/toList","project/instp/application/apply/toList.action?update=1", "基地项目申报数据"},
		// 审核07040102
		{PROJECT_INSTP_APPLICATION_APPLYAUDIT_ADD, "project/instp/application/applyAudit/add", "添加基地项目申报审核"},
		{PROJECT_INSTP_APPLICATION_APPLYAUDIT_DELETE, "project/instp/application/applyAudit/delete", "删除基地项目申报审核"},
		{PROJECT_INSTP_APPLICATION_APPLYAUDIT_MODIFY, "project/instp/application/applyAudit/modify", "修改基地项目申报审核"},
		{PROJECT_INSTP_APPLICATION_APPLYAUDIT_VIEW, "project/instp/application/applyAudit/view", "查看基地项目申报审核"},
		{PROJECT_INSTP_APPLICATION_APPLYAUDIT_SUBMIT, "project/instp/application/applyAudit/submit", "提交基地项目申报审核"},
		{PROJECT_INSTP_APPLICATION_APPLYAUDIT_BACK, "project/instp/application/applyAudit/back", "退回基地项目申报申请"},
		// 评审07040103
		{PROJECT_INSTP_APPLICATION_REVIEW_ADD, "project/instp/application/review/add", "添加基地项目申报评审"},
		{PROJECT_INSTP_APPLICATION_REVIEW_DELETE, "project/instp/application/review/delete", "删除基地项目申报评审"},
		{PROJECT_INSTP_APPLICATION_REVIEW_MODIFY, "project/instp/application/review/modify", "修改基地项目申报评审"},
		{PROJECT_INSTP_APPLICATION_REVIEW_VIEW, "project/instp/application/review/view", "查看基地项目申报专家评审"},
		{PROJECT_INSTP_APPLICATION_REVIEW_VIEWREVIEW, "project/instp/application/review/viewReview", "查看基地项目申报评审"},
		{PROJECT_INSTP_APPLICATION_REVIEW_SUBMIT, "project/instp/application/review/submit", "提交基地项目申报评审"},
		{PROJECT_INSTP_APPLICATION_REVIEW_ADDGROUP, "project/instp/application/review/addGroup", "添加基地项目小组申报评审"},
		{PROJECT_INSTP_APPLICATION_REVIEW_DELETEGROUP, "project/instp/application/review/deleteGroup", "删除基地项目小组申报评审"},
		{PROJECT_INSTP_APPLICATION_REVIEW_MODIFYGROUP, "project/instp/application/review/modifyGroup", "修改基地项目小组申报评审"},
		{PROJECT_INSTP_APPLICATION_REVIEW_VIEWGROUP, "project/instp/application/review/viewGroup", "查看基地项目申报小组评审"},
		{PROJECT_INSTP_APPLICATION_REVIEW_VIEWGROUPOPINION, "project/instp/application/review/viewGroupOpinion", "查看基地项目申报所有专家评审意见"},
		{PROJECT_INSTP_APPLICATION_REVIEW_SUBMITGROUP, "project/instp/application/review/submitGroup", "提交基地项目小组申报评审"},
		{PROJECT_INSTP_APPLICATION_REVIEW_SIMPLESEARCH, "project/instp/application/review/simpleSearch", "初级检索基地项目申报评审"},
		{PROJECT_INSTP_APPLICATION_REVIEW_ADVSEARCH, "project/instp/application/review/advSearch", "高级检索基地项目申报评审"},
		{PROJECT_INSTP_APPLICATION_REVIEW_LIST, "project/instp/application/review/list", "进入基地项目申报评审列表"},
		{PROJECT_INSTP_APPLICATION_REVIEW_LIST, "project/instp/application/review/toList", "project/instp/application/review/toList.action?update=1","基地项目申报评审"},
		
		// 评审审核07040104
		{PROJECT_INSTP_APPLICATION_REVIEWAUDIT_ADD, "project/instp/application/reviewAudit/add", "添加基地项目申报评审审核"},
		{PROJECT_INSTP_APPLICATION_REVIEWAUDIT_DELETE, "project/instp/application/reviewAudit/delete", "删除基地项目申报评审审核"},
		{PROJECT_INSTP_APPLICATION_REVIEWAUDIT_MODIFY, "project/instp/application/reviewAudit/modify", "修改基地项目申报评审审核"},
		{PROJECT_INSTP_APPLICATION_REVIEWAUDIT_VIEW, "project/instp/application/reviewAudit/view", "查看基地项目申报评审审核"},
		{PROJECT_INSTP_APPLICATION_REVIEWAUDIT_SUBMIT, "project/instp/application/reviewAudit/submit", "提交基地项目申报评审审核"},
		// 立项07040103
		...
		// 申报070501
		// 申请07050101
		{PROJECT_POST_APPLICATION_APPLY_ADD, "project/post/application/apply/add", "添加后期资助项目申报申请"},
		{PROJECT_POST_APPLICATION_APPLY_DELETE, "project/post/application/apply/delete", "删除后期资助项目申报申请"},
		{PROJECT_POST_APPLICATION_APPLY_MODIFY, "project/post/application/apply/modify", "修改后期资助项目申报申请"},
		{PROJECT_POST_APPLICATION_APPLY_VIEW, "project/post/application/apply/view", "查看后期资助项目申报申请"},
		{PROJECT_POST_APPLICATION_APPLY_SIMPLESEARCH, "project/post/application/apply/simpleSearch", "初级检索后期资助项目申报申请"},
		{PROJECT_POST_APPLICATION_APPLY_ADVSEARCH, "project/post/application/apply/advSearch", "高级检索后期资助项目申报申请"},
		{PROJECT_POST_APPLICATION_APPLY_DOWNLOAD, "project/post/application/apply/downloadApply", "下载后期资助项目申报申请书"},
		{PROJECT_POST_APPLICATION_APPLY_SUBMIT, "project/post/application/apply/submit", "提交后期资助项目申报申请"},
		{PROJECT_POST_APPLICATION_APPLY_LIST, "project/post/application/apply/list", "进入后期资助项目申报申请列表"},
		{PROJECT_POST_APPLICATION_APPLY_LIST, "project/post/application/apply/toList","project/post/application/apply/toList.action?update=1" , "后期资助项目申报数据"},
		
		// 审核07050102
		{PROJECT_POST_APPLICATION_APPLYAUDIT_ADD, "project/post/application/applyAudit/add", "添加后期资助项目申报审核"},
		{PROJECT_POST_APPLICATION_APPLYAUDIT_DELETE, "project/post/application/applyAudit/delete", "删除后期资助项目申报审核"},
		{PROJECT_POST_APPLICATION_APPLYAUDIT_MODIFY, "project/post/application/applyAudit/modify", "修改后期资助项目申报审核"},
		{PROJECT_POST_APPLICATION_APPLYAUDIT_VIEW, "project/post/application/applyAudit/view", "查看后期资助项目申报审核"},
		{PROJECT_POST_APPLICATION_APPLYAUDIT_SUBMIT, "project/post/application/applyAudit/submit", "提交后期资助项目申报审核"},
		{PROJECT_POST_APPLICATION_APPLYAUDIT_BACK, "project/post/application/applyAudit/back", "退回后期资助项目申报申请"},
		// 评审07050103
		{PROJECT_POST_APPLICATION_REVIEW_ADD, "project/post/application/review/add", "添加后期资助项目申报评审"},
		{PROJECT_POST_APPLICATION_REVIEW_DELETE, "project/post/application/review/delete", "删除后期资助项目申报评审"},
		{PROJECT_POST_APPLICATION_REVIEW_MODIFY, "project/post/application/review/modify", "修改后期资助项目申报评审"},
		{PROJECT_POST_APPLICATION_REVIEW_VIEW, "project/post/application/review/view", "查看后期资助项目申报专家评审"},
		{PROJECT_POST_APPLICATION_REVIEW_VIEWREVIEW, "project/post/application/review/viewReview", "查看后期资助项目申报评审"},
		{PROJECT_POST_APPLICATION_REVIEW_SUBMIT, "project/post/application/review/submit", "提交后期资助项目申报评审"},
		{PROJECT_POST_APPLICATION_REVIEW_ADDGROUP, "project/post/application/review/addGroup", "添加后期资助项目小组申报评审"},
		{PROJECT_POST_APPLICATION_REVIEW_DELETEGROUP, "project/post/application/review/deleteGroup", "删除后期资助项目小组申报评审"},
		{PROJECT_POST_APPLICATION_REVIEW_MODIFYGROUP, "project/post/application/review/modifyGroup", "修改后期资助项目小组申报评审"},
		{PROJECT_POST_APPLICATION_REVIEW_VIEWGROUP, "project/post/application/review/viewGroup", "查看后期资助项目申报小组评审"},
		{PROJECT_POST_APPLICATION_REVIEW_VIEWGROUPOPINION, "project/post/application/review/viewGroupOpinion", "查看后期资助项目申报所有专家评审意见"},
		{PROJECT_POST_APPLICATION_REVIEW_SUBMITGROUP, "project/post/application/review/submitGroup", "提交后期资助项目小组申报评审"},
		{PROJECT_POST_APPLICATION_REVIEW_SIMPLESEARCH, "project/post/application/review/simpleSearch", "初级检索后期资助项目申报评审"},
		{PROJECT_POST_APPLICATION_REVIEW_ADVSEARCH, "project/post/application/review/advSearch", "高级检索后期资助项目申报评审"},
		{PROJECT_POST_APPLICATION_REVIEW_LIST, "project/post/application/review/list", "进入后期资助项目申报评审列表"},
		{PROJECT_POST_APPLICATION_REVIEW_LIST, "project/post/application/review/toList", "project/post/application/review/toList.action?update=1","后期资助项目申报评审"},
		
		// 评审审核07050104
		{PROJECT_POST_APPLICATION_REVIEWAUDIT_ADD, "project/post/application/reviewAudit/add", "添加后期资助项目申报评审审核"},
		{PROJECT_POST_APPLICATION_REVIEWAUDIT_DELETE, "project/post/application/reviewAudit/delete", "删除后期资助项目申报评审审核"},
		{PROJECT_POST_APPLICATION_REVIEWAUDIT_MODIFY, "project/post/application/reviewAudit/modify", "修改后期资助项目申报评审审核"},
		{PROJECT_POST_APPLICATION_REVIEWAUDIT_VIEW, "project/post/application/reviewAudit/view", "查看后期资助项目申报评审审核"},
		{PROJECT_POST_APPLICATION_REVIEWAUDIT_SUBMIT, "project/post/application/reviewAudit/submit", "提交后期资助项目申报评审审核"},
		// 立项07050103
		...
		{PROJECT_ENTRUST_APPLICATION_APPLY_TOLIST, "project/entrust/application/apply/toList", "project/entrust/application/apply/toList.action?update=1","委托应急课题申报数据"},
		...
		{PROJECT_ENTRUST_VARIATION_APPLY_TOLIST, "project/entrust/application/review/toList", "project/entrust/application/review/toList.action?update=1","委托应急课题申报评审"},
		...
		{AWARD_MOESOCIAL_APPLY_LIST, "award/moesocial/application/apply/toList","award/moesocial/application/apply/toList.action?update=1&listflag=1" , "人文社科奖申报数据"},
