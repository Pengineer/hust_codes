...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			<div class="link_bar">
				当前位置：账号管理&nbsp;&gt;&nbsp;部级管理账号&nbsp;&gt;&nbsp;子账号
			</div>
			
			<div class="main">
				<div class="main_content">
					<div class="table_main_tr_adv">
						<s:include value="/security/account/ministry/sub/search.jsp"/>
					</div>
					...
					<textarea id="list_template" style="display:none;">
						<table id="list_table" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
							<thead id="list_head">
								...
								<sec:authorize ifAnyGranted="ROLE_SECURITY_ACCOUNT_MINISTRY_SUB_DELETE,ROLE_SECURITY_ACCOUNT_MINISTRY_SUB_STATUS,ROLE_SECURITY_ACCOUNT_ASSIGNROLE">
			...
			<script type="text/javascript">
				seajs.use('javascript/security/account/ministry/sub/list.js', function(list) {
					$(function(){
						list.init();
					})
				});
