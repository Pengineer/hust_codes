...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			<div class="link_bar">
				当前位置：账号管理&nbsp;&gt;&nbsp;部级管理账号&nbsp;&gt;&nbsp;主账号
			</div>
			
			<div class="main">
				<div class="main_content">
					<div class="table_main_tr_adv">
						<s:include value="/security/account/ministry/main/search.jsp"/>
					</div>
					...
					<textarea id="list_template" style="display:none;">
						<table id="list_table" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
							<thead id="list_head">
								...
								<sec:authorize ifAnyGranted="ROLE_SECURITY_ACCOUNT_MINISTRY_MAIN_DELETE,ROLE_SECURITY_ACCOUNT_MINISTRY_MAIN_STATUS,ROLE_SECURITY_ACCOUNT_ASSIGNROLE">
									...
									<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
									<td width="90"><a id="sortcolumn1" href="" class="{if sortColumn == 1}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按所属机构排序">所属机构</a></td>
									<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
									<td width="80"><a id="sortcolumn2" href="" class="{if sortColumn == 2}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按账号起始时间排序">创建时间</a></td>
									<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
									<td width="80"><a id="sortcolumn3" href="" class="{if sortColumn == 3}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按账号有效期限排序">有效期限</a></td>
									<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
									<td width="60"><a id="sortcolumn4" href="" class="{if sortColumn == 4}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按账号状态排序">账号状态</a></td>
									<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
							...
							{for item in root} 
								...
								<sec:authorize ifAnyGranted="ROLE_SECURITY_ACCOUNT_MINISTRY_MAIN_DELETE,ROLE_SECURITY_ACCOUNT_MINISTRY_MAIN_STATUS,ROLE_SECURITY_ACCOUNT_ASSIGNROLE">
									...
									<td></td>
									<td class="table_txt_td"><a id="${item.laData[2]}" class="linkA" href="" title="点击查看详细信息">${item.laData[3]}</a></td>
									<td></td>
									<td>${item.laData[4]}</td>
									<td></td>
									<td>${item.laData[5]}</td>
									...
									<li>
										...
										<ul style="display:none;">
											<sec:authorize ifAllGranted="ROLE_SECURITY_ACCOUNT_MINISTRY_MAIN_DELETE">
												<li><input id="list_delete" type="button" class="btn1" value="删除" /></li>
											</sec:authorize>
											<sec:authorize ifAllGranted="ROLE_SECURITY_ACCOUNT_MINISTRY_MAIN_STATUS">
												<li><input id="list_enable" type="button" class="btn1" value="启用" /></li>
												<li><input id="list_disable" type="button" class="btn1" value="停用" /></li>
											</sec:authorize>
											<sec:authorize ifAllGranted="ROLE_SECURITY_ACCOUNT_ASSIGNROLE">
												<li><input id="list_district" type="button" class="btn2" value="分配角色" /></li>
											</sec:authorize>
										</ul>
									</li>
									</ul>
			...
			<script type="text/javascript">
				seajs.use('javascript/security/account/ministry/main/list.js', function(list) {
					$(function(){
						list.init();
					})
				});
