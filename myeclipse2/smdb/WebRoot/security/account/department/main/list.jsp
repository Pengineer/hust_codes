...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			<div class="link_bar">
				当前位置：账号管理&nbsp;&gt;&nbsp;院系管理账号&nbsp;&gt;&nbsp;主账号
			</div>
			
			<div class="main">
				<div class="main_content">
					<div class="table_main_tr_adv">
						<s:include value="/security/account/department/main/search.jsp"/>
					</div>
						...
						<table id="list_table" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
							<thead id="list_head">
								...
								<sec:authorize ifAnyGranted="ROLE_SECURITY_ACCOUNT_DEPARTMENT_MAIN_DELETE,ROLE_SECURITY_ACCOUNT_DEPARTMENT_MAIN_STATUS,ROLE_SECURITY_ACCOUNT_ASSIGNROLE">
									...
									<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
									<td width="70"><a id="sortcolumn1" href="" class="{if sortColumn == 1}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按所属院系排序">所属院系</a></td>
									<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
									<td width="70"><a id="sortcolumn2" href="" class="{if sortColumn == 2}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按所属高校排序">所属高校</a></td>
									<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
									<td width="65"><a id="sortcolumn3" href="" class="{if sortColumn == 3}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按账号起始时间排序">创建时间</a></td>
									<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
									<td width="65"><a id="sortcolumn4" href="" class="{if sortColumn == 4}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按账号有效期限排序">有效期限</a></td>
									<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
									<td width="65"><a id="sortcolumn5" href="" class="{if sortColumn == 5}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按账号状态排序">账号状态</a></td>
									<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
									<td width="90"><a id="sortcolumn6" href="" class="{if sortColumn == 6}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按上次登录时间排序">上次登录时间</a></td>
									<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
									<td>角色分配</td>
								</tr>
							</thead>
							...
							{for item in root}
								...
								<sec:authorize ifAnyGranted="ROLE_SECURITY_ACCOUNT_DEPARTMENT_MAIN_DELETE,ROLE_SECURITY_ACCOUNT_DEPARTMENT_MAIN_STATUS,ROLE_SECURITY_ACCOUNT_ASSIGNROLE">
									...
									<td></td>
									<td class="table_txt_td"><a id="${item.laData[2]}" class="linkD" href="" title="点击查看详细信息">${item.laData[3]}</a></td>
									<td></td>
									<td class="table_txt_td"><a id="${item.laData[4]}" class="linkA" href="" title="点击查看详细信息">${item.laData[5]}</a></td>
									<td></td>
									<td>${item.laData[6]}</td>
									<td></td>
									<td>${item.laData[7]}</td>
			...
			<script type="text/javascript">
				seajs.use('javascript/security/account/department/main/list.js', function(list) {
					$(function(){
						list.init();
					})
				});
