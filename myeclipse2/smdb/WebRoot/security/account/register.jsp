...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<head>
			<title><s:text name="注册教师账号" /></title>
						...
						<div class="login_input_area">
							<div id="identifier">
								...
								<div class="login_find_pw_txt login_reset_pw">
									<ul>
										...
										<li>
											...
											<span><s:select cssClass="select" headerKey="" headerValue="--%{getText('请选择')}--" list="#{'身份证':'身份证','军官证':'军官证','护照':'护照'}" name="person.idcardType" /></span>
										</li>
										<li>
								...
								<div class="login_btn_box1" style="margin-top:0;">
									<input id="valid" class="login_btn" type="button" value="<s:text name='验证' />" />
									<input name="cancel" class="login_btn" type="button" value="<s:text name='取消' />" onclick="history.back();" />
								</div>
							</div>
							...
							<div id="personInfo" style="display:none;">
								...
								<div class="login_find_pw_txt login_reset_pw">
									<ul>
										<li>
											<span class="reg_required"><s:text name='所在高校' /></span>
										...
										<li>
											<span class="reg_required"><s:text name='所在院系' /></span>
											<span><s:select cssClass="select" cssStyle="" list="#{'-1':'--请选择--'}" name="departmentId" id="departmentId" onfocus="selectDepartment()" /></span>
										</li>
										<li>
											<span class="reg_required"><s:text name='专业职称' /></span>
											<span><s:select cssClass="select" cssStyle="" headerKey="-1" headerValue="--%{getText('请选择')}--" list="%{baseService.getSystemOptionMapAsName('GBT8561-2001', null)}" name="academic.specialityTitle" /></span>
										</li>
									</ul>
								</div>
								...
								<div class="login_btn_box1" style="margin-top:0;">
									<input id="prev2" class="login_btn" type="button" value="<s:text name='上一步' />" />
									<input id="next2" class="login_btn" type="button" value="<s:text name='下一步' />" />
									<input name="cancel" class="login_btn" type="button" value="<s:text name='取消' />" onclick="history.back();" />
								</div>
							</div>
							...
							<div id="contactInfo" style="display:none;">
								...
								<div id="" style="margin-left:70px; height:22px; line-height:22px; color:red;"></div>
								<div class="login_btn_box1" style="margin-top:0;">
									<input id="prev3" class="login_btn" type="button" value="<s:text name='上一步' />" />
									<input id="next3" class="login_btn" type="button" value="<s:text name='下一步' />" />
									<input name="cancel" class="login_btn" type="button" value="<s:text name='取消' />" onclick="history.back();" />
								</div>
							</div>
							...
							<div id="accountInfo" style="display:none;">
								...
								<div id="" style="margin-left:70px; height:22px; line-height:22px; color:red;"></div>
								<div class="login_btn_box1" style="margin-top:0;">
									<input id="prev4" class="login_btn" type="button" value="<s:text name='上一步' />" />
									<input id="register" class="login_btn" type="submit" value="<s:text name='注册' />" />
								</div>
							</div>
						</div>
					</div>
