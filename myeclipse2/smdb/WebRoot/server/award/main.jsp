			...
			<div class="top">
				<div class="top_bar">
					...
					<div class="top_menu">
						...
						<ul>
							<li><img src="image/top_ico01.png" /><span><a href="login/awardRight.action" target="main"><s:text name="i18n_Index" /></a></span></li>
				...
				<div class="left_menu">
					...
					<div id="menu" class="menu_bar">
						<ul class="menu">
							...
							<li id="01" class="menu1"><a href="javascript:void(0);"><s:text name="i18n_AwardData" /></a></li>
								<li id="0101" class="menu2" style="display:none;"><a href="javascript:void(0);"><s:text name="i18n_Award" /></a></li>
								<sec:authorize ifAnyGranted="ROLE_AWARD_MOESOCIAL_APPLICATION_APPLY_VIEW"> 
									<li id="010101" class="menu3" style="display:none;"><a href="award/moesocial/application/apply/toList.action?update=1&listflag=1" target="main"><s:text name="i18n_ApplyData" /></a></li>
								</sec:authorize> 
								<sec:authorize ifAnyGranted="ROLE_AWARD_MOESOCIAL_APPLICATION_PUBLICITY_VIEW">
									<li id="010102" class="menu3" style="display:none;"><a href="award/moesocial/application/publicity/toList.action?update=1&listflag=2" target="main"><s:text name="i18n_PublicityData" /></a></li>
								</sec:authorize>
								<sec:authorize ifAnyGranted="ROLE_AWARD_MOESOCIAL_APPLICATION_AWARDED_VIEW">
									<li id="010103" class="menu3" style="display:none;"><a href="award/moesocial/application/awarded/toList.action?update=1&listflag=3" target="main"><s:text name="i18n_AwardedData" /></a></li>
								</sec:authorize>
							</sec:authorize>
						</ul>
					</div>
