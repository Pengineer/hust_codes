...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<div class="main">
			<div class="main_content">
				<div class="table_main_tr_adv">
					<s:include value="/product/otherProduct/search.jsp"/>
				</div>
					...
					<table id="list_table" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
						<thead id="list_head">
							<tr class="table_title_tr">
								...
								<td width="90"><a id="sortcolumn5" href="" class="{if sortColumn == 5}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按出版单位排序">出版单位</a></td>
								<td width="2"><img src="image/table_line.gif" width="2" height="24"/></td>
				...
				<s:form id="list" theme="simple" action="delete" namespace="/product/otherProduct">
		...
		<script type="text/javascript">
			seajs.use('javascript/product/otherProduct/list.js', function(list) {
				list.init();
			});
		</script>
	</body>
