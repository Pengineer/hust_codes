...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="main">
			<s:form id="form_product" action="modify" method="post" theme="simple" enctype="multipart/form-data" namespace="/product/book">
   				<s:hidden id="accountType" value="%{#session.loginer.currentType}"/>
   				<s:hidden id="addOrModify" value="0"/>
   				<s:hidden name="entityId" value="%{book.id}"/>
   				<s:hidden id="submitStatus" name="book.submitStatus"/>
				...
				<div  class="main_content" style="margin-top:0px;">
					...
					<div class="edit_info" id="base_info">
						...
						<s:if test="applyType == 0">
							<table width="100%" border="0" cellspacing="2" cellpadding="2" id="personal_info" >
								...
								<s:if test="#session.loginer.currentType.compareTo(@csdc.tool.bean.AccountType@EXPERT)<0">
									<tr class="table_tr2">
										...
										<td class="table_td3">
											...
											<div id="person_per_name_div" class="choose_show"><s:property value="book.authorName"/>&nbsp;&nbsp;&nbsp;<s:property value="book.agencyName"/>&nbsp;<s:property value="book.divisionName"/></div>
								...
								<tr class="table_tr2">
									...
									<td class="table_td3"><s:textfield name="book.otherAuthorName" cssClass="input_css"/></td>
									<td class="table_td4"></td>
								</tr>
							</table>
						</s:if>
						...
						<s:else>
							<table width="100%" border="0" cellspacing="2" cellpadding="2" id="team_info">
								...
								<tr class="table_tr2">
									...
									<td class="table_td3"><s:textfield name="book.orgName" cssClass="input_css"/></td>
									<td class="table_td4"></td>
								</tr>
								<tr class="table_tr2">
									...
									<td class="table_td3">
										...
										<div id="unit" class="choose_show"><s:property value="book.agencyName"/>&nbsp;<s:property value="book.orgDivisionName"/></div>
										<s:hidden id="instituteId" name="book.institute.id"/>
										<s:hidden id="departmentId" name="book.department.id"/>
									</td>
									<td class="table_td4"></td>
								</tr>
								<s:if test="#session.loginer.currentType.compareTo(@csdc.tool.bean.AccountType@EXPERT)<0">
									<tr class="table_tr2">
										...
										<td class="table_td3">
											...
											<div id="team_per_name_div" class="choose_show"><s:property value="author.name"/>&nbsp;&nbsp;<s:property value="book.agencyName"/>&nbsp;<s:property value="book.divisionName"/></div>
								...
								<tr class="table_tr2">
									...
									<td class="table_td3"><s:textfield name="book.orgMember" cssClass="input_css"/>
								...
								<tr class="table_tr2">
									...
									<td class="table_td3">
										...
										<div id="team_disptr" class="choose_show"><s:property value="book.orgDiscipline"/></div>
										<s:hidden name="book.orgDiscipline" id="team_dispName"/>
									</td>
									<td class="table_td4"></td>
								</tr>
								<tr class="table_tr2">
									<td class="table_td2">办公电话：</td>
									<td class="table_td3"><s:textfield name="book.orgOfficePhone" cssClass="input_css"/></td>
									<td class="table_td4"></td>
								</tr>
								<tr class="table_tr2">
									<td class="table_td2">办公地址：</td>
									<td class="table_td3"><s:textfield name="book.orgOfficeAddress" cssClass="input_css"/></td>
									<td class="table_td4"></td>
								</tr>
								<tr class="table_tr2">
									<td class="table_td2">办公邮编：</td>
									<td class="table_td3"><s:textfield name="book.orgOfficePostcode" cssClass="input_css"/></td>
									<td class="table_td4"></td>
								</tr>
								<tr class="table_tr2">
									<td class="table_td2">办公邮箱：</td>
									<td class="table_td3"><s:textfield name="book.orgEmaiL" cssClass="input_css"/></td>
									<td class="table_td4"></td>
								</tr>
								<tr class="table_tr2">
									<td class="table_td2">手机：</td>
									<td class="table_td3"><s:textfield name="book.orgMobilePhone" cssClass="input_css"/></td>
									<td class="table_td4"></td>
								</tr>
							</table>
						</s:else>
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="2">	
							<tr class="table_tr2">
								<td class="table_td2" width="150"><span class="table_title5">书籍类型：</span></td>
								<td class="table_td3">
									<s:select cssClass="select" list="%{baseService.getSystemOptionMap('productType', '02')}" name="book.type.id" 
										headerKey="-1" headerValue="--%{getText('请选择')}--"/>
	 								<span id="originalLanguage" style="padding-left:10px;display:<s:if test="systemOption.standard == 'productType' && systemOption.code == '024' || systemOption.code == '025'"></s:if><s:else>none;</s:else>"><span>原著语言：</span>
							...
							<tr class="table_tr2">
								...
								<td class="table_td3"><s:radio name="book.isTranslation" list="#{'1':getText('是'),'0':getText('否')}"/></td>
								<td class="table_td4"></td>
							</tr>
							<tr class="table_tr2">
								<td class="table_td2">是否与国（境）外合作：</td>
								<td class="table_td3"><s:radio name="book.isForeignCooperation" list="#{'1':getText('是'),'0':getText('否')}"/></td>
								<td class="table_td4"></td>
							</tr>
							<tr class="table_tr2">
							...
							<tr class="table_tr2">
								...
								<td class="table_td3" id="err_dtype">
									...
									<div id="person_disptr" class="choose_show"><s:property value="book.disciplineType"/></div>
									<s:hidden name="book.disciplineType" id="person_dispName"/>
								</td>
								<td class="table_td4"></td>
							</tr>
							<tr class="table_tr2">
							...
							<tr class="table_tr2">
								...
								<td class="table_td3" id="err_keyWord"><s:textfield name="book.keywords" cssClass="input_css"/>
										<br/><span class="tip">多个以分号（即; 或；）隔开！</span></td>
								<td class="table_td4"></td>
							</tr>
							<tr class="table_tr2">
					...
					<div class="edit_info" id="publication_info">
						<table width="100%" border="0" cellspacing="2" cellpadding="0">
							...
							<tr class="table_tr2">
								<td class="table_td2">出版时间：</span></td>
								<td class="table_td3">
									<s:textfield id="publicationDate" name="book.publishDate" cssClass="input_css">
										<s:param name="value">
   		...
   		<script type="text/javascript">
			seajs.use('javascript/product/book/edit.js', function(modify) {
				$(function() {
					modify.init();
				});
			});
