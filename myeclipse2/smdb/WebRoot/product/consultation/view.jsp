...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div class="link_bar">
			...
			<s:else>
				当前位置：社科成果数据&nbsp;&gt;&nbsp;研究咨询报告&nbsp;&gt;&nbsp;查看
			</s:else>
		</div>

		<div class="main">
			<s:form id="view_product" action="" theme="simple" namespace="/product/consultation">
					...
					<div class="title_bar">
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td class="title_bar_td" width="74" align="right">报告名称：</td>
								<td class="title_bar_td">${consultation.chineseName}</td>
							</tr>
							<tr>
								<td class="title_bar_td" width="30" align="right"><img src="image/ico08.gif" width="5" height="9"/></td>
								<td class="title_bar_td" width="74" align="right">英文名称：</td>
								<td class="title_bar_td">${consultation.englishName}</td>
							</tr>
						</table>
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								{if consultation.orgName != null}
										<a id="${consultation.id}" class="view_organization" href="">${consultation.orgName}</a>
									{elseif authorid != null}
										<a id="${authorid}" class="view_author" href="">${consultation.authorName}</a>
									{else}
								...
								<td class="title_bar_td" colspan="3">${consultation.otherAuthorName}</td>
							</tr>
							<tr>
								<td class="title_bar_td" align="right"><img src="image/ico08.gif" width="5" height="9"/></td>
								<td class="title_bar_td" align="right">所属单位：</td>
								<td class="title_bar_td">
									{if universityid!=null && universityid!=""}<a id="${universityid}" class="view_university" href="">${consultation.agencyName}</a>
									{else}${consultation.agencyName}
									{/if}
									</td>
								<td class="title_bar_td" align="right"><img src="image/ico08.gif" width="5" height="9"/></td>
								<td class="title_bar_td" align="right">所属部门：</td>
								<td class="title_bar_td" colspan="3">${consultation.divisionName}</td>
							</tr>
							<tr>
								<td class="title_bar_td" align="right"><img src="image/ico08.gif" width="5" height="9"/></td>
								<td class="title_bar_td" align="right">审核状态：</td>
								<td class="title_bar_td" >
									{if consultation.auditStatus==0}待审
									{else}已审
						   			{/if} 
						   			<!-- 管理人员均能审核 -->
								...
								<td class="title_bar_td" width="120">
									{if consultation.auditResult==0}待审
						   			{elseif consultation.auditResult==1}不同意
						   			{elseif consultation.auditResult==2}同意
						   			{/if}  
					   			</td>
					...
					<div class="p_box_body_t">
						<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
							<tr class="table_tr7">
								...
								<td class="value" width="200">{if consultation.isTranslation==0}否{else}是{/if}</td>
								<td class="key" width="120">是否与国（境）外合作：</td>
								<td class="value">{if consultation.isForeignCooperation==0 || consultation.isForeignCooperation==null}否{else}是{/if}</td>
							</tr>
							<tr class="table_tr7">
								<td class="key">形态：</td>
								<td class="value">${form}</td>
								<td class="key">字数（千）：</td>
								<td class="value">${consultation.wordNumber}</td>
							</tr>
							<tr class="table_tr7">
								<td class="key">学科门类：</td>
								<td class="value">${consultation.disciplineType}</td>
								<td class="key">学科代码：</td>
								<td class="value">${consultation.discipline}</td>
							</tr>
							<tr class="table_tr7">
								<td class="key">关键词：</td>
								<td class="value" colspan="3">${consultation.keywords}</td>
							</tr>
							<tr class="table_tr7">
								<td class="key">简介：</td>
								<td class="value" colspan="3"><pre>${consultation.introduction}</pre></td>
							</tr>
						</table>
					</div>
				</div>
					...
					<div class="p_box_body_t">
						<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
							<tr class="table_tr7">
								...
								<td class="value" width="200">${consultation.useUnit}</td>
								<td class="key" width="120">采纳时间：</td>
								<td class="value">${consultation.publicationDate}</td>
							</tr>
						</table>
					</div>
				</div>
