...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div class="main">
			<div class="main_content">
				<div class="table_main_tr_adv">
					<s:include value="/product/paper/search.jsp"/>
				</div>
					...
					<table id="list_table" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
						<thead id="list_head">
							<tr class="table_title_tr">
								...
								<td><a id="sortcolumn0" href="" class="{if sortColumn == 0}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按论文名称排序">论文名称</a></td>
								<td width="2"><img src="image/table_line.gif" width="2" height="24"/></td>
								
								<td width="64"><a id="sortcolumn1" href="" class="{if sortColumn == 1}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按论文类型排序">论文类型</a></td>
								<td width="2"><img src="image/table_line.gif" width="2" height="24"/></td>
								...
								<s:else>
									<td width="64"><a id="sortcolumn2" href="" class="{if sortColumn == 2}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按第一作者排序">第一作者</a></td>
									<td width="2"><img src="image/table_line.gif" width="2" height="24"/>
								...
								<s:if test="#session.loginer.currentType.within(@csdc.tool.bean.AccountType@DEPARTMENT, @csdc.tool.bean.AccountType@INSTITUTE)">
									<td style="width:85px;"><a id="sortcolumn5" href="" class="{if sortColumn == 5}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按发表刊物排序">发表刊物</a></td>
									<td width="2"><img src="image/table_line.gif" width="2" height="24"/></td>
								</s:if>
								<!-- 其它人员 -->
								<s:else>
									<td style="width:64px;"><a id="sortcolumn5" href="" class="{if sortColumn == 5}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按发表刊物排序">发表刊物</a></td>
									<td width="2"><img src="image/table_line.gif" width="2" height="24"/></td>
								</s:else>
						...
						<tbody>
							{for item in root}
								<tr>
									...
									<!-- 校级管理人员 -->
									<s:elseif test="#session.loginer.currentType.within(@csdc.tool.bean.AccountType@MINISTRY_UNIVERSITY, ountType.地方高校)">
										<td>
				...
				<s:form id="list" theme="simple" action="delete " namespace="/product/paper">
		...
		<script type="text/javascript">
			seajs.use('javascript/product/paper/list.js', function(list) {
				list.init();
			});
		</script>
	</body>
