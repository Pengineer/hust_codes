...
<%--									</table>--%>
										...
										<s:iterator value="members" status="stat">
											<table class="table_valid" width="100%" border="0" cellspacing="0" cellpadding="2">
												...
												<tr class = "j_newMember" style="display: none">
													<td class="table_td8" width="150"><span class="table_title6"><s:text name='姓名'/>：</span></td>
													<td class="table_td9">
												...
												<tr class = "j_newMember" style="display: none">
													<td class="table_td8" ><span><s:text name='性别'/>：</span></td>
													<td class="table_td9">
												...
												<tr>
													...
													<td class="table_td9">
														<s:textfield name="%{'members['+#stat.index+'].workMonthPerYear'}"/>
													</td>
													<td class="table_td10"></td>
												</tr>
												<tr>
												...
												<tr>
													<td class="table_td8"><span class="table_title6">是否首席专家：</span></td>
													<td class="table_td9">
												...
												<tr>
													<td class="table_td8"><span class="table_title6">是否子课题负责人：</span></td>
													<td class="table_td9">
				...
				<table id="table_member" width="100%" border="0" cellspacing="0" cellpadding="0" style="display:none;">
					...
					<tr class = "j_newMember" style="display: none">
						<td class="table_td8"><span><s:text name="姓名" />：</span></td>
						<td class="table_td9">
							<s:select cssClass="select" name="%{'members['+#stat.index+'].gender'}" headerKey="-1" headerValue="--%{getText('i18n_PleaseSelect')}--" list="#application.sexList" />
						</td>
						<td class="table_td10"></td>
					...
					<tr>
						<td class="table_td8"><span class="table_title6">是否子项目负责人：</span></td>
						<td class="table_td9">
