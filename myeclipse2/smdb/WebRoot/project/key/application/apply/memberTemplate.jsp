...
<table id="table_member" width="100%" border="0" cellspacing="0" cellpadding="0" style="display:none;">
	<s:if test="#session.loginer.currentType.equals(@csdc.tool.bean.AccountType@MINISTRY)"><!-- 部级 -->
		...
		<tr>
			...
			<td class="table_td9">
				<s:select cssClass="select" name="rms[].memberType" headerKey='-1' headerValue="--%{getText('请选择')}--" list="#{'1':getText('教师'),'2':getText('外部专家'),'3':getText('学生')}" />
			</td>
			<td class="table_td10" width="90"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="table_td9">
				<s:select cssClass="select" name="rms[].specialistTitle" headerKey="-1" headerValue="--%{getText('请选择')}--" list="%{projectService.getChildrenMapByParentIAndStandard()}" />
			</td>
			<td class="table_td10"></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td class="table_td9">
				<s:select cssClass="select" name="rms[].isDirector" headerKey='-1' headerValue="--%{getText('请选择')}--" list="#{'1':getText('是'),'0':getText('否')}" />
			</td>
			<td class="table_td10"></td>
		</tr>
		<tr>
			...
			<td class="table_td9">
				<s:select cssClass="select" name="rms[].isSubprojectDirector" headerKey='-1' headerValue="--%{getText('请选择')}--" list="#{'1':getText('是'),'0':getText('否')}" />
			</td>
			<td class="table_td10"></td>
		</tr>
		<tr>
	...
	<s:else>
		...
		<tr>
			...
			<td class="table_td17" width="100">
				<s:select cssClass="select" name="rms[].idcardType" headerKey="-1" headerValue="--%{getText('请选择')}--" list="#{'身份证':'身份证','军官证':'军官证','护照':'护照'}"/>
			</td>
		...
		<tr>
			...
			<td class="table_td17">
				<s:select cssClass="select" name="rms[].gender" headerKey="-1" headerValue="--%{getText('请选择')}--" list="#application.sexList" />
			</td>
			<td class="table_td10"></td>
		...
		<tr>
			...
			<td class="table_td17">
				<s:select cssClass="select" name="rms[].divisionType" headerKey="-1" headerValue="--%{getText('请选择')}--" list="#{'1':getText('研究基地'),'2':getText('院系'),'3':getText('外部部门')}" />
			</td>
			<td class="table_td10"></td>
