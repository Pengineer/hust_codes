...
<div class="edit_info" id="apply">
	...
	<table width="100%" border="0" cellspacing="2" cellpadding="2">
		...
		<tr class="table_tr2">
			...
			<td class="table_td3">
				<input type="button" class="btn2 select_btn select_topic_btn" value="选择"/>
					<div id="topic_div" class="choose_show"><s:property value="application1.name"/></div>
				<s:hidden id="topsId" name="application1.topicSelection.id"/>
			</td>
			<td class="table_td4"></td>
		</tr>
		<tr class="table_tr2">
