...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			...
			<script type="text/javascript">
				...
				seajs.use(['javascript/project/key/application/review/edit_result.js','javascript/project/project_share/application/review/validate_result.js'], function(editResult, validate) {
					validate.valid();
					editResult.init();
				});
			</script>
