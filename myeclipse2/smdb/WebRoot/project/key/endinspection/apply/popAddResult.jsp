					...
					<s:form id="end_result">
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="0">
							...
							<tr class="table_tr2">
								...
								<td class="table_td12"><s:radio name="isApplyNoevaluation" cssClass="j_showNoEval" theme="simple" list="#{'1':getText('是'),'0':getText('否')}" value='2' /></td>
							...
							<tr class="table_tr2">
								...
								<td class="table_td12"><s:radio name="isApplyExcellent" cssClass="j_showExcellect" theme="simple" list="#{'1':getText('是'),'0':getText('否')}" value='2' /></td>
								<td class="table_td13"></td>
							</tr>
							<tr class="table_tr2" id="excellect_info" style="display:none;">
								<td class="table_td11"><span class="table_title6">优秀成果结果：</span></td>
								<td class="table_td12"><s:radio name="endExcellentResult" theme="simple" list="#{'2':getText('同意'),'1':getText('不同意'),'0':getText('待定')}" value='-1' /></td>
								<td class="table_td13"></td>
							</tr>
							<tr class="table_tr2">
							...
							<tr class="table_tr2">
								...
								<td class="table_td12"><s:radio cssClass="j_showNumber" name="endResult" theme="simple" list="#{'2':getText('同意'),'1':getText('不同意')}" /></td>
								<td class="table_td13"></td>
							</tr>
