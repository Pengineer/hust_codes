				...
				<s:form id="end_audit">
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						<tr class="table_tr2">
							...
							<td class="table_td12"><s:radio cssClass="r_type j_showOpinionFeedbackOrNot" name="endAuditResult" theme="simple" list="#{'2':getText('同意'),'1':getText('不同意')}" /></td>
					...
					<div class="btn_div_view">
						<input id="save" class="btn1 j_modifyEndAudit" data="2" type="button" value="保存" />
						<input id="submit" class="btn1 j_modifyEndAudit" data="3" type="button" value="提交" />
