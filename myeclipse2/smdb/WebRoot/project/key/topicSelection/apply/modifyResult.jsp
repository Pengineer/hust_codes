					...
					<div class="main_content">
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="0">
							...
							<tr class="table_tr2 university" style="display:none;">
								...
								<td class="table_td3">
									<s:select cssClass="select" cssStyle="float:left; margin-right:10px;" id="projectTypeFlag" name="projectTypeFlag" list="#{'1': getText('一般项目'), '2': getText('基地项目')}" headerKey="-1" headerValue="--%{getText('请选择')}--"/>
