					...
					<s:form id="end_result">
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="0">
							...
							<tr class="table_tr2">
								...
								<td class="table_td12"><s:radio name="isApplyNoevaluation" cssClass="j_showNoEval" theme="simple" list="#{'1':getText('i18n_Yes'),'0':getText('i18n_No')}" /></td>
							...
							<tr class="table_tr2">
								...
								<td class="table_td12"><s:radio name="isApplyExcellent" cssClass="j_showExcellect" theme="simple" list="#{'1':getText('i18n_Yes'),'0':getText('i18n_No')}" /></td>
								<td class="table_td13"></td>
							</tr>
