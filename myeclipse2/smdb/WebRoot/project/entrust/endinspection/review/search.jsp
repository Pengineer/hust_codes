...
<div id="simple_search"><!-- 初级检索 -->	
	<s:form id="search" theme="simple" action="list" namespace="/project/entrust/endinspection/review">
				...
				<td align="right">
					<span class="choose_bar">
						...
						<s:select cssClass="select" name="searchType" value="%{searchQuery.searchType}" headerKey="-1" headerValue="--%{getText('i18n_NoLimit')}--"
							list="#{'1':getText('i18n_ProjectName'),'2':getText('i18n_University'),'3':getText('i18n_IssueType'),'4':getText('i18n_DisciplineType'),'5':getText('i18n_ProjectYear')}" />
					</span>
...
<div id="adv_search" style="display:none;"><!-- 高级检索 -->	
	<s:form id="advSearch" action="advSearch" theme="simple" namespace="/project/entrust/endinspection/review">
