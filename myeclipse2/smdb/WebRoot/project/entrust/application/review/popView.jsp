				...
				<div class="title_bar">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td class="title_bar_td" width="64" align="right"><s:text name="i18n_Reviewer" />：</td>
							<td class="title_bar_td" ><s:property value="appReview.reviewerName" /></td>
							<td class="title_bar_td" width="30" align="right"><img src="image/ico08.gif" width="5" height="9" /></td>
							<td class="title_bar_td" width="90" align="right"><s:text name="i18n_ReviewDate" />：</td>
							<td class="title_bar_td" width="104"><s:date name="appReview.date" format="yyyy-MM-dd HH:mm:ss" /></td>
						</tr>
						<tr>
							...
							<td class="title_bar_td"><s:property value="appReview.score" /></td>
							<td class="title_bar_td" width="30" align="right"><img src="image/ico08.gif" width="5" height="9" /></td>
						...
						<tr>
							...
							<td colspan="1"><s:property value="appReview.innovationScore" /></td>
						</tr>
						<tr>
							<td></td>
							<td></td>
							<td colspan="3"><span><s:text name="i18n_ScientificScore" /></span><span>：</span></td>
							<td colspan="1"><s:property value="appReview.scientificScore" /></td>
						</tr>
						<tr>
							<td></td>
							<td></td>
							<td colspan="3"><span><s:text name="i18n_BenefitScore" /></span><span>：</span></td>
							<td colspan="1"><s:property value="appReview.benefitScore" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="title_bar_td" colspan="4"><s:property value="appReview.qualitativeOpinion" /></td>
						</tr>
						<tr>
							<td class="title_bar_td" width="30" align="right"><img src="image/ico08.gif" width="5" height="9" /></td>
							<td class="title_bar_td" align="right"><s:text name="i18n_ReviewOpinion" />：</td>
							<td class="title_bar_td" colspan="4" >
								<pre><s:property value="appReview.opinion" /></pre>
							</td>
						</tr>
					</table>
				</div>
