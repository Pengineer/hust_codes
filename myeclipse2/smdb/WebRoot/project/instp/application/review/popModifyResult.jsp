	...
	<s:i18n name="csdc.resources.i18n_Project">
		...
		<body>
			...
			<script type="text/javascript">
				...
				seajs.use(['javascript/project/instp/application/review/edit_result.js','javascript/project/project_share/application/review/validate_result.js'], function(editResult, validate) {
					validate.valid();
					editResult.init();
				});
			</script>
