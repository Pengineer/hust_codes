...
<div class="edit_info" id="apply">
	<table width="100%" border="0" cellspacing="2" cellpadding="2">
		...
		<tr class="table_tr2">
			<td class="table_td2"><span class="table_title5"><s:text name="i18n_BelongInstitute" />：</span></td>
			<td class="table_td3">
				<input type="button" id="select_ins_btn" class="btn1 select_btn" value="<s:text name="i18n_Select" />" />
		...
		<tr class="table_tr2">
			...
			<td class="table_td3"><s:select cssClass="select" name="application1.subtype.id" headerKey="-1" headerValue="--%{getText('i18n_PleaseSelect')}--" list="%{baseService.getSystemOptionMap('projectType', '02')}" /></td>
			<td class="table_td4"></td>
		</tr>
		<tr class="table_tr2">
			<td class="table_td2">
