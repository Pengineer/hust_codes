...
<html xmlns="http://www.w3.org/1999/xhtml">
	<s:i18n name="csdc.resources.i18n_Project">
		...
		<body>
			<div class="link_bar">
				<s:text name="i18n_CurrentPosition" />：<s:text name="i18n_ProjectData" />&nbsp;&gt;&nbsp;<s:text name="i18n_InstpProject" />&nbsp;&gt;&nbsp;<s:text name="i18n_ApplyData" />
			</div>
			
			<div class="main">
				<div class="main_content">
					<div class="table_main_tr_adv">
						<s:include value="/project/instp/application/apply/search.jsp"/>
					</div>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
							<tr class="table_main_tr2">
								...
								<s:if test = "#session.loginer.currentType.compareTo(@csdc.tool.bean.AccountType@EXPERT)<0">
									<td width="58" align="center"><sec:authorize ifAllGranted="ROLE_PROJECT_INSTP_APPLICATION_APPLY_ADD"><input class="btn1" type="button" id="list_add_result" value="<s:text name='i18n_AddResult' />" /></sec:authorize></td>
								</s:if>
								<s:else>
									<td width="58" align="center"><sec:authorize ifAllGranted="ROLE_PROJECT_INSTP_APPLICATION_APPLY_ADD"><input class="btn1" type="button" id="list_add" value="<s:text name='i18n_Apply' />" /></sec:authorize></td>
								...
								<sec:authorize ifAllGranted="ROLE_PROJECT_INSTP_APPLICATION_APPLY_PUBLISH">
					...
					<s:form id="list" theme="simple" action="delete" namespace="/project/instp/application/apply">
			...
			<script type="text/javascript">
				seajs.use('javascript/project/instp/application/apply/list.js', function(list) {
					list.init();
				});
			</script>
		</body>
