...
<html xmlns="http://www.w3.org/1999/xhtml">
	<s:i18n name="csdc.resources.i18n_Project">
		...
		<body>
			<div class="link_bar">
				<s:text name="i18n_CurrentPosition" />：<s:text name="i18n_ProjectData" />&nbsp;&gt;&nbsp;<s:text name="i18n_InstpProject" />&nbsp;&gt;&nbsp;<s:text name="i18n_AnninspectionData" />
			</div>
			
			<div class="main">
				<div class="main_content">
					<div class="table_main_tr_adv">
						<s:include value="/project/instp/anninspection/apply/search.jsp"/>
					</div>
					...
					<textarea id="list_template" style="display:none;">
						<table id="list_table" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
							...
							{for item in root}
								...
								<s:if test="#session.loginer.currentType.within(@csdc.tool.bean.AccountType@EXPERT, @csdc.tool.bean.AccountType@STUDENT)"><!-- 研究人员-->
									<td>
										{if item.laData[16]==3}<s:text name="i18n_Submit"/>
										{elseif item.laData[16]==2}<s:text name="i18n_Saved"/>
										{elseif item.laData[16]==1}<s:text name="i18n_SendBack"/>
										{else}
										{/if}
									</td>
									<td></td>
			...
			<script type="text/javascript">
				seajs.use('javascript/project/instp/anninspection/list.js', function(list) {
					list.init();
				});
			</script>
		</body>
