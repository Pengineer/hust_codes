			...
			<div style="width:480px;">
				<s:form id="midFile">
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						<tr class="table_tr2">
							<td class="table_td11" width="100"><span class="table_title6"><s:text name='i18n_UploadMidApply' />：</span></td>
							<td class="table_td12">
						...
						<tr class="table_tr2">
							...
							<td class="table_td3">
								<input type="button" id="addMidFeeApply" class="btn1 select_btn" value="<s:text name="添加" />" />
				...
				<div class="btn_div_view">
					<input id="save" class="btn1" type="button j_addSave" value="<s:text name='i18n_Save' />"  />
					<input id="submit" class="btn1" type="button j_addSubmit" value="<s:text name='i18n_Submit' />" />
