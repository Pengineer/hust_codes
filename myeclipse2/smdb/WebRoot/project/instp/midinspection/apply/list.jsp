...
<html xmlns="http://www.w3.org/1999/xhtml">
	<s:i18n name="csdc.resources.i18n_Project">
		...
		<body>
			<div class="link_bar">
				<s:text name="i18n_CurrentPosition" />：<s:text name="i18n_ProjectData" />&nbsp;&gt;&nbsp;<s:text name="i18n_InstpProject" />&nbsp;&gt;&nbsp;<s:text name="i18n_MidinspectionData" />
			</div>
			
			<div class="main">
				<div class="main_content">
					<div class="table_main_tr_adv">
						<s:include value="/project/instp/midinspection/apply/search.jsp"/>
					</div>
					...
					<textarea id="list_template" style="display:none;">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
							<tr class="table_main_tr2">
								...
								<sec:authorize ifAllGranted="ROLE_PROJECT_INSTP_MIDINSPECTION_APPLY_PUBLISH">
								...
								<sec:authorize ifAllGranted="ROLE_PROJECT_INSTP_MIDINSPECTION_DATA_EXPORT">
			...
			<script type="text/javascript">
				seajs.use('javascript/project/instp/midinspection/list.js', function(list) {
					list.init();
				});
			</script>
		</body>
