			...
			<div id="member">
				<s:iterator value="members" status="stat">
					<table class="table_valid" width="100%" border="0" cellspacing="0" cellpadding="2">
						...
						<tr>
							<td class="table_td8" width="110"><span class="table_title9"><s:text name='i18n_IdcardType' />：</span></td>
						...
						<tr>
							<td class="table_td8"><span class="table_title9"><s:text name="i18n_MemberType" />：</span></td>
							<td class="table_td17">
						...
						<tr>
							<td class="table_td8"><span class="table_title9"><s:text name="i18n_Gender" />：</span></td>
							<td class="table_td17">
						...
						<tr>
							<td class="table_td8"><span class="table_title9"><s:text name="i18n_DeptInstFlag" />：</span></td>
							<td class="table_td17">
						...
						<tr>
							<td class="table_td8"><span  class="table_title9"><s:text name="i18n_SpecialistTitle" />：</span></td>
							<td class="table_td17">
								<s:select cssClass="select" name="%{'members['+#stat.index+'].specialistTitle'}" headerKey="-1" headerValue="--%{getText('i18n_PleaseSelect')}--" list="10、entrust-variation-apply:editTable.jsp\popAddResult.jsp\popModifyResult.jsp
" />
							</td>
							<td class="table_td10"></td>
						...
						<tr>
							...
							<td class="table_td10"></td>
							<td class="table_td8"><span class="table_title2"><s:text name="i18n_WorkMonthPerYear" />：</span></td>
							<td class="table_td18">
						...
						<tr>
							<td class="table_td8"><span class="table_title9"><s:text name="i18n_IsDirector" />：</span></td>
							<td class="table_td17">
							...
							<td class="table_td10"></td>
							<td class="table_td8"><span class="table_title2"><s:text name="i18n_IsSubprojectDirector" />：</span></td>
							<td class="table_td18">
...
<table id="table_member" width="100%" border="0" cellspacing="0" cellpadding="0" style="display:none;">
	...
	<tr>
		<td class="table_td8"><span  class="table_title9"><s:text name="i18n_SpecialistTitle" />：</span></td>
		<td class="table_td17">
			<s:select cssClass="select" name="members[].specialistTitle" headerKey="-1" headerValue="--%{getText('i18n_PleaseSelect')}--" list="10、entrust-variation-apply:editTable.jsp\popAddResult.jsp\popModifyResult.jsp
" />
		</td>
		<td class="table_td10"></td>
		<td class="table_td8"><span><s:text name="i18n_Major" />：</span></td>
