				...
				<div class="main_content">
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="2">
						<tr class="table_tr2">
							...
							<td class="table_td3"><s:radio name="addType" list="#{'1':getText('基于已有申报数据添加'),'2':getText('新建申报数据后添加')}" value="1"/></td>
					...
					<s:form id="select_form" action="add" namespace="/project/post/application/granted">
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="2">
							...
							<tr class="table_tr2">
								...
								<td class="table_td3"><s:select cssClass="select" name="granted.subtype.id" headerKey="-1" headerValue="--%{getText('请选择')}--" list="%{baseService.getSystemOptionMap('projectType', '03')}" /></td>
								<td class="table_td4"></td>
							</tr>
							<tr class="table_tr2">
