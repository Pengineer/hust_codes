...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
			<div class="link_bar">
				当前位置：社科项目数据&nbsp;&gt;&nbsp;后期资助项目&nbsp;&gt;&nbsp;申报数据
			</div>
			
			<div class="main">
				<div class="main_content">
					<div class="table_main_tr_adv">
						<s:include value="/project/post/application/apply/search.jsp"/>
					</div>
						...
						<table id="list_table" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
							<thead id="list_head">
								...
								<s:else>
									...
									<td width="54"><a id="sortcolumn12" href="" class="{if sortColumn == 12}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按申报状态排序">申报状态</a></td>
									<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
									<td width="64"><a id="sortcolumn17" href="" class="{if sortColumn == 17}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按申报时间排序">申报时间</a></td>
								</s:else>
								<s:if test="#session.loginer.currentType.compareTo(@csdc.tool.bean.AccountType@MINISTRY)>0">
									<td width="64"><a id="sortcolumn12" href="" class="{if sortColumn == 12}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="点击按结项状态排序">申报状态</a></td>
								</s:if>
								</tr>
							</thead>
							<tbody>
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
							<tr class="table_main_tr2">
								...
								<s:if test = "#session.loginer.currentType.compareTo(@csdc.tool.bean.AccountType@EXPERT)<0">
									<td width="80" align="center"><sec:authorize ifAllGranted="ROLE_PROJECT_POST_APPLICATION_APPLY_ADD"><input class="btn1" type="button" id="list_add_result" value="添加" /></sec:authorize></td>
								</s:if>
								<s:else>
									<td width="80" align="center"><sec:authorize ifAllGranted="ROLE_PROJECT_POST_APPLICATION_APPLY_ADD"><input class="btn1" type="button" id="list_add" value="申报" /></sec:authorize></td>
									<s:hidden name="deadline" id="deadline" value="%{projectService.checkIfTimeValidate(#session.loginer.currentType, '031')}"/>
								...
								<sec:authorize ifAllGranted="ROLE_PROJECT_POST_APPLICATION_APPLY_PUBLISH">
					...
					<s:form id="list" theme="simple" action="delete" namespace="/project/post/application/apply">
			...
			<script type="text/javascript">
				seajs.use('javascript/project/post/application/apply/list.js', function(list) {
					list.init();
				});
			</script>
		</body>
