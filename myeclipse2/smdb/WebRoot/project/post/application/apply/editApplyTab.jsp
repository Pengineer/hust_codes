	...
	<table width="100%" border="0" cellspacing="2" cellpadding="2">
		...
		<s:else>
			...
			<tr class="table_tr2" style="display:none;" id ="dep">
				...
				<td class="table_td3"><s:select cssClass="select" name="application1.department.id" headerKey="-1" headerValue="--%{getText('请选择')}--" list="%{baseService.getLocalUnitMap()}" /></td>
				<td class="table_td4"></td>
			...
			<tr class="table_tr2" style="display:none;"id ="ins">
				...
				<td class="table_td3"><s:select cssClass="select" name="application1.institute.id" headerKey="-1" headerValue="--%{getText('请选择')}--" list="%{baseService.getLocalInitMap()}" /></td>
				<td class="table_td4"></td>
				<s:hidden id="deptInstFlag" name="teInstFlag" />
			</tr>
		</s:else>
		...
		<tr class="table_tr2">
			<td class="table_td2"><span class="table_title5">项目子类：</span></td>
			<td class="table_td3"><s:select cssClass="select" name="application1.subtype.id" headerKey="-1" headerValue="--%{getText('请选择')}--" list="%{baseService.getSystemOptionMap('projectType', '03')}" /></td>
			<td class="table_td4"></td>
		</tr>
		<tr class="table_tr2">
			<td class="table_td2"><span>项目主题：</span></td>
			<td class="table_td3"><s:select cssClass="select" name="application1.topic.id" headerKey="-1" headerValue="--%{getText('请选择')}--" list="%{baseService.getSystemOptionMap('projectTopic', null)}" /></td>
			<td class="table_td4"></td>
		</tr>
		<tr class="table_tr2">
			<td class="table_td2">
		...
		<tr class="table_tr2">
			...
			<td class="table_td3"><s:select cssClass="select" name="application1.researchType.id" headerKey="-1" headerValue="--%{getText('请选择')}--" list="%{baseService.getSystemOptionMap('researchType', null)}" /></td>
			<td class="table_td4"></td>
		</tr>
		<tr class="table_tr2">
		...
		<tr class="table_tr2">
			<td class="table_td2"><span>关键字：</span></td>
