				...
				<s:form id="end_audit">
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						<tr class="table_tr2">
							...
							<td class="table_td12"><s:radio name="endAuditResult" theme="simple" cssClass="j_showOpinionFeedbackOrNot" list="#{'2':getText('同意'),'1':getText('不同意')}" /></td>
							<td class="table_td13" width="100"></td>
						</tr>
						<s:if test="isApplyNoevaluation == 1">
						<tr class="table_tr2">
							<td class="table_td11"><span class="table_title5">免鉴定结果：</span></td>
							<td class="table_td12"><s:radio name="endNoauditResult" theme="simple" list="#{'2':getText('同意'),'1':getText('不同意')}"/></td>
						...
						<tr class="table_tr2">
							...
							<td class="table_td12"><s:radio name="endExcellentResult" theme="simple" list="#{'2':getText('同意'),'1':getText('不同意')}"/></td>
							<td class="table_td13"></td>
						</tr>
						</s:if>
						<tr class="table_tr2">
						...
						<tr class="table_tr2" id="opinion_feedback" style="display:none;">
							...
							<td class="table_td12"><s:textarea name="opinion_feedback" name="endAuditOpinionFeedback" rows="2" cssClass="textarea_css"  /><br/><span class="warning">此意见将会反馈给该项目负责人，请慎重填写！</span></td>
							<td class="table_td13"></td>
						</tr>
					</table>
					<div class="btn_div_view">
						<input id="save" class="btn1 j_addEndAudit" data="2" type="button" value="保存" />
						<input id="submit" class="btn1 j_addEndAudit" data="3" type="button" value="提交" />
