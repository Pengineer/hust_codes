...
<div id="simple_search"><!-- 初级检索 -->	
	<s:form id="search" theme="simple" action="list" namespace="/project/post/endinspection/review">
...
<div id="adv_search" style="display:none;"><!-- 高级检索 -->	
	<s:form id="advSearch" action="advSearch" theme="simple" namespace="/project/post/endinspection/review">
		...
		<div class="main_content">
			...
			<table class="adv_table" width="100%" border="0" cellspacing="2" cellpadding="0">
				...
				<tr class="adv_tr">
					...
					<td class="adv_td1">
						   <s:select cssClass="select" name="submitStatus" value="%{searchQuery.submitStatus}" list="#{'3':getText('提交'),'2':getText('暂存'),'1':getText('退回'), '0':getText('待审')}" headerKey="-1" headerValue="--%{getText('不限')}--" />
			   		</td>
