...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body >
			...
			<s:form id="end_result">
				...
				<s:hidden name="isApplyExcellent" value="%{#session.isApplyExcellent}"/>
...
<%--					<input id="save" class="btn1" type="button" value="保存" onclick="addEndResult(2, 1, thisPopLayer);" />--%>
...
<%--					<input id="submit" class="btn1" type="button" value="提交" onclick="addEndResult(3, 1, thisPopLayer);" />--%>
