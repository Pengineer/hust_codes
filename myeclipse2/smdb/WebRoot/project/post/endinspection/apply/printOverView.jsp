			...
			<div class="main_content">
				<s:iterator value="#request.dataList" status="stat">
					<s:if test="#request.dataList[#stat.index].size() != 0">
						<div class="content" style="padding-top:15px;margin-left:15px;margin-right:15px;">
							<div style="text-align:center;font-size:20px;font-weight:bold;margin-bottom:10px;">教育部人文社会科学研究后期资助项目结项情况一览表</div>
							...
							<table width="100%" cellspacing="0" cellpadding="2" border="1" bordercolor="#000" style="border-collapse:collapse;">
								...
								<s:iterator value="#request.dataList[#stat.index]" status="stat2">
									<tr>
										...
										<td style="width:100px; text-align:center;"><s:property value="#request.dataList[#stat.index][#stat2.index][7]"/></td>
