		...
		<body>
			<div style="width:580px;">
				...
				<s:form id="endFile">
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						...
						<tr class="table_tr2">
							...
							<td class="table_td15">
								<input type="radio" name="isApplyNoevaluation" value="1" disabled="disabled"/><span class="disable">是</span>
								<input type="radio" name="isApplyNoevaluation" value="0" checked="true"/><span>否</span>
							</td>
						...
						<tr class="table_tr2">
							...
							<td class="table_td15">
								<s:radio name="isApplyExcellent" list="#{'1':getText('是'),'0':getText('否')}"/>
							</td>
							<td class="table_td16"></td>
						</tr>
						<tr class="table_tr2">
				...
				<div class="btn_div_view">
					<input id="save" class="btn1 j_modifyEndApply" data="2" type="button" value="保存" />
					<input id="submit"  class="btn1 j_modifyEndApply" data="3" type="button" value="提交" />
