...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		<body>
				...
				<s:form id="ann_result">
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						...
						<tr class="table_tr2">
							...
							<td class="table_td12"><s:radio name="annResult" theme="simple" list="#{'2':getText('合格'),'1':getText('不合格')}"/></td>
			...
			<script type="text/javascript">
				seajs.use(['javascript/project/post/anninspection/edit.js','javascript/project/project_share/anninspection/validate.js'], function(edit, validate) {
					validate.valid();
					edit.init();
				});
			</script>
