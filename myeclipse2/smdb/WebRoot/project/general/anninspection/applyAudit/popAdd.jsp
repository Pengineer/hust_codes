				...
				<s:form id="ann_audit">
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						<tr class="table_tr2">
							...
							<td class="table_td12"><s:radio name="annAuditResult" theme="simple" cssClass="j_showOpinionFeedbackOrNot" list="#{'2':getText('i18n_Qualified'),'1':getText('i18n_Unqualified')}"/></td>
