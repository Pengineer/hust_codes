			...
			<div style="width:480px;">
				...
				<s:form id="annFile">
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						<tr class="table_tr2">
							<td class="table_td11" width="100"><span><s:text name='i18n_UploadAnnApply' />：</span></td>
							<td class="table_td12">
						...
						<tr class="table_tr2">
							...
							<td class="table_td3">
								<input type="button" id="modifyAnnFeeApply" class="btn1 select_btn" value="<s:text name="修改" />" />
