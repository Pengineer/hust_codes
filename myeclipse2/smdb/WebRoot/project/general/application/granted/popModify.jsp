	...
	<s:i18n name="csdc.resources.i18n_Project">
		...
		<body>
			<div style="width:480px;">
				...
				<s:form id="graFile">
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						<tr class="table_tr2">
							<td class="table_td11" width="100"><span class="table_title4"><s:text name='上传立项计划书' />：</span></td>
							<td class="table_td12">
								<input type="file" id="file_${graId}" />
								<s:hidden id = "graId" name = "graId"></s:hidden>
							</td>
						...
						<tr class="table_tr2">
							...
							<td class="table_td3">
								<input type="button" id="modifyGrantedFeeApply" class="btn1 select_btn" value="<s:text name="修改" />" />
			...
			<script type="text/javascript">
				...
				seajs.use(['javascript/project/general/application/granted/edit.js','javascript/project/project_share/application/validate.js'], function(edit, validate) {
					validate.valid();
					edit.init();
				});
			</script>
