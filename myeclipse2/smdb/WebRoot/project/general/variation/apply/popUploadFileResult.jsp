	...
	<s:i18n name="csdc.resources.i18n_Project">
		...
		<body>
			<div style="width:400px;">
				<s:form id="uploadVarFile_form">
					<s:hidden id="uploadKey" name="uploadKey" value="%{#session.uploadKey}" />
					<s:hidden id="variId" name="variId" />
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						<tr class="table_tr2">
							<td class="table_td2" width="250"><span><s:text name='i18n_UploadVarApply' />：</span></td>
							<td class="table_td3">
			...
			<script type="text/javascript">
				seajs.use('javascript/project/project_share/variation/uploadFileResult.js', function(upload) {
					upload.initUpload();
					window.uploadFileResult = function(data, type, layer){upload.uploadFileResult(data, type, layer)};
				});
			</script>
		</body>
	</s:i18n>
