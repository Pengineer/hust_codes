...
<html xmlns="http://www.w3.org/1999/xhtml">
	<s:i18n name="csdc.resources.i18n_Project">
		...
		<body>
			<div class="link_bar">
				<s:text name="i18n_CurrentPosition" />：<s:text name="i18n_ProjectData" />&nbsp;&gt;&nbsp;<s:text name="i18n_GeneralProject" />&nbsp;&gt;&nbsp;<s:text name="i18n_ModifyVariationApply" />
			</div>
			<div class="main">
				...
				<div class="main_content">
					<s:include value="/validateError.jsp" />
					<s:form id="form_apply" action="modify" namespace="/project/general/variation/apply" theme="simple" enctype="multipart/form-data">
