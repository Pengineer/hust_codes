				...
				<sec:authorize ifAllGranted='ROLE_PROJECT_GENERAL_VARIATION_APPLY_VIEW'>
					{if item.file != null}
						<div style="float: right;"><img src="image/ico09.gif" />
							<a href="" id="${item.id}" class="download_general_4"><s:text name='i18n_DownloadVariation' /></a>
						...
						<tr>
							...
							<td><s:text name="i18n_Postponement"/>
								{if item.postponementPlanFile != null}
									<a href="" id="${item.id}" class="download_general_7">[<s:text name="i18n_DownloadPostponementPlan"/>]</a>
