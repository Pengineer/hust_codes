			...
			<s:include value="/validateError.jsp" />
					...
					<s:form id="end_result">
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="0">
							...
							<tr class="table_tr2">
								...
								<td class="table_td12"><s:radio name="isApplyNoevaluation" theme="simple" list="#{'1':getText('i18n_Yes'),'0':getText('i18n_No')}" /></td>
							...
							<tr class="table_tr2">
								...
								<td class="table_td12"><s:radio name="isApplyExcellent" theme="simple" list="#{'1':getText('i18n_Yes'),'0':getText('i18n_No')}" /></td>
								<td class="table_td13"></td>
							</tr>
				...
				<div class="btn_div_view">
					<s:if test="modifyFlag != 1">
						<input id="save" class="btn1 addEndResult" type="button" data = "2" types = "2" value="<s:text name='i18n_Save' />"  />
<%--						<input id="save" class="btn1" type="button" value="<s:text name='i18n_Save' />" onclick="addEndResult(2, 2, thisPopLayer);" />--%>
					</s:if>
					<s:if test="varPending == 0">
						<input id="submit" class="btn1 addEndResult" type="button" data = "3" types = "2" value="<s:text name='i18n_Submit' />" />
					</s:if>
