		...
		<body>
			<div style="width:580px;">
				...
				<s:form id="endFile">
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						...
						<tr class="table_tr2">
							...
							<td class="table_td3">
								<input type="button" id="modifyEndFeeApply" class="btn1 select_btn" value="<s:text name="修改" />" />
						...
						<tr class="table_tr2">
							...
							<td class="table_td15">
								<s:radio name="isApplyNoevaluation" list="#{'1':getText('i18n_Yes'),'0':getText('i18n_No')}"/>
							</td>
						...
						<tr class="table_tr2">
							...
							<td class="table_td15">
								<s:radio name="isApplyExcellent" list="#{'1':getText('i18n_Yes'),'0':getText('i18n_No')}"/>
							</td>
							<td class="table_td16"></td>
						</tr>
						<tr class="table_tr2">
						...
						<tr class="table_tr2">
							...
							<td class="table_td15">
								<input type="file" id="file_research_${endId}" />
						...
						<tr class="table_tr2">
							...
							<td class="table_td15">
								<s:textfield name="projectData.startDate" cssClass="FloraDatepick" readonly="true">
									<s:param name="value">
										<s:date name="projectData.startDate" format="yyyy-MM-dd" />
									</s:param>
								</s:textfield>
							</td>
							<td class="table_td16"></td>
						...
						<tr class="table_tr2">
							...
							<td class="table_td15">
							<s:textfield name="projectData.endDate" cssClass="FloraDatepick" readonly="true">
								<s:param name="value">
									<s:date name="projectData.endDate" format="yyyy-MM-dd" />
								</s:param>
							</s:textfield>
							</td>
							<td class="table_td16"></td>
				...
				<div class="btn_div_view">
					<input id="save" class="btn1 j_modifyEndApply" type="button" data="2" value="<s:text name='i18n_Save' />" />
					<input id="submit" class="btn1 j_modifyEndApply" type="button" data="3" value="<s:text name='i18n_Submit' />" />
