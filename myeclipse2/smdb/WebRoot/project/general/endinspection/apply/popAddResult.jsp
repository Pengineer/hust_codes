		...
		<body >
			<div style="width:500px;">
					...
					<s:form id="end_result">
						...
						<table width="100%" border="0" cellspacing="2" cellpadding="0">
							...
							<tr class="table_tr2">
								...
								<td class="table_td3">
									<input type="button" id="addEndFee" class="btn1 select_btn" value="<s:text name="添加" />" />
							...
							<tr class="table_tr2">
								...
								<td class="table_td12"><s:radio name="isApplyNoevaluation" theme="simple" list="#{'1':getText('i18n_Yes'),'0':getText('i18n_No')}" value='2' /></td>
							...
							<tr class="table_tr2">
								...
								<td class="table_td12"><s:radio name="isApplyExcellent" theme="simple" list="#{'1':getText('i18n_Yes'),'0':getText('i18n_No')}" value='2' /></td>
								<td class="table_td13"></td>
							</tr>
							<tr class="table_tr2" id="excellect_info" style="display:none;">
								...
								<td class="table_td12"><s:radio name="endExcellentResult" theme="simple" list="#{'2':getText('i18n_Approve'),'1':getText('i18n_NotApprove'),'0':getText('i18n_Pending2')}" value='-1' /></td>
								<td class="table_td13"></td>
							</tr>
							<tr class="table_tr2">
								<td class="table_td11"><span><s:text name="i18n_EndinspectionProductNumber"/>：</span></td>
							...
							<tr class="table_tr2">
								<td class="table_td11"><span><s:text name="i18n_Member" />：<br><s:text name="i18n_NoContainDirector"/></span></td>
							...
							<tr class="table_tr2">
								...
								<td class="table_td12"><s:radio name="endResult" theme="simple" list="#{'2':getText('i18n_Approve'),'1':getText('i18n_NotApprove')}" /></td>
								<td class="table_td13"></td>
							</tr>
				...
				<div class="btn_div_view">
					<input id="save" class="btn1 addEndResult" type="button" data="2" types = "1" value="<s:text name='i18n_Save' />" />
					<input id="submit" class="btn1 addEndResult" type="button" data="3"  types = "1" value="<s:text name='i18n_Submit' />" />
					<input id="cancel" class="btn1" type="button" value="<s:text name='i18n_Cancel' />" />
				</div>
			</div>
			<script type="text/javascript">
				seajs.use(['javascript/project/general/endinspection/apply/edit.js','javascript/project/project_share/endinspection/apply/validate.js'], function(edit, validate) {
					validate.valid();
					edit.init();
				});
			</script>
