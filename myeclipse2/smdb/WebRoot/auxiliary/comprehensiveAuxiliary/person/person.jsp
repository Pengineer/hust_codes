...
<html xmlns="http://www.w3.org/1999/xhtml">
	<s:i18n name="csdc.resources.i18n_Statistic">
		...
		<body>
			<div class="link_bar">
				<s:text name="i18n_CurrentPosition" />：综合辅助信息&nbsp;&gt;&nbsp;社科人员查询
			</div>
							...
							<table width="100%" border="0" cellspacing="2" cellpadding="2">
											...
											<tr>
												<td width="110">
													<s:if test="#session.loginer.currentType.equals(@csdc.tool.bean.AccountType@ADMINISTRATOR)"><!-- 系统管理员 -->
														...
														list="#{'1':getText('部级管理人员'),'2':getText('省级管理人员'),'3':getText('高校管理人员'),
															'4':getText('院系管理人员'),'5':getText('基地管理人员'),'6':getText('外部专家 '),'7':getText('教师'),'8':getText('学生')}" /></span>
													</s:if>
													<s:else>
														<span class="choose_bar"><s:select cssClass="select" name="personType" id="personType" headerKey="-1" headerValue="--请选择--" 
														list="#{'6':getText('外部专家 '),'7':getText('教师'),'8':getText('学生')}" /></span>
													</s:else>
												</td>
												<td id="chose" style="display: none">
													<input type="button" class="btn1 select_btn" id="selectPerson" value="<s:text name='i18n_Select' />" />
								...
								<tr class="table_tr2 j_time" style="width:15%; display:none;">
									...
									<td class="table_td31">
										<table width="100%" border="0" cellspacing="0" >
											<tr>
												<td class="adv_td2"><s:textfield id="startDate" name="startDate" cssClass="input_css_self date_hint FloraDatepick" disabled="disabled" size="10" />&nbsp;<s:text name="i18n_To" />&nbsp;<s:textfield id="endDate" name="endDate" value="%{searchQuery.endDate}" cssClass="input_css_self younger date_hint FloraDatepick" disabled="disabled" size="10" /></td>
											</tr>
										</table>
									</td>
								</tr>
...
<%--													<s:hidden id="lineNum" name="lineNum"></s:hidden>--%>
								...
								<%--<tr class="table_tr2 j_project_set" style="display: none;">
									<td class="table_td2"><span class="table_title3" style="_padding-top:5px;font-weight:bold;"></span></td>
									<td class="table_td31">
										<table width="100%" border="0" cellspacing="0" >
											<tr>
												<td style="width:20%;">
													<input type="checkbox" name="type" value="1" checked="true"/>
													<span>申报</span>
												</td>
												<td style="width:20%;">
			...
			<div class="right2" id="chartIframe" style="display:none;">
				<div class="main_content">
					...
					<div id="tabs" class="p_box_bar">
						<ul>
							<li class="j_project" style="display:none;"><a href="#project"><s:text name="参与项目" /></a></li>
							<li  class="j_award" style="display:none;"><a href="#award"><s:text name="所获奖励" /></a></li>
							<li  class="j_product" style="display:none;"><a href="#product"><s:text name="所获成果" /></a></li>
							<s:if test="#session.loginer.currentType.compareWith(@csdc.tool.bean.AccountType@ADMINISTRATOR ) == 0">
								<li class="j_log" style="display:none;"><a href="#log"><s:text name="访问记录" /></a></li>
							</s:if>
						</ul>
					</div>
