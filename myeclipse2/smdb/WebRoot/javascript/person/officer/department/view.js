define(function(require, exports, module) {
	...
	var nameSpace = "person/departmentOfficer";
	...
	exports.init = function() {
		...
		$("#view_addAccount").live("click", function(){
			popAccountAdd({
				title : "添加子账号",
				src : "account/department/sub/extIfToAdd.action?belongId=" + $("#entityId").val(),
				inData : {data : {"typeName" : "院系子账号", "belongId" : $("#entityId").val(), "belongName" : $("#personName").html()}},
