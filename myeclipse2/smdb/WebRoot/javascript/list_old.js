...
var showPageNo = function() {// 加载页码及翻页按钮
	...
	// 生成翻页
	tr.append($("<td width='58'><input id='list_first' class='btn1' type='button' value='首页' /></td>"));
	tr.append($("<td width='58'><input id='list_previous' class='btn1' type='button' value='上页' /></td>"));
	tr.append($("<td width='58'><input id='list_next' class='btn1' type='button' value='下页' /></td>"));
	tr.append($("<td width='58'><input id='list_last' class='btn1' type='button' value='末页' /></td>"));
...
var initPageShow = function(init) {
	...
	$("#list_add_result").live("click", function() {
...
/**
 * 在离开本页前将本页所选id和之前保存的id拼接并放入checkedIds隐藏域
 * @memberOf {TypeName} 
 */
