...
//			};
			popAddApplyFee({
				title : "修改申请经费概算明细",
				src : "project/instp/application/apply/toAddApplyFee.action?applyFee=" + $("#applyFee").val() + "&otherFee=" + $("#otherFee").val() + 
...
//					var url = basePath + "project/instp/application/apply/addApplyFee.action" + getPara(result);
//					location.href = url;
					this.destroy();
				}
			});
		...
		$("#addGrantedFee").live("click",function() {
			popAddGrantedFee({
				title : "添加立项经费预算明细",
				src : "project/instp/application/apply/toAddGrantedFee.action?approveFee=" + $("#approveFee").val() +  
