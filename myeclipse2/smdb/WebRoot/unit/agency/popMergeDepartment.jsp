...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		<div style="width:450px;">
			...
			<div id="department" style="height: 237px; overflow-y: scroll; overflow-x: hidden;">
		...
		<script type="text/javascript">
			seajs.use('javascript/unit/agency/department/merge.js', function(merge) {
				merge.init();
			});
		</script>
	</body>
