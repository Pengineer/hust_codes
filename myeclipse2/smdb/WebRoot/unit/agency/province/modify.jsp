...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<s:else>
			<div class="link_bar">
				当前位置：社科机构数据&nbsp;&gt;&nbsp;社科管理机构&nbsp;&gt;&nbsp;省级管理机构&nbsp;&gt;&nbsp;修改
			</div>
			<s:hidden name="nameSpace" id="nameSpace" value="unit/agency/province" />
		</s:else>
		...
		<script type="text/javascript">
			seajs.use('javascript/unit/agency/province/modify.js', function(modify) {
				$(function(){
					modify.init();
				})
			});
