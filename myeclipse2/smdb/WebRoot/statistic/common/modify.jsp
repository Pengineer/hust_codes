...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			seajs.use('javascript/statistic/add.js', function(modify) {
				$(function(){
					modify.init();
				})
			});
	...
	<body>
		<div class="link_bar">
			当前位置：常规统计分析&nbsp;&gt;&nbsp;<s:property value="#session.statisticListType"/>&nbsp;&gt;&nbsp;修改
		</div>

		<s:form id="form_stat" action="modify" namespace="/statistic/common" theme="simple">
			<s:hidden value="%{chart_column}" id="column"/>
				...
				<div class="main_content">
					...
					<table width="100%" border="0" cellspacing="2" cellpadding="2">
						...
						<tr class="table_tr2">
							...
							<td class="table_td3">
							<s:textfield name="mdxQuery.date" cssClass="input_css">
								<s:param name="value"><s:date name="%{mdxQuery.date}" format="yyyy-MM-dd"/></s:param>
							</s:textfield>
							</td>
							<td class="table_td4"></td>
						</tr>
					...
					<tr class="table_tr2">
							...
							<td class="table_td3"><s:radio cssClass="config_choose" name="chart_config" list="#{'0':'默认配置','1':'自定义配置'}"/></td>
							<td class="table_td4"></td>
						</tr>
					</table>
					<table id="config" width="100%" border="0" cellspacing="2" cellpadding="2" style="display:none;">
						...
						<tr class="table_tr2">
							...
							<td class="table_td3"><s:radio name="chart_type" list="#{'0':'水平柱图','1':'垂直柱图','2':'饼状图','3':'折线图'}"/></td>
							<td class="table_td4"></td>
						</tr>
					</table>
				</div> 
