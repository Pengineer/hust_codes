...
<html xmlns="http://www.w3.org/1999/xhtml">
	<s:i18n name="csdc.resources.i18n_Project">
		<head>
			<title><s:text name="重大攻关项目经费" /></title>
		...
		<body>
			<div class="link_bar">
				...
				<s:text name="i18n_CurrentPosition" />：<s:text name="研究项目经费" />&nbsp;&gt;&nbsp;<s:text name="重大攻关项目" />&nbsp;&gt;&nbsp;<s:text name="拨款概况" />
			</div>
...
<%--								</sec:authorize>--%>
									...
									<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
									<td width="65"><a id="sortcolumn2" href="" class="{if sortColumn == 2}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="<s:text name='i18n_SortByChiefExpert' />"><s:text name="i18n_ChiefExpert" /></a></td>
								<s:if test="!#session.loginer.currentType.within(@csdc.tool.bean.AccountType@MINISTRY_UNIVERSITY, @csdc.tool.bean.AccountType@INSTITUTE)">
									...
									<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
									<td width="65"><a id="sortcolumn4" href="" class="{if sortColumn == 4}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="<s:text name='i18n_SortByResearchType' />"><s:text name="i18n_ResearchType" /></a></td>
									<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
