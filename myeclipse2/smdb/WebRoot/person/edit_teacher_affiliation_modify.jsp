...
<div class="edit_info" id="teacher_affiliation_modify">
	<table id="table_affiliation" class="table_edit" width="100%" border="0" cellspacing="0" cellpadding="2">
		...
		<tr class="tr_valid" >
			...
			<td></td>
			<td>
				<s:select style="width:70px;" cssClass="select" name="%{'unitType['+#stat.index+']'}" value="%{unitType[#stat.index]}" headerKey="-1" headerValue="--%{getText('请选择')}--" list="#{'0':'院系','1':'基地'}" />
			</td>
			<td>
			...
			<td></td>
			<td>
				<s:select cssClass="select" headerKey="" headerValue="--%{getText('请选择')}--" list="#{'专职人员':'专职人员','兼职人员':'兼职人员','离职人员':'离职人员'}" name="%{'teachers['+#stat.index+'].type'}" value="%{teachers[#stat.index].type}" />
			</td>
			<td></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="2" style="display:none;">
	<tr class="tr_valid" id="tr_affiliation" style="display:none;">
		...
		<td></td>
		<td>
			<s:select style="width:70px;" cssClass="select" name="unitType[]"  headerKey="-1" headerValue="--%{getText('请选择')}--" list="#{'0':'院系','1':'基地'}" />
		</td>
		...
		<td></td>
		<td>
			<s:select cssClass="select" headerKey="" headerValue="--%{getText('请选择')}--" list="#{'专职人员':'专职人员','兼职人员':'兼职人员','离职人员':'离职人员'}"  name="teachers[].type" />
		</td>
		<td></td>
