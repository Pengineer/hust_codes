...
<div class="edit_info" id="basic2">
	<table width="100%" border="0" cellspacing="2" cellpadding="0">
		...
		<tr class="table_tr2">
			...
			<td class="table_td3"><s:select cssClass="select" name="person.membership" headerKey="" headerValue="--请选择--" list="%{baseService.getSystemOptionMapAsName('membership', null)}" /></td>
			<td class="table_td4"></td>
		</tr>
		<tr class="table_tr2">
			<td class="table_td2">国家或地区：</td>
			<td class="table_td3"><s:select cssClass="select" name="person.countryRegion" headerKey="" headerValue="--请选择--" list="%{baseService.getSystemOptionMapAsName('ISO3166-1', null)}" /></td>
			<td class="table_td4"></td>
		</tr>
		<tr class="table_tr2">
			<td class="table_td2">民族：</td>
			<td class="table_td3"><s:select cssClass="select" name="person.ethnic" headerKey="" headerValue="--请选择民族--" list="%{baseService.getSystemOptionMapAsName('GB3304-91', null)}" /></td>
			<td class="table_td4"></td>
		</tr>
		<tr class="table_tr2">
