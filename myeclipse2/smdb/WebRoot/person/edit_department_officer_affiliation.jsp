...
<div class="edit_info" id="department_officer_affiliation">
	<table width="100%" border="0" cellspacing="2" cellpadding="0">
		<tr class="table_tr2">
			<td class="table_td2" width="100"><span class="table_title2">所在院系：</span></td>
			<td class="table_td3">
				<input type="button" id="select_department_btn" class="btn1 select_btn" value="选择"/>
				<div id="departmentName" class="choose_show"><s:property value="%{universityName}"/> <s:property value="%{departmentName}"/></div>
