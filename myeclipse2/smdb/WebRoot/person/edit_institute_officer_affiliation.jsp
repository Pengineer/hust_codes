...
<div class="edit_info" id="institute_officer_affiliation">
	<table width="100%" border="0" cellspacing="2" cellpadding="0">
		<tr class="table_tr2">
			<td class="table_td2" width="100"><span class="table_title2">所在研究基地：</span></td>
			<td class="table_td3">
				<input type="button" id="select_instituteName_btn" class="btn1 select_btn" value="选择"/>
				<div id="instituteName" class="choose_show"><s:property value="%{instituteName}"/></div>
				<s:hidden id="instituteId" name="instituteId" />
			</td>
			<td class="table_td4"></td>
		</tr>
		<tr class="table_tr2">
			<td class="table_td2"><span class="table_title2">人员类型：</span></td>
			<td class="table_td3"><s:select cssClass="select" name="officer.type" headerKey="-1" headerValue="--%{getText('请选择')}--" list="#{'专职人员':'专职人员','兼职人员':'兼职人员','离职人员':'离职人员'}" /></td>
			<td class="table_td4"></td>
		</tr>
		<tr class="table_tr2">
			<td class="table_td2"><span class="">定职时间：</span></td>
			<td class="table_td3">
