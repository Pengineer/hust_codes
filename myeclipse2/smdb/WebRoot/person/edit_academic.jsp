...
<div class="edit_info" id="academic">
	<table width="100%" border="0" cellspacing="2" cellpadding="0">
		...
		<tr class="table_tr2">
			...
			<td class="table_td3"><s:select cssClass="select" headerKey="" headerValue="--%{getText('请选择')}--" list="%{baseService.getSystemOptionMapAsName('educationBackground', null)}" name="academic.lastEducation" /></td>
		...
		<tr class="table_tr2">
			...
			<td class="table_td3"><s:select cssClass="select" headerKey="" headerValue="--%{getText('请选择')}--" list="%{baseService.getSystemOptionMap('expertType', null)}" name="academic.expertType.id" /></td>
			<td class="table_td4"></td>
		</tr>
		<tr class="table_tr2">
		...
		<tr class="table_tr2">
			<td class="table_td2"><s:text name='二级职称' />：</td>
		...
		<tr class="table_tr2">
			...
			<td class="table_td3"><s:select cssClass="select" headerKey="-1" headerValue="--%{getText('请选择')}--" list="%{baseService.getSystemOptionMapAsName('talentType', null)}" name="academic.talent" /></td>
			<td class="table_td4"></td>
		</tr>
		...
		<tr class="table_tr2">
			...
			<td class="table_td3"><s:select cssClass="select" headerKey="" headerValue="--%{getText('请选择')}--" list="%{baseService.getSystemOptionMap('computerLevel', null)}" name="academic.computerLevel.id" /></td>
			<td class="table_td4"></td>
		</tr>
