	...
	<body>
		...
		<div class="main">
			<div class="main_content">
				...
				<textarea id="list_template" style="display:none;">
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
						<tr class="table_main_tr2">
							<td width="4"></td>
							<sec:authorize ifAllGranted="ROLE_PERSON_OFFICER_MINISTRY_ADD">
								<td width="58" align="center"><input id="list_add" class="btn1" type="button" value="添加" /></td>
							</sec:authorize>
							<sec:authorize ifAllGranted="ROLE_PERSON_OFFICER_MINISTRY_DELETE">
								<td width="58"><input id="list_delete" type="button" class="btn1" value="删除" /></td>
							</sec:authorize>
							<sec:authorize ifAllGranted="ROLE_PERSON_OFFICER_MINISTRY_MERGE">
				...
				<s:form id="list" theme="simple" action="delete" namespace="/person/ministryOfficer">
		...
		<script type="text/javascript">
			seajs.use('javascript/person/officer/ministry/list.js', function(list) {
				$(function(){
					list.init();
				})
			});
			seajs.use('javascript/person/pop_merge.js', function(merge) {
				$(function(){
					merge.popMergeDialog(1,"person/ministryOfficer");
				})
			});
		</script>
	</body>
