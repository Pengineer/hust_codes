...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>修改省级管理人员</title>
		<s:include value="/innerBase.jsp" />
	</head>

	<body>
		<div class="link_bar">
			当前位置：社科人员数据&nbsp;&gt;&nbsp;社科管理人员&nbsp;&gt;&nbsp;省级管理人员&nbsp;&gt;&nbsp;合并
		</div>

		<div class="main">
			<s:form id="form_person" action="merge" namespace="/person/provinceOfficer">
				...
				<div id="info" style="display:none">
					<div class="main_content">
						<div id="procedure" class="step_css">
							<ul>
								...
								<li class="proc" name="province_officer_affiliation"><span class="left_step"></span><span class="right_step">任职信息</span></li>
					...
					<div class="main_content">
						...
						<s:include value="/person/edit_province_officer_affiliation.jsp" />
		...
		<script type="text/javascript">
			seajs.use('javascript/person/officer/province/modify.js', function(modify) {
				$(function(){
					modify.init();
				});
			});
			seajs.use('javascript/person/officer/merge.js', function(merge) {
				$(function(){
					merge.init("person/provinceOfficer");
				});
			});
		</script>
	</body>
