...
<div id="simple_search"><!-- 初级检索 -->		
	<s:form id="search" theme="simple" action="list" namespace="/person/instituteOfficer">
				...
				<td align="right">
					<span class="choose_bar">
						<s:select cssClass="select" name="searchType" value="%{searchQuery.searchType}" headerKey="-1" headerValue="--%{getText('不限')}--" 
							list="#{'0':getText('姓名'),'1':getText('所在研究基地'),'2':getText('所在高校'),'3':getText('职务')}" />
					</span>
...
<div id="adv_search" style="display:none;"><!-- 高级检索 -->		
	<s:form id="advSearch" action="advSearch" namespace="/person/instituteOfficer" theme="simple">
		...
		<div class="adv_content">
			...
			<table class="adv_table" width="100%" border="0" cellspacing="2" cellpadding="0">
				<tr class="adv_tr">
					<td class="adv_td1" width="85" align="right">姓名：</td>
					...
					<td class="adv_td1" width="85" align="right">性别：</td>
				...
				<tr class="adv_tr">
					<td class="adv_td1" align="right">所在研究基地：</td>
