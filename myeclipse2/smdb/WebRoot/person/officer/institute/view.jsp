							...
							<div class="p_box_body">
								<div class="p_box_body_t">
									<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#CCCCCC" style="border-collapse:collapse;">
										<tr class="table_tr7">
											<td class="key" width="100">所在研究基地：</td>
											<td class="value" colspan="3"><a class="linkA" id="${subjectionId}" href="">${subjectionName}</a>&nbsp;&nbsp;<a class="linkI" id="${instituteId}" href="">${instituteName}</a></td>
										</tr>
										<tr class="table_tr7">
