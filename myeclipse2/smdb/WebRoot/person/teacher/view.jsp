				...
				<div class="choose_bar">
					<ul>
						...
						<s:if test="!#session.loginer.currentType.within(@csdc.tool.bean.AccountType@EXPERT , @csdc.tool.bean.AccountType@STUDENT)">
							...
							<li id="view_del"><sec:authorize ifAllGranted="ROLE_PERSON_TEACHER_DELETE"><input class="btn1" type="button" value="<s:text name='i18n_Delete' />" /></sec:authorize></li>
							<li id="view_mod"><sec:authorize ifAllGranted="ROLE_PERSON_TEACHER_MODIFY"><input class="btn1" type="button" value="<s:text name='i18n_Modify' />" /></sec:authorize></li>
							<li id="view_add"><sec:authorize ifAllGranted="ROLE_PERSON_TEACHER_ADD"><input class="btn1" type="button" value="<s:text name='i18n_Add' />" /></sec:authorize></li>
						</s:if>
					</ul>
				</div>
