	...
	<body>
		...
		<div class="main">
			<div class="main_content">
				...
				<textarea id="list_template" style="display:none;">
					<table id="list_table" width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
						<thead id="list_head">
							<tr class="table_title_tr">
								...
								<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
								<td width="90"><a id="sortcolumn2" href="" class="{if sortColumn == 2}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="按所在单位排序">所在单位</a></td>
								<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
								<td><a id="sortcolumn3" href="" class="{if sortColumn == 3}{if sortColumnLabel == 1}up_css{else}down_css{/if}{/if}" title="按所在部门排序">所在部门</a></td>
								<td width="2"><img src="image/table_line.gif" width="2" height="24" /></td>
						...
						{for item in root}
							<tr>
								...
								<sec:authorize ifAnyGranted="ROLE_SYSTEM_KEY,ROLE_SYSTEM_KEY_VIEW,ROLE_SYSTEM_KEY_MODIFY">
									<td></td>
									<td>
										<a class="toggleKey" href="javascript:void(0)" alt="${item.laData[6]}" iskey="${item.laData[7]}">
										{if item.laData[7] == 1}<img src="image/person_on.png" title="重点人，点击切换至非重点人" />{else}<img src="image/person_off.png" title="非重点人，点击切换至重点人" />{/if}
										</a>
									</td>
								</sec:authorize>
							</tr>
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table_td_padding">
						<tr class="table_main_tr2">
							<td width="4"></td>
							<sec:authorize ifAllGranted="ROLE_PERSON_EXPERT_ADD">
								<td width="58" align="center"><input id="list_add" class="btn1" type="button" value="添加" /></td>
								</sec:authorize>
							<sec:authorize ifAllGranted="ROLE_PERSON_EXPERT_DELETE">
								<td width="58"><input id="list_delete" type="button" class="btn1" value="删除" /></td>
							</sec:authorize>
							<sec:authorize ifAllGranted="ROLE_PERSON_EXPERT_MERGE">
				...
				<s:form id="list" theme="simple" action="delete" namespace="/person/expert">
		...
		<script type="text/javascript">
			seajs.use('javascript/person/expert/list.js', function(list) {
				$(function(){
					list.init();
				})
			});
			seajs.use('javascript/person/pop_merge.js', function(merge) {
				$(function(){
					merge.popMergeDialog(1,"person/expert");
				})
			});
		</script>
	</body>
