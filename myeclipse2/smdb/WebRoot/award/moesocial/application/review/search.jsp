		...
		<div class="adv_content">
			...
			<table class="adv_table" width="100%" border="0" cellspacing="2" cellpadding="0">
				<tr class="adv_tr">
					...
					<td class="adv_td1" width="210"><s:select cssClass="select" name="ptypeid" value="%{searchQuery.ptypeid}" headerKey="-1" headerValue="--%{getText('请选择')}--" list="%{baseService.getSystemOptionMapAsName('productType', null)}" /></td>
					<td class="adv_td1"></td>
				</tr>
				<tr class="adv_tr">
				...
				<tr class="adv_tr">
					...
					<td class="adv_td1">
						<s:select cssClass="select" name="session3" value="%{searchQuery.session3}" list="{}" id="session3" headerKey="-1" headerValue="--%{getText('请选择')}--"/>
			   		 	至
			   			<s:select cssClass="select" name="session2" value="%{searchQuery.session2}" list="{}" id="session2" headerKey="-1" headerValue="--%{getText('请选择')}--"/>
			   		</td>
					<td class="adv_td1"></td>
				</tr>
				<tr class="adv_tr">
					...
					<td class="adv_td1">
						   <s:select cssClass="select" name="reviewStatus" value="%{searchQuery.reviewStatus}" list="#{'3':getText('已提交'),'2':getText('保存'),'0':getText('待审')}" headerKey="-1" headerValue="--%{getText('请选择')}--" />
			   		</td>
					<td class="adv_td1"></td>
				...
				<tr class="adv_tr">
					...
					<td class="adv_td2">
						   <s:select cssClass="select" name="groupReviewStatus" value="%{searchQuery.groupReviewStatus}" list="#{'32':getText('同意'),'31':getText('不同意'),'22':getText('同意（暂存）'),'21':getText('不同意（暂存）'),'0':getText('待审')}" headerKey="-1" headerValue="--%{getText('请选择')}--" />
			   		</td>
					<td class="adv_td2"></td>
				</tr>
			</table>
