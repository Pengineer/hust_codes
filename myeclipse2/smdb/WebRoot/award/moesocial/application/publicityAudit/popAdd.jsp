	...
	<body>
		<div style="width:450px;">
			<s:form id="award_audit">
				...
				<table width="100%" border="0" cellspacing="2" cellpadding="0">
					<tr class="table_tr2">
						...
						<td class="table_td3"><s:radio name="auditResult" theme="simple" list="#{'2':getText('同意'),'1':getText('不同意')}"/></td>
				...
				<div id="div_awarded" style="display:none">
					<table width="100%" border="0" cellspacing="2" cellpadding="0">
						<tr class="table_tr2">
							...
							<td class="table_td3"><s:select cssClass="select" id="year" name="year" list="%{#session.yearMap}" headerKey="-1" headerValue="--%{getText('不限')}--" /></td>
							<td class="table_td4" width="90"></td>
						</tr>
						<s:if test="audflag == 0">
							<tr class="table_tr2">
			...
			<div class="btn_div_view">
				<input id="awardAuditSave" class="btn1" type="button" value="保存" />
				<input id="awardAuditSubmit" class="btn1" type="button" value="提交"/>
