					...
					<div style="margin-bottom:10px;">
						<table style="width:350px;" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td><s:radio name="type" value="%{type}" list="#{'0':getText('指定级别'),'1':getText('指定名称')}"></s:radio></td>
								<td style="width:100px; text-align:right;">
									<s:select cssClass="select" id="specifyType" cssStyle="display:none;" headerKey="-1" headerValue="--%{getText('所有级别')}--"
										list="#{'1':getText('系统管理员账号'),'2':getText('部级账号'),'3':getText('省级账号'),'4':getText('校级账号'),'6':getText('院系账号'),'7':getText('基地账号'),'8':getText('外部专家账号'),'9':getText('教师账号'),'10':getText('学生账号')}" />
