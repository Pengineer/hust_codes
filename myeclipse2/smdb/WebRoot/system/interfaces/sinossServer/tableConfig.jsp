	...
	<div class="main_content">
		...
		<table width="100%" border="0" cellspacing="2" cellpadding="0">
			...
			<tr class="table_tr2">
				...
				<td class="table_td3">
					<s:select cssClass="select" id="startYear" name="startYear" list="%{projectService.getYearMap()}" headerKey="-1" headerValue="--%{getText('不限')}--" />
					至
					<s:select cssClass="select" id="endYear" name="endYear" list="%{projectService.getYearMap()}" headerKey="-1" headerValue="--%{getText('不限')}--" />
				</td>
			</tr>
			<tr class="table_tr2">
				<td class="table_td2"><s:text name="申请时间" />：</td>
				<td class="table_td3">
			...
			<tr class="table_tr2">
				<td class="table_td2"><s:text name="审核时间" />：</td>
				<td class="table_td3">
