				...
				<s:form id="form_dm" action="toHotspot" namespace="/dataMining/hotspot" theme="simple" >
					<table width="100%" border="0" cellspacing="2" cellpadding="2">
						<tr class="table_tr2">
							...
							<td class="table_td3"><s:select cssClass="select" id="type" name="type" headerKey="-1" headerValue="--%{getText('请选择')}--" list="#{'general':getText('一般项目'), 'key':getText('重大攻关项目基地项目'), 'instp':getText('基地项目'), 'post':getText('后期资助项目'), 'entrust':getText('应急委托课题')}"/></td>
						...
						<tr class="table_tr2">
							...
							<td class="table_td3">
								<s:radio name="analyzeAngle" value="1" list="#{'0':getText('申报数据'), '1':getText('立项数据')}" />
							</td>
							<td class="table_td4"></td>
						</tr>
