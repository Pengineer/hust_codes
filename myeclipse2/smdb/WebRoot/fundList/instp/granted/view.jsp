	...
	<s:i18n name="csdc.resources.i18n_Project">
		<head>
			...
			<script type="text/javascript">
					seajs.use(['javascript/fundList/instp/granted/view.js',
								'javascript/projectFund/instp/list.js'], function(list,view) {
						list.init();
						view.init();
					});
			</script>
			...
			<div class="main">
				...
				<div class="main_content">
					...
					<div class="main_content">
						...
						<div class="p_box">
							<div id="forProject">
								<s:include value="/fundList/instp/granted/projectView.jsp" />
							</div>
							<div id="forUnit">
