...
<div id="simple_search">
	<s:form id="search" theme="simple" action="list" namespace="/fundList/instp/granted">
			...
			<tr class="table_main_tr">
				<td align="right"><span class="choose_bar">
						<s:select cssClass="select" name="searchType" id="search_type" value="%{searchQuery.searchType}" headerKey="-1" headerValue="--%{getText('i18n_NoLimit')}--"
							list="#{'1':getText('清单名称'),'2':getText('经办人'),'3':getText('清单状态'),'4':getText('清单备注')}" />
...
<div id="adv_search" style="display:none;">
	<s:form id="advSearch" action="advSearch" theme="simple" namespace="/fundList/instp/granted">
